...
module DatapointValueMap =
  struct
    ...
    let parse xml = None
    let to_query v =
      Aws.Query.to_query_hashtbl String.to_string Double.to_query v
    let to_json v =
      `Assoc
        (Hashtbl.fold
           (fun k ->
  ...
  struct
      ...
      Some
        {
          timestamp =
            (Aws.Util.option_bind (Aws.Xml.member "Timestamp" xml)
               DateTime.parse);
          sample_count =
            (Aws.Util.option_bind (Aws.Xml.member "SampleCount" xml)
               Double.parse);
          average =
            (Aws.Util.option_bind (Aws.Xml.member "Average" xml) Double.parse);
          sum =
          ...
          unit =
            (Aws.Util.option_bind (Aws.Xml.member "Unit" xml)
               StandardUnit.parse);
          extended_statistics =
            (Aws.Util.option_bind (Aws.Xml.member "ExtendedStatistics" xml)
               DatapointValueMap.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.extended_statistics
              (fun f ->
                 Aws.Query.Pair
                   ("ExtendedStatistics", (DatapointValueMap.to_query f)));
           Aws.Util.option_map v.unit
             (fun f -> Aws.Query.Pair ("Unit", (StandardUnit.to_query f)));
           Aws.Util.option_map v.maximum
             (fun f -> Aws.Query.Pair ("Maximum", (Double.to_query f)));
           Aws.Util.option_map v.minimum
             (fun f -> Aws.Query.Pair ("Minimum", (Double.to_query f)));
           Aws.Util.option_map v.sum
             (fun f -> Aws.Query.Pair ("Sum", (Double.to_query f)));
           Aws.Util.option_map v.average
             (fun f -> Aws.Query.Pair ("Average", (Double.to_query f)));
           Aws.Util.option_map v.sample_count
             (fun f -> Aws.Query.Pair ("SampleCount", (Double.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.extended_statistics
              (fun f -> ("ExtendedStatistics", (DatapointValueMap.to_json f)));
           Aws.Util.option_map v.unit
           ...
           Aws.Util.option_map v.sample_count
             (fun f -> ("SampleCount", (Double.to_json f)));
           Aws.Util.option_map v.timestamp
             (fun f -> ("Timestamp", (DateTime.to_json f)))])
    let of_json j =
      {
        timestamp =
          (Aws.Util.option_map (Aws.Json.lookup j "Timestamp")
             DateTime.of_json);
        sample_count =
          (Aws.Util.option_map (Aws.Json.lookup j "SampleCount")
             Double.of_json);
        average =
          (Aws.Util.option_map (Aws.Json.lookup j "Average") Double.of_json);
        sum = (Aws.Util.option_map (Aws.Json.lookup j "Sum") Double.of_json);
        minimum =
          (Aws.Util.option_map (Aws.Json.lookup j "Minimum") Double.of_json);
        maximum =
          (Aws.Util.option_map (Aws.Json.lookup j "Maximum") Double.of_json);
        unit =
          (Aws.Util.option_map (Aws.Json.lookup j "Unit")
             StandardUnit.of_json);
        extended_statistics =
          (Aws.Util.option_map (Aws.Json.lookup j "ExtendedStatistics")
...
module Datapoints =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Datapoint.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          ...
          datapoints =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Datapoints" xml)
                  Datapoints.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.label
             (fun f -> Aws.Query.Pair ("Label", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("Datapoints", (Datapoints.to_json v.datapoints));
           Aws.Util.option_map v.label
             (fun f -> ("Label", (String.to_json f)))])
    let of_json j =
      {
        label =
          (Aws.Util.option_map (Aws.Json.lookup j "Label") String.of_json);
        datapoints =
          (Datapoints.of_json
  ...
  struct
    ...
    let parse xml =
      Some
        {
          alarm_names =
            (Aws.Xml.required "AlarmNames"
               (Aws.Util.option_bind (Aws.Xml.member "AlarmNames" xml)
                  AlarmNames.parse))
        }
    let to_query v =
      Aws.Query.List
  ...
  struct
    ...
    let parse xml =
      Some
        {
          dashboard_names =
            (Aws.Xml.required "DashboardNames"
               (Aws.Util.option_bind (Aws.Xml.member "DashboardNames" xml)
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("DashboardNames", (DashboardNames.to_json v.dashboard_names))])
    let of_json j =
      {
        dashboard_names =
...
module Dimensions =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Dimension.parse (Aws.Xml.members "member" xml))
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair ("StartTime", (DateTime.to_query v.start_time)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        ...
        end_time =
          (DateTime.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "EndTime")))
      }
  end
module AnomalyDetectorExcludedTimeRanges =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Range.parse (Aws.Xml.members "member" xml))
  ...
  struct
      ...
      Some
        {
          ...
          metric_timezone =
            (Aws.Util.option_bind (Aws.Xml.member "MetricTimezone" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.metric_timezone
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.metric_timezone
              (fun f -> ("MetricTimezone", (String.to_json f)));
           Some
             ("ExcludedTimeRanges",
    ...
    let of_json j =
      {
        ...
        metric_timezone =
          (Aws.Util.option_map (Aws.Json.lookup j "MetricTimezone")
             String.of_json)
      }
  end
          ...
          dimensions =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Dimensions" xml)
                  Dimensions.parse));
          stat =
            (Aws.Xml.required "Stat"
               (Aws.Util.option_bind (Aws.Xml.member "Stat" xml) String.parse));
          configuration =
            (Aws.Util.option_bind (Aws.Xml.member "Configuration" xml)
               AnomalyDetectorConfiguration.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.configuration
              (fun f ->
                 Aws.Query.Pair
                   ("Configuration",
    ...
    let of_json j =
      {
        ...
        stat =
          (String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Stat")));
        configuration =
          (Aws.Util.option_map (Aws.Json.lookup j "Configuration")
...
module ListTagsForResourceOutput =
  struct
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt [Some ("Tags", (TagList.to_json v.tags))])
    let of_json j =
      {
        tags =
          (TagList.of_json
...
module Timestamps =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map DateTime.parse (Aws.Xml.members "member" xml))
...
module MetricDataResultMessages =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map MessageData.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          ...
          timestamps =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Timestamps" xml)
                  Timestamps.parse));
          values =
            (Aws.Util.of_option []
          ...
          status_code =
            (Aws.Util.option_bind (Aws.Xml.member "StatusCode" xml)
               StatusCode.parse);
          messages =
            (Aws.Util.of_option []
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.status_code
             (fun f -> Aws.Query.Pair ("StatusCode", (StatusCode.to_query f)));
           Some
             (Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.status_code
             (fun f -> ("StatusCode", (StatusCode.to_json f)));
    ...
    let of_json j =
      {
        ...
        status_code =
          (Aws.Util.option_map (Aws.Json.lookup j "StatusCode")
             StatusCode.of_json);
        messages =
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("Dimensions.member", (Dimensions.to_query v.dimensions)));
           Aws.Util.option_map v.metric_name
             (fun f -> Aws.Query.Pair ("MetricName", (String.to_query f)));
           Aws.Util.option_map v.namespace
             (fun f -> Aws.Query.Pair ("Namespace", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("Dimensions", (Dimensions.to_json v.dimensions));
           Aws.Util.option_map v.metric_name
             (fun f -> ("MetricName", (String.to_json f)));
           Aws.Util.option_map v.namespace
    ...
    let of_json j =
      {
        ...
        max_results =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxResults")
             Integer.of_json);
        namespace =
          (Aws.Util.option_map (Aws.Json.lookup j "Namespace") String.of_json);
        metric_name =
          (Aws.Util.option_map (Aws.Json.lookup j "MetricName")
             String.of_json);
        dimensions =
          (Dimensions.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Dimensions")))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          metric =
            (Aws.Xml.required "Metric"
               (Aws.Util.option_bind (Aws.Xml.member "Metric" xml)
                  Metric.parse));
          period =
    ...
    let of_json j =
      {
        metric =
          (Metric.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Metric")));
        period =
          (Integer.of_json
      ...
      Some
        {
          ...
          metric_stat =
            (Aws.Util.option_bind (Aws.Xml.member "MetricStat" xml)
               MetricStat.parse);
          expression =
          ...
          label =
            (Aws.Util.option_bind (Aws.Xml.member "Label" xml) String.parse);
          return_data =
            (Aws.Util.option_bind (Aws.Xml.member "ReturnData" xml)
               Boolean.parse);
          period =
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.period
              (fun f -> Aws.Query.Pair ("Period", (Integer.to_query f)));
           Aws.Util.option_map v.return_data
             (fun f -> Aws.Query.Pair ("ReturnData", (Boolean.to_query f)));
           Aws.Util.option_map v.label
             (fun f -> Aws.Query.Pair ("Label", (String.to_query f)));
           Aws.Util.option_map v.expression
             (fun f -> Aws.Query.Pair ("Expression", (String.to_query f)));
           Aws.Util.option_map v.metric_stat
             (fun f -> Aws.Query.Pair ("MetricStat", (MetricStat.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.return_data
             (fun f -> ("ReturnData", (Boolean.to_json f)));
           Aws.Util.option_map v.label
             (fun f -> ("Label", (String.to_json f)));
           Aws.Util.option_map v.expression
             (fun f -> ("Expression", (String.to_json f)));
           Aws.Util.option_map v.metric_stat
             (fun f -> ("MetricStat", (MetricStat.to_json f)));
    ...
    let of_json j =
      {
        ...
        metric_stat =
          (Aws.Util.option_map (Aws.Json.lookup j "MetricStat")
             MetricStat.of_json);
        expression =
          (Aws.Util.option_map (Aws.Json.lookup j "Expression")
             String.of_json);
        label =
          (Aws.Util.option_map (Aws.Json.lookup j "Label") String.of_json);
        return_data =
          (Aws.Util.option_map (Aws.Json.lookup j "ReturnData")
             Boolean.of_json);
        period =
          (Aws.Util.option_map (Aws.Json.lookup j "Period") Integer.of_json)
      }
  end
module MetricDataQueries =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map MetricDataQuery.parse (Aws.Xml.members "member" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          alarm_name =
            (Aws.Util.option_bind (Aws.Xml.member "AlarmName" xml)
               String.parse);
          alarm_arn =
            (Aws.Util.option_bind (Aws.Xml.member "AlarmArn" xml)
               String.parse);
          alarm_description =
            (Aws.Util.option_bind (Aws.Xml.member "AlarmDescription" xml)
               String.parse);
          alarm_configuration_updated_timestamp =
            (Aws.Util.option_bind
               ...
               DateTime.parse);
          actions_enabled =
            (Aws.Util.option_bind (Aws.Xml.member "ActionsEnabled" xml)
               Boolean.parse);
          o_k_actions =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "OKActions" xml)
                  ResourceList.parse));
          alarm_actions =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "AlarmActions" xml)
                  ResourceList.parse));
          insufficient_data_actions =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
                  ...
                  ResourceList.parse));
          state_value =
            (Aws.Util.option_bind (Aws.Xml.member "StateValue" xml)
               StateValue.parse);
          state_reason =
            (Aws.Util.option_bind (Aws.Xml.member "StateReason" xml)
               String.parse);
          state_reason_data =
            (Aws.Util.option_bind (Aws.Xml.member "StateReasonData" xml)
               String.parse);
          state_updated_timestamp =
            (Aws.Util.option_bind
               (Aws.Xml.member "StateUpdatedTimestamp" xml) DateTime.parse);
          metric_name =
            (Aws.Util.option_bind (Aws.Xml.member "MetricName" xml)
               String.parse);
          namespace =
          ...
          statistic =
            (Aws.Util.option_bind (Aws.Xml.member "Statistic" xml)
               Statistic.parse);
          extended_statistic =
            (Aws.Util.option_bind (Aws.Xml.member "ExtendedStatistic" xml)
               String.parse);
          dimensions =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Dimensions" xml)
          ...
          evaluation_periods =
            (Aws.Util.option_bind (Aws.Xml.member "EvaluationPeriods" xml)
               Integer.parse);
          datapoints_to_alarm =
            (Aws.Util.option_bind (Aws.Xml.member "DatapointsToAlarm" xml)
               Integer.parse);
          threshold =
          ...
          treat_missing_data =
            (Aws.Util.option_bind (Aws.Xml.member "TreatMissingData" xml)
               String.parse);
          evaluate_low_sample_count_percentile =
            (Aws.Util.option_bind
          ...
          threshold_metric_id =
            (Aws.Util.option_bind (Aws.Xml.member "ThresholdMetricId" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.threshold_metric_id
              (fun f ->
                 Aws.Query.Pair ("ThresholdMetricId", (String.to_query f)));
           Some
             (Aws.Query.Pair
                ("Metrics.member", (MetricDataQueries.to_query v.metrics)));
           Aws.Util.option_map v.evaluate_low_sample_count_percentile
             (fun f ->
                Aws.Query.Pair
                  ("EvaluateLowSampleCountPercentile", (String.to_query f)));
           Aws.Util.option_map v.treat_missing_data
             (fun f ->
           ...
           Aws.Util.option_map v.threshold
             (fun f -> Aws.Query.Pair ("Threshold", (Double.to_query f)));
           Aws.Util.option_map v.datapoints_to_alarm
             (fun f ->
                Aws.Query.Pair ("DatapointsToAlarm", (Integer.to_query f)));
           Aws.Util.option_map v.evaluation_periods
             (fun f ->
           ...
           Some
             (Aws.Query.Pair
                ("Dimensions.member", (Dimensions.to_query v.dimensions)));
           Aws.Util.option_map v.extended_statistic
             (fun f ->
                Aws.Query.Pair ("ExtendedStatistic", (String.to_query f)));
           Aws.Util.option_map v.statistic
             (fun f -> Aws.Query.Pair ("Statistic", (Statistic.to_query f)));
           Aws.Util.option_map v.namespace
             (fun f -> Aws.Query.Pair ("Namespace", (String.to_query f)));
           Aws.Util.option_map v.metric_name
             (fun f -> Aws.Query.Pair ("MetricName", (String.to_query f)));
           Aws.Util.option_map v.state_updated_timestamp
             (fun f ->
                Aws.Query.Pair
                  ("StateUpdatedTimestamp", (DateTime.to_query f)));
           Aws.Util.option_map v.state_reason_data
             (fun f ->
           ...
           Aws.Util.option_map v.state_value
             (fun f -> Aws.Query.Pair ("StateValue", (StateValue.to_query f)));
           Some
             (Aws.Query.Pair
           ...
           Aws.Util.option_map v.actions_enabled
             (fun f ->
                Aws.Query.Pair ("ActionsEnabled", (Boolean.to_query f)));
           Aws.Util.option_map v.alarm_configuration_updated_timestamp
             (fun f ->
                Aws.Query.Pair
                  ("AlarmConfigurationUpdatedTimestamp",
                    (DateTime.to_query f)));
           Aws.Util.option_map v.alarm_description
             (fun f ->
                Aws.Query.Pair ("AlarmDescription", (String.to_query f)));
           Aws.Util.option_map v.alarm_arn
             (fun f -> Aws.Query.Pair ("AlarmArn", (String.to_query f)));
           Aws.Util.option_map v.alarm_name
             (fun f -> Aws.Query.Pair ("AlarmName", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.threshold_metric_id
              (fun f -> ("ThresholdMetricId", (String.to_json f)));
           Some ("Metrics", (MetricDataQueries.to_json v.metrics));
           Aws.Util.option_map v.evaluate_low_sample_count_percentile
             (fun f ->
                ("EvaluateLowSampleCountPercentile", (String.to_json f)));
           Aws.Util.option_map v.treat_missing_data
             (fun f -> ("TreatMissingData", (String.to_json f)));
           Aws.Util.option_map v.comparison_operator
             (fun f -> ("ComparisonOperator", (ComparisonOperator.to_json f)));
           Aws.Util.option_map v.threshold
             (fun f -> ("Threshold", (Double.to_json f)));
           Aws.Util.option_map v.datapoints_to_alarm
             (fun f -> ("DatapointsToAlarm", (Integer.to_json f)));
           Aws.Util.option_map v.evaluation_periods
             (fun f -> ("EvaluationPeriods", (Integer.to_json f)));
           Aws.Util.option_map v.unit
             (fun f -> ("Unit", (StandardUnit.to_json f)));
           Aws.Util.option_map v.period
             (fun f -> ("Period", (Integer.to_json f)));
           Some ("Dimensions", (Dimensions.to_json v.dimensions));
           Aws.Util.option_map v.extended_statistic
             (fun f -> ("ExtendedStatistic", (String.to_json f)));
           Aws.Util.option_map v.statistic
           ...
           Aws.Util.option_map v.metric_name
             (fun f -> ("MetricName", (String.to_json f)));
           Aws.Util.option_map v.state_updated_timestamp
             (fun f -> ("StateUpdatedTimestamp", (DateTime.to_json f)));
           Aws.Util.option_map v.state_reason_data
             (fun f -> ("StateReasonData", (String.to_json f)));
           Aws.Util.option_map v.state_reason
             (fun f -> ("StateReason", (String.to_json f)));
           Aws.Util.option_map v.state_value
             (fun f -> ("StateValue", (StateValue.to_json f)));
           Some
           ...
           Aws.Util.option_map v.actions_enabled
             (fun f -> ("ActionsEnabled", (Boolean.to_json f)));
           Aws.Util.option_map v.alarm_configuration_updated_timestamp
             (fun f ->
                ("AlarmConfigurationUpdatedTimestamp", (DateTime.to_json f)));
           Aws.Util.option_map v.alarm_description
             (fun f -> ("AlarmDescription", (String.to_json f)));
           Aws.Util.option_map v.alarm_arn
             (fun f -> ("AlarmArn", (String.to_json f)));
           Aws.Util.option_map v.alarm_name
             (fun f -> ("AlarmName", (String.to_json f)))])
    let of_json j =
      {
        alarm_name =
          (Aws.Util.option_map (Aws.Json.lookup j "AlarmName") String.of_json);
        alarm_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "AlarmArn") String.of_json);
        alarm_description =
          (Aws.Util.option_map (Aws.Json.lookup j "AlarmDescription")
             String.of_json);
        alarm_configuration_updated_timestamp =
          (Aws.Util.option_map
             ...
             DateTime.of_json);
        actions_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "ActionsEnabled")
             Boolean.of_json);
        o_k_actions =
          (ResourceList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "OKActions")));
        alarm_actions =
          (ResourceList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AlarmActions")));
        insufficient_data_actions =
          (ResourceList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "InsufficientDataActions")));
        state_value =
          (Aws.Util.option_map (Aws.Json.lookup j "StateValue")
             StateValue.of_json);
        state_reason =
          (Aws.Util.option_map (Aws.Json.lookup j "StateReason")
             String.of_json);
        state_reason_data =
          (Aws.Util.option_map (Aws.Json.lookup j "StateReasonData")
             String.of_json);
        state_updated_timestamp =
          (Aws.Util.option_map (Aws.Json.lookup j "StateUpdatedTimestamp")
             DateTime.of_json);
        metric_name =
          (Aws.Util.option_map (Aws.Json.lookup j "MetricName")
             String.of_json);
        ...
        statistic =
          (Aws.Util.option_map (Aws.Json.lookup j "Statistic")
             Statistic.of_json);
        extended_statistic =
          (Aws.Util.option_map (Aws.Json.lookup j "ExtendedStatistic")
             String.of_json);
        dimensions =
          (Dimensions.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Dimensions")));
        ...
        unit =
          (Aws.Util.option_map (Aws.Json.lookup j "Unit")
             StandardUnit.of_json);
        evaluation_periods =
          (Aws.Util.option_map (Aws.Json.lookup j "EvaluationPeriods")
             Integer.of_json);
        datapoints_to_alarm =
          (Aws.Util.option_map (Aws.Json.lookup j "DatapointsToAlarm")
             Integer.of_json);
        threshold =
          (Aws.Util.option_map (Aws.Json.lookup j "Threshold") Double.of_json);
        comparison_operator =
          (Aws.Util.option_map (Aws.Json.lookup j "ComparisonOperator")
             ComparisonOperator.of_json);
        treat_missing_data =
          (Aws.Util.option_map (Aws.Json.lookup j "TreatMissingData")
             String.of_json);
        evaluate_low_sample_count_percentile =
          (Aws.Util.option_map
        ...
        threshold_metric_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ThresholdMetricId")
             String.of_json)
      }
  end
module MetricAlarms =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map MetricAlarm.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          metric_alarms =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "MetricAlarms" xml)
                  MetricAlarms.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        metric_alarms =
          (MetricAlarms.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MetricAlarms")))
      }
  end
  ...
  struct
           ...
           Aws.Util.option_map v.configuration
             (fun f ->
                Aws.Query.Pair
                  ("Configuration",
                    (AnomalyDetectorConfiguration.to_query f)));
           Aws.Util.option_map v.stat
             (fun f -> Aws.Query.Pair ("Stat", (String.to_query f)));
           Some
             (Aws.Query.Pair
                ("Dimensions.member", (Dimensions.to_query v.dimensions)));
           Aws.Util.option_map v.metric_name
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.state_value
              (fun f -> ("StateValue", (AnomalyDetectorStateValue.to_json f)));
           Aws.Util.option_map v.configuration
             (fun f ->
                ("Configuration", (AnomalyDetectorConfiguration.to_json f)));
    ...
    let of_json j =
      {
        ...
        dimensions =
          (Dimensions.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Dimensions")));
        stat =
          (Aws.Util.option_map (Aws.Json.lookup j "Stat") String.of_json);
        configuration =
          (Aws.Util.option_map (Aws.Json.lookup j "Configuration")
             AnomalyDetectorConfiguration.of_json);
        state_value =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          sample_count =
            (Aws.Xml.required "SampleCount"
               (Aws.Util.option_bind (Aws.Xml.member "SampleCount" xml)
                  Double.parse));
          sum =
            (Aws.Xml.required "Sum"
               (Aws.Util.option_bind (Aws.Xml.member "Sum" xml) Double.parse));
          minimum =
            (Aws.Xml.required "Minimum"
               (Aws.Util.option_bind (Aws.Xml.member "Minimum" xml)
                  Double.parse));
          maximum =
            (Aws.Xml.required "Maximum"
               (Aws.Util.option_bind (Aws.Xml.member "Maximum" xml)
                  Double.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("SampleCount", (Double.to_query v.sample_count)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        sample_count =
          (Double.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "SampleCount")));
        sum =
          (Double.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Sum")));
        minimum =
          (Double.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Minimum")));
        maximum =
          (Double.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Maximum")))
      }
  end
module Counts =
  struct
  ...
  struct
      ...
      Some
        {
          ...
          statistic_values =
            (Aws.Util.option_bind (Aws.Xml.member "StatisticValues" xml)
               StatisticSet.parse);
          values =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Values" xml)
          ...
          counts =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Counts" xml)
                  Counts.parse));
          unit =
            (Aws.Util.option_bind (Aws.Xml.member "Unit" xml)
               StandardUnit.parse);
          storage_resolution =
            (Aws.Util.option_bind (Aws.Xml.member "StorageResolution" xml)
               Integer.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.storage_resolution
              (fun f ->
                 Aws.Query.Pair ("StorageResolution", (Integer.to_query f)));
           Aws.Util.option_map v.unit
             (fun f -> Aws.Query.Pair ("Unit", (StandardUnit.to_query f)));
           Some
             (Aws.Query.Pair ("Counts.member", (Counts.to_query v.counts)));
           Some
             (Aws.Query.Pair ("Values.member", (Values.to_query v.values)));
           Aws.Util.option_map v.statistic_values
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.storage_resolution
              (fun f -> ("StorageResolution", (Integer.to_json f)));
           Aws.Util.option_map v.unit
             (fun f -> ("Unit", (StandardUnit.to_json f)));
           Some ("Counts", (Counts.to_json v.counts));
           Some ("Values", (Values.to_json v.values));
           Aws.Util.option_map v.statistic_values
             (fun f -> ("StatisticValues", (StatisticSet.to_json f)));
           Aws.Util.option_map v.value
             (fun f -> ("Value", (Double.to_json f)));
           Aws.Util.option_map v.timestamp
             (fun f -> ("Timestamp", (DateTime.to_json f)));
           Some ("Dimensions", (Dimensions.to_json v.dimensions));
           Some ("MetricName", (String.to_json v.metric_name))])
    let of_json j =
      {
        ...
        timestamp =
          (Aws.Util.option_map (Aws.Json.lookup j "Timestamp")
             DateTime.of_json);
        value =
          (Aws.Util.option_map (Aws.Json.lookup j "Value") Double.of_json);
        statistic_values =
          (Aws.Util.option_map (Aws.Json.lookup j "StatisticValues")
        ...
        counts =
          (Counts.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Counts")));
        unit =
          (Aws.Util.option_map (Aws.Json.lookup j "Unit")
             StandardUnit.of_json);
        storage_resolution =
          (Aws.Util.option_map (Aws.Json.lookup j "StorageResolution")
             Integer.of_json)
      }
  end
module MetricData =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map MetricDatum.parse (Aws.Xml.members "member" xml))
          ...
          namespace =
            (Aws.Xml.required "Namespace"
               (Aws.Util.option_bind (Aws.Xml.member "Namespace" xml)
                  String.parse));
          metric_data =
            (Aws.Xml.required "MetricData"
               (Aws.Util.option_bind (Aws.Xml.member "MetricData" xml)
                  MetricData.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        ...
        metric_data =
          (MetricData.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MetricData")))
      }
  end
module Statistics =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Statistic.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          ...
          statistics =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Statistics" xml)
                  Statistics.parse));
          extended_statistics =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        ...
        statistics =
          (Statistics.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Statistics")));
        extended_statistics =
      ...
      Some
        {
          ...
          alarm_description =
            (Aws.Util.option_bind (Aws.Xml.member "AlarmDescription" xml)
               String.parse);
          alarm_name =
            (Aws.Xml.required "AlarmName"
               (Aws.Util.option_bind (Aws.Xml.member "AlarmName" xml)
                  String.parse));
          alarm_rule =
            (Aws.Xml.required "AlarmRule"
               (Aws.Util.option_bind (Aws.Xml.member "AlarmRule" xml)
                  String.parse));
          insufficient_data_actions =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
           ...
           Some
             (Aws.Query.Pair
                ("InsufficientDataActions.member",
                  (ResourceList.to_query v.insufficient_data_actions)));
           Some
             (Aws.Query.Pair ("AlarmRule", (String.to_query v.alarm_rule)));
           Some
             (Aws.Query.Pair ("AlarmName", (String.to_query v.alarm_name)));
           Aws.Util.option_map v.alarm_description
             (fun f ->
                Aws.Query.Pair ("AlarmDescription", (String.to_query f)));
           Some
    ...
    let of_json j =
      {
        ...
        alarm_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AlarmName")));
        alarm_rule =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AlarmRule")));
        insufficient_data_actions =
          (ResourceList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "InsufficientDataActions")));
          ...
          state =
            (Aws.Xml.required "State"
               (Aws.Util.option_bind (Aws.Xml.member "State" xml)
                  String.parse));
          schema =
            (Aws.Xml.required "Schema"
               (Aws.Util.option_bind (Aws.Xml.member "Schema" xml)
                  String.parse));
          definition =
            (Aws.Xml.required "Definition"
               (Aws.Util.option_bind (Aws.Xml.member "Definition" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair ("Definition", (String.to_query v.definition)));
    ...
    let of_json j =
      {
        ...
        schema =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Schema")));
        definition =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Definition")))
      }
  end
module InsightRules =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map InsightRule.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          ...
          insight_rules =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "InsightRules" xml)
                  InsightRules.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        ...
        insight_rules =
          (InsightRules.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "InsightRules")))
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          failure_resource =
            (Aws.Util.option_bind (Aws.Xml.member "FailureResource" xml)
               String.parse);
          exception_type =
            (Aws.Util.option_bind (Aws.Xml.member "ExceptionType" xml)
               String.parse);
          failure_code =
            (Aws.Util.option_bind (Aws.Xml.member "FailureCode" xml)
               String.parse);
          failure_description =
            (Aws.Util.option_bind (Aws.Xml.member "FailureDescription" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.failure_description
              (fun f ->
           ...
           Aws.Util.option_map v.exception_type
             (fun f -> Aws.Query.Pair ("ExceptionType", (String.to_query f)));
           Aws.Util.option_map v.failure_resource
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.failure_description
              (fun f -> ("FailureDescription", (String.to_json f)));
           Aws.Util.option_map v.failure_code
             (fun f -> ("FailureCode", (String.to_json f)));
           Aws.Util.option_map v.exception_type
             (fun f -> ("ExceptionType", (String.to_json f)));
           Aws.Util.option_map v.failure_resource
             (fun f -> ("FailureResource", (String.to_json f)))])
    let of_json j =
      {
        failure_resource =
          (Aws.Util.option_map (Aws.Json.lookup j "FailureResource")
             String.of_json);
        exception_type =
          (Aws.Util.option_map (Aws.Json.lookup j "ExceptionType")
             String.of_json);
        failure_code =
          (Aws.Util.option_map (Aws.Json.lookup j "FailureCode")
             String.of_json);
        failure_description =
          (Aws.Util.option_map (Aws.Json.lookup j "FailureDescription")
             String.of_json)
      }
  end
module BatchFailures =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map PartialFailure.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          failures =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Failures" xml)
                  BatchFailures.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        failures =
          (BatchFailures.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Failures")))
      }
  end
module AlarmType =
  struct
...
module AlarmTypes =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map AlarmType.parse (Aws.Xml.members "member" xml))
...
module Metrics =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Metric.parse (Aws.Xml.members "member" xml))
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Some
             (Aws.Query.Pair ("Metrics.member", (Metrics.to_query v.metrics)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
  ...
  struct
    ...
    let parse xml =
      Some
        {
          data_path =
            (Aws.Util.option_bind (Aws.Xml.member "DataPath" xml)
               String.parse);
          message =
            (Aws.Util.option_bind (Aws.Xml.member "Message" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.message
              (fun f -> Aws.Query.Pair ("Message", (String.to_query f)));
           Aws.Util.option_map v.data_path
             (fun f -> Aws.Query.Pair ("DataPath", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.message
              (fun f -> ("Message", (String.to_json f)));
           Aws.Util.option_map v.data_path
             (fun f -> ("DataPath", (String.to_json f)))])
    let of_json j =
      {
        data_path =
          (Aws.Util.option_map (Aws.Json.lookup j "DataPath") String.of_json);
        message =
          (Aws.Util.option_map (Aws.Json.lookup j "Message") String.of_json)
      }
  end
module DashboardValidationMessages =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map DashboardValidationMessage.parse
           (Aws.Xml.members "member" xml))
    let to_query v =
      Aws.Query.to_query_list DashboardValidationMessage.to_query v
      ...
      Some
        {
          alarm_name =
            (Aws.Util.option_bind (Aws.Xml.member "AlarmName" xml)
               String.parse);
          alarm_type =
            (Aws.Util.option_bind (Aws.Xml.member "AlarmType" xml)
               AlarmType.parse);
          timestamp =
            (Aws.Util.option_bind (Aws.Xml.member "Timestamp" xml)
               DateTime.parse);
          history_item_type =
            (Aws.Util.option_bind (Aws.Xml.member "HistoryItemType" xml)
               HistoryItemType.parse);
          history_summary =
            (Aws.Util.option_bind (Aws.Xml.member "HistorySummary" xml)
               String.parse);
          history_data =
            (Aws.Util.option_bind (Aws.Xml.member "HistoryData" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.history_data
              (fun f -> Aws.Query.Pair ("HistoryData", (String.to_query f)));
           Aws.Util.option_map v.history_summary
             (fun f -> Aws.Query.Pair ("HistorySummary", (String.to_query f)));
           Aws.Util.option_map v.history_item_type
             (fun f ->
                Aws.Query.Pair
                  ("HistoryItemType", (HistoryItemType.to_query f)));
           Aws.Util.option_map v.timestamp
             (fun f -> Aws.Query.Pair ("Timestamp", (DateTime.to_query f)));
           Aws.Util.option_map v.alarm_type
             (fun f -> Aws.Query.Pair ("AlarmType", (AlarmType.to_query f)));
           Aws.Util.option_map v.alarm_name
             (fun f -> Aws.Query.Pair ("AlarmName", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.history_data
              (fun f -> ("HistoryData", (String.to_json f)));
           Aws.Util.option_map v.history_summary
             (fun f -> ("HistorySummary", (String.to_json f)));
           Aws.Util.option_map v.history_item_type
             (fun f -> ("HistoryItemType", (HistoryItemType.to_json f)));
           Aws.Util.option_map v.timestamp
             (fun f -> ("Timestamp", (DateTime.to_json f)));
           Aws.Util.option_map v.alarm_type
             (fun f -> ("AlarmType", (AlarmType.to_json f)));
           Aws.Util.option_map v.alarm_name
             (fun f -> ("AlarmName", (String.to_json f)))])
    let of_json j =
      {
        alarm_name =
          (Aws.Util.option_map (Aws.Json.lookup j "AlarmName") String.of_json);
        alarm_type =
          (Aws.Util.option_map (Aws.Json.lookup j "AlarmType")
             AlarmType.of_json);
        timestamp =
          (Aws.Util.option_map (Aws.Json.lookup j "Timestamp")
             DateTime.of_json);
        history_item_type =
          (Aws.Util.option_map (Aws.Json.lookup j "HistoryItemType")
             HistoryItemType.of_json);
        history_summary =
          (Aws.Util.option_map (Aws.Json.lookup j "HistorySummary")
             String.of_json);
        history_data =
          (Aws.Util.option_map (Aws.Json.lookup j "HistoryData")
             String.of_json)
      }
  end
module AlarmHistoryItems =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map AlarmHistoryItem.parse (Aws.Xml.members "member" xml))
    ...
    let of_json j =
      {
        dashboard_validation_messages =
          (DashboardValidationMessages.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "DashboardValidationMessages")))
      }
  end
          ...
          timestamp =
            (Aws.Xml.required "Timestamp"
               (Aws.Util.option_bind (Aws.Xml.member "Timestamp" xml)
                  DateTime.parse));
          approximate_value =
            (Aws.Xml.required "ApproximateValue"
               (Aws.Util.option_bind (Aws.Xml.member "ApproximateValue" xml)
                  Double.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        ...
        approximate_value =
          (Double.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ApproximateValue")))
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map InsightRuleContributorDatapoint.parse
           (Aws.Xml.members "member" xml))
    let to_query v =
      Aws.Query.to_query_list InsightRuleContributorDatapoint.to_query v
    let to_json v =
      `List (List.map InsightRuleContributorDatapoint.to_json v)
    let of_json j =
      Aws.Json.to_list InsightRuleContributorDatapoint.of_json j
  end
      ...
      Some
        {
          ...
          approximate_aggregate_value =
            (Aws.Xml.required "ApproximateAggregateValue"
               (Aws.Util.option_bind
                  (Aws.Xml.member "ApproximateAggregateValue" xml)
                  Double.parse));
          datapoints =
            (Aws.Xml.required "Datapoints"
               (Aws.Util.option_bind (Aws.Xml.member "Datapoints" xml)
    ...
    let of_json j =
      {
        ...
        approximate_aggregate_value =
          (Double.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ApproximateAggregateValue")));
        datapoints =
...
module AnomalyDetectors =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map AnomalyDetector.parse (Aws.Xml.members "member" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          dashboard_name =
            (Aws.Util.option_bind (Aws.Xml.member "DashboardName" xml)
               String.parse);
          dashboard_arn =
            (Aws.Util.option_bind (Aws.Xml.member "DashboardArn" xml)
               String.parse);
          last_modified =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.dashboard_arn
             (fun f -> Aws.Query.Pair ("DashboardArn", (String.to_query f)));
           Aws.Util.option_map v.dashboard_name
             (fun f -> Aws.Query.Pair ("DashboardName", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.dashboard_arn
             (fun f -> ("DashboardArn", (String.to_json f)));
           Aws.Util.option_map v.dashboard_name
             (fun f -> ("DashboardName", (String.to_json f)))])
    let of_json j =
      {
        dashboard_name =
          (Aws.Util.option_map (Aws.Json.lookup j "DashboardName")
             String.of_json);
        dashboard_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "DashboardArn")
             String.of_json);
        last_modified =
...
module DashboardEntries =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map DashboardEntry.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          dashboard_entries =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "DashboardEntries" xml)
...
module MetricDataResults =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map MetricDataResult.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          metric_data_results =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "MetricDataResults" xml)
  ...
  struct
    ...
    let parse xml =
      Some
        {
          rule_name =
            (Aws.Xml.required "RuleName"
               (Aws.Util.option_bind (Aws.Xml.member "RuleName" xml)
                  String.parse));
          rule_state =
            (Aws.Util.option_bind (Aws.Xml.member "RuleState" xml)
               String.parse);
          rule_definition =
            (Aws.Xml.required "RuleDefinition"
               (Aws.Util.option_bind (Aws.Xml.member "RuleDefinition" xml)
                  String.parse));
          tags =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Tags" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.rule_state
             (fun f -> Aws.Query.Pair ("RuleState", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.rule_state
             (fun f -> ("RuleState", (String.to_json f)));
           Some ("RuleName", (String.to_json v.rule_name))])
    let of_json j =
      {
        rule_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RuleName")));
        rule_state =
          (Aws.Util.option_map (Aws.Json.lookup j "RuleState") String.of_json);
        rule_definition =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RuleDefinition")));
        tags =
          (TagList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Tags")))
      }
        ...
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("InsufficientDataActions.member",
                  (ResourceList.to_query v.insufficient_data_actions)));
           Aws.Util.option_map v.alarm_rule
             (fun f -> Aws.Query.Pair ("AlarmRule", (String.to_query f)));
           Aws.Util.option_map v.alarm_name
             (fun f -> Aws.Query.Pair ("AlarmName", (String.to_query f)));
           Aws.Util.option_map v.alarm_description
             (fun f ->
        ...
        (Aws.Util.list_filter_opt
           ...
           Some
             ("InsufficientDataActions",
               (ResourceList.to_json v.insufficient_data_actions));
           Aws.Util.option_map v.alarm_rule
             (fun f -> ("AlarmRule", (String.to_json f)));
           Aws.Util.option_map v.alarm_name
             (fun f -> ("AlarmName", (String.to_json f)));
           Aws.Util.option_map v.alarm_description
             (fun f -> ("AlarmDescription", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        alarm_name =
          (Aws.Util.option_map (Aws.Json.lookup j "AlarmName") String.of_json);
        alarm_rule =
          (Aws.Util.option_map (Aws.Json.lookup j "AlarmRule") String.of_json);
        insufficient_data_actions =
          (ResourceList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "InsufficientDataActions")));
...
module CompositeAlarms =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map CompositeAlarm.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          composite_alarms =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "CompositeAlarms" xml)
  ...
  struct
    ...
    let parse xml =
      Some
        {
          dashboard_name =
            (Aws.Xml.required "DashboardName"
               (Aws.Util.option_bind (Aws.Xml.member "DashboardName" xml)
                  String.parse));
          dashboard_body =
            (Aws.Xml.required "DashboardBody"
               (Aws.Util.option_bind (Aws.Xml.member "DashboardBody" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        dashboard_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "DashboardName")));
        dashboard_body =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "DashboardBody")))
      }
  end
      ...
      Some
        {
          anomaly_detectors =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "AnomalyDetectors" xml)
  ...
  struct
    ...
    let parse xml =
      Some
        {
          rule_names =
            (Aws.Xml.required "RuleNames"
               (Aws.Util.option_bind (Aws.Xml.member "RuleNames" xml)
    ...
    let of_json j =
      {
        rule_names =
          (InsightRuleNames.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RuleNames")))
      }
  end
          ...
          timestamp =
            (Aws.Xml.required "Timestamp"
               (Aws.Util.option_bind (Aws.Xml.member "Timestamp" xml)
                  DateTime.parse));
          unique_contributors =
            (Aws.Util.option_bind (Aws.Xml.member "UniqueContributors" xml)
               Double.parse);
          max_contributor_value =
            (Aws.Util.option_bind (Aws.Xml.member "MaxContributorValue" xml)
               Double.parse);
          sample_count =
            (Aws.Util.option_bind (Aws.Xml.member "SampleCount" xml)
               Double.parse);
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.sample_count
             (fun f -> Aws.Query.Pair ("SampleCount", (Double.to_query f)));
           Aws.Util.option_map v.max_contributor_value
             (fun f ->
                Aws.Query.Pair ("MaxContributorValue", (Double.to_query f)));
           Aws.Util.option_map v.unique_contributors
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.sample_count
             (fun f -> ("SampleCount", (Double.to_json f)));
           Aws.Util.option_map v.max_contributor_value
             (fun f -> ("MaxContributorValue", (Double.to_json f)));
           Aws.Util.option_map v.unique_contributors
             (fun f -> ("UniqueContributors", (Double.to_json f)));
           Some ("Timestamp", (DateTime.to_json v.timestamp))])
    let of_json j =
      {
        timestamp =
          (DateTime.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Timestamp")));
        unique_contributors =
          (Aws.Util.option_map (Aws.Json.lookup j "UniqueContributors")
             Double.of_json);
        max_contributor_value =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxContributorValue")
             Double.of_json);
        sample_count =
          (Aws.Util.option_map (Aws.Json.lookup j "SampleCount")
             Double.of_json);
...
module InsightRuleMetricDatapoints =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map InsightRuleMetricDatapoint.parse
           (Aws.Xml.members "member" xml))
    let to_query v =
      Aws.Query.to_query_list InsightRuleMetricDatapoint.to_query v
...
module InsightRuleContributors =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list InsightRuleContributor.to_query v
      ...
      Some
        {
          key_labels =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "KeyLabels" xml)
                  InsightRuleContributorKeyLabels.parse));
          aggregation_statistic =
            (Aws.Util.option_bind (Aws.Xml.member "AggregationStatistic" xml)
               String.parse);
          aggregate_value =
            (Aws.Util.option_bind (Aws.Xml.member "AggregateValue" xml)
               Double.parse);
          approximate_unique_count =
            (Aws.Util.option_bind
               (Aws.Xml.member "ApproximateUniqueCount" xml) Long.parse);
          contributors =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Contributors" xml)
                  InsightRuleContributors.parse));
          metric_datapoints =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "MetricDatapoints" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.approximate_unique_count
             (fun f ->
                Aws.Query.Pair ("ApproximateUniqueCount", (Long.to_query f)));
           Aws.Util.option_map v.aggregate_value
             (fun f -> Aws.Query.Pair ("AggregateValue", (Double.to_query f)));
           Aws.Util.option_map v.aggregation_statistic
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.approximate_unique_count
             (fun f -> ("ApproximateUniqueCount", (Long.to_json f)));
           Aws.Util.option_map v.aggregate_value
             (fun f -> ("AggregateValue", (Double.to_json f)));
           Aws.Util.option_map v.aggregation_statistic
             (fun f -> ("AggregationStatistic", (String.to_json f)));
           Some
             ("KeyLabels",
    ...
    let of_json j =
      {
        ...
        aggregation_statistic =
          (Aws.Util.option_map (Aws.Json.lookup j "AggregationStatistic")
             String.of_json);
        aggregate_value =
          (Aws.Util.option_map (Aws.Json.lookup j "AggregateValue")
             Double.of_json);
        approximate_unique_count =
          (Aws.Util.option_map (Aws.Json.lookup j "ApproximateUniqueCount")
             Long.of_json);
        contributors =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          metric_widget_image =
            (Aws.Util.option_bind (Aws.Xml.member "MetricWidgetImage" xml)
               Blob.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.metric_widget_image
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.metric_widget_image
              (fun f -> ("MetricWidgetImage", (Blob.to_json f)))])
    let of_json j =
      {
        metric_widget_image =
          (Aws.Util.option_map (Aws.Json.lookup j "MetricWidgetImage")
             Blob.of_json)
      }
  end
      ...
      Some
        {
          dashboard_name_prefix =
            (Aws.Util.option_bind (Aws.Xml.member "DashboardNamePrefix" xml)
               String.parse);
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Aws.Util.option_map v.dashboard_name_prefix
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> ("NextToken", (String.to_json f)));
           Aws.Util.option_map v.dashboard_name_prefix
             (fun f -> ("DashboardNamePrefix", (String.to_json f)))])
    let of_json j =
      {
        dashboard_name_prefix =
          (Aws.Util.option_map (Aws.Json.lookup j "DashboardNamePrefix")
             String.of_json);
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
          ...
          alarm_name =
            (Aws.Xml.required "AlarmName"
               (Aws.Util.option_bind (Aws.Xml.member "AlarmName" xml)
                  String.parse));
          state_value =
            (Aws.Xml.required "StateValue"
               (Aws.Util.option_bind (Aws.Xml.member "StateValue" xml)
                  StateValue.parse));
          state_reason =
            (Aws.Xml.required "StateReason"
               (Aws.Util.option_bind (Aws.Xml.member "StateReason" xml)
                  String.parse));
          state_reason_data =
            (Aws.Util.option_bind (Aws.Xml.member "StateReasonData" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("StateReason", (String.to_query v.state_reason)));
           Some
             (Aws.Query.Pair
                ("StateValue", (StateValue.to_query v.state_value)));
           Some
             (Aws.Query.Pair ("AlarmName", (String.to_query v.alarm_name)))])
    let to_json v =
      `Assoc
    ...
    let of_json j =
      {
        ...
        state_value =
          (StateValue.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StateValue")));
        state_reason =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StateReason")));
        state_reason_data =
          (Aws.Util.option_map (Aws.Json.lookup j "StateReasonData")
             String.of_json)
      }
  ...
  struct
    ...
    let parse xml =
      Some
        {
          metric_widget =
            (Aws.Xml.required "MetricWidget"
               (Aws.Util.option_bind (Aws.Xml.member "MetricWidget" xml)
                  String.parse));
          output_format =
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.output_format
              (fun f -> Aws.Query.Pair ("OutputFormat", (String.to_query f)));
           Some
             (Aws.Query.Pair
                ("MetricWidget", (String.to_query v.metric_widget)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.output_format
              (fun f -> ("OutputFormat", (String.to_json f)));
           Some ("MetricWidget", (String.to_json v.metric_widget))])
    let of_json j =
      {
        metric_widget =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MetricWidget")));
        output_format =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          metric_data_queries =
            (Aws.Xml.required "MetricDataQueries"
               (Aws.Util.option_bind (Aws.Xml.member "MetricDataQueries" xml)
                  MetricDataQueries.parse));
          start_time =
            (Aws.Xml.required "StartTime"
               (Aws.Util.option_bind (Aws.Xml.member "StartTime" xml)
          ...
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse);
          scan_by =
            (Aws.Util.option_bind (Aws.Xml.member "ScanBy" xml) ScanBy.parse);
          max_datapoints =
            (Aws.Util.option_bind (Aws.Xml.member "MaxDatapoints" xml)
               Integer.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_datapoints
              (fun f ->
                 Aws.Query.Pair ("MaxDatapoints", (Integer.to_query f)));
           Aws.Util.option_map v.scan_by
             (fun f -> Aws.Query.Pair ("ScanBy", (ScanBy.to_query f)));
           Aws.Util.option_map v.next_token
             (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Some (Aws.Query.Pair ("EndTime", (DateTime.to_query v.end_time)));
           Some
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_datapoints
              (fun f -> ("MaxDatapoints", (Integer.to_json f)));
           Aws.Util.option_map v.scan_by
             (fun f -> ("ScanBy", (ScanBy.to_json f)));
           Aws.Util.option_map v.next_token
             (fun f -> ("NextToken", (String.to_json f)));
           Some ("EndTime", (DateTime.to_json v.end_time));
           Some ("StartTime", (DateTime.to_json v.start_time));
    ...
    let of_json j =
      {
        ...
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json);
        scan_by =
          (Aws.Util.option_map (Aws.Json.lookup j "ScanBy") ScanBy.of_json);
        max_datapoints =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxDatapoints")
             Integer.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          resource_a_r_n =
            (Aws.Xml.required "ResourceARN"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceARN" xml)
                  String.parse));
          tag_keys =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("ResourceARN", (String.to_query v.resource_a_r_n)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        resource_a_r_n =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ResourceARN")));
        tag_keys =
          (TagKeyList.of_json
          ...
          alarm_names =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "AlarmNames" xml)
                  AlarmNames.parse));
          alarm_name_prefix =
            (Aws.Util.option_bind (Aws.Xml.member "AlarmNamePrefix" xml)
               String.parse);
          alarm_types =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "AlarmTypes" xml)
                  AlarmTypes.parse));
          children_of_alarm_name =
            (Aws.Util.option_bind (Aws.Xml.member "ChildrenOfAlarmName" xml)
               String.parse);
          parents_of_alarm_name =
            (Aws.Util.option_bind (Aws.Xml.member "ParentsOfAlarmName" xml)
               String.parse);
          state_value =
            (Aws.Util.option_bind (Aws.Xml.member "StateValue" xml)
               StateValue.parse);
          action_prefix =
            (Aws.Util.option_bind (Aws.Xml.member "ActionPrefix" xml)
               String.parse);
          max_records =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.action_prefix
             (fun f -> Aws.Query.Pair ("ActionPrefix", (String.to_query f)));
           Aws.Util.option_map v.state_value
             (fun f -> Aws.Query.Pair ("StateValue", (StateValue.to_query f)));
           Aws.Util.option_map v.parents_of_alarm_name
             (fun f ->
                Aws.Query.Pair ("ParentsOfAlarmName", (String.to_query f)));
           Aws.Util.option_map v.children_of_alarm_name
             (fun f ->
                Aws.Query.Pair ("ChildrenOfAlarmName", (String.to_query f)));
           Some
             (Aws.Query.Pair
                ("AlarmTypes.member", (AlarmTypes.to_query v.alarm_types)));
           Aws.Util.option_map v.alarm_name_prefix
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.action_prefix
             (fun f -> ("ActionPrefix", (String.to_json f)));
           Aws.Util.option_map v.state_value
             (fun f -> ("StateValue", (StateValue.to_json f)));
           Aws.Util.option_map v.parents_of_alarm_name
             (fun f -> ("ParentsOfAlarmName", (String.to_json f)));
           Aws.Util.option_map v.children_of_alarm_name
             (fun f -> ("ChildrenOfAlarmName", (String.to_json f)));
           Some ("AlarmTypes", (AlarmTypes.to_json v.alarm_types));
           Aws.Util.option_map v.alarm_name_prefix
             (fun f -> ("AlarmNamePrefix", (String.to_json f)));
           Some ("AlarmNames", (AlarmNames.to_json v.alarm_names))])
    let of_json j =
      {
        alarm_names =
          (AlarmNames.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AlarmNames")));
        alarm_name_prefix =
          (Aws.Util.option_map (Aws.Json.lookup j "AlarmNamePrefix")
             String.of_json);
        alarm_types =
          (AlarmTypes.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AlarmTypes")));
        children_of_alarm_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ChildrenOfAlarmName")
             String.of_json);
        parents_of_alarm_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ParentsOfAlarmName")
             String.of_json);
        state_value =
          (Aws.Util.option_map (Aws.Json.lookup j "StateValue")
             StateValue.of_json);
        action_prefix =
          (Aws.Util.option_map (Aws.Json.lookup j "ActionPrefix")
             String.of_json);
        max_records =
      ...
      Some
        {
          ...
          history_item_type =
            (Aws.Util.option_bind (Aws.Xml.member "HistoryItemType" xml)
               HistoryItemType.parse);
          start_date =
            (Aws.Util.option_bind (Aws.Xml.member "StartDate" xml)
               DateTime.parse);
          end_date =
            (Aws.Util.option_bind (Aws.Xml.member "EndDate" xml)
               DateTime.parse);
          max_records =
            (Aws.Util.option_bind (Aws.Xml.member "MaxRecords" xml)
               Integer.parse);
    ...
    let of_json j =
      {
        ...
        history_item_type =
          (Aws.Util.option_map (Aws.Json.lookup j "HistoryItemType")
             HistoryItemType.of_json);
        start_date =
          (Aws.Util.option_map (Aws.Json.lookup j "StartDate")
             DateTime.of_json);
        end_date =
  ...
  struct
      ...
      Some
        {
          ...
          period =
            (Aws.Xml.required "Period"
               (Aws.Util.option_bind (Aws.Xml.member "Period" xml)
                  Integer.parse));
          max_contributor_count =
            (Aws.Util.option_bind (Aws.Xml.member "MaxContributorCount" xml)
               Integer.parse);
          metrics =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Metrics" xml)
          ...
          order_by =
            (Aws.Util.option_bind (Aws.Xml.member "OrderBy" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.order_by
              (fun f -> Aws.Query.Pair ("OrderBy", (String.to_query f)));
           Some
             (Aws.Query.Pair
                ("Metrics.member",
                  (InsightRuleMetricList.to_query v.metrics)));
           Aws.Util.option_map v.max_contributor_count
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.order_by
              (fun f -> ("OrderBy", (String.to_json f)));
           Some ("Metrics", (InsightRuleMetricList.to_json v.metrics));
           Aws.Util.option_map v.max_contributor_count
             (fun f -> ("MaxContributorCount", (Integer.to_json f)));
           Some ("Period", (Integer.to_json v.period));
           Some ("EndTime", (DateTime.to_json v.end_time));
           Some ("StartTime", (DateTime.to_json v.start_time));
           Some ("RuleName", (String.to_json v.rule_name))])
    let of_json j =
      {
        ...
        period =
          (Integer.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Period")));
        max_contributor_count =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxContributorCount")
             Integer.of_json);
        metrics =
          (InsightRuleMetricList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Metrics")));
        order_by =
          (Aws.Util.option_map (Aws.Json.lookup j "OrderBy") String.of_json)
      }
  end
...
module DimensionFilters =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map DimensionFilter.parse (Aws.Xml.members "member" xml))
  ...
  struct
      ...
      Some
        {
          ...
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse);
          recently_active =
            (Aws.Util.option_bind (Aws.Xml.member "RecentlyActive" xml)
               RecentlyActive.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.recently_active
              (fun f ->
                 Aws.Query.Pair
                   ("RecentlyActive", (RecentlyActive.to_query f)));
           Aws.Util.option_map v.next_token
             (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Some
             (Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.recently_active
              (fun f -> ("RecentlyActive", (RecentlyActive.to_json f)));
           Aws.Util.option_map v.next_token
             (fun f -> ("NextToken", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json);
        recently_active =
          (Aws.Util.option_map (Aws.Json.lookup j "RecentlyActive")
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.dashboard_name
              (fun f -> Aws.Query.Pair ("DashboardName", (String.to_query f)));
           Aws.Util.option_map v.dashboard_body
             (fun f -> Aws.Query.Pair ("DashboardBody", (String.to_query f)));
           Aws.Util.option_map v.dashboard_arn
             (fun f -> Aws.Query.Pair ("DashboardArn", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.dashboard_name
              (fun f -> ("DashboardName", (String.to_json f)));
           Aws.Util.option_map v.dashboard_body
             (fun f -> ("DashboardBody", (String.to_json f)));
           Aws.Util.option_map v.dashboard_arn
             (fun f -> ("DashboardArn", (String.to_json f)))])
    let of_json j =
      {
        dashboard_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "DashboardArn")
             String.of_json);
        dashboard_body =
          (Aws.Util.option_map (Aws.Json.lookup j "DashboardBody")
             String.of_json);
        dashboard_name =
          (Aws.Util.option_map (Aws.Json.lookup j "DashboardName")
             String.of_json)
      ...
      Some
        {
          alarm_history_items =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "AlarmHistoryItems" xml)
