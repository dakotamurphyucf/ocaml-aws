          ...
          value =
            (Aws.Xml.required "Value"
               (Aws.Util.option_bind (Aws.Xml.member "Value" xml)
                  String.parse));
          replace =
            (Aws.Util.option_bind (Aws.Xml.member "Replace" xml)
               Boolean.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.replace
              (fun f -> Aws.Query.Pair ("Replace", (Boolean.to_query f)));
    ...
    let of_json j =
      {
        ...
        replace =
          (Aws.Util.option_map (Aws.Json.lookup j "Replace") Boolean.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          box_usage =
            (Aws.Util.option_bind (Aws.Xml.member "BoxUsage" xml) Float.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.box_usage
              (fun f -> Aws.Query.Pair ("BoxUsage", (Float.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.box_usage
              (fun f -> ("BoxUsage", (Float.to_json f)))])
    let of_json j =
      {
        box_usage =
          (Aws.Util.option_map (Aws.Json.lookup j "BoxUsage") Float.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          domain_name =
            (Aws.Xml.required "DomainName"
               (Aws.Util.option_bind (Aws.Xml.member "DomainName" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair ("DomainName", (String.to_query v.domain_name)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        domain_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "DomainName")))
      }
  end
...
module DomainNameList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "DomainName" xml))
  ...
  struct
      ...
      Some
        {
          ...
          alternate_name_encoding =
            (Aws.Util.option_bind
               (Aws.Xml.member "AlternateNameEncoding" xml) String.parse);
          value =
            (Aws.Xml.required "Value"
               (Aws.Util.option_bind (Aws.Xml.member "Value" xml)
                  String.parse));
          alternate_value_encoding =
            (Aws.Util.option_bind
               (Aws.Xml.member "AlternateValueEncoding" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.alternate_value_encoding
              (fun f ->
                 Aws.Query.Pair
                   ("AlternateValueEncoding", (String.to_query f)));
           Some (Aws.Query.Pair ("Value", (String.to_query v.value)));
           Aws.Util.option_map v.alternate_name_encoding
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.alternate_value_encoding
              (fun f -> ("AlternateValueEncoding", (String.to_json f)));
           Some ("Value", (String.to_json v.value));
           Aws.Util.option_map v.alternate_name_encoding
             (fun f -> ("AlternateNameEncoding", (String.to_json f)));
           Some ("Name", (String.to_json v.name))])
    let of_json j =
      {
        name =
          (String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Name")));
        alternate_name_encoding =
          (Aws.Util.option_map (Aws.Json.lookup j "AlternateNameEncoding")
             String.of_json);
        value =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Value")));
        alternate_value_encoding =
          (Aws.Util.option_map (Aws.Json.lookup j "AlternateValueEncoding")
             String.of_json)
      }
  end
module AttributeList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Attribute.parse (Aws.Xml.members "Attribute" xml))
      ...
      Some
        {
          ...
          alternate_name_encoding =
            (Aws.Util.option_bind
               (Aws.Xml.member "AlternateNameEncoding" xml) String.parse);
          attributes =
            (Aws.Xml.required "Attributes" (AttributeList.parse xml))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        domain_names =
          (DomainNameList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "DomainNames")));
        next_token =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          name =
            (Aws.Xml.required "ItemName"
               (Aws.Util.option_bind (Aws.Xml.member "ItemName" xml)
                  String.parse));
    ...
    let of_json j =
      {
        name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ItemName")));
        attributes =
          (AttributeList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Attributes")))
      }
...
module DeletableItemList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map DeletableItem.parse (Aws.Xml.members "Item" xml))
...
module ReplaceableAttributeList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ReplaceableAttribute.parse
           (Aws.Xml.members "Attribute" xml))
      ...
      Some
        {
          ...
          attributes =
            (Aws.Xml.required "Attributes"
               (ReplaceableAttributeList.parse xml))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
  ...
  struct
    ...
    let parse xml =
      Some
        {
          item_count =
            (Aws.Util.option_bind (Aws.Xml.member "ItemCount" xml)
               Integer.parse);
          item_names_size_bytes =
            (Aws.Util.option_bind (Aws.Xml.member "ItemNamesSizeBytes" xml)
               Long.parse);
          attribute_name_count =
            (Aws.Util.option_bind (Aws.Xml.member "AttributeNameCount" xml)
               Integer.parse);
          attribute_names_size_bytes =
            (Aws.Util.option_bind
               (Aws.Xml.member "AttributeNamesSizeBytes" xml) Long.parse);
          attribute_value_count =
            (Aws.Util.option_bind (Aws.Xml.member "AttributeValueCount" xml)
               Integer.parse);
          attribute_values_size_bytes =
            (Aws.Util.option_bind
               (Aws.Xml.member "AttributeValuesSizeBytes" xml) Long.parse);
          timestamp =
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.timestamp
              (fun f -> Aws.Query.Pair ("Timestamp", (Integer.to_query f)));
           Aws.Util.option_map v.attribute_values_size_bytes
             (fun f ->
                Aws.Query.Pair
                  ("AttributeValuesSizeBytes", (Long.to_query f)));
           Aws.Util.option_map v.attribute_value_count
             (fun f ->
                Aws.Query.Pair ("AttributeValueCount", (Integer.to_query f)));
           Aws.Util.option_map v.attribute_names_size_bytes
             (fun f ->
                Aws.Query.Pair ("AttributeNamesSizeBytes", (Long.to_query f)));
           Aws.Util.option_map v.attribute_name_count
             (fun f ->
                Aws.Query.Pair ("AttributeNameCount", (Integer.to_query f)));
           Aws.Util.option_map v.item_names_size_bytes
             (fun f ->
                Aws.Query.Pair ("ItemNamesSizeBytes", (Long.to_query f)));
           Aws.Util.option_map v.item_count
             (fun f -> Aws.Query.Pair ("ItemCount", (Integer.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.timestamp
           ...
           Aws.Util.option_map v.attribute_values_size_bytes
             (fun f -> ("AttributeValuesSizeBytes", (Long.to_json f)));
           Aws.Util.option_map v.attribute_value_count
             (fun f -> ("AttributeValueCount", (Integer.to_json f)));
           Aws.Util.option_map v.attribute_names_size_bytes
             (fun f -> ("AttributeNamesSizeBytes", (Long.to_json f)));
           Aws.Util.option_map v.attribute_name_count
             (fun f -> ("AttributeNameCount", (Integer.to_json f)));
           Aws.Util.option_map v.item_names_size_bytes
             (fun f -> ("ItemNamesSizeBytes", (Long.to_json f)));
           Aws.Util.option_map v.item_count
             (fun f -> ("ItemCount", (Integer.to_json f)))])
    let of_json j =
      {
        item_count =
          (Aws.Util.option_map (Aws.Json.lookup j "ItemCount")
             Integer.of_json);
        item_names_size_bytes =
          (Aws.Util.option_map (Aws.Json.lookup j "ItemNamesSizeBytes")
             Long.of_json);
        attribute_name_count =
          (Aws.Util.option_map (Aws.Json.lookup j "AttributeNameCount")
             Integer.of_json);
        attribute_names_size_bytes =
          (Aws.Util.option_map (Aws.Json.lookup j "AttributeNamesSizeBytes")
             Long.of_json);
        attribute_value_count =
          (Aws.Util.option_map (Aws.Json.lookup j "AttributeValueCount")
             Integer.of_json);
        attribute_values_size_bytes =
          (Aws.Util.option_map (Aws.Json.lookup j "AttributeValuesSizeBytes")
             Long.of_json);
        timestamp =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          select_expression =
            (Aws.Xml.required "SelectExpression"
               (Aws.Util.option_bind (Aws.Xml.member "SelectExpression" xml)
                  String.parse));
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse);
    ...
    let of_json j =
      {
        select_expression =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "SelectExpression")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json);
        consistent_read =
      ...
      Some
        {
          max_number_of_domains =
            (Aws.Util.option_bind (Aws.Xml.member "MaxNumberOfDomains" xml)
               Integer.parse);
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Aws.Util.option_map v.max_number_of_domains
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> ("NextToken", (String.to_json f)));
           Aws.Util.option_map v.max_number_of_domains
             (fun f -> ("MaxNumberOfDomains", (Integer.to_json f)))])
    let of_json j =
      {
        max_number_of_domains =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxNumberOfDomains")
             Integer.of_json);
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
...
module ItemList =
  struct
    ...
    let make elems () = elems
    let parse xml =
      Aws.Util.option_all (List.map Item.parse (Aws.Xml.members "Item" xml))
...
module AttributeNameList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "AttributeName" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
...
module GetAttributesResult =
  struct
    ...
    let parse xml =
      Some { attributes = (Aws.Util.of_option [] (AttributeList.parse xml)) }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
...
module ReplaceableItemList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ReplaceableItem.parse (Aws.Xml.members "Item" xml))
