...
module RecordData =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "RecordDataEntry" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          nameserver =
            (Aws.Xml.required "Nameserver"
               (Aws.Util.option_bind (Aws.Xml.member "Nameserver" xml)
                  String.parse));
          record_name =
            (Aws.Xml.required "RecordName"
               (Aws.Util.option_bind (Aws.Xml.member "RecordName" xml)
                  String.parse));
          record_type =
            (Aws.Xml.required "RecordType"
               (Aws.Util.option_bind (Aws.Xml.member "RecordType" xml)
                  RRType.parse));
          record_data =
            (Aws.Xml.required "RecordData"
               (Aws.Util.option_bind (Aws.Xml.member "RecordData" xml)
                  RecordData.parse));
          response_code =
            (Aws.Xml.required "ResponseCode"
               (Aws.Util.option_bind (Aws.Xml.member "ResponseCode" xml)
                  String.parse));
          protocol =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("ResponseCode", (String.to_query v.response_code)));
           Some
             (Aws.Query.Pair
                ("RecordData.member", (RecordData.to_query v.record_data)));
           Some
             (Aws.Query.Pair ("RecordType", (RRType.to_query v.record_type)));
           Some
             (Aws.Query.Pair ("RecordName", (String.to_query v.record_name)));
           Some
             (Aws.Query.Pair ("Nameserver", (String.to_query v.nameserver)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        nameserver =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Nameserver")));
        record_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RecordName")));
        record_type =
          (RRType.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RecordType")));
        record_data =
          (RecordData.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RecordData")));
        response_code =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ResponseCode")));
        protocol =
          (String.of_json
  ...
  struct
    ...
    let parse xml =
      Some
        {
          owning_account =
            (Aws.Util.option_bind (Aws.Xml.member "OwningAccount" xml)
               String.parse);
          owning_service =
            (Aws.Util.option_bind (Aws.Xml.member "OwningService" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.owning_service
              (fun f -> Aws.Query.Pair ("OwningService", (String.to_query f)));
           Aws.Util.option_map v.owning_account
             (fun f -> Aws.Query.Pair ("OwningAccount", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.owning_service
              (fun f -> ("OwningService", (String.to_json f)));
           Aws.Util.option_map v.owning_account
             (fun f -> ("OwningAccount", (String.to_json f)))])
    let of_json j =
      {
        owning_account =
          (Aws.Util.option_map (Aws.Json.lookup j "OwningAccount")
             String.of_json);
        owning_service =
          (Aws.Util.option_map (Aws.Json.lookup j "OwningService")
             String.of_json)
      }
  end
  ...
  struct
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair ("Owner", (HostedZoneOwner.to_query v.owner)));
           Some (Aws.Query.Pair ("Name", (String.to_query v.name)));
           Some
             (Aws.Query.Pair
                ("HostedZoneId", (String.to_query v.hosted_zone_id)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        hosted_zone_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "HostedZoneId")));
        name =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          v_p_c_region =
            (Aws.Util.option_bind (Aws.Xml.member "VPCRegion" xml)
               VPCRegion.parse);
          v_p_c_id =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.v_p_c_id
              (fun f -> Aws.Query.Pair ("VPCId", (String.to_query f)));
           Aws.Util.option_map v.v_p_c_region
             (fun f -> Aws.Query.Pair ("VPCRegion", (VPCRegion.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.v_p_c_id
           ...
           Aws.Util.option_map v.v_p_c_region
             (fun f -> ("VPCRegion", (VPCRegion.to_json f)))])
    let of_json j =
      {
        v_p_c_region =
          (Aws.Util.option_map (Aws.Json.lookup j "VPCRegion")
             VPCRegion.of_json);
        v_p_c_id =
    ...
    let of_json j =
      {
        ...
        v_p_c =
          (VPC.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "VPC")))
      }
  end
      ...
      Some
        {
          ...
          cloud_watch_logs_log_group_arn =
            (Aws.Xml.required "CloudWatchLogsLogGroupArn"
        ...
        cloud_watch_logs_log_group_arn =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CloudWatchLogsLogGroupArn")))
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map QueryLoggingConfig.parse
           (Aws.Xml.members "QueryLoggingConfig" xml))
      ...
      Some
        {
          ...
          hosted_zone_id =
            (Aws.Util.option_bind (Aws.Xml.member "hostedzoneid" xml)
               String.parse);
          max_items =
            (Aws.Util.option_bind (Aws.Xml.member "maxitems" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
              (fun f -> Aws.Query.Pair ("maxitems", (String.to_query f)));
           Aws.Util.option_map v.hosted_zone_id
             (fun f -> Aws.Query.Pair ("hostedzoneid", (String.to_query f)));
           Aws.Util.option_map v.d_n_s_name
             (fun f -> Aws.Query.Pair ("dnsname", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
              (fun f -> ("maxitems", (String.to_json f)));
           Aws.Util.option_map v.hosted_zone_id
    ...
    let of_json j =
      {
        ...
        hosted_zone_id =
          (Aws.Util.option_map (Aws.Json.lookup j "hostedzoneid")
             String.of_json);
        max_items =
          (Aws.Util.option_map (Aws.Json.lookup j "maxitems") String.of_json)
      }
  end
  ...
  struct
          ...
          message =
            (Aws.Xml.required "Message"
               (Aws.Util.option_bind (Aws.Xml.member "Message" xml)
                  String.parse));
          traffic_policy_id =
            (Aws.Xml.required "TrafficPolicyId"
               (Aws.Util.option_bind (Aws.Xml.member "TrafficPolicyId" xml)
                  String.parse));
          traffic_policy_version =
            (Aws.Xml.required "TrafficPolicyVersion"
               (Aws.Util.option_bind
                  (Aws.Xml.member "TrafficPolicyVersion" xml) Integer.parse));
          traffic_policy_type =
            (Aws.Xml.required "TrafficPolicyType"
               (Aws.Util.option_bind (Aws.Xml.member "TrafficPolicyType" xml)
                  RRType.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("TrafficPolicyType", (RRType.to_json v.traffic_policy_type));
           Some
             ("TrafficPolicyVersion",
    ...
    let of_json j =
      {
        ...
        name =
          (String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Name")));
        t_t_l =
          (Long.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "TTL")));
        state =
          (String.of_json
        ...
        traffic_policy_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TrafficPolicyId")));
        traffic_policy_version =
          (Integer.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "TrafficPolicyVersion")));
        traffic_policy_type =
          (RRType.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TrafficPolicyType")))
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map TrafficPolicyInstance.parse
           (Aws.Xml.members "TrafficPolicyInstance" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          traffic_policy_instances =
            (Aws.Xml.required "TrafficPolicyInstances"
               (Aws.Util.option_bind
                  (Aws.Xml.member "TrafficPolicyInstances" xml)
                  TrafficPolicyInstances.parse));
          hosted_zone_id_marker =
            (Aws.Util.option_bind (Aws.Xml.member "HostedZoneIdMarker" xml)
               String.parse);
          traffic_policy_instance_name_marker =
            (Aws.Util.option_bind
          ...
          traffic_policy_instance_type_marker =
            (Aws.Util.option_bind
               ...
               RRType.parse);
          is_truncated =
            (Aws.Xml.required "IsTruncated"
               (Aws.Util.option_bind (Aws.Xml.member "IsTruncated" xml)
                  Boolean.parse));
          max_items =
            (Aws.Xml.required "MaxItems"
               (Aws.Util.option_bind (Aws.Xml.member "MaxItems" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("IsTruncated", (Boolean.to_query v.is_truncated)));
           Aws.Util.option_map v.traffic_policy_instance_type_marker
             (fun f ->
                Aws.Query.Pair
                  ("TrafficPolicyInstanceTypeMarker", (RRType.to_query f)));
           Aws.Util.option_map v.traffic_policy_instance_name_marker
             (fun f ->
                Aws.Query.Pair
                  ("TrafficPolicyInstanceNameMarker", (String.to_query f)));
           Aws.Util.option_map v.hosted_zone_id_marker
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.hosted_zone_id_marker
             (fun f -> ("HostedZoneIdMarker", (String.to_json f)));
           Some
    ...
    let of_json j =
      {
        traffic_policy_instances =
          (TrafficPolicyInstances.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "TrafficPolicyInstances")));
        hosted_zone_id_marker =
          (Aws.Util.option_map (Aws.Json.lookup j "HostedZoneIdMarker")
             String.of_json);
        traffic_policy_instance_name_marker =
          (Aws.Util.option_map
        ...
        is_truncated =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "IsTruncated")));
        max_items =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MaxItems")))
      }
  end
module ResourceRecord =
  struct
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt [Some ("Value", (String.to_json v.value))])
    let of_json j =
      {
        value =
          (String.of_json
  ...
  struct
    ...
    let parse xml =
      Some
        {
          continent_code =
            (Aws.Util.option_bind (Aws.Xml.member "ContinentCode" xml)
               String.parse);
          country_code =
            (Aws.Util.option_bind (Aws.Xml.member "CountryCode" xml)
               String.parse);
          subdivision_code =
            (Aws.Util.option_bind (Aws.Xml.member "SubdivisionCode" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.subdivision_code
              (fun f ->
                 Aws.Query.Pair ("SubdivisionCode", (String.to_query f)));
           Aws.Util.option_map v.country_code
             (fun f -> Aws.Query.Pair ("CountryCode", (String.to_query f)));
           Aws.Util.option_map v.continent_code
             (fun f -> Aws.Query.Pair ("ContinentCode", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.subdivision_code
              (fun f -> ("SubdivisionCode", (String.to_json f)));
           Aws.Util.option_map v.country_code
             (fun f -> ("CountryCode", (String.to_json f)));
           Aws.Util.option_map v.continent_code
             (fun f -> ("ContinentCode", (String.to_json f)))])
    let of_json j =
      {
        continent_code =
          (Aws.Util.option_map (Aws.Json.lookup j "ContinentCode")
             String.of_json);
        country_code =
          (Aws.Util.option_map (Aws.Json.lookup j "CountryCode")
             String.of_json);
        subdivision_code =
          (Aws.Util.option_map (Aws.Json.lookup j "SubdivisionCode")
             String.of_json)
      }
  end
module AliasTarget =
          ...
          hosted_zone_id =
            (Aws.Xml.required "HostedZoneId"
               (Aws.Util.option_bind (Aws.Xml.member "HostedZoneId" xml)
                  String.parse));
          d_n_s_name =
            (Aws.Xml.required "DNSName"
               (Aws.Util.option_bind (Aws.Xml.member "DNSName" xml)
                  String.parse));
          evaluate_target_health =
            (Aws.Xml.required "EvaluateTargetHealth"
               (Aws.Util.option_bind
                  (Aws.Xml.member "EvaluateTargetHealth" xml) Boolean.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        ...
        d_n_s_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "DNSName")));
        evaluate_target_health =
          (Boolean.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "EvaluateTargetHealth")))
      }
  end
  ...
  struct
      ...
      Some
        {
          ...
          set_identifier =
            (Aws.Util.option_bind (Aws.Xml.member "SetIdentifier" xml)
               String.parse);
          weight =
            (Aws.Util.option_bind (Aws.Xml.member "Weight" xml) Long.parse);
          region =
            (Aws.Util.option_bind (Aws.Xml.member "Region" xml)
               ResourceRecordSetRegion.parse);
          geo_location =
            (Aws.Util.option_bind (Aws.Xml.member "GeoLocation" xml)
               GeoLocation.parse);
          failover =
            (Aws.Util.option_bind (Aws.Xml.member "Failover" xml)
               ResourceRecordSetFailover.parse);
          multi_value_answer =
            (Aws.Util.option_bind (Aws.Xml.member "MultiValueAnswer" xml)
               Boolean.parse);
          t_t_l =
            (Aws.Util.option_bind (Aws.Xml.member "TTL" xml) Long.parse);
          resource_records =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ResourceRecords" xml)
                  ResourceRecords.parse));
          alias_target =
            (Aws.Util.option_bind (Aws.Xml.member "AliasTarget" xml)
               AliasTarget.parse);
          health_check_id =
            (Aws.Util.option_bind (Aws.Xml.member "HealthCheckId" xml)
               String.parse);
          traffic_policy_instance_id =
            (Aws.Util.option_bind
               (Aws.Xml.member "TrafficPolicyInstanceId" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.traffic_policy_instance_id
              (fun f ->
                 Aws.Query.Pair
                   ("TrafficPolicyInstanceId", (String.to_query f)));
           Aws.Util.option_map v.health_check_id
             (fun f -> Aws.Query.Pair ("HealthCheckId", (String.to_query f)));
           Aws.Util.option_map v.alias_target
             (fun f ->
           ...
           Aws.Util.option_map v.t_t_l
             (fun f -> Aws.Query.Pair ("TTL", (Long.to_query f)));
           Aws.Util.option_map v.multi_value_answer
             (fun f ->
                Aws.Query.Pair ("MultiValueAnswer", (Boolean.to_query f)));
           Aws.Util.option_map v.failover
             (fun f ->
                Aws.Query.Pair
                  ("Failover", (ResourceRecordSetFailover.to_query f)));
           Aws.Util.option_map v.geo_location
             (fun f ->
                Aws.Query.Pair ("GeoLocation", (GeoLocation.to_query f)));
           Aws.Util.option_map v.region
             (fun f ->
                Aws.Query.Pair
                  ("Region", (ResourceRecordSetRegion.to_query f)));
           Aws.Util.option_map v.weight
             (fun f -> Aws.Query.Pair ("Weight", (Long.to_query f)));
           Aws.Util.option_map v.set_identifier
             (fun f -> Aws.Query.Pair ("SetIdentifier", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.traffic_policy_instance_id
              (fun f -> ("TrafficPolicyInstanceId", (String.to_json f)));
           Aws.Util.option_map v.health_check_id
             (fun f -> ("HealthCheckId", (String.to_json f)));
           Aws.Util.option_map v.alias_target
             (fun f -> ("AliasTarget", (AliasTarget.to_json f)));
           Some
             ("ResourceRecords",
               (ResourceRecords.to_json v.resource_records));
           Aws.Util.option_map v.t_t_l (fun f -> ("TTL", (Long.to_json f)));
           Aws.Util.option_map v.multi_value_answer
             (fun f -> ("MultiValueAnswer", (Boolean.to_json f)));
           Aws.Util.option_map v.failover
             (fun f -> ("Failover", (ResourceRecordSetFailover.to_json f)));
           Aws.Util.option_map v.geo_location
             (fun f -> ("GeoLocation", (GeoLocation.to_json f)));
           Aws.Util.option_map v.region
             (fun f -> ("Region", (ResourceRecordSetRegion.to_json f)));
           Aws.Util.option_map v.weight
             (fun f -> ("Weight", (Long.to_json f)));
           Aws.Util.option_map v.set_identifier
             (fun f -> ("SetIdentifier", (String.to_json f)));
    ...
    let of_json j =
      {
        name =
          (String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Name")));
        type_ =
          (RRType.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Type")));
        set_identifier =
          (Aws.Util.option_map (Aws.Json.lookup j "SetIdentifier")
             String.of_json);
        weight =
          (Aws.Util.option_map (Aws.Json.lookup j "Weight") Long.of_json);
        region =
          (Aws.Util.option_map (Aws.Json.lookup j "Region")
             ResourceRecordSetRegion.of_json);
        geo_location =
          (Aws.Util.option_map (Aws.Json.lookup j "GeoLocation")
             GeoLocation.of_json);
        failover =
          (Aws.Util.option_map (Aws.Json.lookup j "Failover")
             ResourceRecordSetFailover.of_json);
        multi_value_answer =
          (Aws.Util.option_map (Aws.Json.lookup j "MultiValueAnswer")
             Boolean.of_json);
        ...
        alias_target =
          (Aws.Util.option_map (Aws.Json.lookup j "AliasTarget")
             AliasTarget.of_json);
        health_check_id =
          (Aws.Util.option_map (Aws.Json.lookup j "HealthCheckId")
             String.of_json);
        traffic_policy_instance_id =
          (Aws.Util.option_map (Aws.Json.lookup j "TrafficPolicyInstanceId")
             String.of_json)
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ResourceRecordSet.parse
           (Aws.Xml.members "ResourceRecordSet" xml))
...
module DelegationSetNameServers =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "NameServer" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
      ...
      Some
        {
          ...
          caller_reference =
            (Aws.Util.option_bind (Aws.Xml.member "CallerReference" xml)
               String.parse);
          name_servers =
            (Aws.Xml.required "NameServers"
               (Aws.Util.option_bind (Aws.Xml.member "NameServers" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.caller_reference
             (fun f ->
      ...
      Some
        {
          id =
            (Aws.Xml.required "Id"
               (Aws.Util.option_bind (Aws.Xml.member "Id" xml) String.parse));
          version =
            (Aws.Xml.required "Version"
               (Aws.Util.option_bind (Aws.Xml.member "Version" xml)
                  Integer.parse));
          name =
            (Aws.Xml.required "Name"
               (Aws.Util.option_bind (Aws.Xml.member "Name" xml) String.parse));
          type_ =
            (Aws.Xml.required "Type"
               (Aws.Util.option_bind (Aws.Xml.member "Type" xml) RRType.parse));
          document =
            (Aws.Xml.required "Document"
               (Aws.Util.option_bind (Aws.Xml.member "Document" xml)
                  String.parse));
          comment =
            (Aws.Util.option_bind (Aws.Xml.member "Comment" xml) String.parse)
        }
    ...
    let of_json j =
      {
        ...
        document =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Document")));
        comment =
          (Aws.Util.option_map (Aws.Json.lookup j "Comment") String.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          traffic_policy =
            (Aws.Xml.required "TrafficPolicy"
               (Aws.Util.option_bind (Aws.Xml.member "TrafficPolicy" xml)
                  TrafficPolicy.parse));
          location =
            (Aws.Xml.required "Location"
    ...
    let of_json j =
      {
        traffic_policy =
          (TrafficPolicy.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TrafficPolicy")));
        location =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Location")))
      }
  end
module VPCs =
  struct
    ...
    let make elems () = elems
    let parse xml =
      Aws.Util.option_all (List.map VPC.parse (Aws.Xml.members "VPC" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          service_principal =
            (Aws.Util.option_bind (Aws.Xml.member "ServicePrincipal" xml)
               String.parse);
          description =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.service_principal
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.service_principal
             (fun f -> ("ServicePrincipal", (String.to_json f)))])
    let of_json j =
      {
        service_principal =
          (Aws.Util.option_map (Aws.Json.lookup j "ServicePrincipal")
             String.of_json);
        description =
      ...
      Some
        {
          comment =
            (Aws.Util.option_bind (Aws.Xml.member "Comment" xml) String.parse);
          private_zone =
            (Aws.Util.option_bind (Aws.Xml.member "PrivateZone" xml)
               Boolean.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.private_zone
              (fun f -> Aws.Query.Pair ("PrivateZone", (Boolean.to_query f)));
           Aws.Util.option_map v.comment
             (fun f -> Aws.Query.Pair ("Comment", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.private_zone
              (fun f -> ("PrivateZone", (Boolean.to_json f)));
           Aws.Util.option_map v.comment
             (fun f -> ("Comment", (String.to_json f)))])
    let of_json j =
      {
        comment =
          (Aws.Util.option_map (Aws.Json.lookup j "Comment") String.of_json);
        private_zone =
          (Aws.Util.option_map (Aws.Json.lookup j "PrivateZone")
             Boolean.of_json)
      }
  end
module HostedZone =
  struct
      ...
      Some
        {
          ...
          name =
            (Aws.Xml.required "Name"
               (Aws.Util.option_bind (Aws.Xml.member "Name" xml) String.parse));
          caller_reference =
            (Aws.Xml.required "CallerReference"
               (Aws.Util.option_bind (Aws.Xml.member "CallerReference" xml)
                  String.parse));
          config =
            (Aws.Util.option_bind (Aws.Xml.member "Config" xml)
               HostedZoneConfig.parse);
          resource_record_set_count =
            (Aws.Util.option_bind
               (Aws.Xml.member "ResourceRecordSetCount" xml) Long.parse);
          linked_service =
            (Aws.Util.option_bind (Aws.Xml.member "LinkedService" xml)
               LinkedService.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.linked_service
              (fun f ->
                 Aws.Query.Pair ("LinkedService", (LinkedService.to_query f)));
           Aws.Util.option_map v.resource_record_set_count
             (fun f ->
                Aws.Query.Pair ("ResourceRecordSetCount", (Long.to_query f)));
           Aws.Util.option_map v.config
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.linked_service
              (fun f -> ("LinkedService", (LinkedService.to_json f)));
           Aws.Util.option_map v.resource_record_set_count
             (fun f -> ("ResourceRecordSetCount", (Long.to_json f)));
           Aws.Util.option_map v.config
    ...
    let of_json j =
      {
        ...
        caller_reference =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "CallerReference")));
        config =
          (Aws.Util.option_map (Aws.Json.lookup j "Config")
             HostedZoneConfig.of_json);
        resource_record_set_count =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourceRecordSetCount")
             Long.of_json);
        linked_service =
          (Aws.Util.option_map (Aws.Json.lookup j "LinkedService")
  ...
  struct
    ...
    let parse xml =
      Some
        {
          hosted_zone =
            (Aws.Xml.required "HostedZone"
               (Aws.Util.option_bind (Aws.Xml.member "HostedZone" xml)
                  HostedZone.parse));
          delegation_set =
            (Aws.Util.option_bind (Aws.Xml.member "DelegationSet" xml)
               DelegationSet.parse);
          v_p_cs =
            (Aws.Util.of_option []
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.delegation_set
             (fun f ->
                Aws.Query.Pair ("DelegationSet", (DelegationSet.to_query f)));
           Some
             (Aws.Query.Pair
                ("HostedZone", (HostedZone.to_query v.hosted_zone)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("VPCs", (VPCs.to_json v.v_p_cs));
           Aws.Util.option_map v.delegation_set
             (fun f -> ("DelegationSet", (DelegationSet.to_json f)));
           Some ("HostedZone", (HostedZone.to_json v.hosted_zone))])
    let of_json j =
      {
        hosted_zone =
          (HostedZone.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "HostedZone")));
        delegation_set =
          (Aws.Util.option_map (Aws.Json.lookup j "DelegationSet")
             DelegationSet.of_json);
        v_p_cs =
          (VPCs.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "VPCs")))
      }
  end
module ChangeAction =
  struct
  ...
  struct
    ...
    let parse xml =
      Some
        {
          action =
            (Aws.Xml.required "Action"
               (Aws.Util.option_bind (Aws.Xml.member "Action" xml)
                  ChangeAction.parse));
          resource_record_set =
            (Aws.Xml.required "ResourceRecordSet"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceRecordSet" xml)
...
module Changes =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Change.parse (Aws.Xml.members "Change" xml))
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("Changes.member", (Changes.to_query v.changes)));
           Aws.Util.option_map v.comment
             (fun f -> Aws.Query.Pair ("Comment", (String.to_query f)))])
    let to_json v =
      `Assoc
      ...
      Some
        {
          hosted_zone_id =
            (Aws.Xml.required "Id"
               (Aws.Util.option_bind (Aws.Xml.member "Id" xml) String.parse));
          change_batch =
            (Aws.Xml.required "ChangeBatch"
               (Aws.Util.option_bind (Aws.Xml.member "ChangeBatch" xml)
                  ChangeBatch.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        ...
        change_batch =
          (ChangeBatch.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ChangeBatch")))
      }
  end
      ...
      Some
        {
          ...
          type_ =
            (Aws.Xml.required "Type"
               (Aws.Util.option_bind (Aws.Xml.member "Type" xml) RRType.parse));
          latest_version =
            (Aws.Xml.required "LatestVersion"
               (Aws.Util.option_bind (Aws.Xml.member "LatestVersion" xml)
                  Integer.parse));
          traffic_policy_count =
            (Aws.Xml.required "TrafficPolicyCount"
               (Aws.Util.option_bind
                  (Aws.Xml.member "TrafficPolicyCount" xml) Integer.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        ...
        latest_version =
          (Integer.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "LatestVersion")));
        traffic_policy_count =
          (Integer.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TrafficPolicyCount")))
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map TrafficPolicySummary.parse
           (Aws.Xml.members "TrafficPolicySummary" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          traffic_policy_summaries =
            (Aws.Xml.required "TrafficPolicySummaries"
               (Aws.Util.option_bind
          ...
          is_truncated =
            (Aws.Xml.required "IsTruncated"
               (Aws.Util.option_bind (Aws.Xml.member "IsTruncated" xml)
                  Boolean.parse));
          traffic_policy_id_marker =
            (Aws.Xml.required "TrafficPolicyIdMarker"
               (Aws.Util.option_bind
                  (Aws.Xml.member "TrafficPolicyIdMarker" xml) String.parse));
          max_items =
            (Aws.Xml.required "MaxItems"
               (Aws.Util.option_bind (Aws.Xml.member "MaxItems" xml)
                  String.parse))
    ...
    let of_json j =
      {
        traffic_policy_summaries =
          (TrafficPolicySummaries.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "TrafficPolicySummaries")));
        is_truncated =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "IsTruncated")));
        traffic_policy_id_marker =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "TrafficPolicyIdMarker")));
        max_items =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MaxItems")))
      }
  ...
  struct
    ...
    let parse xml =
      Some
        {
          health_check_id =
            (Aws.Xml.required "HealthCheckId"
               (Aws.Util.option_bind (Aws.Xml.member "HealthCheckId" xml)
                  String.parse))
        }
    let to_query v =
    ...
    let of_json j =
      {
        health_check_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "HealthCheckId")))
      }
  end
    ...
    let of_json j =
      {
        ...
        value =
          (Long.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Value")))
      }
  end
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some (Aws.Query.Pair ("Id", (String.to_query v.id)))])
    let to_json v =
      `Assoc (Aws.Util.list_filter_opt [Some ("Id", (String.to_json v.id))])
    let of_json j =
      {
        id =
          (String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Id")))
          ...
          caller_reference =
            (Aws.Xml.required "CallerReference"
               (Aws.Util.option_bind (Aws.Xml.member "CallerReference" xml)
                  String.parse));
          hosted_zone_config =
            (Aws.Util.option_bind (Aws.Xml.member "HostedZoneConfig" xml)
               HostedZoneConfig.parse);
          delegation_set_id =
            (Aws.Util.option_bind (Aws.Xml.member "DelegationSetId" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.delegation_set_id
              (fun f ->
                 Aws.Query.Pair ("DelegationSetId", (String.to_query f)));
           Aws.Util.option_map v.hosted_zone_config
             (fun f ->
                Aws.Query.Pair
           ...
           Some
             (Aws.Query.Pair
                ("CallerReference", (String.to_query v.caller_reference)));
           Aws.Util.option_map v.v_p_c
             (fun f -> Aws.Query.Pair ("VPC", (VPC.to_query f)));
           Some (Aws.Query.Pair ("Name", (String.to_query v.name)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.delegation_set_id
              (fun f -> ("DelegationSetId", (String.to_json f)));
           Aws.Util.option_map v.hosted_zone_config
             (fun f -> ("HostedZoneConfig", (HostedZoneConfig.to_json f)));
           Some ("CallerReference", (String.to_json v.caller_reference));
    ...
    let of_json j =
      {
        ...
        caller_reference =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "CallerReference")));
        hosted_zone_config =
          (Aws.Util.option_map (Aws.Json.lookup j "HostedZoneConfig")
             HostedZoneConfig.of_json);
        delegation_set_id =
          (Aws.Util.option_map (Aws.Json.lookup j "DelegationSetId")
             String.of_json)
      }
  end
...
module HealthCheckRegionList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map HealthCheckRegion.parse (Aws.Xml.members "Region" xml))
...
module ChildHealthCheckList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "ChildHealthCheck" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some (Aws.Query.Pair ("Name", (String.to_query v.name)));
           Some
             (Aws.Query.Pair ("Region", (CloudWatchRegion.to_query v.region)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("Name", (String.to_json v.name));
    ...
    let of_json j =
      {
        region =
          (CloudWatchRegion.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Region")));
        name =
          (String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Name")))
      }
  end
module HealthCheckConfig =
  struct
      ...
      Some
        {
          ...
          resource_path =
            (Aws.Util.option_bind (Aws.Xml.member "ResourcePath" xml)
               String.parse);
          fully_qualified_domain_name =
            (Aws.Util.option_bind
               (Aws.Xml.member "FullyQualifiedDomainName" xml) String.parse);
          search_string =
            (Aws.Util.option_bind (Aws.Xml.member "SearchString" xml)
               String.parse);
          request_interval =
            (Aws.Util.option_bind (Aws.Xml.member "RequestInterval" xml)
               Integer.parse);
          failure_threshold =
            (Aws.Util.option_bind (Aws.Xml.member "FailureThreshold" xml)
               Integer.parse);
          measure_latency =
            (Aws.Util.option_bind (Aws.Xml.member "MeasureLatency" xml)
               Boolean.parse);
          inverted =
            (Aws.Util.option_bind (Aws.Xml.member "Inverted" xml)
               Boolean.parse);
          disabled =
            (Aws.Util.option_bind (Aws.Xml.member "Disabled" xml)
               Boolean.parse);
          health_threshold =
            (Aws.Util.option_bind (Aws.Xml.member "HealthThreshold" xml)
               Integer.parse);
          child_health_checks =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ChildHealthChecks" xml)
                  ChildHealthCheckList.parse));
          enable_s_n_i =
            (Aws.Util.option_bind (Aws.Xml.member "EnableSNI" xml)
               Boolean.parse);
          regions =
            (Aws.Util.of_option []
          ...
          alarm_identifier =
            (Aws.Util.option_bind (Aws.Xml.member "AlarmIdentifier" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.insufficient_data_health_status
              (fun f ->
                 Aws.Query.Pair
                   ("InsufficientDataHealthStatus",
                     (InsufficientDataHealthStatus.to_query f)));
           Aws.Util.option_map v.alarm_identifier
             (fun f ->
                Aws.Query.Pair
                  ("AlarmIdentifier", (AlarmIdentifier.to_query f)));
           Some
             (Aws.Query.Pair
                ("Regions.member",
                  (HealthCheckRegionList.to_query v.regions)));
           Aws.Util.option_map v.enable_s_n_i
             (fun f -> Aws.Query.Pair ("EnableSNI", (Boolean.to_query f)));
           Some
             (Aws.Query.Pair
                ("ChildHealthChecks.member",
                  (ChildHealthCheckList.to_query v.child_health_checks)));
           Aws.Util.option_map v.health_threshold
             (fun f ->
                Aws.Query.Pair ("HealthThreshold", (Integer.to_query f)));
           Aws.Util.option_map v.disabled
             (fun f -> Aws.Query.Pair ("Disabled", (Boolean.to_query f)));
           Aws.Util.option_map v.inverted
             (fun f -> Aws.Query.Pair ("Inverted", (Boolean.to_query f)));
           Aws.Util.option_map v.measure_latency
             (fun f ->
                Aws.Query.Pair ("MeasureLatency", (Boolean.to_query f)));
           Aws.Util.option_map v.failure_threshold
             (fun f ->
                Aws.Query.Pair ("FailureThreshold", (Integer.to_query f)));
           Aws.Util.option_map v.request_interval
             (fun f ->
                Aws.Query.Pair ("RequestInterval", (Integer.to_query f)));
           Aws.Util.option_map v.search_string
             (fun f -> Aws.Query.Pair ("SearchString", (String.to_query f)));
           Aws.Util.option_map v.fully_qualified_domain_name
             (fun f ->
                Aws.Query.Pair
                  ("FullyQualifiedDomainName", (String.to_query f)));
           Aws.Util.option_map v.resource_path
             (fun f -> Aws.Query.Pair ("ResourcePath", (String.to_query f)));
           ...
           Aws.Util.option_map v.i_p_address
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.alarm_identifier
             (fun f -> ("AlarmIdentifier", (AlarmIdentifier.to_json f)));
           Some ("Regions", (HealthCheckRegionList.to_json v.regions));
           Aws.Util.option_map v.enable_s_n_i
             (fun f -> ("EnableSNI", (Boolean.to_json f)));
           Some
             ("ChildHealthChecks",
               (ChildHealthCheckList.to_json v.child_health_checks));
           Aws.Util.option_map v.health_threshold
             (fun f -> ("HealthThreshold", (Integer.to_json f)));
           Aws.Util.option_map v.disabled
             (fun f -> ("Disabled", (Boolean.to_json f)));
           Aws.Util.option_map v.inverted
             (fun f -> ("Inverted", (Boolean.to_json f)));
           Aws.Util.option_map v.measure_latency
             (fun f -> ("MeasureLatency", (Boolean.to_json f)));
           Aws.Util.option_map v.failure_threshold
             (fun f -> ("FailureThreshold", (Integer.to_json f)));
           Aws.Util.option_map v.request_interval
             (fun f -> ("RequestInterval", (Integer.to_json f)));
           Aws.Util.option_map v.search_string
             (fun f -> ("SearchString", (String.to_json f)));
           Aws.Util.option_map v.fully_qualified_domain_name
             (fun f -> ("FullyQualifiedDomainName", (String.to_json f)));
           Aws.Util.option_map v.resource_path
             (fun f -> ("ResourcePath", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        type_ =
          (HealthCheckType.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Type")));
        resource_path =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourcePath")
             String.of_json);
        fully_qualified_domain_name =
          (Aws.Util.option_map (Aws.Json.lookup j "FullyQualifiedDomainName")
             String.of_json);
        search_string =
          (Aws.Util.option_map (Aws.Json.lookup j "SearchString")
             String.of_json);
        request_interval =
          (Aws.Util.option_map (Aws.Json.lookup j "RequestInterval")
             Integer.of_json);
        failure_threshold =
          (Aws.Util.option_map (Aws.Json.lookup j "FailureThreshold")
             Integer.of_json);
        measure_latency =
          (Aws.Util.option_map (Aws.Json.lookup j "MeasureLatency")
             Boolean.of_json);
        inverted =
          (Aws.Util.option_map (Aws.Json.lookup j "Inverted") Boolean.of_json);
        disabled =
          (Aws.Util.option_map (Aws.Json.lookup j "Disabled") Boolean.of_json);
        health_threshold =
          (Aws.Util.option_map (Aws.Json.lookup j "HealthThreshold")
             Integer.of_json);
        child_health_checks =
          (ChildHealthCheckList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ChildHealthChecks")));
        enable_s_n_i =
          (Aws.Util.option_map (Aws.Json.lookup j "EnableSNI")
             Boolean.of_json);
        regions =
          (HealthCheckRegionList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Regions")));
        alarm_identifier =
          (Aws.Util.option_map (Aws.Json.lookup j "AlarmIdentifier")
          ...
          caller_reference =
            (Aws.Xml.required "CallerReference"
               (Aws.Util.option_bind (Aws.Xml.member "CallerReference" xml)
                  String.parse));
          health_check_config =
            (Aws.Xml.required "HealthCheckConfig"
               (Aws.Util.option_bind (Aws.Xml.member "HealthCheckConfig" xml)
...
module DimensionList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Dimension.parse (Aws.Xml.members "Dimension" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          evaluation_periods =
            (Aws.Xml.required "EvaluationPeriods"
               (Aws.Util.option_bind (Aws.Xml.member "EvaluationPeriods" xml)
                  Integer.parse));
          threshold =
            (Aws.Xml.required "Threshold"
               (Aws.Util.option_bind (Aws.Xml.member "Threshold" xml)
                  Double.parse));
          comparison_operator =
          ...
          period =
            (Aws.Xml.required "Period"
               (Aws.Util.option_bind (Aws.Xml.member "Period" xml)
                  Integer.parse));
          metric_name =
            (Aws.Xml.required "MetricName"
               (Aws.Util.option_bind (Aws.Xml.member "MetricName" xml)
                  String.parse));
          namespace =
            (Aws.Xml.required "Namespace"
               (Aws.Util.option_bind (Aws.Xml.member "Namespace" xml)
                  String.parse));
          statistic =
            (Aws.Xml.required "Statistic"
               (Aws.Util.option_bind (Aws.Xml.member "Statistic" xml)
                  Statistic.parse));
          dimensions =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Dimensions" xml)
                  DimensionList.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair ("Statistic", (Statistic.to_query v.statistic)));
           Some (Aws.Query.Pair ("Namespace", (String.to_query v.namespace)));
           Some
             (Aws.Query.Pair ("MetricName", (String.to_query v.metric_name)));
    ...
    let of_json j =
      {
        evaluation_periods =
          (Integer.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "EvaluationPeriods")));
        threshold =
          (Double.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Threshold")));
        comparison_operator =
          (ComparisonOperator.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ComparisonOperator")));
        period =
          (Integer.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Period")));
        metric_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MetricName")));
        namespace =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Namespace")));
        statistic =
          (Statistic.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Statistic")));
        dimensions =
          (DimensionList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Dimensions")))
      }
  end
module HealthCheck =
  struct
          ...
          health_check_config =
            (Aws.Xml.required "HealthCheckConfig"
               (Aws.Util.option_bind (Aws.Xml.member "HealthCheckConfig" xml)
                  HealthCheckConfig.parse));
          health_check_version =
            (Aws.Xml.required "HealthCheckVersion"
               (Aws.Util.option_bind
                  (Aws.Xml.member "HealthCheckVersion" xml) Long.parse));
          cloud_watch_alarm_configuration =
            (Aws.Util.option_bind
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cloud_watch_alarm_configuration
              (fun f ->
                 Aws.Query.Pair
    ...
    let of_json j =
      {
        ...
        health_check_version =
          (Long.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "HealthCheckVersion")));
        cloud_watch_alarm_configuration =
          (Aws.Util.option_map
  ...
  struct
    ...
    let parse xml =
      Some
        {
          delegation_sets =
            (Aws.Xml.required "DelegationSets"
               (Aws.Util.option_bind (Aws.Xml.member "DelegationSets" xml)
                  DelegationSets.parse));
          marker =
            (Aws.Xml.required "Marker"
               (Aws.Util.option_bind (Aws.Xml.member "Marker" xml)
                  String.parse));
          is_truncated =
            (Aws.Xml.required "IsTruncated"
               (Aws.Util.option_bind (Aws.Xml.member "IsTruncated" xml)
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Some
             ("DelegationSets", (DelegationSets.to_json v.delegation_sets))])
    let of_json j =
      {
        delegation_sets =
        ...
        marker =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Marker")));
        is_truncated =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "IsTruncated")));
        next_marker =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          limit =
            (Aws.Xml.required "Limit"
               (Aws.Util.option_bind (Aws.Xml.member "Limit" xml)
                  ReusableDelegationSetLimit.parse));
          count =
            (Aws.Xml.required "Count"
    ...
    let of_json j =
      {
        ...
        count =
          (Long.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Count")))
      }
  end
          ...
          status =
            (Aws.Xml.required "Status"
               (Aws.Util.option_bind (Aws.Xml.member "Status" xml)
                  ChangeStatus.parse));
          submitted_at =
            (Aws.Xml.required "SubmittedAt"
               (Aws.Util.option_bind (Aws.Xml.member "SubmittedAt" xml)
                  DateTime.parse));
          comment =
            (Aws.Util.option_bind (Aws.Xml.member "Comment" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("SubmittedAt", (DateTime.to_query v.submitted_at)));
    ...
    let of_json j =
      {
        id =
          (String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Id")));
        status =
          (ChangeStatus.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Status")));
        submitted_at =
          (DateTime.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "SubmittedAt")));
        comment =
          (Aws.Util.option_map (Aws.Json.lookup j "Comment") String.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          change_info =
            (Aws.Xml.required "ChangeInfo"
               (Aws.Util.option_bind (Aws.Xml.member "ChangeInfo" xml)
                  ChangeInfo.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("ChangeInfo", (ChangeInfo.to_query v.change_info)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        change_info =
          (ChangeInfo.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ChangeInfo")))
      }
  end
      ...
      Some
        {
          ...
          traffic_policy_instance_name_marker =
            (Aws.Util.option_bind
               (Aws.Xml.member "trafficpolicyinstancename" xml) String.parse);
          traffic_policy_instance_type_marker =
            (Aws.Util.option_bind
               (Aws.Xml.member "trafficpolicyinstancetype" xml) RRType.parse);
          max_items =
            (Aws.Util.option_bind (Aws.Xml.member "maxitems" xml)
               String.parse)
        }
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.traffic_policy_instance_type_marker
             (fun f ->
                Aws.Query.Pair
                  ("trafficpolicyinstancetype", (RRType.to_query f)));
           Aws.Util.option_map v.traffic_policy_instance_name_marker
             (fun f ->
                Aws.Query.Pair
                  ("trafficpolicyinstancename", (String.to_query f)));
           Aws.Util.option_map v.hosted_zone_id_marker
             (fun f -> Aws.Query.Pair ("hostedzoneid", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
              (fun f -> ("maxitems", (String.to_json f)));
           Aws.Util.option_map v.traffic_policy_instance_type_marker
             (fun f -> ("trafficpolicyinstancetype", (RRType.to_json f)));
           Aws.Util.option_map v.traffic_policy_instance_name_marker
             (fun f -> ("trafficpolicyinstancename", (String.to_json f)));
           Aws.Util.option_map v.hosted_zone_id_marker
             (fun f -> ("hostedzoneid", (String.to_json f)))])
    let of_json j =
      {
        ...
        traffic_policy_instance_name_marker =
          (Aws.Util.option_map
             (Aws.Json.lookup j "trafficpolicyinstancename") String.of_json);
        traffic_policy_instance_type_marker =
          (Aws.Util.option_map
             (Aws.Json.lookup j "trafficpolicyinstancetype") RRType.of_json);
        max_items =
          (Aws.Util.option_map (Aws.Json.lookup j "maxitems") String.of_json)
      }
  end
      ...
      Some
        {
          traffic_policy_instance =
            (Aws.Xml.required "TrafficPolicyInstance"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        traffic_policy_instance =
          (TrafficPolicyInstance.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "TrafficPolicyInstance")))
      }
  end
          ...
          version =
            (Aws.Xml.required "Version"
               (Aws.Util.option_bind (Aws.Xml.member "Version" xml)
                  Integer.parse));
          comment =
            (Aws.Xml.required "Comment"
               (Aws.Util.option_bind (Aws.Xml.member "Comment" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
              (fun f -> Aws.Query.Pair ("maxitems", (String.to_query f)));
           Aws.Util.option_map v.traffic_policy_id_marker
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
              (fun f -> ("maxitems", (String.to_json f)));
           Aws.Util.option_map v.traffic_policy_id_marker
             (fun f -> ("trafficpolicyid", (String.to_json f)))])
    let of_json j =
      {
        traffic_policy_id_marker =
          (Aws.Util.option_map (Aws.Json.lookup j "trafficpolicyid")
             String.of_json);
        max_items =
          (Aws.Util.option_map (Aws.Json.lookup j "maxitems") String.of_json)
      }
  ...
  struct
    ...
    let parse xml =
      Some
        {
          resource_record_sets =
            (Aws.Xml.required "ResourceRecordSets"
               (Aws.Util.option_bind
          ...
          is_truncated =
            (Aws.Xml.required "IsTruncated"
               (Aws.Util.option_bind (Aws.Xml.member "IsTruncated" xml)
                  Boolean.parse));
          next_record_name =
            (Aws.Util.option_bind (Aws.Xml.member "NextRecordName" xml)
               String.parse);
          next_record_type =
            (Aws.Util.option_bind (Aws.Xml.member "NextRecordType" xml)
               RRType.parse);
          next_record_identifier =
            (Aws.Util.option_bind (Aws.Xml.member "NextRecordIdentifier" xml)
               String.parse);
          max_items =
            (Aws.Xml.required "MaxItems"
               (Aws.Util.option_bind (Aws.Xml.member "MaxItems" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some (Aws.Query.Pair ("MaxItems", (String.to_query v.max_items)));
           Aws.Util.option_map v.next_record_identifier
             (fun f ->
                Aws.Query.Pair ("NextRecordIdentifier", (String.to_query f)));
           Aws.Util.option_map v.next_record_type
             (fun f -> Aws.Query.Pair ("NextRecordType", (RRType.to_query f)));
           Aws.Util.option_map v.next_record_name
             (fun f -> Aws.Query.Pair ("NextRecordName", (String.to_query f)));
           Some
             (Aws.Query.Pair
                ("IsTruncated", (Boolean.to_query v.is_truncated)));
           Some
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("MaxItems", (String.to_json v.max_items));
           Aws.Util.option_map v.next_record_identifier
             (fun f -> ("NextRecordIdentifier", (String.to_json f)));
           Aws.Util.option_map v.next_record_type
             (fun f -> ("NextRecordType", (RRType.to_json f)));
           Aws.Util.option_map v.next_record_name
             (fun f -> ("NextRecordName", (String.to_json f)));
           Some ("IsTruncated", (Boolean.to_json v.is_truncated));
           Some
             ("ResourceRecordSets",
    ...
    let of_json j =
      {
        ...
        is_truncated =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "IsTruncated")));
        next_record_name =
          (Aws.Util.option_map (Aws.Json.lookup j "NextRecordName")
             String.of_json);
        next_record_type =
          (Aws.Util.option_map (Aws.Json.lookup j "NextRecordType")
             RRType.of_json);
        next_record_identifier =
          (Aws.Util.option_map (Aws.Json.lookup j "NextRecordIdentifier")
             String.of_json);
        max_items =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MaxItems")))
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some (Aws.Query.Pair ("Value", (Long.to_query v.value)));
           Some
             (Aws.Query.Pair ("Type", (AccountLimitType.to_query v.type_)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("Value", (Long.to_json v.value));
  ...
  struct
    ...
    let parse xml =
      Some
        {
          delegation_set =
            (Aws.Xml.required "DelegationSet"
               (Aws.Util.option_bind (Aws.Xml.member "DelegationSet" xml)
                  DelegationSet.parse));
          location =
            (Aws.Xml.required "Location"
    ...
    let of_json j =
      {
        delegation_set =
          (DelegationSet.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "DelegationSet")));
        location =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Location")))
      }
  ...
  struct
    ...
    let parse xml =
      Some
        {
          start_continent_code =
            (Aws.Util.option_bind (Aws.Xml.member "startcontinentcode" xml)
               String.parse);
          start_country_code =
            (Aws.Util.option_bind (Aws.Xml.member "startcountrycode" xml)
               String.parse);
          start_subdivision_code =
            (Aws.Util.option_bind (Aws.Xml.member "startsubdivisioncode" xml)
               String.parse);
          max_items =
            (Aws.Util.option_bind (Aws.Xml.member "maxitems" xml)
               String.parse)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
              (fun f -> Aws.Query.Pair ("maxitems", (String.to_query f)));
           Aws.Util.option_map v.start_subdivision_code
             (fun f ->
                Aws.Query.Pair ("startsubdivisioncode", (String.to_query f)));
           Aws.Util.option_map v.start_country_code
             (fun f ->
                Aws.Query.Pair ("startcountrycode", (String.to_query f)));
           Aws.Util.option_map v.start_continent_code
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
              (fun f -> ("maxitems", (String.to_json f)));
           Aws.Util.option_map v.start_subdivision_code
             (fun f -> ("startsubdivisioncode", (String.to_json f)));
           Aws.Util.option_map v.start_country_code
             (fun f -> ("startcountrycode", (String.to_json f)));
           Aws.Util.option_map v.start_continent_code
             (fun f -> ("startcontinentcode", (String.to_json f)))])
    let of_json j =
      {
        start_continent_code =
          (Aws.Util.option_map (Aws.Json.lookup j "startcontinentcode")
             String.of_json);
        start_country_code =
          (Aws.Util.option_map (Aws.Json.lookup j "startcountrycode")
             String.of_json);
        start_subdivision_code =
          (Aws.Util.option_map (Aws.Json.lookup j "startsubdivisioncode")
             String.of_json);
        max_items =
          (Aws.Util.option_map (Aws.Json.lookup j "maxitems") String.of_json)
      }
  ...
  struct
    ...
    let parse xml =
      Some
        {
          hosted_zone_count =
            (Aws.Xml.required "HostedZoneCount"
               (Aws.Util.option_bind (Aws.Xml.member "HostedZoneCount" xml)
                  Long.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        hosted_zone_count =
          (Long.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "HostedZoneCount")))
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map HostedZoneSummary.parse
           (Aws.Xml.members "HostedZoneSummary" xml))
...
module HostedZones =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map HostedZone.parse (Aws.Xml.members "HostedZone" xml))
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.resource_type
             (fun f -> ("ResourceType", (TagResourceType.to_json f)))])
    let of_json j =
      {
        resource_type =
        ...
        resource_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourceId")
             String.of_json);
        tags =
          (TagList.of_json
  ...
  struct
    ...
    let parse xml =
      Some
        {
          resource_tag_sets =
            (Aws.Xml.required "ResourceTagSets"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceTagSets" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("vpcregion", (VPCRegion.to_query v.v_p_c_region)));
    ...
    let of_json j =
      {
        ...
        v_p_c_region =
          (VPCRegion.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "vpcregion")));
        max_items =
          (Aws.Util.option_map (Aws.Json.lookup j "maxitems") String.of_json);
        next_token =
  ...
  struct
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair ("Id", (String.to_query v.delegation_set_id)));
           Some
             (Aws.Query.Pair
                ("Type", (ReusableDelegationSetLimitType.to_query v.type_)))])
    let to_json v =
  ...
  struct
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_results
              (fun f -> Aws.Query.Pair ("maxresults", (String.to_query f)));
           Aws.Util.option_map v.next_token
             (fun f -> Aws.Query.Pair ("nexttoken", (String.to_query f)));
           Aws.Util.option_map v.hosted_zone_id
             (fun f -> Aws.Query.Pair ("hostedzoneid", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_results
              (fun f -> ("maxresults", (String.to_json f)));
           Aws.Util.option_map v.next_token
             (fun f -> ("nexttoken", (String.to_json f)));
           Aws.Util.option_map v.hosted_zone_id
             (fun f -> ("hostedzoneid", (String.to_json f)))])
      ...
      Some
        {
          query_logging_config =
            (Aws.Xml.required "QueryLoggingConfig"
               (Aws.Util.option_bind
...
module TagKeyList =
  struct
    ...
    let make elems () = elems
    let parse xml =
      Aws.Util.option_all (List.map String.parse (Aws.Xml.members "Key" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
      ...
      Some
        {
          ...
          add_tags =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "AddTags" xml)
                  TagList.parse));
          remove_tag_keys =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "RemoveTagKeys" xml)
                  TagKeyList.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("AddTags.member", (TagList.to_query v.add_tags)));
           Some
             (Aws.Query.Pair ("ResourceId", (String.to_query v.resource_id)));
           Some
             (Aws.Query.Pair
    ...
    let of_json j =
      {
        ...
        add_tags =
          (TagList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AddTags")));
        remove_tag_keys =
          (TagKeyList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RemoveTagKeys")))
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          health_check =
            (Aws.Xml.required "HealthCheck"
               (Aws.Util.option_bind (Aws.Xml.member "HealthCheck" xml)
                  HealthCheck.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        health_check =
          (HealthCheck.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "HealthCheck")))
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          traffic_policy_instance_count =
            (Aws.Xml.required "TrafficPolicyInstanceCount"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        traffic_policy_instance_count =
          (Integer.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "TrafficPolicyInstanceCount")))
      }
  end
      ...
      Some
        {
          query_logging_configs =
            (Aws.Xml.required "QueryLoggingConfigs"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        query_logging_configs =
          (QueryLoggingConfigs.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "QueryLoggingConfigs")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
...
module HealthChecks =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map HealthCheck.parse (Aws.Xml.members "HealthCheck" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          health_checks =
            (Aws.Xml.required "HealthChecks"
               (Aws.Util.option_bind (Aws.Xml.member "HealthChecks" xml)
                  HealthChecks.parse));
          marker =
            (Aws.Xml.required "Marker"
               (Aws.Util.option_bind (Aws.Xml.member "Marker" xml)
    ...
    let of_json j =
      {
        health_checks =
          (HealthChecks.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "HealthChecks")));
        marker =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Marker")));
        is_truncated =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some (Aws.Query.Pair ("Value", (Long.to_query v.value)));
           Some
             (Aws.Query.Pair ("Type", (HostedZoneLimitType.to_query v.type_)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("Value", (Long.to_json v.value));
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some (Aws.Query.Pair ("Count", (Long.to_query v.count)));
           Some
             (Aws.Query.Pair ("Limit", (HostedZoneLimit.to_query v.limit)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("Count", (Long.to_json v.count));
      ...
      Some
        {
          continent_code =
            (Aws.Util.option_bind (Aws.Xml.member "ContinentCode" xml)
               String.parse);
          continent_name =
            (Aws.Util.option_bind (Aws.Xml.member "ContinentName" xml)
               String.parse);
          country_code =
            (Aws.Util.option_bind (Aws.Xml.member "CountryCode" xml)
               String.parse);
          country_name =
            (Aws.Util.option_bind (Aws.Xml.member "CountryName" xml)
               String.parse);
          subdivision_code =
            (Aws.Util.option_bind (Aws.Xml.member "SubdivisionCode" xml)
               String.parse);
          subdivision_name =
            (Aws.Util.option_bind (Aws.Xml.member "SubdivisionName" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.subdivision_name
              (fun f ->
                 Aws.Query.Pair ("SubdivisionName", (String.to_query f)));
           Aws.Util.option_map v.subdivision_code
             (fun f ->
                Aws.Query.Pair ("SubdivisionCode", (String.to_query f)));
           Aws.Util.option_map v.country_name
             (fun f -> Aws.Query.Pair ("CountryName", (String.to_query f)));
           Aws.Util.option_map v.country_code
             (fun f -> Aws.Query.Pair ("CountryCode", (String.to_query f)));
           Aws.Util.option_map v.continent_name
             (fun f -> Aws.Query.Pair ("ContinentName", (String.to_query f)));
           Aws.Util.option_map v.continent_code
             (fun f -> Aws.Query.Pair ("ContinentCode", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.subdivision_name
              (fun f -> ("SubdivisionName", (String.to_json f)));
           Aws.Util.option_map v.subdivision_code
             (fun f -> ("SubdivisionCode", (String.to_json f)));
           Aws.Util.option_map v.country_name
             (fun f -> ("CountryName", (String.to_json f)));
           Aws.Util.option_map v.country_code
             (fun f -> ("CountryCode", (String.to_json f)));
           Aws.Util.option_map v.continent_name
             (fun f -> ("ContinentName", (String.to_json f)));
           Aws.Util.option_map v.continent_code
             (fun f -> ("ContinentCode", (String.to_json f)))])
    let of_json j =
      {
        continent_code =
          (Aws.Util.option_map (Aws.Json.lookup j "ContinentCode")
             String.of_json);
        continent_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ContinentName")
             String.of_json);
        country_code =
          (Aws.Util.option_map (Aws.Json.lookup j "CountryCode")
             String.of_json);
        country_name =
          (Aws.Util.option_map (Aws.Json.lookup j "CountryName")
             String.of_json);
        subdivision_code =
          (Aws.Util.option_map (Aws.Json.lookup j "SubdivisionCode")
             String.of_json);
        subdivision_name =
          (Aws.Util.option_map (Aws.Json.lookup j "SubdivisionName")
             String.of_json)
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map GeoLocationDetails.parse
           (Aws.Xml.members "GeoLocationDetails" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          geo_location_details_list =
            (Aws.Xml.required "GeoLocationDetailsList"
               (Aws.Util.option_bind
          ...
          is_truncated =
            (Aws.Xml.required "IsTruncated"
               (Aws.Util.option_bind (Aws.Xml.member "IsTruncated" xml)
                  Boolean.parse));
          next_continent_code =
            (Aws.Util.option_bind (Aws.Xml.member "NextContinentCode" xml)
               String.parse);
          next_country_code =
            (Aws.Util.option_bind (Aws.Xml.member "NextCountryCode" xml)
               String.parse);
          next_subdivision_code =
            (Aws.Util.option_bind (Aws.Xml.member "NextSubdivisionCode" xml)
               String.parse);
          max_items =
            (Aws.Xml.required "MaxItems"
               (Aws.Util.option_bind (Aws.Xml.member "MaxItems" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some (Aws.Query.Pair ("MaxItems", (String.to_query v.max_items)));
           Aws.Util.option_map v.next_subdivision_code
             (fun f ->
                Aws.Query.Pair ("NextSubdivisionCode", (String.to_query f)));
           Aws.Util.option_map v.next_country_code
             (fun f ->
                Aws.Query.Pair ("NextCountryCode", (String.to_query f)));
           Aws.Util.option_map v.next_continent_code
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("MaxItems", (String.to_json v.max_items));
           Aws.Util.option_map v.next_subdivision_code
             (fun f -> ("NextSubdivisionCode", (String.to_json f)));
           Aws.Util.option_map v.next_country_code
             (fun f -> ("NextCountryCode", (String.to_json f)));
           Aws.Util.option_map v.next_continent_code
             (fun f -> ("NextContinentCode", (String.to_json f)));
           Some ("IsTruncated", (Boolean.to_json v.is_truncated));
           Some
    ...
    let of_json j =
      {
        geo_location_details_list =
          (GeoLocationDetailsList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "GeoLocationDetailsList")));
        is_truncated =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "IsTruncated")));
        next_continent_code =
          (Aws.Util.option_map (Aws.Json.lookup j "NextContinentCode")
             String.of_json);
        next_country_code =
          (Aws.Util.option_map (Aws.Json.lookup j "NextCountryCode")
             String.of_json);
        next_subdivision_code =
          (Aws.Util.option_map (Aws.Json.lookup j "NextSubdivisionCode")
             String.of_json);
        max_items =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MaxItems")))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          resource_tag_set =
            (Aws.Xml.required "ResourceTagSet"
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("ResourceTagSet", (ResourceTagSet.to_json v.resource_tag_set))])
    let of_json j =
      {
        resource_tag_set =
...
module ErrorMessages =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "Message" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          hosted_zones =
            (Aws.Xml.required "HostedZones"
               (Aws.Util.option_bind (Aws.Xml.member "HostedZones" xml)
                  HostedZones.parse));
          marker =
    ...
    let of_json j =
      {
        hosted_zones =
          (HostedZones.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "HostedZones")));
        marker =
...
module TagResourceIdList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "ResourceId" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
          ...
          resource_type =
            (Aws.Xml.required "ResourceType"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceType" xml)
                  TagResourceType.parse));
          resource_ids =
            (Aws.Xml.required "ResourceIds"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceIds" xml)
  ...
  struct
      ...
      Some
        {
          ...
          checked_time =
            (Aws.Util.option_bind (Aws.Xml.member "CheckedTime" xml)
               DateTime.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.checked_time
              (fun f -> Aws.Query.Pair ("CheckedTime", (DateTime.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.checked_time
              (fun f -> ("CheckedTime", (DateTime.to_json f)));
           Aws.Util.option_map v.status
    ...
    let of_json j =
      {
        ...
        checked_time =
          (Aws.Util.option_map (Aws.Json.lookup j "CheckedTime")
             DateTime.of_json)
      }
  end
  ...
  struct
      ...
      Some
        {
          ...
          i_p_address =
            (Aws.Util.option_bind (Aws.Xml.member "IPAddress" xml)
               String.parse);
          status_report =
            (Aws.Util.option_bind (Aws.Xml.member "StatusReport" xml)
               StatusReport.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.status_report
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.status_report
              (fun f -> ("StatusReport", (StatusReport.to_json f)));
           Aws.Util.option_map v.i_p_address
             (fun f -> ("IPAddress", (String.to_json f)));
           Aws.Util.option_map v.region
    ...
    let of_json j =
      {
        region =
          (Aws.Util.option_map (Aws.Json.lookup j "Region")
             HealthCheckRegion.of_json);
        i_p_address =
          (Aws.Util.option_map (Aws.Json.lookup j "IPAddress") String.of_json);
        status_report =
          (Aws.Util.option_map (Aws.Json.lookup j "StatusReport")
  ...
  struct
    ...
    let parse xml =
      Some
        {
          health_check_count =
            (Aws.Xml.required "HealthCheckCount"
               (Aws.Util.option_bind (Aws.Xml.member "HealthCheckCount" xml)
                  Long.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        health_check_count =
          (Long.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "HealthCheckCount")))
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ResettableElementName.parse
           (Aws.Xml.members "ResettableElementName" xml))
      ...
      Some
        {
          health_check_id =
            (Aws.Xml.required "HealthCheckId"
               (Aws.Util.option_bind (Aws.Xml.member "HealthCheckId" xml)
                  String.parse));
          health_check_version =
            (Aws.Util.option_bind (Aws.Xml.member "HealthCheckVersion" xml)
               Long.parse);
          i_p_address =
            (Aws.Util.option_bind (Aws.Xml.member "IPAddress" xml)
               String.parse);
          ...
          reset_elements =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ResetElements" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.i_p_address
             (fun f -> Aws.Query.Pair ("IPAddress", (String.to_query f)));
           Aws.Util.option_map v.health_check_version
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.i_p_address
             (fun f -> ("IPAddress", (String.to_json f)));
           Aws.Util.option_map v.health_check_version
             (fun f -> ("HealthCheckVersion", (Long.to_json f)));
           Some ("HealthCheckId", (String.to_json v.health_check_id))])
    let of_json j =
      {
        health_check_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "HealthCheckId")));
        health_check_version =
          (Aws.Util.option_map (Aws.Json.lookup j "HealthCheckVersion")
             Long.of_json);
        i_p_address =
          (Aws.Util.option_map (Aws.Json.lookup j "IPAddress") String.of_json);
        port =
      ...
      Some
        {
          ...
          traffic_policy_version_marker =
            (Aws.Util.option_bind (Aws.Xml.member "trafficpolicyversion" xml)
               String.parse);
          max_items =
            (Aws.Util.option_bind (Aws.Xml.member "maxitems" xml)
               String.parse)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
              (fun f -> Aws.Query.Pair ("maxitems", (String.to_query f)));
           Aws.Util.option_map v.traffic_policy_version_marker
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
              (fun f -> ("maxitems", (String.to_json f)));
           Aws.Util.option_map v.traffic_policy_version_marker
             (fun f -> ("trafficpolicyversion", (String.to_json f)));
           Some ("Id", (String.to_json v.id))])
    let of_json j =
      {
        id =
          (String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Id")));
        traffic_policy_version_marker =
          (Aws.Util.option_map (Aws.Json.lookup j "trafficpolicyversion")
             String.of_json);
        max_items =
          (Aws.Util.option_map (Aws.Json.lookup j "maxitems") String.of_json)
      }
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair ("id", (String.to_query v.traffic_policy_id)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
      ...
      Some
        {
          messages =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "messages" xml)
                  ErrorMessages.parse));
          message =
            (Aws.Util.option_bind (Aws.Xml.member "message" xml) String.parse)
        }
  ...
  struct
          ...
          record_type =
            (Aws.Xml.required "recordtype"
               (Aws.Util.option_bind (Aws.Xml.member "recordtype" xml)
                  RRType.parse));
          resolver_i_p =
            (Aws.Util.option_bind (Aws.Xml.member "resolverip" xml)
               String.parse);
          e_d_n_s0_client_subnet_i_p =
            (Aws.Util.option_bind (Aws.Xml.member "edns0clientsubnetip" xml)
               String.parse);
          e_d_n_s0_client_subnet_mask =
            (Aws.Util.option_bind
               (Aws.Xml.member "edns0clientsubnetmask" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.e_d_n_s0_client_subnet_mask
              (fun f ->
                 Aws.Query.Pair
                   ("edns0clientsubnetmask", (String.to_query f)));
           Aws.Util.option_map v.e_d_n_s0_client_subnet_i_p
             (fun f ->
                Aws.Query.Pair ("edns0clientsubnetip", (String.to_query f)));
           Aws.Util.option_map v.resolver_i_p
             (fun f -> Aws.Query.Pair ("resolverip", (String.to_query f)));
           Some
             (Aws.Query.Pair ("recordtype", (RRType.to_query v.record_type)));
           Some
             (Aws.Query.Pair ("recordname", (String.to_query v.record_name)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.e_d_n_s0_client_subnet_mask
              (fun f -> ("edns0clientsubnetmask", (String.to_json f)));
           Aws.Util.option_map v.e_d_n_s0_client_subnet_i_p
             (fun f -> ("edns0clientsubnetip", (String.to_json f)));
           Aws.Util.option_map v.resolver_i_p
             (fun f -> ("resolverip", (String.to_json f)));
           Some ("recordtype", (RRType.to_json v.record_type));
           Some ("recordname", (String.to_json v.record_name));
           Some ("hostedzoneid", (String.to_json v.hosted_zone_id))])
    let of_json j =
      {
        ...
        record_type =
          (RRType.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "recordtype")));
        resolver_i_p =
          (Aws.Util.option_map (Aws.Json.lookup j "resolverip")
             String.of_json);
        e_d_n_s0_client_subnet_i_p =
          (Aws.Util.option_map (Aws.Json.lookup j "edns0clientsubnetip")
             String.of_json);
        e_d_n_s0_client_subnet_mask =
          (Aws.Util.option_map (Aws.Json.lookup j "edns0clientsubnetmask")
             String.of_json)
      }
  end
module HealthCheckObservations =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list HealthCheckObservation.to_query v
      ...
      Some
        {
          ...
          start_record_type =
            (Aws.Util.option_bind (Aws.Xml.member "type" xml) RRType.parse);
          start_record_identifier =
            (Aws.Util.option_bind (Aws.Xml.member "identifier" xml)
               String.parse);
          max_items =
            (Aws.Util.option_bind (Aws.Xml.member "maxitems" xml)
               String.parse)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
              (fun f -> Aws.Query.Pair ("maxitems", (String.to_query f)));
           Aws.Util.option_map v.start_record_identifier
             (fun f -> Aws.Query.Pair ("identifier", (String.to_query f)));
           Aws.Util.option_map v.start_record_type
             (fun f -> Aws.Query.Pair ("type", (RRType.to_query f)));
           Aws.Util.option_map v.start_record_name
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_items
              (fun f -> ("maxitems", (String.to_json f)));
           Aws.Util.option_map v.start_record_identifier
             (fun f -> ("identifier", (String.to_json f)));
           Aws.Util.option_map v.start_record_type
             (fun f -> ("type", (RRType.to_json f)));
           Aws.Util.option_map v.start_record_name
    ...
    let of_json j =
      {
        ...
        start_record_type =
          (Aws.Util.option_map (Aws.Json.lookup j "type") RRType.of_json);
        start_record_identifier =
          (Aws.Util.option_map (Aws.Json.lookup j "identifier")
             String.of_json);
        max_items =
          (Aws.Util.option_map (Aws.Json.lookup j "maxitems") String.of_json)
      }
      ...
      Some
        {
          hosted_zone_summaries =
            (Aws.Xml.required "HostedZoneSummaries"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        hosted_zone_summaries =
          (HostedZoneSummaries.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "HostedZoneSummaries")));
        max_items =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MaxItems")));
        next_token =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          checker_ip_ranges =
            (Aws.Xml.required "CheckerIpRanges"
               (Aws.Util.option_bind (Aws.Xml.member "CheckerIpRanges" xml)
      ...
      Some
        {
          health_check_observations =
            (Aws.Xml.required "HealthCheckObservations"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        health_check_observations =
          (HealthCheckObservations.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "HealthCheckObservations")))
      }
  end
      ...
      Some
        {
          geo_location_details =
            (Aws.Xml.required "GeoLocationDetails"
               (Aws.Util.option_bind
  ...
  struct
    ...
    let parse xml =
      Some
        {
          traffic_policies =
            (Aws.Xml.required "TrafficPolicies"
               (Aws.Util.option_bind (Aws.Xml.member "TrafficPolicies" xml)
          ...
          is_truncated =
            (Aws.Xml.required "IsTruncated"
               (Aws.Util.option_bind (Aws.Xml.member "IsTruncated" xml)
                  Boolean.parse));
          traffic_policy_version_marker =
            (Aws.Xml.required "TrafficPolicyVersionMarker"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        ...
        traffic_policy_version_marker =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "TrafficPolicyVersionMarker")));
        max_items =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MaxItems")))
      }
  ...
  struct
          ...
          is_truncated =
            (Aws.Xml.required "IsTruncated"
               (Aws.Util.option_bind (Aws.Xml.member "IsTruncated" xml)
                  Boolean.parse));
          next_d_n_s_name =
            (Aws.Util.option_bind (Aws.Xml.member "NextDNSName" xml)
               String.parse);
          next_hosted_zone_id =
            (Aws.Util.option_bind (Aws.Xml.member "NextHostedZoneId" xml)
               String.parse);
          max_items =
            (Aws.Xml.required "MaxItems"
               (Aws.Util.option_bind (Aws.Xml.member "MaxItems" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some (Aws.Query.Pair ("MaxItems", (String.to_query v.max_items)));
           Aws.Util.option_map v.next_hosted_zone_id
             (fun f ->
                Aws.Query.Pair ("NextHostedZoneId", (String.to_query f)));
           Aws.Util.option_map v.next_d_n_s_name
             (fun f -> Aws.Query.Pair ("NextDNSName", (String.to_query f)));
           Some
             (Aws.Query.Pair
                ("IsTruncated", (Boolean.to_query v.is_truncated)));
           Aws.Util.option_map v.hosted_zone_id
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("MaxItems", (String.to_json v.max_items));
           Aws.Util.option_map v.next_hosted_zone_id
             (fun f -> ("NextHostedZoneId", (String.to_json f)));
           Aws.Util.option_map v.next_d_n_s_name
             (fun f -> ("NextDNSName", (String.to_json f)));
           Some ("IsTruncated", (Boolean.to_json v.is_truncated));
           Aws.Util.option_map v.hosted_zone_id
             (fun f -> ("HostedZoneId", (String.to_json f)));
           Aws.Util.option_map v.d_n_s_name
    ...
    let of_json j =
      {
        ...
        is_truncated =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "IsTruncated")));
        next_d_n_s_name =
          (Aws.Util.option_map (Aws.Json.lookup j "NextDNSName")
             String.of_json);
        next_hosted_zone_id =
          (Aws.Util.option_map (Aws.Json.lookup j "NextHostedZoneId")
             String.of_json);
        max_items =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MaxItems")))
