  ...
  struct
    ...
    let parse xml =
      Some
        {
          tag_key =
            (Aws.Xml.required "TagKey"
               (Aws.Util.option_bind (Aws.Xml.member "TagKey" xml)
                  String.parse));
          tag_value =
            (Aws.Xml.required "TagValue"
               (Aws.Util.option_bind (Aws.Xml.member "TagValue" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        ...
        tag_value =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TagValue")))
      }
  end
module TagList =
  struct
...
module MultiRegionKeyList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map MultiRegionKey.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          multi_region_key_type =
            (Aws.Util.option_bind (Aws.Xml.member "MultiRegionKeyType" xml)
               MultiRegionKeyType.parse);
          primary_key =
            (Aws.Util.option_bind (Aws.Xml.member "PrimaryKey" xml)
               MultiRegionKey.parse);
          replica_keys =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ReplicaKeys" xml)
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("ReplicaKeys.member",
                   (MultiRegionKeyList.to_query v.replica_keys)));
           Aws.Util.option_map v.primary_key
             (fun f ->
                Aws.Query.Pair ("PrimaryKey", (MultiRegionKey.to_query f)));
           Aws.Util.option_map v.multi_region_key_type
             (fun f ->
                Aws.Query.Pair
                  ("MultiRegionKeyType", (MultiRegionKeyType.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("ReplicaKeys", (MultiRegionKeyList.to_json v.replica_keys));
           Aws.Util.option_map v.primary_key
             (fun f -> ("PrimaryKey", (MultiRegionKey.to_json f)));
           Aws.Util.option_map v.multi_region_key_type
             (fun f -> ("MultiRegionKeyType", (MultiRegionKeyType.to_json f)))])
    let of_json j =
      {
        multi_region_key_type =
          (Aws.Util.option_map (Aws.Json.lookup j "MultiRegionKeyType")
             MultiRegionKeyType.of_json);
        primary_key =
          (Aws.Util.option_map (Aws.Json.lookup j "PrimaryKey")
             MultiRegionKey.of_json);
        replica_keys =
...
module EncryptionAlgorithmSpecList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map EncryptionAlgorithmSpec.parse
           (Aws.Xml.members "member" xml))
    let to_query v =
      Aws.Query.to_query_list EncryptionAlgorithmSpec.to_query v
  ...
  struct
    ...
    let make ?a_w_s_account_id  ~key_id  ?arn  ?creation_date  ?enabled 
      ...
      ?origin  ?custom_key_store_id  ?cloud_hsm_cluster_id  ?expiration_model
       ?key_manager  ?customer_master_key_spec  ?key_spec 
      ?(encryption_algorithms= [])  ?(signing_algorithms= [])  ?multi_region 
      ...
      Some
        {
          ...
          description =
            (Aws.Util.option_bind (Aws.Xml.member "Description" xml)
               String.parse);
          key_usage =
            (Aws.Util.option_bind (Aws.Xml.member "KeyUsage" xml)
               KeyUsageType.parse);
          key_state =
            (Aws.Util.option_bind (Aws.Xml.member "KeyState" xml)
               KeyState.parse);
          deletion_date =
            (Aws.Util.option_bind (Aws.Xml.member "DeletionDate" xml)
               DateTime.parse);
          valid_to =
            (Aws.Util.option_bind (Aws.Xml.member "ValidTo" xml)
               DateTime.parse);
          origin =
            (Aws.Util.option_bind (Aws.Xml.member "Origin" xml)
               OriginType.parse);
          custom_key_store_id =
            (Aws.Util.option_bind (Aws.Xml.member "CustomKeyStoreId" xml)
               String.parse);
          cloud_hsm_cluster_id =
            (Aws.Util.option_bind (Aws.Xml.member "CloudHsmClusterId" xml)
               String.parse);
          expiration_model =
            (Aws.Util.option_bind (Aws.Xml.member "ExpirationModel" xml)
               ExpirationModelType.parse);
          key_manager =
            (Aws.Util.option_bind (Aws.Xml.member "KeyManager" xml)
          ...
          key_spec =
            (Aws.Util.option_bind (Aws.Xml.member "KeySpec" xml)
               KeySpec.parse);
          encryption_algorithms =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
          ...
          signing_algorithms =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "SigningAlgorithms" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.pending_deletion_window_in_days
              (fun f ->
                 Aws.Query.Pair
                   ("PendingDeletionWindowInDays", (Integer.to_query f)));
           Aws.Util.option_map v.multi_region_configuration
             (fun f ->
                Aws.Query.Pair
                  ("MultiRegionConfiguration",
                    (MultiRegionConfiguration.to_query f)));
           ...
           Aws.Util.option_map v.key_spec
             (fun f -> Aws.Query.Pair ("KeySpec", (KeySpec.to_query f)));
           Aws.Util.option_map v.customer_master_key_spec
             (fun f ->
                Aws.Query.Pair
                  ("CustomerMasterKeySpec",
                    (CustomerMasterKeySpec.to_query f)));
           Aws.Util.option_map v.key_manager
             (fun f ->
                Aws.Query.Pair ("KeyManager", (KeyManagerType.to_query f)));
           Aws.Util.option_map v.expiration_model
             (fun f ->
                Aws.Query.Pair
                  ("ExpirationModel", (ExpirationModelType.to_query f)));
           Aws.Util.option_map v.cloud_hsm_cluster_id
             (fun f ->
                Aws.Query.Pair ("CloudHsmClusterId", (String.to_query f)));
           Aws.Util.option_map v.custom_key_store_id
             (fun f ->
                Aws.Query.Pair ("CustomKeyStoreId", (String.to_query f)));
           Aws.Util.option_map v.origin
             (fun f -> Aws.Query.Pair ("Origin", (OriginType.to_query f)));
           Aws.Util.option_map v.valid_to
             (fun f -> Aws.Query.Pair ("ValidTo", (DateTime.to_query f)));
           Aws.Util.option_map v.deletion_date
             (fun f -> Aws.Query.Pair ("DeletionDate", (DateTime.to_query f)));
           Aws.Util.option_map v.key_state
             (fun f -> Aws.Query.Pair ("KeyState", (KeyState.to_query f)));
           Aws.Util.option_map v.key_usage
             (fun f -> Aws.Query.Pair ("KeyUsage", (KeyUsageType.to_query f)));
           ...
           Aws.Util.option_map v.arn
             (fun f -> Aws.Query.Pair ("Arn", (String.to_query f)));
           Some (Aws.Query.Pair ("KeyId", (String.to_query v.key_id)));
           Aws.Util.option_map v.a_w_s_account_id
             (fun f -> Aws.Query.Pair ("AWSAccountId", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.pending_deletion_window_in_days
              (fun f -> ("PendingDeletionWindowInDays", (Integer.to_json f)));
           Aws.Util.option_map v.multi_region_configuration
             (fun f ->
                ("MultiRegionConfiguration",
                  (MultiRegionConfiguration.to_json f)));
           Aws.Util.option_map v.multi_region
           ...
           Aws.Util.option_map v.key_spec
             (fun f -> ("KeySpec", (KeySpec.to_json f)));
           Aws.Util.option_map v.customer_master_key_spec
             (fun f ->
                ("CustomerMasterKeySpec", (CustomerMasterKeySpec.to_json f)));
           Aws.Util.option_map v.key_manager
             (fun f -> ("KeyManager", (KeyManagerType.to_json f)));
           Aws.Util.option_map v.expiration_model
             (fun f -> ("ExpirationModel", (ExpirationModelType.to_json f)));
           Aws.Util.option_map v.cloud_hsm_cluster_id
             (fun f -> ("CloudHsmClusterId", (String.to_json f)));
           Aws.Util.option_map v.custom_key_store_id
             (fun f -> ("CustomKeyStoreId", (String.to_json f)));
           Aws.Util.option_map v.origin
             (fun f -> ("Origin", (OriginType.to_json f)));
           Aws.Util.option_map v.valid_to
             (fun f -> ("ValidTo", (DateTime.to_json f)));
           Aws.Util.option_map v.deletion_date
             (fun f -> ("DeletionDate", (DateTime.to_json f)));
           Aws.Util.option_map v.key_state
             (fun f -> ("KeyState", (KeyState.to_json f)));
           Aws.Util.option_map v.key_usage
             (fun f -> ("KeyUsage", (KeyUsageType.to_json f)));
           Aws.Util.option_map v.description
    ...
    let of_json j =
      {
        a_w_s_account_id =
          (Aws.Util.option_map (Aws.Json.lookup j "AWSAccountId")
             String.of_json);
        key_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "KeyId")));
        ...
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json);
        key_usage =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyUsage")
             KeyUsageType.of_json);
        key_state =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyState")
             KeyState.of_json);
        deletion_date =
          (Aws.Util.option_map (Aws.Json.lookup j "DeletionDate")
             DateTime.of_json);
        valid_to =
          (Aws.Util.option_map (Aws.Json.lookup j "ValidTo") DateTime.of_json);
        origin =
          (Aws.Util.option_map (Aws.Json.lookup j "Origin")
             OriginType.of_json);
        custom_key_store_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CustomKeyStoreId")
             String.of_json);
        cloud_hsm_cluster_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CloudHsmClusterId")
             String.of_json);
        expiration_model =
          (Aws.Util.option_map (Aws.Json.lookup j "ExpirationModel")
             ExpirationModelType.of_json);
        key_manager =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyManager")
             KeyManagerType.of_json);
        customer_master_key_spec =
          (Aws.Util.option_map (Aws.Json.lookup j "CustomerMasterKeySpec")
             CustomerMasterKeySpec.of_json);
        key_spec =
          (Aws.Util.option_map (Aws.Json.lookup j "KeySpec") KeySpec.of_json);
        encryption_algorithms =
          (EncryptionAlgorithmSpecList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "EncryptionAlgorithms")));
        signing_algorithms =
          (SigningAlgorithmSpecList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "SigningAlgorithms")));
        multi_region =
          (Aws.Util.option_map (Aws.Json.lookup j "MultiRegion")
             Boolean.of_json);
        multi_region_configuration =
          (Aws.Util.option_map (Aws.Json.lookup j "MultiRegionConfiguration")
      ...
      Some
        {
          replica_key_metadata =
            (Aws.Util.option_bind (Aws.Xml.member "ReplicaKeyMetadata" xml)
               KeyMetadata.parse);
          replica_policy =
            (Aws.Util.option_bind (Aws.Xml.member "ReplicaPolicy" xml)
               String.parse);
          replica_tags =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ReplicaTags" xml)
                  TagList.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("ReplicaTags.member", (TagList.to_query v.replica_tags)));
           Aws.Util.option_map v.replica_policy
             (fun f -> Aws.Query.Pair ("ReplicaPolicy", (String.to_query f)));
           Aws.Util.option_map v.replica_key_metadata
             (fun f ->
                Aws.Query.Pair
                  ("ReplicaKeyMetadata", (KeyMetadata.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("ReplicaTags", (TagList.to_json v.replica_tags));
           Aws.Util.option_map v.replica_policy
             (fun f -> ("ReplicaPolicy", (String.to_json f)));
           Aws.Util.option_map v.replica_key_metadata
             (fun f -> ("ReplicaKeyMetadata", (KeyMetadata.to_json f)))])
    let of_json j =
      {
        replica_key_metadata =
          (Aws.Util.option_map (Aws.Json.lookup j "ReplicaKeyMetadata")
             KeyMetadata.of_json);
        replica_policy =
          (Aws.Util.option_map (Aws.Json.lookup j "ReplicaPolicy")
             String.of_json);
        replica_tags =
          (TagList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ReplicaTags")))
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          key_metadata =
            (Aws.Util.option_bind (Aws.Xml.member "KeyMetadata" xml)
               KeyMetadata.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.key_metadata
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.key_metadata
              (fun f -> ("KeyMetadata", (KeyMetadata.to_json f)))])
    let of_json j =
      {
        key_metadata =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyMetadata")
             KeyMetadata.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          ciphertext_blob =
            (Aws.Util.option_bind (Aws.Xml.member "CiphertextBlob" xml)
               Blob.parse);
          source_key_id =
            (Aws.Util.option_bind (Aws.Xml.member "SourceKeyId" xml)
               String.parse);
          key_id =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.destination_encryption_algorithm
              (fun f ->
                 Aws.Query.Pair
                   ("DestinationEncryptionAlgorithm",
                     (EncryptionAlgorithmSpec.to_query f)));
           Aws.Util.option_map v.source_encryption_algorithm
             (fun f ->
                Aws.Query.Pair
                  ("SourceEncryptionAlgorithm",
                    (EncryptionAlgorithmSpec.to_query f)));
           Aws.Util.option_map v.key_id
             (fun f -> Aws.Query.Pair ("KeyId", (String.to_query f)));
           Aws.Util.option_map v.source_key_id
             (fun f -> Aws.Query.Pair ("SourceKeyId", (String.to_query f)));
           Aws.Util.option_map v.ciphertext_blob
             (fun f -> Aws.Query.Pair ("CiphertextBlob", (Blob.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.destination_encryption_algorithm
           ...
           Aws.Util.option_map v.source_encryption_algorithm
             (fun f ->
                ("SourceEncryptionAlgorithm",
                  (EncryptionAlgorithmSpec.to_json f)));
           Aws.Util.option_map v.key_id
             (fun f -> ("KeyId", (String.to_json f)));
           Aws.Util.option_map v.source_key_id
             (fun f -> ("SourceKeyId", (String.to_json f)));
           Aws.Util.option_map v.ciphertext_blob
             (fun f -> ("CiphertextBlob", (Blob.to_json f)))])
    let of_json j =
      {
        ciphertext_blob =
          (Aws.Util.option_map (Aws.Json.lookup j "CiphertextBlob")
             Blob.of_json);
        source_key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "SourceKeyId")
             String.of_json);
        key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyId") String.of_json);
        source_encryption_algorithm =
          (Aws.Util.option_map
      ...
      Some
        {
          ...
          grant_tokens =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "GrantTokens" xml)
    ...
    let of_json j =
      {
        ...
        grant_tokens =
          (GrantTokenList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "GrantTokens")))
      }
  end
module TagException =
  struct
      ...
      Some
        {
          key_id =
            (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml) String.parse);
          import_token =
            (Aws.Util.option_bind (Aws.Xml.member "ImportToken" xml)
               Blob.parse);
          public_key =
            (Aws.Util.option_bind (Aws.Xml.member "PublicKey" xml) Blob.parse);
          parameters_valid_to =
            (Aws.Util.option_bind (Aws.Xml.member "ParametersValidTo" xml)
               DateTime.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.parameters_valid_to
              (fun f ->
                 Aws.Query.Pair ("ParametersValidTo", (DateTime.to_query f)));
           Aws.Util.option_map v.public_key
             (fun f -> Aws.Query.Pair ("PublicKey", (Blob.to_query f)));
           Aws.Util.option_map v.import_token
             (fun f -> Aws.Query.Pair ("ImportToken", (Blob.to_query f)));
           Aws.Util.option_map v.key_id
             (fun f -> Aws.Query.Pair ("KeyId", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.parameters_valid_to
              (fun f -> ("ParametersValidTo", (DateTime.to_json f)));
           Aws.Util.option_map v.public_key
             (fun f -> ("PublicKey", (Blob.to_json f)));
           Aws.Util.option_map v.import_token
             (fun f -> ("ImportToken", (Blob.to_json f)));
           Aws.Util.option_map v.key_id
             (fun f -> ("KeyId", (String.to_json f)))])
    let of_json j =
      {
        key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyId") String.of_json);
        import_token =
          (Aws.Util.option_map (Aws.Json.lookup j "ImportToken") Blob.of_json);
        public_key =
          (Aws.Util.option_map (Aws.Json.lookup j "PublicKey") Blob.of_json);
        parameters_valid_to =
          (Aws.Util.option_map (Aws.Json.lookup j "ParametersValidTo")
             DateTime.of_json)
      }
  end
  ...
  struct
      ...
      Some
        {
          ...
          pending_window_in_days =
            (Aws.Util.option_bind (Aws.Xml.member "PendingWindowInDays" xml)
               Integer.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.pending_window_in_days
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.pending_window_in_days
              (fun f -> ("PendingWindowInDays", (Integer.to_json f)));
           Aws.Util.option_map v.key_state
             (fun f -> ("KeyState", (KeyState.to_json f)));
           Aws.Util.option_map v.deletion_date
             (fun f -> ("DeletionDate", (DateTime.to_json f)));
    ...
    let of_json j =
      {
        ...
        key_state =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyState")
             KeyState.of_json);
        pending_window_in_days =
          (Aws.Util.option_map (Aws.Json.lookup j "PendingWindowInDays")
             Integer.of_json)
      }
  end
...
module GrantOperationList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map GrantOperation.parse (Aws.Xml.members "member" xml))
...
module GrantConstraints =
  struct
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.encryption_context_equals
              (fun f ->
                 Aws.Query.Pair
                   ("EncryptionContextEquals",
                     (EncryptionContextType.to_query f)));
           Aws.Util.option_map v.encryption_context_subset
             (fun f ->
                Aws.Query.Pair
    ...
    let of_json j =
      {
        encryption_context_subset =
          (Aws.Util.option_map (Aws.Json.lookup j "EncryptionContextSubset")
             EncryptionContextType.of_json);
        encryption_context_equals =
          (Aws.Util.option_map (Aws.Json.lookup j "EncryptionContextEquals")
             EncryptionContextType.of_json)
      }
  end
      ...
      Some
        {
          ...
          creation_date =
            (Aws.Util.option_bind (Aws.Xml.member "CreationDate" xml)
               DateTime.parse);
          grantee_principal =
            (Aws.Util.option_bind (Aws.Xml.member "GranteePrincipal" xml)
               String.parse);
          retiring_principal =
            (Aws.Util.option_bind (Aws.Xml.member "RetiringPrincipal" xml)
               String.parse);
          issuing_account =
            (Aws.Util.option_bind (Aws.Xml.member "IssuingAccount" xml)
               String.parse);
          operations =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Operations" xml)
                  GrantOperationList.parse));
          constraints =
            (Aws.Util.option_bind (Aws.Xml.member "Constraints" xml)
               GrantConstraints.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.constraints
              (fun f ->
                 Aws.Query.Pair
                   ("Constraints", (GrantConstraints.to_query f)));
           Some
             (Aws.Query.Pair
                ("Operations.member",
                  (GrantOperationList.to_query v.operations)));
           Aws.Util.option_map v.issuing_account
             (fun f -> Aws.Query.Pair ("IssuingAccount", (String.to_query f)));
           Aws.Util.option_map v.retiring_principal
             (fun f ->
                Aws.Query.Pair ("RetiringPrincipal", (String.to_query f)));
           Aws.Util.option_map v.grantee_principal
             (fun f ->
           ...
           Aws.Util.option_map v.grant_id
             (fun f -> Aws.Query.Pair ("GrantId", (String.to_query f)));
           Aws.Util.option_map v.key_id
             (fun f -> Aws.Query.Pair ("KeyId", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.issuing_account
             (fun f -> ("IssuingAccount", (String.to_json f)));
           Aws.Util.option_map v.retiring_principal
             (fun f -> ("RetiringPrincipal", (String.to_json f)));
           Aws.Util.option_map v.grantee_principal
             (fun f -> ("GranteePrincipal", (String.to_json f)));
           Aws.Util.option_map v.creation_date
             (fun f -> ("CreationDate", (DateTime.to_json f)));
           Aws.Util.option_map v.name (fun f -> ("Name", (String.to_json f)));
           Aws.Util.option_map v.grant_id
             (fun f -> ("GrantId", (String.to_json f)));
           Aws.Util.option_map v.key_id
             (fun f -> ("KeyId", (String.to_json f)))])
    let of_json j =
      {
        key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyId") String.of_json);
        grant_id =
          (Aws.Util.option_map (Aws.Json.lookup j "GrantId") String.of_json);
        name =
        ...
        creation_date =
          (Aws.Util.option_map (Aws.Json.lookup j "CreationDate")
             DateTime.of_json);
        grantee_principal =
          (Aws.Util.option_map (Aws.Json.lookup j "GranteePrincipal")
             String.of_json);
        retiring_principal =
          (Aws.Util.option_map (Aws.Json.lookup j "RetiringPrincipal")
             String.of_json);
        issuing_account =
          (Aws.Util.option_map (Aws.Json.lookup j "IssuingAccount")
             String.of_json);
        operations =
          (GrantOperationList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Operations")));
        constraints =
          (Aws.Util.option_map (Aws.Json.lookup j "Constraints")
...
module GrantList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map GrantListEntry.parse (Aws.Xml.members "member" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          custom_key_store_name =
            (Aws.Xml.required "CustomKeyStoreName"
               (Aws.Util.option_bind
                  (Aws.Xml.member "CustomKeyStoreName" xml) String.parse));
          cloud_hsm_cluster_id =
            (Aws.Xml.required "CloudHsmClusterId"
               (Aws.Util.option_bind (Aws.Xml.member "CloudHsmClusterId" xml)
                  String.parse));
          trust_anchor_certificate =
            (Aws.Xml.required "TrustAnchorCertificate"
               (Aws.Util.option_bind
                  (Aws.Xml.member "TrustAnchorCertificate" xml) String.parse));
          key_store_password =
            (Aws.Xml.required "KeyStorePassword"
               (Aws.Util.option_bind (Aws.Xml.member "KeyStorePassword" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Some
             ("CloudHsmClusterId", (String.to_json v.cloud_hsm_cluster_id));
           Some
             ("CustomKeyStoreName", (String.to_json v.custom_key_store_name))])
    let of_json j =
      {
        custom_key_store_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "CustomKeyStoreName")));
        cloud_hsm_cluster_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "CloudHsmClusterId")));
        trust_anchor_certificate =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "TrustAnchorCertificate")));
        key_store_password =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "KeyStorePassword")))
      }
  end
      ...
      Some
        {
          custom_key_store_id =
            (Aws.Util.option_bind (Aws.Xml.member "CustomKeyStoreId" xml)
               String.parse);
          custom_key_store_name =
            (Aws.Util.option_bind (Aws.Xml.member "CustomKeyStoreName" xml)
               String.parse);
          cloud_hsm_cluster_id =
            (Aws.Util.option_bind (Aws.Xml.member "CloudHsmClusterId" xml)
               String.parse);
          trust_anchor_certificate =
            (Aws.Util.option_bind
               (Aws.Xml.member "TrustAnchorCertificate" xml) String.parse);
          connection_state =
            (Aws.Util.option_bind (Aws.Xml.member "ConnectionState" xml)
               ConnectionStateType.parse);
          connection_error_code =
            (Aws.Util.option_bind (Aws.Xml.member "ConnectionErrorCode" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.connection_error_code
             (fun f ->
                Aws.Query.Pair
                  ("ConnectionErrorCode",
                    (ConnectionErrorCodeType.to_query f)));
           Aws.Util.option_map v.connection_state
             (fun f ->
                Aws.Query.Pair
                  ("ConnectionState", (ConnectionStateType.to_query f)));
           Aws.Util.option_map v.trust_anchor_certificate
             (fun f ->
                Aws.Query.Pair
                  ("TrustAnchorCertificate", (String.to_query f)));
           Aws.Util.option_map v.cloud_hsm_cluster_id
             (fun f ->
                Aws.Query.Pair ("CloudHsmClusterId", (String.to_query f)));
           Aws.Util.option_map v.custom_key_store_name
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.connection_state
             (fun f -> ("ConnectionState", (ConnectionStateType.to_json f)));
           Aws.Util.option_map v.trust_anchor_certificate
             (fun f -> ("TrustAnchorCertificate", (String.to_json f)));
           Aws.Util.option_map v.cloud_hsm_cluster_id
             (fun f -> ("CloudHsmClusterId", (String.to_json f)));
           Aws.Util.option_map v.custom_key_store_name
             (fun f -> ("CustomKeyStoreName", (String.to_json f)));
           Aws.Util.option_map v.custom_key_store_id
             (fun f -> ("CustomKeyStoreId", (String.to_json f)))])
    let of_json j =
      {
        custom_key_store_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CustomKeyStoreId")
             String.of_json);
        custom_key_store_name =
          (Aws.Util.option_map (Aws.Json.lookup j "CustomKeyStoreName")
             String.of_json);
        cloud_hsm_cluster_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CloudHsmClusterId")
             String.of_json);
        trust_anchor_certificate =
          (Aws.Util.option_map (Aws.Json.lookup j "TrustAnchorCertificate")
             String.of_json);
        connection_state =
          (Aws.Util.option_map (Aws.Json.lookup j "ConnectionState")
             ConnectionStateType.of_json);
        connection_error_code =
          (Aws.Util.option_map (Aws.Json.lookup j "ConnectionErrorCode")
...
module AliasListEntry =
  struct
    ...
    let make ?alias_name  ?alias_arn  ?target_key_id  ?creation_date 
      ?last_updated_date  () =
      {
        alias_name;
        alias_arn;
    ...
    let parse xml =
      Some
        {
          alias_name =
            (Aws.Util.option_bind (Aws.Xml.member "AliasName" xml)
               String.parse);
          alias_arn =
            (Aws.Util.option_bind (Aws.Xml.member "AliasArn" xml)
               String.parse);
          target_key_id =
            (Aws.Util.option_bind (Aws.Xml.member "TargetKeyId" xml)
               String.parse);
          creation_date =
            (Aws.Util.option_bind (Aws.Xml.member "CreationDate" xml)
               DateTime.parse);
          last_updated_date =
            (Aws.Util.option_bind (Aws.Xml.member "LastUpdatedDate" xml)
               DateTime.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.last_updated_date
              (fun f ->
                 Aws.Query.Pair ("LastUpdatedDate", (DateTime.to_query f)));
           Aws.Util.option_map v.creation_date
             (fun f -> Aws.Query.Pair ("CreationDate", (DateTime.to_query f)));
           Aws.Util.option_map v.target_key_id
             (fun f -> Aws.Query.Pair ("TargetKeyId", (String.to_query f)));
           Aws.Util.option_map v.alias_arn
             (fun f -> Aws.Query.Pair ("AliasArn", (String.to_query f)));
           Aws.Util.option_map v.alias_name
             (fun f -> Aws.Query.Pair ("AliasName", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.last_updated_date
              (fun f -> ("LastUpdatedDate", (DateTime.to_json f)));
           Aws.Util.option_map v.creation_date
             (fun f -> ("CreationDate", (DateTime.to_json f)));
           Aws.Util.option_map v.target_key_id
             (fun f -> ("TargetKeyId", (String.to_json f)));
           Aws.Util.option_map v.alias_arn
             (fun f -> ("AliasArn", (String.to_json f)));
           Aws.Util.option_map v.alias_name
             (fun f -> ("AliasName", (String.to_json f)))])
    let of_json j =
      {
        alias_name =
          (Aws.Util.option_map (Aws.Json.lookup j "AliasName") String.of_json);
        alias_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "AliasArn") String.of_json);
        target_key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "TargetKeyId")
             String.of_json);
        creation_date =
          (Aws.Util.option_map (Aws.Json.lookup j "CreationDate")
             DateTime.of_json);
        last_updated_date =
          (Aws.Util.option_map (Aws.Json.lookup j "LastUpdatedDate")
             DateTime.of_json)
      }
  end
module AliasList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map AliasListEntry.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          private_key_ciphertext_blob =
            (Aws.Util.option_bind
               (Aws.Xml.member "PrivateKeyCiphertextBlob" xml) Blob.parse);
          public_key =
            (Aws.Util.option_bind (Aws.Xml.member "PublicKey" xml) Blob.parse);
          key_id =
            (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml) String.parse);
          key_pair_spec =
            (Aws.Util.option_bind (Aws.Xml.member "KeyPairSpec" xml)
               DataKeyPairSpec.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.key_pair_spec
              (fun f ->
           ...
           Aws.Util.option_map v.public_key
             (fun f -> Aws.Query.Pair ("PublicKey", (Blob.to_query f)));
           Aws.Util.option_map v.private_key_ciphertext_blob
             (fun f ->
                Aws.Query.Pair
                  ("PrivateKeyCiphertextBlob", (Blob.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.key_pair_spec
              (fun f -> ("KeyPairSpec", (DataKeyPairSpec.to_json f)));
           Aws.Util.option_map v.key_id
             (fun f -> ("KeyId", (String.to_json f)));
           Aws.Util.option_map v.public_key
             (fun f -> ("PublicKey", (Blob.to_json f)));
           Aws.Util.option_map v.private_key_ciphertext_blob
             (fun f -> ("PrivateKeyCiphertextBlob", (Blob.to_json f)))])
    let of_json j =
      {
        private_key_ciphertext_blob =
          (Aws.Util.option_map (Aws.Json.lookup j "PrivateKeyCiphertextBlob")
             Blob.of_json);
        public_key =
          (Aws.Util.option_map (Aws.Json.lookup j "PublicKey") Blob.of_json);
        key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyId") String.of_json);
        key_pair_spec =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyPairSpec")
...
module CreateKeyRequest =
  struct
    ...
    let make ?policy  ?description  ?key_usage  ?customer_master_key_spec 
      ?key_spec  ?origin  ?custom_key_store_id 
      ?bypass_policy_lockout_safety_check  ?(tags= [])  ?multi_region  () =
      {
        policy;
        description;
        key_usage;
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.bypass_policy_lockout_safety_check
             (fun f ->
                Aws.Query.Pair
      ...
      Some
        {
          aliases =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Aliases" xml)
                  AliasList.parse));
          next_marker =
            (Aws.Util.option_bind (Aws.Xml.member "NextMarker" xml)
               String.parse);
          truncated =
            (Aws.Util.option_bind (Aws.Xml.member "Truncated" xml)
               Boolean.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.truncated
              (fun f -> Aws.Query.Pair ("Truncated", (Boolean.to_query f)));
           Aws.Util.option_map v.next_marker
             (fun f -> Aws.Query.Pair ("NextMarker", (String.to_query f)));
           Some
             (Aws.Query.Pair
                ("Aliases.member", (AliasList.to_query v.aliases)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.truncated
    ...
    let of_json j =
      {
        aliases =
          (AliasList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Aliases")));
        next_marker =
          (Aws.Util.option_map (Aws.Json.lookup j "NextMarker")
             String.of_json);
        truncated =
          (Aws.Util.option_map (Aws.Json.lookup j "Truncated")
             Boolean.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          custom_key_store_id =
            (Aws.Xml.required "CustomKeyStoreId"
               (Aws.Util.option_bind (Aws.Xml.member "CustomKeyStoreId" xml)
                  String.parse))
        }
    let to_query v =
    ...
    let of_json j =
      {
        custom_key_store_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "CustomKeyStoreId")))
      }
  end
  ...
  struct
      ...
      Some
        {
          key_rotation_enabled =
            (Aws.Util.option_bind (Aws.Xml.member "KeyRotationEnabled" xml)
               Boolean.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.key_rotation_enabled
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.key_rotation_enabled
              (fun f -> ("KeyRotationEnabled", (Boolean.to_json f)))])
    let of_json j =
      {
        key_rotation_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyRotationEnabled")
             Boolean.of_json)
      }
  end
module ReplicateKeyRequest =
  struct
    type t =
      ...
      description: String.t option ;
      tags: TagList.t }
    let make ~key_id  ~replica_region  ?policy 
      ?bypass_policy_lockout_safety_check  ?description  ?(tags= [])  () =
      {
        key_id;
        replica_region;
        policy;
          ...
          key_id =
            (Aws.Xml.required "KeyId"
               (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml)
                  String.parse));
          replica_region =
            (Aws.Xml.required "ReplicaRegion"
               (Aws.Util.option_bind (Aws.Xml.member "ReplicaRegion" xml)
                  String.parse));
          policy =
            (Aws.Util.option_bind (Aws.Xml.member "Policy" xml) String.parse);
          bypass_policy_lockout_safety_check =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("ReplicaRegion", (String.to_query v.replica_region)));
           Some (Aws.Query.Pair ("KeyId", (String.to_query v.key_id)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        ...
        replica_region =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ReplicaRegion")));
        policy =
          (Aws.Util.option_map (Aws.Json.lookup j "Policy") String.of_json);
        bypass_policy_lockout_safety_check =
          (Aws.Util.option_map
          ...
          key_id =
            (Aws.Xml.required "KeyId"
               (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml)
                  String.parse));
          grant_id =
            (Aws.Xml.required "GrantId"
               (Aws.Util.option_bind (Aws.Xml.member "GrantId" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        ...
        grant_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "GrantId")))
      }
  end
      ...
      Some
        {
          key_id =
            (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml) String.parse);
          key_arn =
            (Aws.Util.option_bind (Aws.Xml.member "KeyArn" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.key_arn
              (fun f -> Aws.Query.Pair ("KeyArn", (String.to_query f)));
           Aws.Util.option_map v.key_id
             (fun f -> Aws.Query.Pair ("KeyId", (String.to_query f)))])
    let to_json v =
      `Assoc
    ...
    let of_json j =
      {
        key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyId") String.of_json);
        key_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyArn") String.of_json)
      }
  end
module KeyList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map KeyListEntry.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          private_key_ciphertext_blob =
            (Aws.Util.option_bind
               (Aws.Xml.member "PrivateKeyCiphertextBlob" xml) Blob.parse);
          private_key_plaintext =
            (Aws.Util.option_bind (Aws.Xml.member "PrivateKeyPlaintext" xml)
               Blob.parse);
          public_key =
            (Aws.Util.option_bind (Aws.Xml.member "PublicKey" xml) Blob.parse);
          key_id =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.public_key
             (fun f -> Aws.Query.Pair ("PublicKey", (Blob.to_query f)));
           Aws.Util.option_map v.private_key_plaintext
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.public_key
             (fun f -> ("PublicKey", (Blob.to_json f)));
           Aws.Util.option_map v.private_key_plaintext
             (fun f -> ("PrivateKeyPlaintext", (Blob.to_json f)));
           Aws.Util.option_map v.private_key_ciphertext_blob
             (fun f -> ("PrivateKeyCiphertextBlob", (Blob.to_json f)))])
    let of_json j =
      {
        private_key_ciphertext_blob =
          (Aws.Util.option_map (Aws.Json.lookup j "PrivateKeyCiphertextBlob")
             Blob.of_json);
        private_key_plaintext =
          (Aws.Util.option_map (Aws.Json.lookup j "PrivateKeyPlaintext")
             Blob.of_json);
        public_key =
          (Aws.Util.option_map (Aws.Json.lookup j "PublicKey") Blob.of_json);
        key_id =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          alias_name =
            (Aws.Xml.required "AliasName"
               (Aws.Util.option_bind (Aws.Xml.member "AliasName" xml)
                  String.parse));
          target_key_id =
            (Aws.Xml.required "TargetKeyId"
               (Aws.Util.option_bind (Aws.Xml.member "TargetKeyId" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("TargetKeyId", (String.to_query v.target_key_id)));
           Some
             (Aws.Query.Pair ("AliasName", (String.to_query v.alias_name)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        alias_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AliasName")));
        target_key_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TargetKeyId")))
      }
  end
          ...
          key_id =
            (Aws.Xml.required "KeyId"
               (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml)
                  String.parse));
          encryption_context =
            (Aws.Util.option_bind (Aws.Xml.member "EncryptionContext" xml)
               EncryptionContextType.parse);
          key_spec =
            (Aws.Util.option_bind (Aws.Xml.member "KeySpec" xml)
               DataKeySpec.parse);
          number_of_bytes =
            (Aws.Util.option_bind (Aws.Xml.member "NumberOfBytes" xml)
               Integer.parse);
          grant_tokens =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "GrantTokens" xml)
        ...
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("GrantTokens.member",
                   (GrantTokenList.to_query v.grant_tokens)));
           Aws.Util.option_map v.number_of_bytes
             (fun f -> Aws.Query.Pair ("NumberOfBytes", (Integer.to_query f)));
           Aws.Util.option_map v.key_spec
             (fun f -> Aws.Query.Pair ("KeySpec", (DataKeySpec.to_query f)));
           Aws.Util.option_map v.encryption_context
             (fun f ->
                Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("GrantTokens", (GrantTokenList.to_json v.grant_tokens));
           Aws.Util.option_map v.number_of_bytes
             (fun f -> ("NumberOfBytes", (Integer.to_json f)));
           Aws.Util.option_map v.key_spec
             (fun f -> ("KeySpec", (DataKeySpec.to_json f)));
           Aws.Util.option_map v.encryption_context
             (fun f ->
    ...
    let of_json j =
      {
        key_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "KeyId")));
        encryption_context =
          (Aws.Util.option_map (Aws.Json.lookup j "EncryptionContext")
             EncryptionContextType.of_json);
        key_spec =
          (Aws.Util.option_map (Aws.Json.lookup j "KeySpec")
             DataKeySpec.of_json);
        number_of_bytes =
          (Aws.Util.option_map (Aws.Json.lookup j "NumberOfBytes")
             Integer.of_json);
        grant_tokens =
          (GrantTokenList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "GrantTokens")))
          ...
          key_id =
            (Aws.Xml.required "KeyId"
               (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml)
                  String.parse));
          grantee_principal =
            (Aws.Xml.required "GranteePrincipal"
               (Aws.Util.option_bind (Aws.Xml.member "GranteePrincipal" xml)
                  String.parse));
          retiring_principal =
            (Aws.Util.option_bind (Aws.Xml.member "RetiringPrincipal" xml)
    ...
    let of_json j =
      {
        ...
        grantee_principal =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "GranteePrincipal")));
        retiring_principal =
          (Aws.Util.option_map (Aws.Json.lookup j "RetiringPrincipal")
             String.of_json);
        operations =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          ciphertext_blob =
            (Aws.Xml.required "CiphertextBlob"
               (Aws.Util.option_bind (Aws.Xml.member "CiphertextBlob" xml)
                  Blob.parse));
          plaintext =
            (Aws.Xml.required "Plaintext"
               (Aws.Util.option_bind (Aws.Xml.member "Plaintext" xml)
                  Blob.parse));
          key_id =
            (Aws.Xml.required "KeyId"
               (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml)
    ...
    let of_json j =
      {
        ciphertext_blob =
          (Blob.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "CiphertextBlob")));
        plaintext =
          (Blob.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Plaintext")));
        key_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "KeyId")))
      }
      ...
      Some
        {
          ...
          key_id =
            (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml) String.parse);
          encryption_algorithm =
            (Aws.Util.option_bind (Aws.Xml.member "EncryptionAlgorithm" xml)
               EncryptionAlgorithmSpec.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.encryption_algorithm
              (fun f ->
                 Aws.Query.Pair
                   ("EncryptionAlgorithm",
                     (EncryptionAlgorithmSpec.to_query f)));
    ...
    let of_json j =
      {
        ...
        key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyId") String.of_json);
        encryption_algorithm =
          (Aws.Util.option_map (Aws.Json.lookup j "EncryptionAlgorithm")
             EncryptionAlgorithmSpec.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          grant_token =
            (Aws.Util.option_bind (Aws.Xml.member "GrantToken" xml)
               String.parse);
          grant_id =
            (Aws.Util.option_bind (Aws.Xml.member "GrantId" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.grant_id
              (fun f -> Aws.Query.Pair ("GrantId", (String.to_query f)));
           Aws.Util.option_map v.grant_token
             (fun f -> Aws.Query.Pair ("GrantToken", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.grant_id
              (fun f -> ("GrantId", (String.to_json f)));
           Aws.Util.option_map v.grant_token
             (fun f -> ("GrantToken", (String.to_json f)))])
    let of_json j =
      {
        grant_token =
          (Aws.Util.option_map (Aws.Json.lookup j "GrantToken")
             String.of_json);
        grant_id =
          (Aws.Util.option_map (Aws.Json.lookup j "GrantId") String.of_json)
      }
    ...
    let of_json j =
      {
        ...
        key_pair_spec =
          (DataKeyPairSpec.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "KeyPairSpec")));
        grant_tokens =
          (GrantTokenList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "GrantTokens")))
      }
          ...
          message =
            (Aws.Xml.required "Message"
               (Aws.Util.option_bind (Aws.Xml.member "Message" xml)
                  Blob.parse));
          message_type =
            (Aws.Util.option_bind (Aws.Xml.member "MessageType" xml)
               MessageType.parse);
          grant_tokens =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "GrantTokens" xml)
                  GrantTokenList.parse));
          signing_algorithm =
            (Aws.Xml.required "SigningAlgorithm"
               (Aws.Util.option_bind (Aws.Xml.member "SigningAlgorithm" xml)
        ...
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("GrantTokens.member",
                  (GrantTokenList.to_query v.grant_tokens)));
           Aws.Util.option_map v.message_type
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Some ("GrantTokens", (GrantTokenList.to_json v.grant_tokens));
           Aws.Util.option_map v.message_type
             (fun f -> ("MessageType", (MessageType.to_json f)));
    ...
    let of_json j =
      {
        ...
        message_type =
          (Aws.Util.option_map (Aws.Json.lookup j "MessageType")
             MessageType.of_json);
        grant_tokens =
          (GrantTokenList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "GrantTokens")));
      ...
      Some
        {
          grants =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Grants" xml)
                  GrantList.parse));
          next_marker =
            (Aws.Util.option_bind (Aws.Xml.member "NextMarker" xml)
               String.parse);
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.next_marker
             (fun f -> Aws.Query.Pair ("NextMarker", (String.to_query f)));
           Some
             (Aws.Query.Pair ("Grants.member", (GrantList.to_query v.grants)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.truncated
    ...
    let of_json j =
      {
        grants =
          (GrantList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Grants")));
        next_marker =
          (Aws.Util.option_map (Aws.Json.lookup j "NextMarker")
             String.of_json);
        truncated =
...
module VerifyResponse =
  struct
      ...
      Some
        {
          key_id =
            (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml) String.parse);
          signature_valid =
            (Aws.Util.option_bind (Aws.Xml.member "SignatureValid" xml)
               Boolean.parse);
          signing_algorithm =
            (Aws.Util.option_bind (Aws.Xml.member "SigningAlgorithm" xml)
               SigningAlgorithmSpec.parse)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.signing_algorithm
              (fun f ->
                 Aws.Query.Pair
                   ("SigningAlgorithm", (SigningAlgorithmSpec.to_query f)));
           Aws.Util.option_map v.signature_valid
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.signature_valid
             (fun f -> ("SignatureValid", (Boolean.to_json f)));
           Aws.Util.option_map v.key_id
             (fun f -> ("KeyId", (String.to_json f)))])
    let of_json j =
      {
        key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyId") String.of_json);
        signature_valid =
          (Aws.Util.option_map (Aws.Json.lookup j "SignatureValid")
             Boolean.of_json);
        signing_algorithm =
          (Aws.Util.option_map (Aws.Json.lookup j "SigningAlgorithm")
             SigningAlgorithmSpec.of_json)
      }
  end
        ...
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.signing_algorithm
              (fun f ->
                 Aws.Query.Pair
                   ("SigningAlgorithm", (SigningAlgorithmSpec.to_query f)));
           Aws.Util.option_map v.signature
             (fun f -> Aws.Query.Pair ("Signature", (Blob.to_query f)));
           Aws.Util.option_map v.key_id
             (fun f -> Aws.Query.Pair ("KeyId", (String.to_query f)))])
    let to_json v =
      `Assoc
    ...
    let of_json j =
      {
        key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyId") String.of_json);
        signature =
          (Aws.Util.option_map (Aws.Json.lookup j "Signature") Blob.of_json);
        signing_algorithm =
          (Aws.Util.option_map (Aws.Json.lookup j "SigningAlgorithm")
             SigningAlgorithmSpec.of_json)
      }
           ...
           [Aws.Util.option_map v.encryption_algorithm
              (fun f ->
                 Aws.Query.Pair
                   ("EncryptionAlgorithm",
                     (EncryptionAlgorithmSpec.to_query f)));
           Aws.Util.option_map v.plaintext
             (fun f -> Aws.Query.Pair ("Plaintext", (Blob.to_query f)));
           Aws.Util.option_map v.key_id
             (fun f -> Aws.Query.Pair ("KeyId", (String.to_query f)))])
    let to_json v =
      `Assoc
    ...
    let of_json j =
      {
        key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyId") String.of_json);
        plaintext =
          (Aws.Util.option_map (Aws.Json.lookup j "Plaintext") Blob.of_json);
        encryption_algorithm =
          (Aws.Util.option_map (Aws.Json.lookup j "EncryptionAlgorithm")
             EncryptionAlgorithmSpec.of_json)
      }
...
module GetPublicKeyResponse =
  struct
    type t =
      ...
      encryption_algorithms: EncryptionAlgorithmSpecList.t ;
      signing_algorithms: SigningAlgorithmSpecList.t }
    let make ?key_id  ?public_key  ?customer_master_key_spec  ?key_spec 
      ?key_usage  ?(encryption_algorithms= [])  ?(signing_algorithms= [])  ()
      =
      {
        key_id;
        public_key;
      ...
      Some
        {
          ...
          source_key_id =
            (Aws.Util.option_bind (Aws.Xml.member "SourceKeyId" xml)
               String.parse);
          destination_key_id =
            (Aws.Xml.required "DestinationKeyId"
               (Aws.Util.option_bind (Aws.Xml.member "DestinationKeyId" xml)
                  String.parse));
          destination_encryption_context =
            (Aws.Util.option_bind
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.source_encryption_algorithm
             (fun f ->
                Aws.Query.Pair
                  ("SourceEncryptionAlgorithm",
                    (EncryptionAlgorithmSpec.to_query f)));
           Aws.Util.option_map v.destination_encryption_context
             (fun f ->
                Aws.Query.Pair
           ...
           Aws.Util.option_map v.source_key_id
             (fun f -> Aws.Query.Pair ("SourceKeyId", (String.to_query f)));
           Aws.Util.option_map v.source_encryption_context
             (fun f ->
                Aws.Query.Pair
    ...
    let of_json j =
      {
        ciphertext_blob =
          (Blob.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "CiphertextBlob")));
        source_encryption_context =
          (Aws.Util.option_map (Aws.Json.lookup j "SourceEncryptionContext")
             EncryptionContextType.of_json);
        source_key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "SourceKeyId")
             String.of_json);
        destination_key_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "DestinationKeyId")));
        destination_encryption_context =
          (Aws.Util.option_map
...
module CustomKeyStoresList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map CustomKeyStoresListEntry.parse
           (Aws.Xml.members "member" xml))
    let to_query v =
      Aws.Query.to_query_list CustomKeyStoresListEntry.to_query v
          ...
          key_id =
            (Aws.Xml.required "KeyId"
               (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml)
                  String.parse));
          import_token =
            (Aws.Xml.required "ImportToken"
               (Aws.Util.option_bind (Aws.Xml.member "ImportToken" xml)
                  Blob.parse));
          encrypted_key_material =
            (Aws.Xml.required "EncryptedKeyMaterial"
               (Aws.Util.option_bind
                  (Aws.Xml.member "EncryptedKeyMaterial" xml) Blob.parse));
          valid_to =
            (Aws.Util.option_bind (Aws.Xml.member "ValidTo" xml)
               DateTime.parse);
          expiration_model =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair ("ImportToken", (Blob.to_query v.import_token)));
           Some (Aws.Query.Pair ("KeyId", (String.to_query v.key_id)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        ...
        import_token =
          (Blob.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ImportToken")));
        encrypted_key_material =
          (Blob.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "EncryptedKeyMaterial")));
        valid_to =
          (Aws.Util.option_map (Aws.Json.lookup j "ValidTo") DateTime.of_json);
        expiration_model =
          (Aws.Util.option_map (Aws.Json.lookup j "ExpirationModel")
      ...
      Some
        {
          custom_key_stores =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "CustomKeyStores" xml)
      ...
      Some
        {
          ...
          marker =
            (Aws.Util.option_bind (Aws.Xml.member "Marker" xml) String.parse);
          retiring_principal =
            (Aws.Xml.required "RetiringPrincipal"
               (Aws.Util.option_bind (Aws.Xml.member "RetiringPrincipal" xml)
                  String.parse))
        }
    let to_query v =
    ...
    let of_json j =
      {
        ...
        retiring_principal =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RetiringPrincipal")))
      }
  end
      ...
      Some
        {
          ...
          new_custom_key_store_name =
            (Aws.Util.option_bind
               (Aws.Xml.member "NewCustomKeyStoreName" xml) String.parse);
          key_store_password =
            (Aws.Util.option_bind (Aws.Xml.member "KeyStorePassword" xml)
               String.parse);
          cloud_hsm_cluster_id =
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cloud_hsm_cluster_id
              (fun f ->
                 Aws.Query.Pair ("CloudHsmClusterId", (String.to_query f)));
           Aws.Util.option_map v.key_store_password
             (fun f ->
                Aws.Query.Pair ("KeyStorePassword", (String.to_query f)));
           Aws.Util.option_map v.new_custom_key_store_name
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cloud_hsm_cluster_id
              (fun f -> ("CloudHsmClusterId", (String.to_json f)));
           Aws.Util.option_map v.key_store_password
             (fun f -> ("KeyStorePassword", (String.to_json f)));
           Aws.Util.option_map v.new_custom_key_store_name
             (fun f -> ("NewCustomKeyStoreName", (String.to_json f)));
           Some ("CustomKeyStoreId", (String.to_json v.custom_key_store_id))])
    let of_json j =
      {
        custom_key_store_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "CustomKeyStoreId")));
        new_custom_key_store_name =
          (Aws.Util.option_map (Aws.Json.lookup j "NewCustomKeyStoreName")
             String.of_json);
        key_store_password =
          (Aws.Util.option_map (Aws.Json.lookup j "KeyStorePassword")
             String.of_json);
        cloud_hsm_cluster_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CloudHsmClusterId")
             String.of_json)
          ...
          key_id =
            (Aws.Xml.required "KeyId"
               (Aws.Util.option_bind (Aws.Xml.member "KeyId" xml)
                  String.parse));
          wrapping_algorithm =
            (Aws.Xml.required "WrappingAlgorithm"
               (Aws.Util.option_bind (Aws.Xml.member "WrappingAlgorithm" xml)
                  AlgorithmSpec.parse));
          wrapping_key_spec =
            (Aws.Xml.required "WrappingKeySpec"
               (Aws.Util.option_bind (Aws.Xml.member "WrappingKeySpec" xml)
