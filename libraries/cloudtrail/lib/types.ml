  ...
  struct
      ...
      Some
        {
          ...
          s3_bucket_name =
            (Aws.Util.option_bind (Aws.Xml.member "S3BucketName" xml)
               String.parse);
          s3_key_prefix =
            (Aws.Util.option_bind (Aws.Xml.member "S3KeyPrefix" xml)
               String.parse);
          sns_topic_name =
            (Aws.Util.option_bind (Aws.Xml.member "SnsTopicName" xml)
               String.parse);
          sns_topic_a_r_n =
            (Aws.Util.option_bind (Aws.Xml.member "SnsTopicARN" xml)
               String.parse);
          include_global_service_events =
            (Aws.Util.option_bind
               ...
               Boolean.parse);
          is_multi_region_trail =
            (Aws.Util.option_bind (Aws.Xml.member "IsMultiRegionTrail" xml)
               Boolean.parse);
          home_region =
            (Aws.Util.option_bind (Aws.Xml.member "HomeRegion" xml)
               String.parse);
          trail_a_r_n =
            (Aws.Util.option_bind (Aws.Xml.member "TrailARN" xml)
               String.parse);
          log_file_validation_enabled =
            (Aws.Util.option_bind
               (Aws.Xml.member "LogFileValidationEnabled" xml) Boolean.parse);
          cloud_watch_logs_log_group_arn =
            (Aws.Util.option_bind
               (Aws.Xml.member "CloudWatchLogsLogGroupArn" xml) String.parse);
          cloud_watch_logs_role_arn =
            (Aws.Util.option_bind
               (Aws.Xml.member "CloudWatchLogsRoleArn" xml) String.parse);
          kms_key_id =
            (Aws.Util.option_bind (Aws.Xml.member "KmsKeyId" xml)
               String.parse);
          has_custom_event_selectors =
            (Aws.Util.option_bind
               (Aws.Xml.member "HasCustomEventSelectors" xml) Boolean.parse);
          has_insight_selectors =
            (Aws.Util.option_bind (Aws.Xml.member "HasInsightSelectors" xml)
               Boolean.parse);
          is_organization_trail =
            (Aws.Util.option_bind (Aws.Xml.member "IsOrganizationTrail" xml)
               Boolean.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.is_organization_trail
              (fun f ->
                 Aws.Query.Pair ("IsOrganizationTrail", (Boolean.to_query f)));
           Aws.Util.option_map v.has_insight_selectors
             (fun f ->
                Aws.Query.Pair ("HasInsightSelectors", (Boolean.to_query f)));
           Aws.Util.option_map v.has_custom_event_selectors
             (fun f ->
                Aws.Query.Pair
                  ("HasCustomEventSelectors", (Boolean.to_query f)));
           Aws.Util.option_map v.kms_key_id
             (fun f -> Aws.Query.Pair ("KmsKeyId", (String.to_query f)));
           Aws.Util.option_map v.cloud_watch_logs_role_arn
             (fun f ->
                Aws.Query.Pair ("CloudWatchLogsRoleArn", (String.to_query f)));
           Aws.Util.option_map v.cloud_watch_logs_log_group_arn
             (fun f ->
                Aws.Query.Pair
                  ("CloudWatchLogsLogGroupArn", (String.to_query f)));
           Aws.Util.option_map v.log_file_validation_enabled
             (fun f ->
                Aws.Query.Pair
                  ("LogFileValidationEnabled", (Boolean.to_query f)));
           Aws.Util.option_map v.trail_a_r_n
             (fun f -> Aws.Query.Pair ("TrailARN", (String.to_query f)));
           Aws.Util.option_map v.home_region
             (fun f -> Aws.Query.Pair ("HomeRegion", (String.to_query f)));
           Aws.Util.option_map v.is_multi_region_trail
             (fun f ->
                Aws.Query.Pair ("IsMultiRegionTrail", (Boolean.to_query f)));
           Aws.Util.option_map v.include_global_service_events
             (fun f ->
                Aws.Query.Pair
                  ("IncludeGlobalServiceEvents", (Boolean.to_query f)));
           Aws.Util.option_map v.sns_topic_a_r_n
             (fun f -> Aws.Query.Pair ("SnsTopicARN", (String.to_query f)));
           Aws.Util.option_map v.sns_topic_name
             (fun f -> Aws.Query.Pair ("SnsTopicName", (String.to_query f)));
           Aws.Util.option_map v.s3_key_prefix
             (fun f -> Aws.Query.Pair ("S3KeyPrefix", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.is_organization_trail
              (fun f -> ("IsOrganizationTrail", (Boolean.to_json f)));
           Aws.Util.option_map v.has_insight_selectors
             (fun f -> ("HasInsightSelectors", (Boolean.to_json f)));
           Aws.Util.option_map v.has_custom_event_selectors
             (fun f -> ("HasCustomEventSelectors", (Boolean.to_json f)));
           Aws.Util.option_map v.kms_key_id
             (fun f -> ("KmsKeyId", (String.to_json f)));
           Aws.Util.option_map v.cloud_watch_logs_role_arn
             (fun f -> ("CloudWatchLogsRoleArn", (String.to_json f)));
           Aws.Util.option_map v.cloud_watch_logs_log_group_arn
             (fun f -> ("CloudWatchLogsLogGroupArn", (String.to_json f)));
           Aws.Util.option_map v.log_file_validation_enabled
             (fun f -> ("LogFileValidationEnabled", (Boolean.to_json f)));
           Aws.Util.option_map v.trail_a_r_n
             (fun f -> ("TrailARN", (String.to_json f)));
           Aws.Util.option_map v.home_region
             (fun f -> ("HomeRegion", (String.to_json f)));
           Aws.Util.option_map v.is_multi_region_trail
             (fun f -> ("IsMultiRegionTrail", (Boolean.to_json f)));
           Aws.Util.option_map v.include_global_service_events
             (fun f -> ("IncludeGlobalServiceEvents", (Boolean.to_json f)));
           Aws.Util.option_map v.sns_topic_a_r_n
             (fun f -> ("SnsTopicARN", (String.to_json f)));
           Aws.Util.option_map v.sns_topic_name
             (fun f -> ("SnsTopicName", (String.to_json f)));
           Aws.Util.option_map v.s3_key_prefix
             (fun f -> ("S3KeyPrefix", (String.to_json f)));
           Aws.Util.option_map v.s3_bucket_name
    ...
    let of_json j =
      {
        ...
        s3_bucket_name =
          (Aws.Util.option_map (Aws.Json.lookup j "S3BucketName")
             String.of_json);
        s3_key_prefix =
          (Aws.Util.option_map (Aws.Json.lookup j "S3KeyPrefix")
             String.of_json);
        sns_topic_name =
          (Aws.Util.option_map (Aws.Json.lookup j "SnsTopicName")
             String.of_json);
        sns_topic_a_r_n =
          (Aws.Util.option_map (Aws.Json.lookup j "SnsTopicARN")
             String.of_json);
        include_global_service_events =
          (Aws.Util.option_map
             (Aws.Json.lookup j "IncludeGlobalServiceEvents") Boolean.of_json);
        is_multi_region_trail =
          (Aws.Util.option_map (Aws.Json.lookup j "IsMultiRegionTrail")
             Boolean.of_json);
        home_region =
          (Aws.Util.option_map (Aws.Json.lookup j "HomeRegion")
             String.of_json);
        trail_a_r_n =
          (Aws.Util.option_map (Aws.Json.lookup j "TrailARN") String.of_json);
        log_file_validation_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "LogFileValidationEnabled")
             Boolean.of_json);
        cloud_watch_logs_log_group_arn =
          (Aws.Util.option_map
             (Aws.Json.lookup j "CloudWatchLogsLogGroupArn") String.of_json);
        cloud_watch_logs_role_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "CloudWatchLogsRoleArn")
             String.of_json);
        kms_key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KmsKeyId") String.of_json);
        has_custom_event_selectors =
          (Aws.Util.option_map (Aws.Json.lookup j "HasCustomEventSelectors")
             Boolean.of_json);
        has_insight_selectors =
          (Aws.Util.option_map (Aws.Json.lookup j "HasInsightSelectors")
             Boolean.of_json);
        is_organization_trail =
          (Aws.Util.option_map (Aws.Json.lookup j "IsOrganizationTrail")
             Boolean.of_json)
      }
  end
module TrailList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Trail.parse (Aws.Xml.members "member" xml))
...
module DescribeTrailsResponse =
  struct
      ...
      Some
        {
          trail_list =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "trailList" xml)
                  TrailList.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("trailList", (TrailList.to_json v.trail_list))])
    let of_json j =
      {
        trail_list =
          (TrailList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "trailList")))
      }
  end
      ...
      Some
        {
          ...
          tags_list =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "TagsList" xml)
                  TagsList.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        ...
        tags_list =
          (TagsList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TagsList")))
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          attribute_key =
            (Aws.Xml.required "AttributeKey"
               (Aws.Util.option_bind (Aws.Xml.member "AttributeKey" xml)
                  LookupAttributeKey.parse));
          attribute_value =
            (Aws.Xml.required "AttributeValue"
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Some
             ("AttributeKey", (LookupAttributeKey.to_json v.attribute_key))])
    let of_json j =
      {
        attribute_key =
        ...
        attribute_value =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AttributeValue")))
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          value =
            (Aws.Util.option_bind (Aws.Xml.member "Value" xml) Blob.parse);
          validity_start_time =
            (Aws.Util.option_bind (Aws.Xml.member "ValidityStartTime" xml)
               DateTime.parse);
          validity_end_time =
            (Aws.Util.option_bind (Aws.Xml.member "ValidityEndTime" xml)
               DateTime.parse);
          fingerprint =
            (Aws.Util.option_bind (Aws.Xml.member "Fingerprint" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.fingerprint
              (fun f -> Aws.Query.Pair ("Fingerprint", (String.to_query f)));
           Aws.Util.option_map v.validity_end_time
             (fun f ->
                Aws.Query.Pair ("ValidityEndTime", (DateTime.to_query f)));
           Aws.Util.option_map v.validity_start_time
             (fun f ->
                Aws.Query.Pair ("ValidityStartTime", (DateTime.to_query f)));
           Aws.Util.option_map v.value
             (fun f -> Aws.Query.Pair ("Value", (Blob.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.fingerprint
           ...
           Aws.Util.option_map v.validity_end_time
             (fun f -> ("ValidityEndTime", (DateTime.to_json f)));
           Aws.Util.option_map v.validity_start_time
             (fun f -> ("ValidityStartTime", (DateTime.to_json f)));
           Aws.Util.option_map v.value (fun f -> ("Value", (Blob.to_json f)))])
    let of_json j =
      {
        value =
          (Aws.Util.option_map (Aws.Json.lookup j "Value") Blob.of_json);
        validity_start_time =
          (Aws.Util.option_map (Aws.Json.lookup j "ValidityStartTime")
             DateTime.of_json);
        validity_end_time =
          (Aws.Util.option_map (Aws.Json.lookup j "ValidityEndTime")
             DateTime.of_json);
        fingerprint =
          (Aws.Util.option_map (Aws.Json.lookup j "Fingerprint")
             String.of_json)
      }
  end
module PublicKeyList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map PublicKey.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          public_key_list =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "PublicKeyList" xml)
                  PublicKeyList.parse));
          next_token =
    ...
    let of_json j =
      {
        public_key_list =
          (PublicKeyList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "PublicKeyList")));
        next_token =
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.type_
             (fun f -> ("Type", (String.to_json f)))])
    let of_json j =
      {
        type_ =
          (Aws.Util.option_map (Aws.Json.lookup j "Type") String.of_json);
        values =
...
module DataResources =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map DataResource.parse (Aws.Xml.members "member" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          read_write_type =
            (Aws.Util.option_bind (Aws.Xml.member "ReadWriteType" xml)
               ReadWriteType.parse);
          include_management_events =
            (Aws.Util.option_bind
               (Aws.Xml.member "IncludeManagementEvents" xml) Boolean.parse);
          data_resources =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "DataResources" xml)
                  DataResources.parse));
          exclude_management_event_sources =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.include_management_events
             (fun f ->
                Aws.Query.Pair
                  ("IncludeManagementEvents", (Boolean.to_query f)));
           Aws.Util.option_map v.read_write_type
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.include_management_events
             (fun f -> ("IncludeManagementEvents", (Boolean.to_json f)));
           Aws.Util.option_map v.read_write_type
             (fun f -> ("ReadWriteType", (ReadWriteType.to_json f)))])
    let of_json j =
      {
        read_write_type =
          (Aws.Util.option_map (Aws.Json.lookup j "ReadWriteType")
             ReadWriteType.of_json);
        include_management_events =
          (Aws.Util.option_map (Aws.Json.lookup j "IncludeManagementEvents")
             Boolean.of_json);
        data_resources =
          (DataResources.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "DataResources")));
        exclude_management_event_sources =
          (ExcludeManagementEventSources.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ExcludeManagementEventSources")))
      }
  end
module EventSelectors =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map EventSelector.parse (Aws.Xml.members "member" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          insight_type =
            (Aws.Util.option_bind (Aws.Xml.member "InsightType" xml)
               InsightType.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.insight_type
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.insight_type
              (fun f -> ("InsightType", (InsightType.to_json f)))])
    let of_json j =
      {
        insight_type =
          (Aws.Util.option_map (Aws.Json.lookup j "InsightType")
             InsightType.of_json)
      }
  end
module InsightSelectors =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map InsightSelector.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          ...
          insight_selectors =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "InsightSelectors" xml)
  ...
  struct
      ...
      Some
        {
          ...
          event_selectors =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "EventSelectors" xml)
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("EventSelectors", (EventSelectors.to_json v.event_selectors));
           Aws.Util.option_map v.trail_a_r_n
             (fun f -> ("TrailARN", (String.to_json f)))])
    let of_json j =
      {
  ...
  struct
    ...
    let parse xml =
      Some
        {
          trail_name =
            (Aws.Xml.required "TrailName"
               (Aws.Util.option_bind (Aws.Xml.member "TrailName" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair ("TrailName", (String.to_query v.trail_name)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        trail_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TrailName")))
      }
  end
module Resource =
  struct
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.resource_name
              (fun f -> Aws.Query.Pair ("ResourceName", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.resource_name
              (fun f -> ("ResourceName", (String.to_json f)));
           Aws.Util.option_map v.resource_type
    ...
    let of_json j =
      {
        resource_type =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourceType")
             String.of_json);
        resource_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourceName")
             String.of_json)
      }
  end
module ResourceList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Resource.parse (Aws.Xml.members "member" xml))
  ...
  struct
      ...
      Some
        {
          ...
          event_name =
            (Aws.Util.option_bind (Aws.Xml.member "EventName" xml)
               String.parse);
          read_only =
            (Aws.Util.option_bind (Aws.Xml.member "ReadOnly" xml)
               String.parse);
          access_key_id =
            (Aws.Util.option_bind (Aws.Xml.member "AccessKeyId" xml)
               String.parse);
          event_time =
            (Aws.Util.option_bind (Aws.Xml.member "EventTime" xml)
               DateTime.parse);
          event_source =
            (Aws.Util.option_bind (Aws.Xml.member "EventSource" xml)
               String.parse);
          username =
          ...
          resources =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Resources" xml)
                  ResourceList.parse));
          cloud_trail_event =
            (Aws.Util.option_bind (Aws.Xml.member "CloudTrailEvent" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cloud_trail_event
              (fun f ->
           ...
           Aws.Util.option_map v.event_source
             (fun f -> Aws.Query.Pair ("EventSource", (String.to_query f)));
           Aws.Util.option_map v.event_time
             (fun f -> Aws.Query.Pair ("EventTime", (DateTime.to_query f)));
           Aws.Util.option_map v.access_key_id
             (fun f -> Aws.Query.Pair ("AccessKeyId", (String.to_query f)));
           Aws.Util.option_map v.read_only
             (fun f -> Aws.Query.Pair ("ReadOnly", (String.to_query f)));
           Aws.Util.option_map v.event_name
             (fun f -> Aws.Query.Pair ("EventName", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cloud_trail_event
              (fun f -> ("CloudTrailEvent", (String.to_json f)));
           Some ("Resources", (ResourceList.to_json v.resources));
           Aws.Util.option_map v.username
             (fun f -> ("Username", (String.to_json f)));
           Aws.Util.option_map v.event_source
             (fun f -> ("EventSource", (String.to_json f)));
           Aws.Util.option_map v.event_time
             (fun f -> ("EventTime", (DateTime.to_json f)));
           Aws.Util.option_map v.access_key_id
             (fun f -> ("AccessKeyId", (String.to_json f)));
           Aws.Util.option_map v.read_only
             (fun f -> ("ReadOnly", (String.to_json f)));
           Aws.Util.option_map v.event_name
             (fun f -> ("EventName", (String.to_json f)));
           Aws.Util.option_map v.event_id
    ...
    let of_json j =
      {
        ...
        event_name =
          (Aws.Util.option_map (Aws.Json.lookup j "EventName") String.of_json);
        read_only =
          (Aws.Util.option_map (Aws.Json.lookup j "ReadOnly") String.of_json);
        access_key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "AccessKeyId")
             String.of_json);
        event_time =
          (Aws.Util.option_map (Aws.Json.lookup j "EventTime")
             DateTime.of_json);
        event_source =
          (Aws.Util.option_map (Aws.Json.lookup j "EventSource")
             String.of_json);
        username =
        ...
        cloud_trail_event =
          (Aws.Util.option_map (Aws.Json.lookup j "CloudTrailEvent")
             String.of_json)
      }
  end
module EventsList =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("Events.member", (EventsList.to_query v.events)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
  ...
  struct
      ...
      Some
        {
          trail_name_list =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "trailNameList" xml)
                  TrailNameList.parse));
          include_shadow_trails =
            (Aws.Util.option_bind (Aws.Xml.member "includeShadowTrails" xml)
               Boolean.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.include_shadow_trails
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.include_shadow_trails
              (fun f -> ("includeShadowTrails", (Boolean.to_json f)));
           Some ("trailNameList", (TrailNameList.to_json v.trail_name_list))])
    let of_json j =
      {
        trail_name_list =
          (TrailNameList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "trailNameList")));
        include_shadow_trails =
          (Aws.Util.option_map (Aws.Json.lookup j "includeShadowTrails")
             Boolean.of_json)
      }
  end
...
module Trails =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map TrailInfo.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          ...
          enable_log_file_validation =
            (Aws.Util.option_bind
               (Aws.Xml.member "EnableLogFileValidation" xml) Boolean.parse);
          cloud_watch_logs_log_group_arn =
            (Aws.Util.option_bind
               (Aws.Xml.member "CloudWatchLogsLogGroupArn" xml) String.parse);
          cloud_watch_logs_role_arn =
        ...
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.cloud_watch_logs_log_group_arn
             (fun f ->
                Aws.Query.Pair
                  ("CloudWatchLogsLogGroupArn", (String.to_query f)));
           Aws.Util.option_map v.enable_log_file_validation
             (fun f ->
                Aws.Query.Pair
                  ("EnableLogFileValidation", (Boolean.to_query f)));
           Aws.Util.option_map v.is_multi_region_trail
             (fun f ->
                Aws.Query.Pair ("IsMultiRegionTrail", (Boolean.to_query f)));
           Aws.Util.option_map v.include_global_service_events
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.cloud_watch_logs_log_group_arn
             (fun f -> ("CloudWatchLogsLogGroupArn", (String.to_json f)));
           Aws.Util.option_map v.enable_log_file_validation
             (fun f -> ("EnableLogFileValidation", (Boolean.to_json f)));
           Aws.Util.option_map v.is_multi_region_trail
             (fun f -> ("IsMultiRegionTrail", (Boolean.to_json f)));
           Aws.Util.option_map v.include_global_service_events
             (fun f -> ("IncludeGlobalServiceEvents", (Boolean.to_json f)));
    ...
    let of_json j =
      {
        ...
        is_multi_region_trail =
          (Aws.Util.option_map (Aws.Json.lookup j "IsMultiRegionTrail")
             Boolean.of_json);
        enable_log_file_validation =
          (Aws.Util.option_map (Aws.Json.lookup j "EnableLogFileValidation")
             Boolean.of_json);
        cloud_watch_logs_log_group_arn =
          (Aws.Util.option_map
             (Aws.Json.lookup j "CloudWatchLogsLogGroupArn") String.of_json);
          ...
          trail_name =
            (Aws.Xml.required "TrailName"
               (Aws.Util.option_bind (Aws.Xml.member "TrailName" xml)
                  String.parse));
          event_selectors =
            (Aws.Xml.required "EventSelectors"
               (Aws.Util.option_bind (Aws.Xml.member "EventSelectors" xml)
                  EventSelectors.parse))
        }
    let to_query v =
          ...
          trail_name =
            (Aws.Xml.required "TrailName"
               (Aws.Util.option_bind (Aws.Xml.member "TrailName" xml)
                  String.parse));
          insight_selectors =
            (Aws.Xml.required "InsightSelectors"
               (Aws.Util.option_bind (Aws.Xml.member "InsightSelectors" xml)
                  InsightSelectors.parse))
        }
    let to_query v =
...
module ResourceTagList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ResourceTag.parse (Aws.Xml.members "member" xml))
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("S3BucketName", (String.to_query v.s3_bucket_name)));
           Some (Aws.Query.Pair ("Name", (String.to_query v.name)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
  ...
  struct
    ...
    let parse xml =
      Some
        {
          trail =
            (Aws.Util.option_bind (Aws.Xml.member "Trail" xml) Trail.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.trail
              (fun f -> Aws.Query.Pair ("Trail", (Trail.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.trail
              (fun f -> ("Trail", (Trail.to_json f)))])
    let of_json j =
      {
        trail =
          (Aws.Util.option_map (Aws.Json.lookup j "Trail") Trail.of_json)
      }
  end
      ...
      Some
        {
          trails =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Trails" xml)
                  Trails.parse));
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse)
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Some
             (Aws.Query.Pair ("Trails.member", (Trails.to_query v.trails)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
    ...
    let of_json j =
      {
        trails =
          (Trails.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Trails")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
...
module LookupAttributesList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map LookupAttribute.parse (Aws.Xml.members "member" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          is_logging =
            (Aws.Util.option_bind (Aws.Xml.member "IsLogging" xml)
               Boolean.parse);
          latest_delivery_error =
            (Aws.Util.option_bind (Aws.Xml.member "LatestDeliveryError" xml)
               String.parse);
          latest_notification_error =
            (Aws.Util.option_bind
               (Aws.Xml.member "LatestNotificationError" xml) String.parse);
          latest_delivery_time =
            (Aws.Util.option_bind (Aws.Xml.member "LatestDeliveryTime" xml)
               DateTime.parse);
          latest_notification_time =
            (Aws.Util.option_bind
               (Aws.Xml.member "LatestNotificationTime" xml) DateTime.parse);
          start_logging_time =
            (Aws.Util.option_bind (Aws.Xml.member "StartLoggingTime" xml)
               DateTime.parse);
          stop_logging_time =
            (Aws.Util.option_bind (Aws.Xml.member "StopLoggingTime" xml)
               DateTime.parse);
          latest_cloud_watch_logs_delivery_error =
            (Aws.Util.option_bind
          ...
          latest_digest_delivery_time =
            (Aws.Util.option_bind
               (Aws.Xml.member "LatestDigestDeliveryTime" xml) DateTime.parse);
          latest_digest_delivery_error =
            (Aws.Util.option_bind
               (Aws.Xml.member "LatestDigestDeliveryError" xml) String.parse);
          latest_delivery_attempt_time =
            (Aws.Util.option_bind
               (Aws.Xml.member "LatestDeliveryAttemptTime" xml) String.parse);
          latest_notification_attempt_time =
            (Aws.Util.option_bind
          ...
          latest_delivery_attempt_succeeded =
            (Aws.Util.option_bind
               ...
               String.parse);
          time_logging_started =
            (Aws.Util.option_bind (Aws.Xml.member "TimeLoggingStarted" xml)
               String.parse);
          time_logging_stopped =
            (Aws.Util.option_bind (Aws.Xml.member "TimeLoggingStopped" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.time_logging_stopped
              (fun f ->
                 Aws.Query.Pair ("TimeLoggingStopped", (String.to_query f)));
           Aws.Util.option_map v.time_logging_started
             (fun f ->
                Aws.Query.Pair ("TimeLoggingStarted", (String.to_query f)));
           Aws.Util.option_map v.latest_delivery_attempt_succeeded
             (fun f ->
                Aws.Query.Pair
                  ("LatestDeliveryAttemptSucceeded", (String.to_query f)));
           Aws.Util.option_map v.latest_notification_attempt_succeeded
             (fun f ->
                Aws.Query.Pair
                  ("LatestNotificationAttemptSucceeded", (String.to_query f)));
           Aws.Util.option_map v.latest_notification_attempt_time
             (fun f ->
                Aws.Query.Pair
                  ("LatestNotificationAttemptTime", (String.to_query f)));
           Aws.Util.option_map v.latest_delivery_attempt_time
             (fun f ->
                Aws.Query.Pair
                  ("LatestDeliveryAttemptTime", (String.to_query f)));
           Aws.Util.option_map v.latest_digest_delivery_error
             (fun f ->
                Aws.Query.Pair
                  ("LatestDigestDeliveryError", (String.to_query f)));
           Aws.Util.option_map v.latest_digest_delivery_time
             (fun f ->
                Aws.Query.Pair
                  ("LatestDigestDeliveryTime", (DateTime.to_query f)));
           Aws.Util.option_map v.latest_cloud_watch_logs_delivery_time
             (fun f ->
                Aws.Query.Pair
                  ("LatestCloudWatchLogsDeliveryTime", (DateTime.to_query f)));
           Aws.Util.option_map v.latest_cloud_watch_logs_delivery_error
             (fun f ->
                Aws.Query.Pair
                  ("LatestCloudWatchLogsDeliveryError", (String.to_query f)));
           Aws.Util.option_map v.stop_logging_time
             (fun f ->
                Aws.Query.Pair ("StopLoggingTime", (DateTime.to_query f)));
           Aws.Util.option_map v.start_logging_time
             (fun f ->
                Aws.Query.Pair ("StartLoggingTime", (DateTime.to_query f)));
           Aws.Util.option_map v.latest_notification_time
             (fun f ->
                Aws.Query.Pair
                  ("LatestNotificationTime", (DateTime.to_query f)));
           Aws.Util.option_map v.latest_delivery_time
             (fun f ->
                Aws.Query.Pair ("LatestDeliveryTime", (DateTime.to_query f)));
           Aws.Util.option_map v.latest_notification_error
             (fun f ->
                Aws.Query.Pair
                  ("LatestNotificationError", (String.to_query f)));
           Aws.Util.option_map v.latest_delivery_error
             (fun f ->
                Aws.Query.Pair ("LatestDeliveryError", (String.to_query f)));
           Aws.Util.option_map v.is_logging
             (fun f -> Aws.Query.Pair ("IsLogging", (Boolean.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.time_logging_stopped
              (fun f -> ("TimeLoggingStopped", (String.to_json f)));
           Aws.Util.option_map v.time_logging_started
             (fun f -> ("TimeLoggingStarted", (String.to_json f)));
           Aws.Util.option_map v.latest_delivery_attempt_succeeded
             (fun f -> ("LatestDeliveryAttemptSucceeded", (String.to_json f)));
           Aws.Util.option_map v.latest_notification_attempt_succeeded
             (fun f ->
                ("LatestNotificationAttemptSucceeded", (String.to_json f)));
           Aws.Util.option_map v.latest_notification_attempt_time
             (fun f -> ("LatestNotificationAttemptTime", (String.to_json f)));
           Aws.Util.option_map v.latest_delivery_attempt_time
             (fun f -> ("LatestDeliveryAttemptTime", (String.to_json f)));
           Aws.Util.option_map v.latest_digest_delivery_error
             (fun f -> ("LatestDigestDeliveryError", (String.to_json f)));
           Aws.Util.option_map v.latest_digest_delivery_time
             (fun f -> ("LatestDigestDeliveryTime", (DateTime.to_json f)));
           Aws.Util.option_map v.latest_cloud_watch_logs_delivery_time
             (fun f ->
           ...
           Aws.Util.option_map v.stop_logging_time
             (fun f -> ("StopLoggingTime", (DateTime.to_json f)));
           Aws.Util.option_map v.start_logging_time
             (fun f -> ("StartLoggingTime", (DateTime.to_json f)));
           Aws.Util.option_map v.latest_notification_time
             (fun f -> ("LatestNotificationTime", (DateTime.to_json f)));
           Aws.Util.option_map v.latest_delivery_time
             (fun f -> ("LatestDeliveryTime", (DateTime.to_json f)));
           Aws.Util.option_map v.latest_notification_error
             (fun f -> ("LatestNotificationError", (String.to_json f)));
           Aws.Util.option_map v.latest_delivery_error
             (fun f -> ("LatestDeliveryError", (String.to_json f)));
           Aws.Util.option_map v.is_logging
             (fun f -> ("IsLogging", (Boolean.to_json f)))])
    let of_json j =
      {
        is_logging =
          (Aws.Util.option_map (Aws.Json.lookup j "IsLogging")
             Boolean.of_json);
        latest_delivery_error =
          (Aws.Util.option_map (Aws.Json.lookup j "LatestDeliveryError")
             String.of_json);
        latest_notification_error =
          (Aws.Util.option_map (Aws.Json.lookup j "LatestNotificationError")
             String.of_json);
        latest_delivery_time =
          (Aws.Util.option_map (Aws.Json.lookup j "LatestDeliveryTime")
             DateTime.of_json);
        latest_notification_time =
          (Aws.Util.option_map (Aws.Json.lookup j "LatestNotificationTime")
             DateTime.of_json);
        start_logging_time =
          (Aws.Util.option_map (Aws.Json.lookup j "StartLoggingTime")
             DateTime.of_json);
        stop_logging_time =
          (Aws.Util.option_map (Aws.Json.lookup j "StopLoggingTime")
             DateTime.of_json);
        latest_cloud_watch_logs_delivery_error =
          (Aws.Util.option_map
        ...
        latest_cloud_watch_logs_delivery_time =
          (Aws.Util.option_map
             ...
             DateTime.of_json);
        latest_digest_delivery_time =
          (Aws.Util.option_map (Aws.Json.lookup j "LatestDigestDeliveryTime")
             DateTime.of_json);
        latest_digest_delivery_error =
          (Aws.Util.option_map
             (Aws.Json.lookup j "LatestDigestDeliveryError") String.of_json);
        latest_delivery_attempt_time =
          (Aws.Util.option_map
             (Aws.Json.lookup j "LatestDeliveryAttemptTime") String.of_json);
        latest_notification_attempt_time =
          (Aws.Util.option_map
        ...
        latest_delivery_attempt_succeeded =
          (Aws.Util.option_map
             ...
             String.of_json);
        time_logging_started =
          (Aws.Util.option_map (Aws.Json.lookup j "TimeLoggingStarted")
             String.of_json);
        time_logging_stopped =
          (Aws.Util.option_map (Aws.Json.lookup j "TimeLoggingStopped")
             String.of_json)
      }
  end
      ...
      Some
        {
          lookup_attributes =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "LookupAttributes" xml)
          ...
          end_time =
            (Aws.Util.option_bind (Aws.Xml.member "EndTime" xml)
               DateTime.parse);
          event_category =
            (Aws.Util.option_bind (Aws.Xml.member "EventCategory" xml)
               EventCategory.parse);
          max_results =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.event_category
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.event_category
             (fun f -> ("EventCategory", (EventCategory.to_json f)));
           Aws.Util.option_map v.end_time
             (fun f -> ("EndTime", (DateTime.to_json f)));
           Aws.Util.option_map v.start_time
             (fun f -> ("StartTime", (DateTime.to_json f)));
    ...
    let of_json j =
      {
        ...
        end_time =
          (Aws.Util.option_map (Aws.Json.lookup j "EndTime") DateTime.of_json);
        event_category =
          (Aws.Util.option_map (Aws.Json.lookup j "EventCategory")
      ...
      Some
        {
          resource_tag_list =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ResourceTagList" xml)
  ...
  struct
    ...
    let parse xml =
      Some
        {
          resource_id_list =
            (Aws.Xml.required "ResourceIdList"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceIdList" xml)
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> ("NextToken", (String.to_json f)));
           Some
             ("ResourceIdList", (ResourceIdList.to_json v.resource_id_list))])
    let of_json j =
      {
        resource_id_list =
