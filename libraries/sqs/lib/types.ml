...
module BinaryList = struct
  ...
  let parse xml =
    Util.option_all (List.map Blob.parse (Xml.members "BinaryListValue" xml))
...
module StringList = struct
  ...
  let parse xml =
    Util.option_all (List.map String.parse (Xml.members "StringListValue" xml))
...
module ChangeMessageVisibilityBatchRequestEntry = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("ReceiptHandle", String.to_query v.receipt_handle))
  ...
  let of_json j =
    ...
    ; receipt_handle =
        String.of_json (Util.of_option_exn (Json.lookup j "receipt_handle"))
    ; visibility_timeout =
...
module BatchResultErrorEntry = struct
  ...
  let parse xml =
    Some
      ...
      ; code = Xml.required "Code" (Util.option_bind (Xml.member "Code" xml) String.parse)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("SenderFault", Boolean.to_query v.sender_fault))
         ; Some (Query.Pair ("Id", String.to_query v.id))
         ])
  ...
  let of_json j =
    { id = String.of_json (Util.of_option_exn (Json.lookup j "id"))
    ; sender_fault = Boolean.of_json (Util.of_option_exn (Json.lookup j "sender_fault"))
...
module SendMessageBatchResultEntry = struct
  ...
  let of_json j =
    { id = String.of_json (Util.of_option_exn (Json.lookup j "id"))
    ; message_id = String.of_json (Util.of_option_exn (Json.lookup j "message_id"))
    ; m_d5_of_message_body =
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.receipt_handle (fun f ->
               Query.Pair ("ReceiptHandle", String.to_query f))
...
module ChangeMessageVisibilityBatchRequestEntryList = struct
  ...
  let to_query v = Query.to_query_list ChangeMessageVisibilityBatchRequestEntry.to_query v

  let to_json v = `List (List.map ChangeMessageVisibilityBatchRequestEntry.to_json v)

  let of_json j = Json.to_list ChangeMessageVisibilityBatchRequestEntry.of_json j
end
...
module SendMessageBatchRequestEntryList = struct
  ...
  let to_query v = Query.to_query_list SendMessageBatchRequestEntry.to_query v
...
module DeleteMessageBatchRequestEntryList = struct
  ...
  let to_query v = Query.to_query_list DeleteMessageBatchRequestEntry.to_query v
...
module BatchResultErrorEntryList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map BatchResultErrorEntry.parse (Xml.members "BatchResultErrorEntry" xml))
...
module ChangeMessageVisibilityBatchResultEntryList = struct
  ...
  let to_query v = Query.to_query_list ChangeMessageVisibilityBatchResultEntry.to_query v

  let to_json v = `List (List.map ChangeMessageVisibilityBatchResultEntry.to_json v)

  let of_json j = Json.to_list ChangeMessageVisibilityBatchResultEntry.of_json j
end
...
module SendMessageBatchResultEntryList = struct
  ...
  let to_query v = Query.to_query_list SendMessageBatchResultEntry.to_query v
...
module AWSAccountIdList = struct
  ...
  let parse xml = Util.option_all (List.map String.parse (Xml.members "AWSAccountId" xml))
...
module ActionNameList = struct
  ...
  let parse xml = Util.option_all (List.map String.parse (Xml.members "ActionName" xml))
...
module AttributeNameList = struct
  ...
  let parse xml =
    Util.option_all (List.map QueueAttributeName.parse (Xml.members "AttributeName" xml))
...
module MessageAttributeNameList = struct
  ...
  let parse xml =
    Util.option_all (List.map String.parse (Xml.members "MessageAttributeName" xml))
...
module QueueUrlList = struct
  ...
  let parse xml = Util.option_all (List.map String.parse (Xml.members "QueueUrl" xml))
...
module MessageList = struct
  ...
  let parse xml = Util.option_all (List.map Message.parse (Xml.members "Message" xml))
...
module DeleteMessageBatchResultEntryList = struct
  ...
  let to_query v = Query.to_query_list DeleteMessageBatchResultEntry.to_query v
...
module GetQueueUrlRequest = struct
  ...
  let parse xml =
    Some
      ...
      ; queue_owner_a_w_s_account_id =
          Util.option_bind (Xml.member "QueueOwnerAWSAccountId" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.queue_owner_a_w_s_account_id (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.queue_owner_a_w_s_account_id (fun f ->
               "queue_owner_a_w_s_account_id", String.to_json f)
  ...
  let of_json j =
    ...
    ; queue_owner_a_w_s_account_id =
        Util.option_map (Json.lookup j "queue_owner_a_w_s_account_id") String.of_json
    }
end
    ...
    Some
      { queue_url =
          Xml.required
            ...
            (Util.option_bind (Xml.member "QueueUrl" xml) String.parse)
      ; entries =
          Xml.required "Entries" (ChangeMessageVisibilityBatchRequestEntryList.parse xml)
      }
    ...
    Some
      { queue_url =
          Xml.required
            "QueueUrl"
            (Util.option_bind (Xml.member "QueueUrl" xml) String.parse)
      ; entries = Xml.required "Entries" (SendMessageBatchRequestEntryList.parse xml)
      }
    ...
    Some
      { queue_url =
          Xml.required
            "QueueUrl"
            (Util.option_bind (Xml.member "QueueUrl" xml) String.parse)
      ; entries = Xml.required "Entries" (DeleteMessageBatchRequestEntryList.parse xml)
      }
...
module ChangeMessageVisibilityBatchResult = struct
  ...
  let parse xml =
    Some
      ...
      ; failed = Xml.required "Failed" (BatchResultErrorEntryList.parse xml)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("Failed.member", BatchResultErrorEntryList.to_query v.failed))
         ; Some
             (Query.Pair
                ( "Successful.member"
  ...
  let of_json j =
    ...
    ; failed =
        BatchResultErrorEntryList.of_json (Util.of_option_exn (Json.lookup j "failed"))
    }
end
    ...
    Some
      { queue_url =
          Xml.required
            ...
            (Util.option_bind (Xml.member "QueueUrl" xml) String.parse)
      ; label =
          Xml.required "Label" (Util.option_bind (Xml.member "Label" xml) String.parse)
      }
...
module SendMessageBatchResult = struct
  ...
  let parse xml =
    Some
      { successful = Xml.required "Successful" (SendMessageBatchResultEntryList.parse xml)
      ; failed = Xml.required "Failed" (BatchResultErrorEntryList.parse xml)
      }
...
module AddPermissionRequest = struct
  ...
  let parse xml =
    Some
      ...
      ; label =
          Xml.required "Label" (Util.option_bind (Xml.member "Label" xml) String.parse)
      ; a_w_s_account_ids = Xml.required "AWSAccountIds" (AWSAccountIdList.parse xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Actions.member", ActionNameList.to_query v.actions))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("a_w_s_account_ids", AWSAccountIdList.to_json v.a_w_s_account_ids)
         ; Some ("label", String.to_json v.label)
         ; Some ("queue_url", String.to_json v.queue_url)
         ])
  ...
  let of_json j =
    ...
    ; label = String.of_json (Util.of_option_exn (Json.lookup j "label"))
    ; a_w_s_account_ids =
        AWSAccountIdList.of_json (Util.of_option_exn (Json.lookup j "a_w_s_account_ids"))
    ; actions = ActionNameList.of_json (Util.of_option_exn (Json.lookup j "actions"))
    }
end
...
module ChangeMessageVisibilityRequest = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("VisibilityTimeout", Integer.to_query v.visibility_timeout))
         ; Some (Query.Pair ("ReceiptHandle", String.to_query v.receipt_handle))
         ; Some (Query.Pair ("QueueUrl", String.to_query v.queue_url))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("visibility_timeout", Integer.to_json v.visibility_timeout)
         ; Some ("receipt_handle", String.to_json v.receipt_handle)
         ; Some ("queue_url", String.to_json v.queue_url)
         ])
  ...
  let of_json j =
    ...
    ; receipt_handle =
        String.of_json (Util.of_option_exn (Json.lookup j "receipt_handle"))
    ; visibility_timeout =
        Integer.of_json (Util.of_option_exn (Json.lookup j "visibility_timeout"))
    }
end
...
module ReceiveMessageRequest = struct
  ...
  let parse xml =
    Some
      ...
      ; message_attribute_names = Util.of_option [] (MessageAttributeNameList.parse xml)
      ; max_number_of_messages =
          Util.option_bind (Xml.member "MaxNumberOfMessages" xml) Integer.parse
      ; visibility_timeout =
          Util.option_bind (Xml.member "VisibilityTimeout" xml) Integer.parse
      ; wait_time_seconds =
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.visibility_timeout (fun f ->
               Query.Pair ("VisibilityTimeout", Integer.to_query f))
         ; Util.option_map v.max_number_of_messages (fun f ->
    ...
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.visibility_timeout (fun f ->
               "visibility_timeout", Integer.to_json f)
         ; Util.option_map v.max_number_of_messages (fun f ->
               "max_number_of_messages", Integer.to_json f)
         ; Some
             ( "message_attribute_names"
             , MessageAttributeNameList.to_json v.message_attribute_names )
         ; Some ("attribute_names", AttributeNameList.to_json v.attribute_names)
         ; Some ("queue_url", String.to_json v.queue_url)
         ])
  ...
  let of_json j =
    { queue_url = String.of_json (Util.of_option_exn (Json.lookup j "queue_url"))
    ; attribute_names =
        AttributeNameList.of_json (Util.of_option_exn (Json.lookup j "attribute_names"))
    ; message_attribute_names =
        MessageAttributeNameList.of_json
          (Util.of_option_exn (Json.lookup j "message_attribute_names"))
    ; max_number_of_messages =
        Util.option_map (Json.lookup j "max_number_of_messages") Integer.of_json
    ; visibility_timeout =
        Util.option_map (Json.lookup j "visibility_timeout") Integer.of_json
    ; wait_time_seconds =
    ...
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.m_d5_of_message_body (fun f ->
               Query.Pair ("MD5OfMessageBody", String.to_query f))
         ])
    ...
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.m_d5_of_message_attributes (fun f ->
               "m_d5_of_message_attributes", String.to_json f)
         ; Util.option_map v.m_d5_of_message_body (fun f ->
               "m_d5_of_message_body", String.to_json f)
         ])
...
module CreateQueueResult = struct
  ...
  let parse xml =
    Some { queue_url = Util.option_bind (Xml.member "QueueUrl" xml) String.parse }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.queue_url (fun f ->
               Query.Pair ("QueueUrl", String.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.queue_url (fun f -> "queue_url", String.to_json f) ])
...
module ReceiveMessageResult = struct
  ...
  let parse xml = Some { messages = Util.of_option [] (MessageList.parse xml) }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Messages.member", MessageList.to_query v.messages)) ])

  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("messages", MessageList.to_json v.messages) ])

  let of_json j =
    { messages = MessageList.of_json (Util.of_option_exn (Json.lookup j "messages")) }
end
...
module DeleteMessageBatchResult = struct
  ...
  let parse xml =
    Some
      { successful =
          Xml.required "Successful" (DeleteMessageBatchResultEntryList.parse xml)
      ; failed = Xml.required "Failed" (BatchResultErrorEntryList.parse xml)
      }
