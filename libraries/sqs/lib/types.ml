  ...
  struct
    ...
    let parse xml =
      Some
        {
          queue_url =
            (Aws.Xml.required "QueueUrl"
               (Aws.Util.option_bind (Aws.Xml.member "QueueUrl" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        queue_url =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "QueueUrl")))
      }
  end
...
module QueueAttributeMap =
  struct
    ...
    let parse xml = None
    let to_query v =
      Aws.Query.to_query_hashtbl QueueAttributeName.to_string String.to_query
        v
    let to_json v =
      `Assoc
        (Hashtbl.fold
           (fun k ->
              fun v ->
                fun acc ->
                  ...
                  acc) v [])
    let of_json j =
      Aws.Json.to_hashtbl QueueAttributeName.of_string String.of_json j
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          queue_name =
            (Aws.Xml.required "QueueName"
               (Aws.Util.option_bind (Aws.Xml.member "QueueName" xml)
                  String.parse));
          attributes =
            (Aws.Util.option_bind (Aws.Xml.member "Attribute" xml)
               QueueAttributeMap.parse);
          tags =
            (Aws.Util.option_bind (Aws.Xml.member "Tag" xml) TagMap.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.tags
              (fun f -> Aws.Query.Pair ("Tag", (TagMap.to_query f)));
           Aws.Util.option_map v.attributes
             (fun f ->
                Aws.Query.Pair ("Attribute", (QueueAttributeMap.to_query f)));
           Some
             (Aws.Query.Pair ("QueueName", (String.to_query v.queue_name)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.tags (fun f -> ("Tag", (TagMap.to_json f)));
           Aws.Util.option_map v.attributes
             (fun f -> ("Attribute", (QueueAttributeMap.to_json f)));
           Some ("QueueName", (String.to_json v.queue_name))])
    let of_json j =
      {
        queue_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "QueueName")));
        attributes =
...
module QueueUrlList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "QueueUrl" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
    ...
    let of_json j =
      {
        queue_urls =
          (QueueUrlList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "QueueUrls")));
        next_token =
      ...
      Some
        {
          ...
          receipt_handle =
            (Aws.Xml.required "ReceiptHandle"
               (Aws.Util.option_bind (Aws.Xml.member "ReceiptHandle" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        ...
        receipt_handle =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ReceiptHandle")))
      }
  end
  ...
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list
        ChangeMessageVisibilityBatchResultEntry.to_query v
    let to_json v =
      `List (List.map ChangeMessageVisibilityBatchResultEntry.to_json v)
    let of_json j =
      Aws.Json.to_list ChangeMessageVisibilityBatchResultEntry.of_json j
  end
...
module TagKeyList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "TagKey" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
...
module StringList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "StringListValue" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
module BinaryList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Blob.parse (Aws.Xml.members "BinaryListValue" xml))
      ...
      Some
        {
          ...
          string_list_values =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "StringListValue" xml)
                  StringList.parse));
          binary_list_values =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "BinaryListValue" xml)
                  BinaryList.parse));
          data_type =
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Some
             ("BinaryListValue", (BinaryList.to_json v.binary_list_values));
           Some
             ("StringListValue", (StringList.to_json v.string_list_values));
           Aws.Util.option_map v.binary_value
    ...
    let of_json j =
      {
        ...
        string_list_values =
          (StringList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StringListValue")));
        binary_list_values =
          (BinaryList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "BinaryListValue")));
        data_type =
          (String.of_json
           ...
           (fun k ->
              fun v ->
                fun acc ->
                  ...
                  :: acc) v [])
    let of_json j =
      Aws.Json.to_hashtbl MessageSystemAttributeName.of_string String.of_json
        j
  end
      ...
      Some
        {
          ...
          receipt_handle =
            (Aws.Util.option_bind (Aws.Xml.member "ReceiptHandle" xml)
               String.parse);
          m_d5_of_body =
            (Aws.Util.option_bind (Aws.Xml.member "MD5OfBody" xml)
               String.parse);
          body =
          ...
          message_attributes =
            (Aws.Util.option_bind (Aws.Xml.member "MessageAttribute" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.m_d5_of_message_attributes
             (fun f ->
                Aws.Query.Pair
                  ("MD5OfMessageAttributes", (String.to_query f)));
           Aws.Util.option_map v.attributes
             (fun f ->
                Aws.Query.Pair
                  ("Attribute", (MessageSystemAttributeMap.to_query f)));
           Aws.Util.option_map v.body
             (fun f -> Aws.Query.Pair ("Body", (String.to_query f)));
           Aws.Util.option_map v.m_d5_of_body
             (fun f -> Aws.Query.Pair ("MD5OfBody", (String.to_query f)));
           Aws.Util.option_map v.receipt_handle
             (fun f -> Aws.Query.Pair ("ReceiptHandle", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.m_d5_of_message_attributes
             (fun f -> ("MD5OfMessageAttributes", (String.to_json f)));
           Aws.Util.option_map v.attributes
             (fun f -> ("Attribute", (MessageSystemAttributeMap.to_json f)));
           Aws.Util.option_map v.body (fun f -> ("Body", (String.to_json f)));
           Aws.Util.option_map v.m_d5_of_body
             (fun f -> ("MD5OfBody", (String.to_json f)));
           Aws.Util.option_map v.receipt_handle
             (fun f -> ("ReceiptHandle", (String.to_json f)));
           Aws.Util.option_map v.message_id
    ...
    let of_json j =
      {
        ...
        receipt_handle =
          (Aws.Util.option_map (Aws.Json.lookup j "ReceiptHandle")
             String.of_json);
        m_d5_of_body =
          (Aws.Util.option_map (Aws.Json.lookup j "MD5OfBody") String.of_json);
        body =
          (Aws.Util.option_map (Aws.Json.lookup j "Body") String.of_json);
        attributes =
          (Aws.Util.option_map (Aws.Json.lookup j "Attribute")
             MessageSystemAttributeMap.of_json);
        m_d5_of_message_attributes =
          (Aws.Util.option_map (Aws.Json.lookup j "MD5OfMessageAttributes")
             String.of_json);
        message_attributes =
          (Aws.Util.option_map (Aws.Json.lookup j "MessageAttribute")
...
module DeleteMessageBatchResultEntryList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list DeleteMessageBatchResultEntry.to_query v
      ...
      Some
        {
          id =
            (Aws.Xml.required "Id"
               (Aws.Util.option_bind (Aws.Xml.member "Id" xml) String.parse));
          sender_fault =
            (Aws.Xml.required "SenderFault"
               (Aws.Util.option_bind (Aws.Xml.member "SenderFault" xml)
                  Boolean.parse));
          code =
            (Aws.Xml.required "Code"
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("SenderFault", (Boolean.to_query v.sender_fault)));
           Some (Aws.Query.Pair ("Id", (String.to_query v.id)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        ...
        sender_fault =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "SenderFault")));
        code =
          (String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Code")));
        message =
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map BatchResultErrorEntry.parse
           (Aws.Xml.members "BatchResultErrorEntry" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          successful =
            (Aws.Xml.required "Successful"
               (DeleteMessageBatchResultEntryList.parse xml));
          failed =
            (Aws.Xml.required "Failed" (BatchResultErrorEntryList.parse xml))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
...
module AttributeNameList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map QueueAttributeName.parse
          ...
          queue_url =
            (Aws.Xml.required "QueueUrl"
               (Aws.Util.option_bind (Aws.Xml.member "QueueUrl" xml)
                  String.parse));
          attribute_names =
            (Aws.Util.of_option [] (AttributeNameList.parse xml))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
...
module MessageList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Message.parse (Aws.Xml.members "Message" xml))
...
module ReceiveMessageResult =
  struct
    ...
    let parse xml =
      Some { messages = (Aws.Util.of_option [] (MessageList.parse xml)) }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
...
module DeleteMessageBatchRequestEntryList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list DeleteMessageBatchRequestEntry.to_query v
...
module MessageBodySystemAttributeMap =
  struct
    ...
    let parse xml = None
    let to_query v =
      Aws.Query.to_query_hashtbl MessageSystemAttributeNameForSends.to_string
           ...
           (fun k ->
              fun v ->
                fun acc ->
                  ...
                  :: acc) v [])
    let of_json j =
      Aws.Json.to_hashtbl MessageSystemAttributeNameForSends.of_string
      ...
      Some
        {
          id =
            (Aws.Xml.required "Id"
               (Aws.Util.option_bind (Aws.Xml.member "Id" xml) String.parse));
          message_body =
            (Aws.Xml.required "MessageBody"
               (Aws.Util.option_bind (Aws.Xml.member "MessageBody" xml)
                  String.parse));
          delay_seconds =
            (Aws.Util.option_bind (Aws.Xml.member "DelaySeconds" xml)
               Integer.parse);
          message_attributes =
            (Aws.Util.option_bind (Aws.Xml.member "MessageAttribute" xml)
               MessageBodyAttributeMap.parse);
          ...
          message_deduplication_id =
            (Aws.Util.option_bind
               (Aws.Xml.member "MessageDeduplicationId" xml) String.parse);
          message_group_id =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.message_deduplication_id
             (fun f ->
                Aws.Query.Pair
                  ("MessageDeduplicationId", (String.to_query f)));
           Aws.Util.option_map v.message_system_attributes
             (fun f ->
                Aws.Query.Pair
           ...
           Aws.Util.option_map v.message_attributes
             (fun f ->
                Aws.Query.Pair
                  ("MessageAttribute", (MessageBodyAttributeMap.to_query f)));
           Aws.Util.option_map v.delay_seconds
             (fun f -> Aws.Query.Pair ("DelaySeconds", (Integer.to_query f)));
           Some
             (Aws.Query.Pair
                ("MessageBody", (String.to_query v.message_body)));
           Some (Aws.Query.Pair ("Id", (String.to_query v.id)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.message_deduplication_id
             (fun f -> ("MessageDeduplicationId", (String.to_json f)));
           Aws.Util.option_map v.message_system_attributes
             (fun f ->
                ("MessageSystemAttribute",
           ...
           Aws.Util.option_map v.message_attributes
             (fun f ->
                ("MessageAttribute", (MessageBodyAttributeMap.to_json f)));
           Aws.Util.option_map v.delay_seconds
             (fun f -> ("DelaySeconds", (Integer.to_json f)));
    ...
    let of_json j =
      {
        ...
        message_body =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MessageBody")));
        delay_seconds =
          (Aws.Util.option_map (Aws.Json.lookup j "DelaySeconds")
             Integer.of_json);
        message_attributes =
          (Aws.Util.option_map (Aws.Json.lookup j "MessageAttribute")
             MessageBodyAttributeMap.of_json);
        message_system_attributes =
          (Aws.Util.option_map (Aws.Json.lookup j "MessageSystemAttribute")
             MessageBodySystemAttributeMap.of_json);
        message_deduplication_id =
          (Aws.Util.option_map (Aws.Json.lookup j "MessageDeduplicationId")
             String.of_json);
        message_group_id =
          (Aws.Util.option_map (Aws.Json.lookup j "MessageGroupId")
             String.of_json)
      }
  end
module SendMessageBatchRequestEntryList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list SendMessageBatchRequestEntry.to_query v
    ...
    let of_json j =
      {
        queue_url =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "QueueUrl")));
        tags =
          (TagMap.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Tags")))
      }
  end
      ...
      Some
        {
          id =
            (Aws.Xml.required "Id"
               (Aws.Util.option_bind (Aws.Xml.member "Id" xml) String.parse));
          message_id =
            (Aws.Xml.required "MessageId"
               (Aws.Util.option_bind (Aws.Xml.member "MessageId" xml)
                  String.parse));
          m_d5_of_message_body =
            (Aws.Xml.required "MD5OfMessageBody"
               (Aws.Util.option_bind (Aws.Xml.member "MD5OfMessageBody" xml)
                  String.parse));
          m_d5_of_message_attributes =
            (Aws.Util.option_bind
               (Aws.Xml.member "MD5OfMessageAttributes" xml) String.parse);
          m_d5_of_message_system_attributes =
            (Aws.Util.option_bind
               ...
               String.parse);
          sequence_number =
            (Aws.Util.option_bind (Aws.Xml.member "SequenceNumber" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.sequence_number
              (fun f ->
                 Aws.Query.Pair ("SequenceNumber", (String.to_query f)));
           Aws.Util.option_map v.m_d5_of_message_system_attributes
             (fun f ->
                Aws.Query.Pair
           ...
           Some
             (Aws.Query.Pair ("MessageId", (String.to_query v.message_id)));
           Some (Aws.Query.Pair ("Id", (String.to_query v.id)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.sequence_number
              (fun f -> ("SequenceNumber", (String.to_json f)));
           Aws.Util.option_map v.m_d5_of_message_system_attributes
             (fun f -> ("MD5OfMessageSystemAttributes", (String.to_json f)));
           Aws.Util.option_map v.m_d5_of_message_attributes
             (fun f -> ("MD5OfMessageAttributes", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        message_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MessageId")));
        m_d5_of_message_body =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "MD5OfMessageBody")));
        m_d5_of_message_attributes =
          (Aws.Util.option_map (Aws.Json.lookup j "MD5OfMessageAttributes")
             String.of_json);
        m_d5_of_message_system_attributes =
          (Aws.Util.option_map
             ...
             String.of_json);
        sequence_number =
          (Aws.Util.option_map (Aws.Json.lookup j "SequenceNumber")
             String.of_json)
      }
  end
module CreateQueueResult =
  struct
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.queue_url
              (fun f -> Aws.Query.Pair ("QueueUrl", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.queue_url
              (fun f -> ("QueueUrl", (String.to_json f)))])
    let of_json j =
      {
        queue_url =
          (Aws.Util.option_map (Aws.Json.lookup j "QueueUrl") String.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          queue_name_prefix =
            (Aws.Util.option_bind (Aws.Xml.member "QueueNamePrefix" xml)
               String.parse);
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse);
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.next_token
             (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Aws.Util.option_map v.queue_name_prefix
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.next_token
             (fun f -> ("NextToken", (String.to_json f)));
           Aws.Util.option_map v.queue_name_prefix
             (fun f -> ("QueueNamePrefix", (String.to_json f)))])
    let of_json j =
      {
        queue_name_prefix =
          (Aws.Util.option_map (Aws.Json.lookup j "QueueNamePrefix")
             String.of_json);
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json);
        max_results =
  ...
  struct
          ...
          receipt_handle =
            (Aws.Xml.required "ReceiptHandle"
               (Aws.Util.option_bind (Aws.Xml.member "ReceiptHandle" xml)
                  String.parse));
          visibility_timeout =
            (Aws.Util.option_bind (Aws.Xml.member "VisibilityTimeout" xml)
               Integer.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.visibility_timeout
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.visibility_timeout
              (fun f -> ("VisibilityTimeout", (Integer.to_json f)));
           Some ("ReceiptHandle", (String.to_json v.receipt_handle));
           Some ("Id", (String.to_json v.id))])
    let of_json j =
      {
        ...
        receipt_handle =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ReceiptHandle")));
        visibility_timeout =
          (Aws.Util.option_map (Aws.Json.lookup j "VisibilityTimeout")
             Integer.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          queue_urls =
            (Aws.Xml.required "queueUrls" (QueueUrlList.parse xml));
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse)
        }
...
module AWSAccountIdList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "AWSAccountId" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
        ...
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.m_d5_of_message_attributes
             (fun f ->
                Aws.Query.Pair
                  ("MD5OfMessageAttributes", (String.to_query f)));
           Aws.Util.option_map v.m_d5_of_message_body
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.m_d5_of_message_attributes
             (fun f -> ("MD5OfMessageAttributes", (String.to_json f)));
           Aws.Util.option_map v.m_d5_of_message_body
             (fun f -> ("MD5OfMessageBody", (String.to_json f)))])
    let of_json j =
      {
        m_d5_of_message_body =
          (Aws.Util.option_map (Aws.Json.lookup j "MD5OfMessageBody")
             String.of_json);
        m_d5_of_message_attributes =
          (Aws.Util.option_map (Aws.Json.lookup j "MD5OfMessageAttributes")
             String.of_json);
  ...
  struct
      ...
      Some
        {
          ...
          max_number_of_messages =
            (Aws.Util.option_bind (Aws.Xml.member "MaxNumberOfMessages" xml)
               Integer.parse);
          visibility_timeout =
            (Aws.Util.option_bind (Aws.Xml.member "VisibilityTimeout" xml)
               Integer.parse);
          wait_time_seconds =
            (Aws.Util.option_bind (Aws.Xml.member "WaitTimeSeconds" xml)
               Integer.parse);
          receive_request_attempt_id =
            (Aws.Util.option_bind
               (Aws.Xml.member "ReceiveRequestAttemptId" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.receive_request_attempt_id
              (fun f ->
                 Aws.Query.Pair
                   ("ReceiveRequestAttemptId", (String.to_query f)));
           Aws.Util.option_map v.wait_time_seconds
             (fun f ->
                Aws.Query.Pair ("WaitTimeSeconds", (Integer.to_query f)));
           Aws.Util.option_map v.visibility_timeout
             (fun f ->
                Aws.Query.Pair ("VisibilityTimeout", (Integer.to_query f)));
           Aws.Util.option_map v.max_number_of_messages
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.receive_request_attempt_id
              (fun f -> ("ReceiveRequestAttemptId", (String.to_json f)));
           Aws.Util.option_map v.wait_time_seconds
             (fun f -> ("WaitTimeSeconds", (Integer.to_json f)));
           Aws.Util.option_map v.visibility_timeout
             (fun f -> ("VisibilityTimeout", (Integer.to_json f)));
           Aws.Util.option_map v.max_number_of_messages
             (fun f -> ("MaxNumberOfMessages", (Integer.to_json f)));
           Some
    ...
    let of_json j =
      {
        ...
        message_attribute_names =
          (MessageAttributeNameList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "MessageAttributeNames")));
        max_number_of_messages =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxNumberOfMessages")
             Integer.of_json);
        visibility_timeout =
          (Aws.Util.option_map (Aws.Json.lookup j "VisibilityTimeout")
             Integer.of_json);
        wait_time_seconds =
          (Aws.Util.option_map (Aws.Json.lookup j "WaitTimeSeconds")
             Integer.of_json);
        receive_request_attempt_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ReceiveRequestAttemptId")
             String.of_json)
      }
  end
  ...
  struct
          ...
          receipt_handle =
            (Aws.Xml.required "ReceiptHandle"
               (Aws.Util.option_bind (Aws.Xml.member "ReceiptHandle" xml)
                  String.parse));
          visibility_timeout =
            (Aws.Xml.required "VisibilityTimeout"
               (Aws.Util.option_bind (Aws.Xml.member "VisibilityTimeout" xml)
                  Integer.parse))
        }
    let to_query v =
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("VisibilityTimeout", (Integer.to_json v.visibility_timeout));
           Some ("ReceiptHandle", (String.to_json v.receipt_handle));
           Some ("QueueUrl", (String.to_json v.queue_url))])
    let of_json j =
      {
        ...
        visibility_timeout =
          (Integer.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "VisibilityTimeout")))
      }
  end
module ActionNameList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "ActionName" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
          ...
          label =
            (Aws.Xml.required "Label"
               (Aws.Util.option_bind (Aws.Xml.member "Label" xml)
                  String.parse));
          a_w_s_account_ids =
            (Aws.Xml.required "AWSAccountIds" (AWSAccountIdList.parse xml));
    ...
    let of_json j =
      {
        ...
        actions =
          (ActionNameList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Actions")))
      }
  end
module SendMessageBatchResultEntryList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list SendMessageBatchResultEntry.to_query v
...
module ChangeMessageVisibilityBatchRequestEntryList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list
        ChangeMessageVisibilityBatchRequestEntry.to_query v
    let to_json v =
      `List (List.map ChangeMessageVisibilityBatchRequestEntry.to_json v)
    let of_json j =
      Aws.Json.to_list ChangeMessageVisibilityBatchRequestEntry.of_json j
  end
      ...
      Some
        {
          ...
          queue_owner_a_w_s_account_id =
            (Aws.Util.option_bind
               (Aws.Xml.member "QueueOwnerAWSAccountId" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.queue_owner_a_w_s_account_id
              (fun f ->
                 Aws.Query.Pair
                   ("QueueOwnerAWSAccountId", (String.to_query f)));
           Some
             (Aws.Query.Pair ("QueueName", (String.to_query v.queue_name)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.queue_owner_a_w_s_account_id
              (fun f -> ("QueueOwnerAWSAccountId", (String.to_json f)));
           Some ("QueueName", (String.to_json v.queue_name))])
    let of_json j =
      {
        queue_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "QueueName")));
        queue_owner_a_w_s_account_id =
          (Aws.Util.option_map (Aws.Json.lookup j "QueueOwnerAWSAccountId")
             String.of_json)
      }
  end
