  ...
  struct
    ...
    let parse xml =
      Some
        {
          global_replication_group_id =
            (Aws.Xml.required "GlobalReplicationGroupId"
               (Aws.Util.option_bind
                  (Aws.Xml.member "GlobalReplicationGroupId" xml)
                  String.parse));
          replication_group_id =
            (Aws.Xml.required "ReplicationGroupId"
               (Aws.Util.option_bind
                  (Aws.Xml.member "ReplicationGroupId" xml) String.parse));
          replication_group_region =
            (Aws.Xml.required "ReplicationGroupRegion"
               (Aws.Util.option_bind
                  (Aws.Xml.member "ReplicationGroupRegion" xml) String.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Some
             ("ReplicationGroupId", (String.to_json v.replication_group_id));
           Some
             ("GlobalReplicationGroupId",
        ...
        global_replication_group_id =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "GlobalReplicationGroupId")));
        replication_group_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ReplicationGroupId")));
        replication_group_region =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ReplicationGroupRegion")))
      }
  end
      ...
      Some
        {
          ...
          values =
            (Aws.Xml.required "Values"
               (Aws.Util.option_bind (Aws.Xml.member "Values" xml)
  ...
  struct
      ...
      Some
        {
          recurring_charge_amount =
            (Aws.Util.option_bind
               (Aws.Xml.member "RecurringChargeAmount" xml) Double.parse);
          recurring_charge_frequency =
            (Aws.Util.option_bind
               (Aws.Xml.member "RecurringChargeFrequency" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.recurring_charge_frequency
              (fun f ->
                 Aws.Query.Pair
                   ("RecurringChargeFrequency", (String.to_query f)));
           Aws.Util.option_map v.recurring_charge_amount
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.recurring_charge_frequency
              (fun f -> ("RecurringChargeFrequency", (String.to_json f)));
           Aws.Util.option_map v.recurring_charge_amount
             (fun f -> ("RecurringChargeAmount", (Double.to_json f)))])
    let of_json j =
      {
        recurring_charge_amount =
          (Aws.Util.option_map (Aws.Json.lookup j "RecurringChargeAmount")
             Double.of_json);
        recurring_charge_frequency =
          (Aws.Util.option_map (Aws.Json.lookup j "RecurringChargeFrequency")
             String.of_json)
      }
  end
module RecurringChargeList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map RecurringCharge.parse
           (Aws.Xml.members "RecurringCharge" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          reserved_cache_node_id =
            (Aws.Util.option_bind (Aws.Xml.member "ReservedCacheNodeId" xml)
               String.parse);
          reserved_cache_nodes_offering_id =
            (Aws.Util.option_bind
               ...
               String.parse);
          cache_node_type =
            (Aws.Util.option_bind (Aws.Xml.member "CacheNodeType" xml)
               String.parse);
          start_time =
            (Aws.Util.option_bind (Aws.Xml.member "StartTime" xml)
               DateTime.parse);
          duration =
            (Aws.Util.option_bind (Aws.Xml.member "Duration" xml)
               Integer.parse);
          fixed_price =
            (Aws.Util.option_bind (Aws.Xml.member "FixedPrice" xml)
               Double.parse);
          usage_price =
            (Aws.Util.option_bind (Aws.Xml.member "UsagePrice" xml)
               Double.parse);
          cache_node_count =
            (Aws.Util.option_bind (Aws.Xml.member "CacheNodeCount" xml)
               Integer.parse);
          product_description =
          ...
          recurring_charges =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "RecurringCharges" xml)
                  RecurringChargeList.parse));
          reservation_a_r_n =
            (Aws.Util.option_bind (Aws.Xml.member "ReservationARN" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.reservation_a_r_n
              (fun f ->
           ...
           Aws.Util.option_map v.offering_type
             (fun f -> Aws.Query.Pair ("OfferingType", (String.to_query f)));
           Aws.Util.option_map v.product_description
             (fun f ->
                Aws.Query.Pair ("ProductDescription", (String.to_query f)));
           Aws.Util.option_map v.cache_node_count
             (fun f ->
                Aws.Query.Pair ("CacheNodeCount", (Integer.to_query f)));
           Aws.Util.option_map v.usage_price
             (fun f -> Aws.Query.Pair ("UsagePrice", (Double.to_query f)));
           Aws.Util.option_map v.fixed_price
             (fun f -> Aws.Query.Pair ("FixedPrice", (Double.to_query f)));
           Aws.Util.option_map v.duration
             (fun f -> Aws.Query.Pair ("Duration", (Integer.to_query f)));
           Aws.Util.option_map v.start_time
             (fun f -> Aws.Query.Pair ("StartTime", (DateTime.to_query f)));
           Aws.Util.option_map v.cache_node_type
             (fun f -> Aws.Query.Pair ("CacheNodeType", (String.to_query f)));
           Aws.Util.option_map v.reserved_cache_nodes_offering_id
             (fun f ->
                Aws.Query.Pair
                  ("ReservedCacheNodesOfferingId", (String.to_query f)));
           Aws.Util.option_map v.reserved_cache_node_id
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.reservation_a_r_n
              (fun f -> ("ReservationARN", (String.to_json f)));
           Some
             ("RecurringCharges",
               (RecurringChargeList.to_json v.recurring_charges));
           Aws.Util.option_map v.state
             (fun f -> ("State", (String.to_json f)));
           Aws.Util.option_map v.offering_type
             (fun f -> ("OfferingType", (String.to_json f)));
           Aws.Util.option_map v.product_description
             (fun f -> ("ProductDescription", (String.to_json f)));
           Aws.Util.option_map v.cache_node_count
             (fun f -> ("CacheNodeCount", (Integer.to_json f)));
           Aws.Util.option_map v.usage_price
             (fun f -> ("UsagePrice", (Double.to_json f)));
           Aws.Util.option_map v.fixed_price
             (fun f -> ("FixedPrice", (Double.to_json f)));
           Aws.Util.option_map v.duration
             (fun f -> ("Duration", (Integer.to_json f)));
           Aws.Util.option_map v.start_time
             (fun f -> ("StartTime", (DateTime.to_json f)));
           Aws.Util.option_map v.cache_node_type
             (fun f -> ("CacheNodeType", (String.to_json f)));
           Aws.Util.option_map v.reserved_cache_nodes_offering_id
             (fun f -> ("ReservedCacheNodesOfferingId", (String.to_json f)));
           Aws.Util.option_map v.reserved_cache_node_id
             (fun f -> ("ReservedCacheNodeId", (String.to_json f)))])
    let of_json j =
      {
        reserved_cache_node_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ReservedCacheNodeId")
             String.of_json);
        reserved_cache_nodes_offering_id =
          (Aws.Util.option_map
             ...
             String.of_json);
        cache_node_type =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeType")
             String.of_json);
        start_time =
          (Aws.Util.option_map (Aws.Json.lookup j "StartTime")
             DateTime.of_json);
        duration =
          (Aws.Util.option_map (Aws.Json.lookup j "Duration") Integer.of_json);
        fixed_price =
          (Aws.Util.option_map (Aws.Json.lookup j "FixedPrice")
             Double.of_json);
        usage_price =
          (Aws.Util.option_map (Aws.Json.lookup j "UsagePrice")
             Double.of_json);
        cache_node_count =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeCount")
             Integer.of_json);
        product_description =
        ...
        offering_type =
          (Aws.Util.option_map (Aws.Json.lookup j "OfferingType")
             String.of_json);
        state =
          (Aws.Util.option_map (Aws.Json.lookup j "State") String.of_json);
        recurring_charges =
          (RecurringChargeList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RecurringCharges")));
        reservation_a_r_n =
          (Aws.Util.option_map (Aws.Json.lookup j "ReservationARN")
             String.of_json)
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ReservedCacheNode.parse
           (Aws.Xml.members "ReservedCacheNode" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          replication_group_id =
            (Aws.Util.option_bind (Aws.Xml.member "ReplicationGroupId" xml)
               String.parse);
          replication_group_region =
            (Aws.Util.option_bind
               (Aws.Xml.member "ReplicationGroupRegion" xml) String.parse);
          ...
          automatic_failover =
            (Aws.Util.option_bind (Aws.Xml.member "AutomaticFailover" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.automatic_failover
             (fun f ->
                Aws.Query.Pair
                  ("AutomaticFailover", (AutomaticFailoverStatus.to_query f)));
           Aws.Util.option_map v.role
             (fun f -> Aws.Query.Pair ("Role", (String.to_query f)));
           Aws.Util.option_map v.replication_group_region
             (fun f ->
                Aws.Query.Pair
                  ("ReplicationGroupRegion", (String.to_query f)));
           Aws.Util.option_map v.replication_group_id
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.replication_group_region
             (fun f -> ("ReplicationGroupRegion", (String.to_json f)));
           Aws.Util.option_map v.replication_group_id
             (fun f -> ("ReplicationGroupId", (String.to_json f)))])
    let of_json j =
      {
        replication_group_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ReplicationGroupId")
             String.of_json);
        replication_group_region =
          (Aws.Util.option_map (Aws.Json.lookup j "ReplicationGroupRegion")
             String.of_json);
        role =
          (Aws.Util.option_map (Aws.Json.lookup j "Role") String.of_json);
        automatic_failover =
          (Aws.Util.option_map (Aws.Json.lookup j "AutomaticFailover")
...
module GlobalReplicationGroupMemberList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list GlobalReplicationGroupMember.to_query v
  ...
  struct
      ...
      Some
        {
          global_node_group_id =
            (Aws.Util.option_bind (Aws.Xml.member "GlobalNodeGroupId" xml)
               String.parse);
          slots =
            (Aws.Util.option_bind (Aws.Xml.member "Slots" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.slots
              (fun f -> Aws.Query.Pair ("Slots", (String.to_query f)));
           Aws.Util.option_map v.global_node_group_id
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.slots
              (fun f -> ("Slots", (String.to_json f)));
           Aws.Util.option_map v.global_node_group_id
             (fun f -> ("GlobalNodeGroupId", (String.to_json f)))])
    let of_json j =
      {
        global_node_group_id =
          (Aws.Util.option_map (Aws.Json.lookup j "GlobalNodeGroupId")
             String.of_json);
        slots =
          (Aws.Util.option_map (Aws.Json.lookup j "Slots") String.of_json)
      }
  end
module GlobalNodeGroupList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map GlobalNodeGroup.parse
           (Aws.Xml.members "GlobalNodeGroup" xml))
...
module GlobalReplicationGroup =
  struct
      ...
      Some
        {
          global_replication_group_id =
            (Aws.Util.option_bind
               (Aws.Xml.member "GlobalReplicationGroupId" xml) String.parse);
          global_replication_group_description =
            (Aws.Util.option_bind
          ...
          engine_version =
            (Aws.Util.option_bind (Aws.Xml.member "EngineVersion" xml)
               String.parse);
          members =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Members" xml)
                  GlobalReplicationGroupMemberList.parse));
          cluster_enabled =
            (Aws.Util.option_bind (Aws.Xml.member "ClusterEnabled" xml)
               Boolean.parse);
          global_node_groups =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "GlobalNodeGroups" xml)
                  GlobalNodeGroupList.parse));
          auth_token_enabled =
            (Aws.Util.option_bind (Aws.Xml.member "AuthTokenEnabled" xml)
               Boolean.parse);
          transit_encryption_enabled =
            (Aws.Util.option_bind
               (Aws.Xml.member "TransitEncryptionEnabled" xml) Boolean.parse);
          at_rest_encryption_enabled =
            (Aws.Util.option_bind
               (Aws.Xml.member "AtRestEncryptionEnabled" xml) Boolean.parse);
          a_r_n =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.a_r_n
              (fun f -> Aws.Query.Pair ("ARN", (String.to_query f)));
           Aws.Util.option_map v.at_rest_encryption_enabled
             (fun f ->
                Aws.Query.Pair
                  ("AtRestEncryptionEnabled", (Boolean.to_query f)));
           Aws.Util.option_map v.transit_encryption_enabled
             (fun f ->
                Aws.Query.Pair
                  ("TransitEncryptionEnabled", (Boolean.to_query f)));
           Aws.Util.option_map v.auth_token_enabled
             (fun f ->
           ...
           Aws.Util.option_map v.cluster_enabled
             (fun f ->
           ...
           Aws.Util.option_map v.engine_version
             (fun f -> Aws.Query.Pair ("EngineVersion", (String.to_query f)));
           Aws.Util.option_map v.engine
             (fun f -> Aws.Query.Pair ("Engine", (String.to_query f)));
           Aws.Util.option_map v.cache_node_type
             (fun f -> Aws.Query.Pair ("CacheNodeType", (String.to_query f)));
           Aws.Util.option_map v.status
             (fun f -> Aws.Query.Pair ("Status", (String.to_query f)));
           Aws.Util.option_map v.global_replication_group_description
             (fun f ->
                Aws.Query.Pair
                  ("GlobalReplicationGroupDescription", (String.to_query f)));
           Aws.Util.option_map v.global_replication_group_id
             (fun f ->
                Aws.Query.Pair
                  ("GlobalReplicationGroupId", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.a_r_n
              (fun f -> ("ARN", (String.to_json f)));
           Aws.Util.option_map v.at_rest_encryption_enabled
             (fun f -> ("AtRestEncryptionEnabled", (Boolean.to_json f)));
           Aws.Util.option_map v.transit_encryption_enabled
             (fun f -> ("TransitEncryptionEnabled", (Boolean.to_json f)));
           Aws.Util.option_map v.auth_token_enabled
             (fun f -> ("AuthTokenEnabled", (Boolean.to_json f)));
           Some
             ("GlobalNodeGroups",
               (GlobalNodeGroupList.to_json v.global_node_groups));
           Aws.Util.option_map v.cluster_enabled
             (fun f -> ("ClusterEnabled", (Boolean.to_json f)));
           Some
             ("Members",
               (GlobalReplicationGroupMemberList.to_json v.members));
           Aws.Util.option_map v.engine_version
             (fun f -> ("EngineVersion", (String.to_json f)));
           Aws.Util.option_map v.engine
           ...
           Aws.Util.option_map v.global_replication_group_id
             (fun f -> ("GlobalReplicationGroupId", (String.to_json f)))])
    let of_json j =
      {
        global_replication_group_id =
          (Aws.Util.option_map (Aws.Json.lookup j "GlobalReplicationGroupId")
             String.of_json);
        global_replication_group_description =
          (Aws.Util.option_map
        ...
        cache_node_type =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeType")
             String.of_json);
        engine =
          (Aws.Util.option_map (Aws.Json.lookup j "Engine") String.of_json);
        engine_version =
          (Aws.Util.option_map (Aws.Json.lookup j "EngineVersion")
             String.of_json);
        members =
          (GlobalReplicationGroupMemberList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Members")));
        cluster_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "ClusterEnabled")
             Boolean.of_json);
        global_node_groups =
          (GlobalNodeGroupList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "GlobalNodeGroups")));
        auth_token_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "AuthTokenEnabled")
             Boolean.of_json);
        transit_encryption_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "TransitEncryptionEnabled")
             Boolean.of_json);
        at_rest_encryption_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "AtRestEncryptionEnabled")
             Boolean.of_json);
        a_r_n =
          (Aws.Util.option_map (Aws.Json.lookup j "ARN") String.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          parameter_name =
            (Aws.Util.option_bind (Aws.Xml.member "ParameterName" xml)
               String.parse);
          parameter_value =
            (Aws.Util.option_bind (Aws.Xml.member "ParameterValue" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.parameter_value
              (fun f ->
                 Aws.Query.Pair ("ParameterValue", (String.to_query f)));
           Aws.Util.option_map v.parameter_name
             (fun f -> Aws.Query.Pair ("ParameterName", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.parameter_value
              (fun f -> ("ParameterValue", (String.to_json f)));
           Aws.Util.option_map v.parameter_name
             (fun f -> ("ParameterName", (String.to_json f)))])
    let of_json j =
      {
        parameter_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ParameterName")
             String.of_json);
        parameter_value =
          (Aws.Util.option_map (Aws.Json.lookup j "ParameterValue")
             String.of_json)
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ParameterNameValue.parse
           (Aws.Xml.members "ParameterNameValue" xml))
      ...
      Some
        {
          cache_parameter_group_name =
            (Aws.Xml.required "CacheParameterGroupName"
               (Aws.Util.option_bind
                  (Aws.Xml.member "CacheParameterGroupName" xml) String.parse));
          parameter_name_values =
            (Aws.Xml.required "ParameterNameValues"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        cache_parameter_group_name =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheParameterGroupName")));
        parameter_name_values =
          (ParameterNameValueList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ParameterNameValues")))
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse
           (Aws.Xml.members "PreferredAvailabilityZone" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          node_group_id =
            (Aws.Xml.required "NodeGroupId"
               (Aws.Util.option_bind (Aws.Xml.member "NodeGroupId" xml)
                  String.parse));
          new_replica_count =
            (Aws.Xml.required "NewReplicaCount"
               (Aws.Util.option_bind (Aws.Xml.member "NewReplicaCount" xml)
                  Integer.parse));
          preferred_availability_zones =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("NodeGroupId", (String.to_query v.node_group_id)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
    ...
    let of_json j =
      {
        node_group_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "NodeGroupId")));
        new_replica_count =
          (Integer.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "NewReplicaCount")));
        preferred_availability_zones =
          (PreferredAvailabilityZoneList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "PreferredAvailabilityZones")));
        preferred_outpost_arns =
          (PreferredOutpostArnList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "PreferredOutpostArns")))
      }
  end
      ...
      Some
        {
          ...
          apply_immediately =
            (Aws.Xml.required "ApplyImmediately"
               (Aws.Util.option_bind (Aws.Xml.member "ApplyImmediately" xml)
                  Boolean.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.new_replica_count
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.new_replica_count
             (fun f -> ("NewReplicaCount", (Integer.to_json f)));
           Some
             ("ReplicationGroupId", (String.to_json v.replication_group_id))])
    let of_json j =
      {
        replication_group_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ReplicationGroupId")));
        new_replica_count =
          (Aws.Util.option_map (Aws.Json.lookup j "NewReplicaCount")
             Integer.of_json);
        replica_configuration =
          (ReplicaConfigurationList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ReplicaConfiguration")));
        apply_immediately =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ApplyImmediately")))
      }
  end
module DeleteGlobalReplicationGroupResult =
  struct
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.global_replication_group
              (fun f ->
                 Aws.Query.Pair
    ...
    let of_json j =
      {
        global_replication_group =
          (Aws.Util.option_map (Aws.Json.lookup j "GlobalReplicationGroup")
      ...
      Some
        {
          user_group_ids_to_add =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "UserGroupIdsToAdd" xml)
    ...
    let of_json j =
      {
        ...
        user_group_ids_to_remove =
          (UserGroupIdList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "UserGroupIdsToRemove")))
      }
  end
  ...
  struct
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.progress_percentage
              (fun f -> ("ProgressPercentage", (Double.to_json f)))])
    let of_json j =
      {
        progress_percentage =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          slot_migration =
            (Aws.Util.option_bind (Aws.Xml.member "SlotMigration" xml)
               SlotMigration.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.slot_migration
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.slot_migration
              (fun f -> ("SlotMigration", (SlotMigration.to_json f)))])
    let of_json j =
      {
        slot_migration =
          (Aws.Util.option_map (Aws.Json.lookup j "SlotMigration")
  ...
  struct
    ...
    let parse xml =
      Some
        {
          primary_cluster_id =
            (Aws.Util.option_bind (Aws.Xml.member "PrimaryClusterId" xml)
               String.parse);
          automatic_failover_status =
            (Aws.Util.option_bind
          ...
          resharding =
            (Aws.Util.option_bind (Aws.Xml.member "Resharding" xml)
               ReshardingStatus.parse);
          auth_token_status =
            (Aws.Util.option_bind (Aws.Xml.member "AuthTokenStatus" xml)
               AuthTokenUpdateStatus.parse);
          user_groups =
            (Aws.Util.option_bind (Aws.Xml.member "UserGroups" xml)
               UserGroupsUpdateStatus.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.user_groups
              (fun f ->
                 Aws.Query.Pair
                   ("UserGroups", (UserGroupsUpdateStatus.to_query f)));
           Aws.Util.option_map v.auth_token_status
             (fun f ->
                Aws.Query.Pair
                  ("AuthTokenStatus", (AuthTokenUpdateStatus.to_query f)));
           Aws.Util.option_map v.resharding
             (fun f ->
                Aws.Query.Pair ("Resharding", (ReshardingStatus.to_query f)));
           Aws.Util.option_map v.automatic_failover_status
             (fun f ->
                Aws.Query.Pair
                  ("AutomaticFailoverStatus",
                    (PendingAutomaticFailoverStatus.to_query f)));
           Aws.Util.option_map v.primary_cluster_id
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.user_groups
              (fun f -> ("UserGroups", (UserGroupsUpdateStatus.to_json f)));
           Aws.Util.option_map v.auth_token_status
             (fun f -> ("AuthTokenStatus", (AuthTokenUpdateStatus.to_json f)));
           Aws.Util.option_map v.resharding
           ...
           Aws.Util.option_map v.primary_cluster_id
             (fun f -> ("PrimaryClusterId", (String.to_json f)))])
    let of_json j =
      {
        primary_cluster_id =
          (Aws.Util.option_map (Aws.Json.lookup j "PrimaryClusterId")
             String.of_json);
        automatic_failover_status =
          (Aws.Util.option_map (Aws.Json.lookup j "AutomaticFailoverStatus")
             PendingAutomaticFailoverStatus.of_json);
        resharding =
          (Aws.Util.option_map (Aws.Json.lookup j "Resharding")
             ReshardingStatus.of_json);
        auth_token_status =
          (Aws.Util.option_map (Aws.Json.lookup j "AuthTokenStatus")
             AuthTokenUpdateStatus.of_json);
        user_groups =
          (Aws.Util.option_map (Aws.Json.lookup j "UserGroups")
...
module ReplicationGroupOutpostArnList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse
           (Aws.Xml.members "ReplicationGroupOutpostArn" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
      ...
      Some
        {
          ...
          port =
            (Aws.Util.option_bind (Aws.Xml.member "Port" xml) Integer.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        ...
        port =
          (Aws.Util.option_map (Aws.Json.lookup j "Port") Integer.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          cache_cluster_id =
            (Aws.Util.option_bind (Aws.Xml.member "CacheClusterId" xml)
               String.parse);
          cache_node_id =
            (Aws.Util.option_bind (Aws.Xml.member "CacheNodeId" xml)
               String.parse);
          read_endpoint =
            (Aws.Util.option_bind (Aws.Xml.member "ReadEndpoint" xml)
               Endpoint.parse);
          preferred_availability_zone =
            (Aws.Util.option_bind
               (Aws.Xml.member "PreferredAvailabilityZone" xml) String.parse);
          preferred_outpost_arn =
            (Aws.Util.option_bind (Aws.Xml.member "PreferredOutpostArn" xml)
               String.parse);
          current_role =
            (Aws.Util.option_bind (Aws.Xml.member "CurrentRole" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.current_role
              (fun f -> Aws.Query.Pair ("CurrentRole", (String.to_query f)));
           Aws.Util.option_map v.preferred_outpost_arn
             (fun f ->
                Aws.Query.Pair ("PreferredOutpostArn", (String.to_query f)));
           Aws.Util.option_map v.preferred_availability_zone
             (fun f ->
                Aws.Query.Pair
                  ("PreferredAvailabilityZone", (String.to_query f)));
           Aws.Util.option_map v.read_endpoint
             (fun f -> Aws.Query.Pair ("ReadEndpoint", (Endpoint.to_query f)));
           Aws.Util.option_map v.cache_node_id
             (fun f -> Aws.Query.Pair ("CacheNodeId", (String.to_query f)));
           Aws.Util.option_map v.cache_cluster_id
             (fun f -> Aws.Query.Pair ("CacheClusterId", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.current_role
              (fun f -> ("CurrentRole", (String.to_json f)));
           Aws.Util.option_map v.preferred_outpost_arn
             (fun f -> ("PreferredOutpostArn", (String.to_json f)));
           Aws.Util.option_map v.preferred_availability_zone
             (fun f -> ("PreferredAvailabilityZone", (String.to_json f)));
           Aws.Util.option_map v.read_endpoint
             (fun f -> ("ReadEndpoint", (Endpoint.to_json f)));
           Aws.Util.option_map v.cache_node_id
             (fun f -> ("CacheNodeId", (String.to_json f)));
           Aws.Util.option_map v.cache_cluster_id
             (fun f -> ("CacheClusterId", (String.to_json f)))])
    let of_json j =
      {
        cache_cluster_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheClusterId")
             String.of_json);
        cache_node_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeId")
             String.of_json);
        read_endpoint =
          (Aws.Util.option_map (Aws.Json.lookup j "ReadEndpoint")
             Endpoint.of_json);
        preferred_availability_zone =
          (Aws.Util.option_map
             (Aws.Json.lookup j "PreferredAvailabilityZone") String.of_json);
        preferred_outpost_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "PreferredOutpostArn")
             String.of_json);
        current_role =
          (Aws.Util.option_map (Aws.Json.lookup j "CurrentRole")
             String.of_json)
      }
  end
module NodeGroupMemberList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map NodeGroupMember.parse
           (Aws.Xml.members "NodeGroupMember" xml))
      ...
      Some
        {
          ...
          status =
            (Aws.Util.option_bind (Aws.Xml.member "Status" xml) String.parse);
          primary_endpoint =
            (Aws.Util.option_bind (Aws.Xml.member "PrimaryEndpoint" xml)
               Endpoint.parse);
          reader_endpoint =
            (Aws.Util.option_bind (Aws.Xml.member "ReaderEndpoint" xml)
               Endpoint.parse);
          slots =
            (Aws.Util.option_bind (Aws.Xml.member "Slots" xml) String.parse);
          node_group_members =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "NodeGroupMembers" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.slots
             (fun f -> Aws.Query.Pair ("Slots", (String.to_query f)));
           Aws.Util.option_map v.reader_endpoint
             (fun f ->
                Aws.Query.Pair ("ReaderEndpoint", (Endpoint.to_query f)));
           Aws.Util.option_map v.primary_endpoint
             (fun f ->
                Aws.Query.Pair ("PrimaryEndpoint", (Endpoint.to_query f)));
           Aws.Util.option_map v.status
             (fun f -> Aws.Query.Pair ("Status", (String.to_query f)));
           Aws.Util.option_map v.node_group_id
             (fun f -> Aws.Query.Pair ("NodeGroupId", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
           ...
           Aws.Util.option_map v.slots
             (fun f -> ("Slots", (String.to_json f)));
           Aws.Util.option_map v.reader_endpoint
             (fun f -> ("ReaderEndpoint", (Endpoint.to_json f)));
           Aws.Util.option_map v.primary_endpoint
             (fun f -> ("PrimaryEndpoint", (Endpoint.to_json f)));
           Aws.Util.option_map v.status
             (fun f -> ("Status", (String.to_json f)));
           Aws.Util.option_map v.node_group_id
             (fun f -> ("NodeGroupId", (String.to_json f)))])
    let of_json j =
      {
        node_group_id =
          (Aws.Util.option_map (Aws.Json.lookup j "NodeGroupId")
             String.of_json);
        status =
          (Aws.Util.option_map (Aws.Json.lookup j "Status") String.of_json);
        primary_endpoint =
          (Aws.Util.option_map (Aws.Json.lookup j "PrimaryEndpoint")
             Endpoint.of_json);
        reader_endpoint =
          (Aws.Util.option_map (Aws.Json.lookup j "ReaderEndpoint")
             Endpoint.of_json);
        slots =
          (Aws.Util.option_map (Aws.Json.lookup j "Slots") String.of_json);
        node_group_members =
...
module NodeGroupList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map NodeGroup.parse (Aws.Xml.members "NodeGroup" xml))
...
module GlobalReplicationGroupInfo =
  struct
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.global_replication_group_member_role
              (fun f ->
                 Aws.Query.Pair
...
module ClusterIdList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "ClusterId" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
      ...
      Some
        {
          ...
          member_clusters =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "MemberClusters" xml)
                  ClusterIdList.parse));
          node_groups =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "NodeGroups" xml)
                  NodeGroupList.parse));
          snapshotting_cluster_id =
            (Aws.Util.option_bind
               (Aws.Xml.member "SnapshottingClusterId" xml) String.parse);
          automatic_failover =
            (Aws.Util.option_bind (Aws.Xml.member "AutomaticFailover" xml)
               AutomaticFailoverStatus.parse);
          multi_a_z =
            (Aws.Util.option_bind (Aws.Xml.member "MultiAZ" xml)
               MultiAZStatus.parse);
          configuration_endpoint =
            (Aws.Util.option_bind
               (Aws.Xml.member "ConfigurationEndpoint" xml) Endpoint.parse);
          snapshot_retention_limit =
            (Aws.Util.option_bind
               (Aws.Xml.member "SnapshotRetentionLimit" xml) Integer.parse);
          snapshot_window =
            (Aws.Util.option_bind (Aws.Xml.member "SnapshotWindow" xml)
               String.parse);
          cluster_enabled =
            (Aws.Util.option_bind (Aws.Xml.member "ClusterEnabled" xml)
               Boolean.parse);
          ...
          user_group_ids =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "UserGroupIds" xml)
                  UserGroupIdList.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.transit_encryption_enabled
             (fun f ->
                Aws.Query.Pair
                  ("TransitEncryptionEnabled", (Boolean.to_query f)));
           Aws.Util.option_map v.auth_token_last_modified_date
             (fun f ->
                Aws.Query.Pair
           ...
           Aws.Util.option_map v.cluster_enabled
             (fun f ->
                Aws.Query.Pair ("ClusterEnabled", (Boolean.to_query f)));
           Aws.Util.option_map v.snapshot_window
             (fun f -> Aws.Query.Pair ("SnapshotWindow", (String.to_query f)));
           Aws.Util.option_map v.snapshot_retention_limit
             (fun f ->
                Aws.Query.Pair
                  ("SnapshotRetentionLimit", (Integer.to_query f)));
           Aws.Util.option_map v.configuration_endpoint
             (fun f ->
                Aws.Query.Pair
                  ("ConfigurationEndpoint", (Endpoint.to_query f)));
           Aws.Util.option_map v.multi_a_z
             (fun f -> Aws.Query.Pair ("MultiAZ", (MultiAZStatus.to_query f)));
           Aws.Util.option_map v.automatic_failover
             (fun f ->
                Aws.Query.Pair
                  ("AutomaticFailover", (AutomaticFailoverStatus.to_query f)));
           Aws.Util.option_map v.snapshotting_cluster_id
             (fun f ->
           ...
           Aws.Util.option_map v.pending_modified_values
             (fun f ->
                Aws.Query.Pair
           ...
           Aws.Util.option_map v.status
             (fun f -> Aws.Query.Pair ("Status", (String.to_query f)));
           Aws.Util.option_map v.global_replication_group_info
             (fun f ->
                Aws.Query.Pair
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.transit_encryption_enabled
             (fun f -> ("TransitEncryptionEnabled", (Boolean.to_json f)));
           Aws.Util.option_map v.auth_token_last_modified_date
             (fun f -> ("AuthTokenLastModifiedDate", (DateTime.to_json f)));
           Aws.Util.option_map v.auth_token_enabled
             (fun f -> ("AuthTokenEnabled", (Boolean.to_json f)));
           Aws.Util.option_map v.cache_node_type
             (fun f -> ("CacheNodeType", (String.to_json f)));
           Aws.Util.option_map v.cluster_enabled
             (fun f -> ("ClusterEnabled", (Boolean.to_json f)));
           Aws.Util.option_map v.snapshot_window
             (fun f -> ("SnapshotWindow", (String.to_json f)));
           Aws.Util.option_map v.snapshot_retention_limit
             (fun f -> ("SnapshotRetentionLimit", (Integer.to_json f)));
           Aws.Util.option_map v.configuration_endpoint
             (fun f -> ("ConfigurationEndpoint", (Endpoint.to_json f)));
           Aws.Util.option_map v.multi_a_z
             (fun f -> ("MultiAZ", (MultiAZStatus.to_json f)));
           Aws.Util.option_map v.automatic_failover
             (fun f ->
                ("AutomaticFailover", (AutomaticFailoverStatus.to_json f)));
           Aws.Util.option_map v.snapshotting_cluster_id
             (fun f -> ("SnapshottingClusterId", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        status =
          (Aws.Util.option_map (Aws.Json.lookup j "Status") String.of_json);
        pending_modified_values =
          (Aws.Util.option_map (Aws.Json.lookup j "PendingModifiedValues")
        ...
        node_groups =
          (NodeGroupList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "NodeGroups")));
        snapshotting_cluster_id =
          (Aws.Util.option_map (Aws.Json.lookup j "SnapshottingClusterId")
             String.of_json);
        automatic_failover =
          (Aws.Util.option_map (Aws.Json.lookup j "AutomaticFailover")
             AutomaticFailoverStatus.of_json);
        multi_a_z =
          (Aws.Util.option_map (Aws.Json.lookup j "MultiAZ")
             MultiAZStatus.of_json);
        configuration_endpoint =
          (Aws.Util.option_map (Aws.Json.lookup j "ConfigurationEndpoint")
             Endpoint.of_json);
        snapshot_retention_limit =
          (Aws.Util.option_map (Aws.Json.lookup j "SnapshotRetentionLimit")
             Integer.of_json);
        snapshot_window =
          (Aws.Util.option_map (Aws.Json.lookup j "SnapshotWindow")
             String.of_json);
        cluster_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "ClusterEnabled")
             Boolean.of_json);
        ...
        auth_token_last_modified_date =
          (Aws.Util.option_map
             (Aws.Json.lookup j "AuthTokenLastModifiedDate") DateTime.of_json);
        transit_encryption_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "TransitEncryptionEnabled")
             Boolean.of_json);
        at_rest_encryption_enabled =
        ...
        member_clusters_outpost_arns =
          (ReplicationGroupOutpostArnList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "MemberClustersOutpostArns")));
        kms_key_id =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          replication_group =
            (Aws.Util.option_bind (Aws.Xml.member "ReplicationGroup" xml)
               ReplicationGroup.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.replication_group
              (fun f ->
                 Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.replication_group
              (fun f -> ("ReplicationGroup", (ReplicationGroup.to_json f)))])
    let of_json j =
      {
        replication_group =
          (Aws.Util.option_map (Aws.Json.lookup j "ReplicationGroup")
      ...
      Some
        {
          cache_parameter_group_family =
            (Aws.Xml.required "CacheParameterGroupFamily"
               (Aws.Util.option_bind
                  (Aws.Xml.member "CacheParameterGroupFamily" xml)
                  String.parse));
          max_records =
            (Aws.Util.option_bind (Aws.Xml.member "MaxRecords" xml)
               Integer.parse);
          marker =
            (Aws.Util.option_bind (Aws.Xml.member "Marker" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.marker
              (fun f -> Aws.Query.Pair ("Marker", (String.to_query f)));
           Aws.Util.option_map v.max_records
             (fun f -> Aws.Query.Pair ("MaxRecords", (Integer.to_query f)));
           Some
             (Aws.Query.Pair
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.marker
              (fun f -> ("Marker", (String.to_json f)));
           Aws.Util.option_map v.max_records
             (fun f -> ("MaxRecords", (Integer.to_json f)));
           Some
             ("CacheParameterGroupFamily",
    ...
    let of_json j =
      {
        cache_parameter_group_family =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheParameterGroupFamily")));
        max_records =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxRecords")
             Integer.of_json);
        marker =
          (Aws.Util.option_map (Aws.Json.lookup j "Marker") String.of_json)
      }
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.status
              (fun f -> Aws.Query.Pair ("Status", (String.to_query f)));
           Aws.Util.option_map v.security_group_id
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.status
              (fun f -> ("Status", (String.to_json f)));
           Aws.Util.option_map v.security_group_id
             (fun f -> ("SecurityGroupId", (String.to_json f)))])
    let of_json j =
      {
        security_group_id =
          (Aws.Util.option_map (Aws.Json.lookup j "SecurityGroupId")
             String.of_json);
        status =
          (Aws.Util.option_map (Aws.Json.lookup j "Status") String.of_json)
      }
...
module SecurityGroupMembershipList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map SecurityGroupMembership.parse
           (Aws.Xml.members "member" xml))
    let to_query v =
      Aws.Query.to_query_list SecurityGroupMembership.to_query v
...
module CacheNodeIdsList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "CacheNodeId" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          num_cache_nodes =
            (Aws.Util.option_bind (Aws.Xml.member "NumCacheNodes" xml)
               Integer.parse);
          cache_node_ids_to_remove =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.num_cache_nodes
             (fun f -> Aws.Query.Pair ("NumCacheNodes", (Integer.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.auth_token_status
           ...
           Aws.Util.option_map v.num_cache_nodes
             (fun f -> ("NumCacheNodes", (Integer.to_json f)))])
    let of_json j =
      {
        num_cache_nodes =
          (Aws.Util.option_map (Aws.Json.lookup j "NumCacheNodes")
             Integer.of_json);
        cache_node_ids_to_remove =
          (CacheNodeIdsList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheNodeIdsToRemove")));
        engine_version =
          (Aws.Util.option_map (Aws.Json.lookup j "EngineVersion")
             String.of_json);
        cache_node_type =
  ...
  struct
      ...
      Some
        {
          topic_arn =
            (Aws.Util.option_bind (Aws.Xml.member "TopicArn" xml)
               String.parse);
          topic_status =
            (Aws.Util.option_bind (Aws.Xml.member "TopicStatus" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.topic_status
              (fun f -> Aws.Query.Pair ("TopicStatus", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.topic_status
              (fun f -> ("TopicStatus", (String.to_json f)));
           Aws.Util.option_map v.topic_arn
    ...
    let of_json j =
      {
        ...
        topic_status =
          (Aws.Util.option_map (Aws.Json.lookup j "TopicStatus")
             String.of_json)
      }
  end
      ...
      Some
        {
          cache_security_group_name =
            (Aws.Util.option_bind
               (Aws.Xml.member "CacheSecurityGroupName" xml) String.parse);
          status =
            (Aws.Util.option_bind (Aws.Xml.member "Status" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.status
              (fun f -> Aws.Query.Pair ("Status", (String.to_query f)));
           Aws.Util.option_map v.cache_security_group_name
             (fun f ->
                Aws.Query.Pair
                  ("CacheSecurityGroupName", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.status
              (fun f -> ("Status", (String.to_json f)));
           Aws.Util.option_map v.cache_security_group_name
             (fun f -> ("CacheSecurityGroupName", (String.to_json f)))])
    let of_json j =
      {
        cache_security_group_name =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheSecurityGroupName")
             String.of_json);
        status =
          (Aws.Util.option_map (Aws.Json.lookup j "Status") String.of_json)
      }
...
module CacheSecurityGroupMembershipList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list CacheSecurityGroupMembership.to_query v
      ...
      Some
        {
          cache_parameter_group_name =
            (Aws.Util.option_bind
               (Aws.Xml.member "CacheParameterGroupName" xml) String.parse);
          parameter_apply_status =
            (Aws.Util.option_bind (Aws.Xml.member "ParameterApplyStatus" xml)
               String.parse);
          cache_node_ids_to_reboot =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.parameter_apply_status
             (fun f ->
                Aws.Query.Pair ("ParameterApplyStatus", (String.to_query f)));
           Aws.Util.option_map v.cache_parameter_group_name
             (fun f ->
                Aws.Query.Pair
                  ("CacheParameterGroupName", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
           ...
           Aws.Util.option_map v.parameter_apply_status
             (fun f -> ("ParameterApplyStatus", (String.to_json f)));
           Aws.Util.option_map v.cache_parameter_group_name
             (fun f -> ("CacheParameterGroupName", (String.to_json f)))])
    let of_json j =
      {
        cache_parameter_group_name =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheParameterGroupName")
             String.of_json);
        parameter_apply_status =
          (Aws.Util.option_map (Aws.Json.lookup j "ParameterApplyStatus")
             String.of_json);
        cache_node_ids_to_reboot =
          (CacheNodeIdsList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheNodeIdsToReboot")))
      }
  end
module CacheNode =
  struct
      ...
      Some
        {
          cache_node_id =
            (Aws.Util.option_bind (Aws.Xml.member "CacheNodeId" xml)
               String.parse);
          cache_node_status =
            (Aws.Util.option_bind (Aws.Xml.member "CacheNodeStatus" xml)
               String.parse);
          cache_node_create_time =
            (Aws.Util.option_bind (Aws.Xml.member "CacheNodeCreateTime" xml)
               DateTime.parse);
          endpoint =
            (Aws.Util.option_bind (Aws.Xml.member "Endpoint" xml)
               Endpoint.parse);
          parameter_group_status =
            (Aws.Util.option_bind (Aws.Xml.member "ParameterGroupStatus" xml)
               String.parse);
          source_cache_node_id =
            (Aws.Util.option_bind (Aws.Xml.member "SourceCacheNodeId" xml)
               String.parse);
          customer_availability_zone =
            (Aws.Util.option_bind
               (Aws.Xml.member "CustomerAvailabilityZone" xml) String.parse);
          customer_outpost_arn =
            (Aws.Util.option_bind (Aws.Xml.member "CustomerOutpostArn" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.customer_outpost_arn
              (fun f ->
                 Aws.Query.Pair ("CustomerOutpostArn", (String.to_query f)));
           Aws.Util.option_map v.customer_availability_zone
             (fun f ->
                Aws.Query.Pair
                  ("CustomerAvailabilityZone", (String.to_query f)));
           Aws.Util.option_map v.source_cache_node_id
             (fun f ->
                Aws.Query.Pair ("SourceCacheNodeId", (String.to_query f)));
           Aws.Util.option_map v.parameter_group_status
             (fun f ->
                Aws.Query.Pair ("ParameterGroupStatus", (String.to_query f)));
           Aws.Util.option_map v.endpoint
             (fun f -> Aws.Query.Pair ("Endpoint", (Endpoint.to_query f)));
           Aws.Util.option_map v.cache_node_create_time
             (fun f ->
                Aws.Query.Pair ("CacheNodeCreateTime", (DateTime.to_query f)));
           Aws.Util.option_map v.cache_node_status
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.customer_outpost_arn
              (fun f -> ("CustomerOutpostArn", (String.to_json f)));
           Aws.Util.option_map v.customer_availability_zone
             (fun f -> ("CustomerAvailabilityZone", (String.to_json f)));
           Aws.Util.option_map v.source_cache_node_id
             (fun f -> ("SourceCacheNodeId", (String.to_json f)));
           Aws.Util.option_map v.parameter_group_status
             (fun f -> ("ParameterGroupStatus", (String.to_json f)));
           Aws.Util.option_map v.endpoint
             (fun f -> ("Endpoint", (Endpoint.to_json f)));
           Aws.Util.option_map v.cache_node_create_time
             (fun f -> ("CacheNodeCreateTime", (DateTime.to_json f)));
           Aws.Util.option_map v.cache_node_status
             (fun f -> ("CacheNodeStatus", (String.to_json f)));
           Aws.Util.option_map v.cache_node_id
             (fun f -> ("CacheNodeId", (String.to_json f)))])
    let of_json j =
      {
        cache_node_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeId")
             String.of_json);
        cache_node_status =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeStatus")
             String.of_json);
        cache_node_create_time =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeCreateTime")
             DateTime.of_json);
        endpoint =
          (Aws.Util.option_map (Aws.Json.lookup j "Endpoint")
             Endpoint.of_json);
        parameter_group_status =
          (Aws.Util.option_map (Aws.Json.lookup j "ParameterGroupStatus")
             String.of_json);
        source_cache_node_id =
          (Aws.Util.option_map (Aws.Json.lookup j "SourceCacheNodeId")
             String.of_json);
        customer_availability_zone =
          (Aws.Util.option_map (Aws.Json.lookup j "CustomerAvailabilityZone")
             String.of_json);
        customer_outpost_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "CustomerOutpostArn")
             String.of_json)
      }
  end
module CacheNodeList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map CacheNode.parse (Aws.Xml.members "CacheNode" xml))
      ...
      Some
        {
          ...
          client_download_landing_page =
            (Aws.Util.option_bind
               (Aws.Xml.member "ClientDownloadLandingPage" xml) String.parse);
          cache_node_type =
            (Aws.Util.option_bind (Aws.Xml.member "CacheNodeType" xml)
               String.parse);
          engine =
          ...
          engine_version =
            (Aws.Util.option_bind (Aws.Xml.member "EngineVersion" xml)
               String.parse);
          cache_cluster_status =
            (Aws.Util.option_bind (Aws.Xml.member "CacheClusterStatus" xml)
               String.parse);
          num_cache_nodes =
            (Aws.Util.option_bind (Aws.Xml.member "NumCacheNodes" xml)
               Integer.parse);
          ...
          cache_cluster_create_time =
            (Aws.Util.option_bind
               (Aws.Xml.member "CacheClusterCreateTime" xml) DateTime.parse);
          preferred_maintenance_window =
            (Aws.Util.option_bind
               (Aws.Xml.member "PreferredMaintenanceWindow" xml) String.parse);
          pending_modified_values =
            (Aws.Util.option_bind
               (Aws.Xml.member "PendingModifiedValues" xml)
          ...
          cache_parameter_group =
            (Aws.Util.option_bind (Aws.Xml.member "CacheParameterGroup" xml)
               CacheParameterGroupStatus.parse);
          cache_subnet_group_name =
            (Aws.Util.option_bind (Aws.Xml.member "CacheSubnetGroupName" xml)
               String.parse);
          cache_nodes =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "CacheNodes" xml)
                  CacheNodeList.parse));
          auto_minor_version_upgrade =
            (Aws.Util.option_bind
               (Aws.Xml.member "AutoMinorVersionUpgrade" xml) Boolean.parse);
          security_groups =
            (Aws.Util.of_option []
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.auto_minor_version_upgrade
             (fun f ->
                Aws.Query.Pair
                  ("AutoMinorVersionUpgrade", (Boolean.to_query f)));
           Some
             (Aws.Query.Pair
                ("CacheNodes.member", (CacheNodeList.to_query v.cache_nodes)));
           Aws.Util.option_map v.cache_subnet_group_name
             (fun f ->
                Aws.Query.Pair ("CacheSubnetGroupName", (String.to_query f)));
           Aws.Util.option_map v.cache_parameter_group
             (fun f ->
                Aws.Query.Pair
                  ("CacheParameterGroup",
           ...
           Aws.Util.option_map v.notification_configuration
             (fun f ->
                Aws.Query.Pair
           ...
           Aws.Util.option_map v.preferred_maintenance_window
             (fun f ->
                Aws.Query.Pair
                  ("PreferredMaintenanceWindow", (String.to_query f)));
           Aws.Util.option_map v.cache_cluster_create_time
             (fun f ->
                Aws.Query.Pair
                  ("CacheClusterCreateTime", (DateTime.to_query f)));
           Aws.Util.option_map v.preferred_outpost_arn
             (fun f ->
                Aws.Query.Pair ("PreferredOutpostArn", (String.to_query f)));
           Aws.Util.option_map v.preferred_availability_zone
           ...
           Aws.Util.option_map v.num_cache_nodes
             (fun f -> Aws.Query.Pair ("NumCacheNodes", (Integer.to_query f)));
           Aws.Util.option_map v.cache_cluster_status
             (fun f ->
           ...
           Aws.Util.option_map v.cache_node_type
             (fun f -> Aws.Query.Pair ("CacheNodeType", (String.to_query f)));
           Aws.Util.option_map v.client_download_landing_page
             (fun f ->
                Aws.Query.Pair
                  ("ClientDownloadLandingPage", (String.to_query f)));
           Aws.Util.option_map v.configuration_endpoint
             (fun f ->
                Aws.Query.Pair
                  ("ConfigurationEndpoint", (Endpoint.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.auto_minor_version_upgrade
             (fun f -> ("AutoMinorVersionUpgrade", (Boolean.to_json f)));
           Some ("CacheNodes", (CacheNodeList.to_json v.cache_nodes));
           Aws.Util.option_map v.cache_subnet_group_name
             (fun f -> ("CacheSubnetGroupName", (String.to_json f)));
           Aws.Util.option_map v.cache_parameter_group
             (fun f ->
                ("CacheParameterGroup",
           ...
           Aws.Util.option_map v.preferred_maintenance_window
             (fun f -> ("PreferredMaintenanceWindow", (String.to_json f)));
           Aws.Util.option_map v.cache_cluster_create_time
             (fun f -> ("CacheClusterCreateTime", (DateTime.to_json f)));
           Aws.Util.option_map v.preferred_outpost_arn
             (fun f -> ("PreferredOutpostArn", (String.to_json f)));
           Aws.Util.option_map v.preferred_availability_zone
             (fun f -> ("PreferredAvailabilityZone", (String.to_json f)));
           Aws.Util.option_map v.num_cache_nodes
             (fun f -> ("NumCacheNodes", (Integer.to_json f)));
           Aws.Util.option_map v.cache_cluster_status
             (fun f -> ("CacheClusterStatus", (String.to_json f)));
           Aws.Util.option_map v.engine_version
             (fun f -> ("EngineVersion", (String.to_json f)));
           Aws.Util.option_map v.engine
             (fun f -> ("Engine", (String.to_json f)));
           Aws.Util.option_map v.cache_node_type
             (fun f -> ("CacheNodeType", (String.to_json f)));
           Aws.Util.option_map v.client_download_landing_page
             (fun f -> ("ClientDownloadLandingPage", (String.to_json f)));
           Aws.Util.option_map v.configuration_endpoint
             (fun f -> ("ConfigurationEndpoint", (Endpoint.to_json f)));
           Aws.Util.option_map v.cache_cluster_id
             (fun f -> ("CacheClusterId", (String.to_json f)))])
    let of_json j =
      {
        ...
        client_download_landing_page =
          (Aws.Util.option_map
             (Aws.Json.lookup j "ClientDownloadLandingPage") String.of_json);
        cache_node_type =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeType")
             String.of_json);
        engine =
        ...
        engine_version =
          (Aws.Util.option_map (Aws.Json.lookup j "EngineVersion")
             String.of_json);
        cache_cluster_status =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheClusterStatus")
             String.of_json);
        num_cache_nodes =
          (Aws.Util.option_map (Aws.Json.lookup j "NumCacheNodes")
             Integer.of_json);
        ...
        preferred_outpost_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "PreferredOutpostArn")
             String.of_json);
        cache_cluster_create_time =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheClusterCreateTime")
             DateTime.of_json);
        preferred_maintenance_window =
          (Aws.Util.option_map
             (Aws.Json.lookup j "PreferredMaintenanceWindow") String.of_json);
        pending_modified_values =
          (Aws.Util.option_map (Aws.Json.lookup j "PendingModifiedValues")
        ...
        cache_security_groups =
          (CacheSecurityGroupMembershipList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheSecurityGroups")));
        cache_parameter_group =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheParameterGroup")
             CacheParameterGroupStatus.of_json);
        cache_subnet_group_name =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheSubnetGroupName")
             String.of_json);
        cache_nodes =
          (CacheNodeList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "CacheNodes")));
        auto_minor_version_upgrade =
          (Aws.Util.option_map (Aws.Json.lookup j "AutoMinorVersionUpgrade")
             Boolean.of_json);
        security_groups =
...
module CacheClusterList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map CacheCluster.parse (Aws.Xml.members "CacheCluster" xml))
...
module NodeGroupMemberUpdateStatus =
  struct
      ...
      Some
        {
          ...
          cache_node_id =
            (Aws.Util.option_bind (Aws.Xml.member "CacheNodeId" xml)
               String.parse);
          node_update_status =
            (Aws.Util.option_bind (Aws.Xml.member "NodeUpdateStatus" xml)
               NodeUpdateStatus.parse);
          node_deletion_date =
            (Aws.Util.option_bind (Aws.Xml.member "NodeDeletionDate" xml)
               DateTime.parse);
          node_update_start_date =
            (Aws.Util.option_bind (Aws.Xml.member "NodeUpdateStartDate" xml)
               DateTime.parse);
          node_update_end_date =
            (Aws.Util.option_bind (Aws.Xml.member "NodeUpdateEndDate" xml)
               DateTime.parse);
          node_update_initiated_by =
            (Aws.Util.option_bind
          ...
          node_update_initiated_date =
            (Aws.Util.option_bind
               (Aws.Xml.member "NodeUpdateInitiatedDate" xml) DateTime.parse);
          node_update_status_modified_date =
            (Aws.Util.option_bind
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.node_update_status_modified_date
              (fun f ->
                 Aws.Query.Pair
                   ("NodeUpdateStatusModifiedDate", (DateTime.to_query f)));
           Aws.Util.option_map v.node_update_initiated_date
             (fun f ->
                Aws.Query.Pair
                  ("NodeUpdateInitiatedDate", (DateTime.to_query f)));
           Aws.Util.option_map v.node_update_initiated_by
             (fun f ->
                Aws.Query.Pair
                  ("NodeUpdateInitiatedBy",
                    (NodeUpdateInitiatedBy.to_query f)));
           Aws.Util.option_map v.node_update_end_date
             (fun f ->
                Aws.Query.Pair ("NodeUpdateEndDate", (DateTime.to_query f)));
           Aws.Util.option_map v.node_update_start_date
             (fun f ->
                Aws.Query.Pair ("NodeUpdateStartDate", (DateTime.to_query f)));
           Aws.Util.option_map v.node_deletion_date
             (fun f ->
                Aws.Query.Pair ("NodeDeletionDate", (DateTime.to_query f)));
           Aws.Util.option_map v.node_update_status
             (fun f ->
                Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.node_update_initiated_date
             (fun f -> ("NodeUpdateInitiatedDate", (DateTime.to_json f)));
           Aws.Util.option_map v.node_update_initiated_by
             (fun f ->
                ("NodeUpdateInitiatedBy", (NodeUpdateInitiatedBy.to_json f)));
           Aws.Util.option_map v.node_update_end_date
             (fun f -> ("NodeUpdateEndDate", (DateTime.to_json f)));
           Aws.Util.option_map v.node_update_start_date
             (fun f -> ("NodeUpdateStartDate", (DateTime.to_json f)));
           Aws.Util.option_map v.node_deletion_date
             (fun f -> ("NodeDeletionDate", (DateTime.to_json f)));
           Aws.Util.option_map v.node_update_status
             (fun f -> ("NodeUpdateStatus", (NodeUpdateStatus.to_json f)));
           Aws.Util.option_map v.cache_node_id
             (fun f -> ("CacheNodeId", (String.to_json f)));
           Aws.Util.option_map v.cache_cluster_id
             (fun f -> ("CacheClusterId", (String.to_json f)))])
    let of_json j =
      {
        ...
        cache_node_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeId")
             String.of_json);
        node_update_status =
          (Aws.Util.option_map (Aws.Json.lookup j "NodeUpdateStatus")
             NodeUpdateStatus.of_json);
        node_deletion_date =
          (Aws.Util.option_map (Aws.Json.lookup j "NodeDeletionDate")
             DateTime.of_json);
        node_update_start_date =
          (Aws.Util.option_map (Aws.Json.lookup j "NodeUpdateStartDate")
             DateTime.of_json);
        node_update_end_date =
          (Aws.Util.option_map (Aws.Json.lookup j "NodeUpdateEndDate")
             DateTime.of_json);
        node_update_initiated_by =
          (Aws.Util.option_map (Aws.Json.lookup j "NodeUpdateInitiatedBy")
             NodeUpdateInitiatedBy.of_json);
        node_update_initiated_date =
          (Aws.Util.option_map (Aws.Json.lookup j "NodeUpdateInitiatedDate")
             DateTime.of_json);
        node_update_status_modified_date =
          (Aws.Util.option_map
...
module NodeGroupMemberUpdateStatusList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list NodeGroupMemberUpdateStatus.to_query v
  ...
  struct
    ...
    let parse xml =
      Some
        {
          user_group_id =
            (Aws.Xml.required "UserGroupId"
               (Aws.Util.option_bind (Aws.Xml.member "UserGroupId" xml)
                  String.parse));
          user_ids_to_add =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "UserIdsToAdd" xml)
                  UserIdListInput.parse));
          user_ids_to_remove =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "UserIdsToRemove" xml)
                  UserIdListInput.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("UserGroupId", (String.to_query v.user_group_id)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
    ...
    let of_json j =
      {
        user_group_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "UserGroupId")));
        user_ids_to_add =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          resource_name =
            (Aws.Xml.required "ResourceName"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceName" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("ResourceName", (String.to_query v.resource_name)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        resource_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ResourceName")))
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          reserved_cache_node =
            (Aws.Util.option_bind (Aws.Xml.member "ReservedCacheNode" xml)
               ReservedCacheNode.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.reserved_cache_node
              (fun f ->
                 Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.reserved_cache_node
              (fun f -> ("ReservedCacheNode", (ReservedCacheNode.to_json f)))])
    let of_json j =
      {
        reserved_cache_node =
          (Aws.Util.option_map (Aws.Json.lookup j "ReservedCacheNode")
...
module CacheEngineVersion =
  struct
      ...
      Some
        {
          ...
          cache_parameter_group_family =
            (Aws.Util.option_bind
               (Aws.Xml.member "CacheParameterGroupFamily" xml) String.parse);
          cache_engine_description =
            (Aws.Util.option_bind
               (Aws.Xml.member "CacheEngineDescription" xml) String.parse);
          cache_engine_version_description =
            (Aws.Util.option_bind
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cache_engine_version_description
              (fun f ->
                 Aws.Query.Pair
                   ("CacheEngineVersionDescription", (String.to_query f)));
           Aws.Util.option_map v.cache_engine_description
             (fun f ->
                Aws.Query.Pair
                  ("CacheEngineDescription", (String.to_query f)));
           Aws.Util.option_map v.cache_parameter_group_family
             (fun f ->
                Aws.Query.Pair
                  ("CacheParameterGroupFamily", (String.to_query f)));
           Aws.Util.option_map v.engine_version
             (fun f -> Aws.Query.Pair ("EngineVersion", (String.to_query f)));
           Aws.Util.option_map v.engine
             (fun f -> Aws.Query.Pair ("Engine", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cache_engine_version_description
              (fun f -> ("CacheEngineVersionDescription", (String.to_json f)));
           Aws.Util.option_map v.cache_engine_description
             (fun f -> ("CacheEngineDescription", (String.to_json f)));
           Aws.Util.option_map v.cache_parameter_group_family
             (fun f -> ("CacheParameterGroupFamily", (String.to_json f)));
           Aws.Util.option_map v.engine_version
             (fun f -> ("EngineVersion", (String.to_json f)));
           Aws.Util.option_map v.engine
             (fun f -> ("Engine", (String.to_json f)))])
    let of_json j =
      {
        ...
        cache_parameter_group_family =
          (Aws.Util.option_map
             (Aws.Json.lookup j "CacheParameterGroupFamily") String.of_json);
        cache_engine_description =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheEngineDescription")
             String.of_json);
        cache_engine_version_description =
          (Aws.Util.option_map
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map CacheEngineVersion.parse
           (Aws.Xml.members "CacheEngineVersion" xml))
    ...
    let of_json j =
      {
        ...
        cache_engine_versions =
          (CacheEngineVersionList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheEngineVersions")))
      }
  end
    ...
    let of_json j =
      {
        ...
        node_group_member_update_status =
          (NodeGroupMemberUpdateStatusList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "NodeGroupMemberUpdateStatus")))
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map NodeGroupUpdateStatus.parse
           (Aws.Xml.members "NodeGroupUpdateStatus" xml))
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("Description", (String.to_query v.description)));
           Some
             (Aws.Query.Pair
                ("CacheParameterGroupFamily",
                  (String.to_query v.cache_parameter_group_family)));
...
module CacheNodeTypeSpecificValueList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list CacheNodeTypeSpecificValue.to_query v
  ...
  struct
      ...
      Some
        {
          ...
          data_type =
            (Aws.Util.option_bind (Aws.Xml.member "DataType" xml)
               String.parse);
          allowed_values =
            (Aws.Util.option_bind (Aws.Xml.member "AllowedValues" xml)
               String.parse);
          is_modifiable =
            (Aws.Util.option_bind (Aws.Xml.member "IsModifiable" xml)
               Boolean.parse);
          minimum_engine_version =
            (Aws.Util.option_bind (Aws.Xml.member "MinimumEngineVersion" xml)
               String.parse);
          cache_node_type_specific_values =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
          ...
          change_type =
            (Aws.Util.option_bind (Aws.Xml.member "ChangeType" xml)
               ChangeType.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.change_type
              (fun f ->
           ...
           Aws.Util.option_map v.minimum_engine_version
             (fun f ->
                Aws.Query.Pair ("MinimumEngineVersion", (String.to_query f)));
           Aws.Util.option_map v.is_modifiable
             (fun f -> Aws.Query.Pair ("IsModifiable", (Boolean.to_query f)));
           Aws.Util.option_map v.allowed_values
             (fun f -> Aws.Query.Pair ("AllowedValues", (String.to_query f)));
           Aws.Util.option_map v.data_type
             (fun f -> Aws.Query.Pair ("DataType", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.change_type
              (fun f -> ("ChangeType", (ChangeType.to_json f)));
           Some
             ("CacheNodeTypeSpecificValues",
               (CacheNodeTypeSpecificValueList.to_json
                  v.cache_node_type_specific_values));
           Aws.Util.option_map v.minimum_engine_version
             (fun f -> ("MinimumEngineVersion", (String.to_json f)));
           Aws.Util.option_map v.is_modifiable
             (fun f -> ("IsModifiable", (Boolean.to_json f)));
           Aws.Util.option_map v.allowed_values
             (fun f -> ("AllowedValues", (String.to_json f)));
           Aws.Util.option_map v.data_type
             (fun f -> ("DataType", (String.to_json f)));
           Aws.Util.option_map v.source
    ...
    let of_json j =
      {
        ...
        data_type =
          (Aws.Util.option_map (Aws.Json.lookup j "DataType") String.of_json);
        allowed_values =
          (Aws.Util.option_map (Aws.Json.lookup j "AllowedValues")
             String.of_json);
        is_modifiable =
          (Aws.Util.option_map (Aws.Json.lookup j "IsModifiable")
             Boolean.of_json);
        minimum_engine_version =
          (Aws.Util.option_map (Aws.Json.lookup j "MinimumEngineVersion")
             String.of_json);
        cache_node_type_specific_values =
          (CacheNodeTypeSpecificValueList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheNodeTypeSpecificValues")));
        change_type =
          (Aws.Util.option_map (Aws.Json.lookup j "ChangeType")
             ChangeType.of_json)
      }
  end
module CacheNodeTypeSpecificParametersList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list CacheNodeTypeSpecificParameter.to_query v
...
module ReplicationGroupList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ReplicationGroup.parse
           (Aws.Xml.members "ReplicationGroup" xml))
      ...
      Some
        {
          ...
          replication_groups =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ReplicationGroups" xml)
          ...
          resource_name =
            (Aws.Xml.required "ResourceName"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceName" xml)
                  String.parse));
          tag_keys =
            (Aws.Xml.required "TagKeys"
               (Aws.Util.option_bind (Aws.Xml.member "TagKeys" xml)
                  KeyList.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("TagKeys.member", (KeyList.to_query v.tag_keys)));
           Some
             (Aws.Query.Pair
                ("ResourceName", (String.to_query v.resource_name)))])
    let to_json v =
    ...
    let of_json j =
      {
        ...
        tag_keys =
          (KeyList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TagKeys")))
      }
  end
  ...
  struct
      ...
      Some
        {
          ...
          cache_cluster_id =
            (Aws.Util.option_bind (Aws.Xml.member "CacheClusterId" xml)
               String.parse);
          service_update_name =
            (Aws.Util.option_bind (Aws.Xml.member "ServiceUpdateName" xml)
               String.parse);
          error_type =
            (Aws.Util.option_bind (Aws.Xml.member "ErrorType" xml)
               String.parse);
          error_message =
            (Aws.Util.option_bind (Aws.Xml.member "ErrorMessage" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.error_message
              (fun f -> Aws.Query.Pair ("ErrorMessage", (String.to_query f)));
           Aws.Util.option_map v.error_type
             (fun f -> Aws.Query.Pair ("ErrorType", (String.to_query f)));
           Aws.Util.option_map v.service_update_name
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.error_message
              (fun f -> ("ErrorMessage", (String.to_json f)));
           Aws.Util.option_map v.error_type
             (fun f -> ("ErrorType", (String.to_json f)));
           Aws.Util.option_map v.service_update_name
             (fun f -> ("ServiceUpdateName", (String.to_json f)));
           Aws.Util.option_map v.cache_cluster_id
             (fun f -> ("CacheClusterId", (String.to_json f)));
           Aws.Util.option_map v.replication_group_id
             (fun f -> ("ReplicationGroupId", (String.to_json f)))])
    let of_json j =
      {
        ...
        cache_cluster_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheClusterId")
             String.of_json);
        service_update_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateName")
             String.of_json);
        error_type =
          (Aws.Util.option_map (Aws.Json.lookup j "ErrorType") String.of_json);
        error_message =
          (Aws.Util.option_map (Aws.Json.lookup j "ErrorMessage")
             String.of_json)
      }
  end
module UnprocessedUpdateActionList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list UnprocessedUpdateAction.to_query v
      ...
      Some
        {
          ...
          service_update_name =
            (Aws.Util.option_bind (Aws.Xml.member "ServiceUpdateName" xml)
               String.parse);
          update_action_status =
            (Aws.Util.option_bind (Aws.Xml.member "UpdateActionStatus" xml)
               UpdateActionStatus.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.update_action_status
              (fun f ->
                 Aws.Query.Pair
    ...
    let of_json j =
      {
        ...
        service_update_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateName")
             String.of_json);
        update_action_status =
          (Aws.Util.option_map (Aws.Json.lookup j "UpdateActionStatus")
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ProcessedUpdateAction.parse
           (Aws.Xml.members "ProcessedUpdateAction" xml))
    ...
    let of_json j =
      {
        processed_update_actions =
          (ProcessedUpdateActionList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ProcessedUpdateActions")));
        unprocessed_update_actions =
          (UnprocessedUpdateActionList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "UnprocessedUpdateActions")))
      }
  end
module OutpostArnsList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "OutpostArn" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
module AvailabilityZonesList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "AvailabilityZone" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
      ...
      Some
        {
          ...
          slots =
            (Aws.Util.option_bind (Aws.Xml.member "Slots" xml) String.parse);
          replica_count =
            (Aws.Util.option_bind (Aws.Xml.member "ReplicaCount" xml)
               Integer.parse);
          primary_availability_zone =
            (Aws.Util.option_bind
               (Aws.Xml.member "PrimaryAvailabilityZone" xml) String.parse);
          replica_availability_zones =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
          ...
          primary_outpost_arn =
            (Aws.Util.option_bind (Aws.Xml.member "PrimaryOutpostArn" xml)
               String.parse);
          replica_outpost_arns =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.primary_outpost_arn
             (fun f ->
           ...
           Aws.Util.option_map v.primary_availability_zone
             (fun f ->
                Aws.Query.Pair
                  ("PrimaryAvailabilityZone", (String.to_query f)));
           Aws.Util.option_map v.replica_count
             (fun f -> Aws.Query.Pair ("ReplicaCount", (Integer.to_query f)));
           Aws.Util.option_map v.slots
             (fun f -> Aws.Query.Pair ("Slots", (String.to_query f)));
           Aws.Util.option_map v.node_group_id
             (fun f -> Aws.Query.Pair ("NodeGroupId", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.primary_outpost_arn
             (fun f -> ("PrimaryOutpostArn", (String.to_json f)));
           Some
             ("ReplicaAvailabilityZones",
               (AvailabilityZonesList.to_json v.replica_availability_zones));
           Aws.Util.option_map v.primary_availability_zone
             (fun f -> ("PrimaryAvailabilityZone", (String.to_json f)));
           Aws.Util.option_map v.replica_count
             (fun f -> ("ReplicaCount", (Integer.to_json f)));
           Aws.Util.option_map v.slots
             (fun f -> ("Slots", (String.to_json f)));
           Aws.Util.option_map v.node_group_id
             (fun f -> ("NodeGroupId", (String.to_json f)))])
    let of_json j =
      {
        ...
        slots =
          (Aws.Util.option_map (Aws.Json.lookup j "Slots") String.of_json);
        replica_count =
          (Aws.Util.option_map (Aws.Json.lookup j "ReplicaCount")
             Integer.of_json);
        primary_availability_zone =
          (Aws.Util.option_map (Aws.Json.lookup j "PrimaryAvailabilityZone")
             String.of_json);
        replica_availability_zones =
          (AvailabilityZonesList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ReplicaAvailabilityZones")));
        primary_outpost_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "PrimaryOutpostArn")
             String.of_json);
        replica_outpost_arns =
  ...
  struct
      ...
      Some
        {
          ...
          cache_size =
            (Aws.Util.option_bind (Aws.Xml.member "CacheSize" xml)
               String.parse);
          cache_node_create_time =
            (Aws.Util.option_bind (Aws.Xml.member "CacheNodeCreateTime" xml)
               DateTime.parse);
          snapshot_create_time =
            (Aws.Util.option_bind (Aws.Xml.member "SnapshotCreateTime" xml)
               DateTime.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.snapshot_create_time
              (fun f ->
                 Aws.Query.Pair ("SnapshotCreateTime", (DateTime.to_query f)));
           Aws.Util.option_map v.cache_node_create_time
             (fun f ->
                Aws.Query.Pair ("CacheNodeCreateTime", (DateTime.to_query f)));
           Aws.Util.option_map v.cache_size
             (fun f -> Aws.Query.Pair ("CacheSize", (String.to_query f)));
           Aws.Util.option_map v.node_group_configuration
             (fun f ->
                Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.snapshot_create_time
              (fun f -> ("SnapshotCreateTime", (DateTime.to_json f)));
           Aws.Util.option_map v.cache_node_create_time
             (fun f -> ("CacheNodeCreateTime", (DateTime.to_json f)));
           Aws.Util.option_map v.cache_size
             (fun f -> ("CacheSize", (String.to_json f)));
           Aws.Util.option_map v.node_group_configuration
             (fun f ->
                ("NodeGroupConfiguration",
    ...
    let of_json j =
      {
        ...
        cache_node_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeId")
             String.of_json);
        node_group_configuration =
          (Aws.Util.option_map (Aws.Json.lookup j "NodeGroupConfiguration")
             NodeGroupConfiguration.of_json);
        cache_size =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheSize") String.of_json);
        cache_node_create_time =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeCreateTime")
             DateTime.of_json);
        snapshot_create_time =
          (Aws.Util.option_map (Aws.Json.lookup j "SnapshotCreateTime")
             DateTime.of_json)
      }
  end
module NodeSnapshotList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map NodeSnapshot.parse (Aws.Xml.members "NodeSnapshot" xml))
  ...
  struct
      ...
      Some
        {
          ...
          marker =
            (Aws.Util.option_bind (Aws.Xml.member "Marker" xml) String.parse);
          default_only =
            (Aws.Util.option_bind (Aws.Xml.member "DefaultOnly" xml)
               Boolean.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.default_only
              (fun f -> Aws.Query.Pair ("DefaultOnly", (Boolean.to_query f)));
           Aws.Util.option_map v.marker
             (fun f -> Aws.Query.Pair ("Marker", (String.to_query f)));
           Aws.Util.option_map v.max_records
             (fun f -> Aws.Query.Pair ("MaxRecords", (Integer.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.default_only
              (fun f -> ("DefaultOnly", (Boolean.to_json f)));
           Aws.Util.option_map v.marker
             (fun f -> ("Marker", (String.to_json f)));
           Aws.Util.option_map v.max_records
             (fun f -> ("MaxRecords", (Integer.to_json f)));
    ...
    let of_json j =
      {
        ...
        marker =
          (Aws.Util.option_map (Aws.Json.lookup j "Marker") String.of_json);
        default_only =
          (Aws.Util.option_map (Aws.Json.lookup j "DefaultOnly")
             Boolean.of_json)
      }
  end
module SubnetIdentifierList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "SubnetIdentifier" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
...
module SnapshotArnsList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "SnapshotArn" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
module SecurityGroupIdsList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "SecurityGroupId" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          cache_cluster_id =
            (Aws.Xml.required "CacheClusterId"
               (Aws.Util.option_bind (Aws.Xml.member "CacheClusterId" xml)
                  String.parse));
          replication_group_id =
            (Aws.Util.option_bind (Aws.Xml.member "ReplicationGroupId" xml)
               String.parse);
          a_z_mode =
            (Aws.Util.option_bind (Aws.Xml.member "AZMode" xml) AZMode.parse);
          preferred_availability_zone =
            (Aws.Util.option_bind
               (Aws.Xml.member "PreferredAvailabilityZone" xml) String.parse);
          preferred_availability_zones =
          ...
          tags =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Tags" xml)
                  TagList.parse));
          snapshot_arns =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "SnapshotArns" xml)
                  SnapshotArnsList.parse));
          snapshot_name =
            (Aws.Util.option_bind (Aws.Xml.member "SnapshotName" xml)
               String.parse);
          preferred_maintenance_window =
            (Aws.Util.option_bind
               (Aws.Xml.member "PreferredMaintenanceWindow" xml) String.parse);
          port =
            (Aws.Util.option_bind (Aws.Xml.member "Port" xml) Integer.parse);
          notification_topic_arn =
            (Aws.Util.option_bind (Aws.Xml.member "NotificationTopicArn" xml)
               String.parse);
          auto_minor_version_upgrade =
            (Aws.Util.option_bind
               (Aws.Xml.member "AutoMinorVersionUpgrade" xml) Boolean.parse);
          ...
          snapshot_window =
            (Aws.Util.option_bind (Aws.Xml.member "SnapshotWindow" xml)
               String.parse);
          auth_token =
            (Aws.Util.option_bind (Aws.Xml.member "AuthToken" xml)
               String.parse);
          outpost_mode =
            (Aws.Util.option_bind (Aws.Xml.member "OutpostMode" xml)
               OutpostMode.parse);
          preferred_outpost_arn =
            (Aws.Util.option_bind (Aws.Xml.member "PreferredOutpostArn" xml)
               String.parse);
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.preferred_outpost_arn
             (fun f ->
                Aws.Query.Pair ("PreferredOutpostArn", (String.to_query f)));
           Aws.Util.option_map v.outpost_mode
             (fun f ->
                Aws.Query.Pair ("OutpostMode", (OutpostMode.to_query f)));
           Aws.Util.option_map v.auth_token
             (fun f -> Aws.Query.Pair ("AuthToken", (String.to_query f)));
           Aws.Util.option_map v.snapshot_window
             (fun f -> Aws.Query.Pair ("SnapshotWindow", (String.to_query f)));
           Aws.Util.option_map v.snapshot_retention_limit
             (fun f ->
           ...
           Aws.Util.option_map v.auto_minor_version_upgrade
             (fun f ->
                Aws.Query.Pair
                  ("AutoMinorVersionUpgrade", (Boolean.to_query f)));
           Aws.Util.option_map v.notification_topic_arn
             (fun f ->
           ...
           Aws.Util.option_map v.preferred_maintenance_window
             (fun f ->
                Aws.Query.Pair
                  ("PreferredMaintenanceWindow", (String.to_query f)));
           Aws.Util.option_map v.snapshot_name
             (fun f -> Aws.Query.Pair ("SnapshotName", (String.to_query f)));
           Some
             (Aws.Query.Pair
                ("SnapshotArns.member",
           ...
           Aws.Util.option_map v.preferred_availability_zone
             (fun f ->
                Aws.Query.Pair
                  ("PreferredAvailabilityZone", (String.to_query f)));
           Aws.Util.option_map v.a_z_mode
             (fun f -> Aws.Query.Pair ("AZMode", (AZMode.to_query f)));
           Aws.Util.option_map v.replication_group_id
             (fun f ->
                Aws.Query.Pair ("ReplicationGroupId", (String.to_query f)));
           Some
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.preferred_outpost_arn
             (fun f -> ("PreferredOutpostArn", (String.to_json f)));
           Aws.Util.option_map v.outpost_mode
             (fun f -> ("OutpostMode", (OutpostMode.to_json f)));
           Aws.Util.option_map v.auth_token
             (fun f -> ("AuthToken", (String.to_json f)));
           Aws.Util.option_map v.snapshot_window
             (fun f -> ("SnapshotWindow", (String.to_json f)));
           Aws.Util.option_map v.snapshot_retention_limit
             (fun f -> ("SnapshotRetentionLimit", (Integer.to_json f)));
           Aws.Util.option_map v.auto_minor_version_upgrade
             (fun f -> ("AutoMinorVersionUpgrade", (Boolean.to_json f)));
           Aws.Util.option_map v.notification_topic_arn
             (fun f -> ("NotificationTopicArn", (String.to_json f)));
           Aws.Util.option_map v.port
             (fun f -> ("Port", (Integer.to_json f)));
           Aws.Util.option_map v.preferred_maintenance_window
             (fun f -> ("PreferredMaintenanceWindow", (String.to_json f)));
           Aws.Util.option_map v.snapshot_name
             (fun f -> ("SnapshotName", (String.to_json f)));
    ...
    let of_json j =
      {
        cache_cluster_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "CacheClusterId")));
        replication_group_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ReplicationGroupId")
             String.of_json);
        a_z_mode =
          (Aws.Util.option_map (Aws.Json.lookup j "AZMode") AZMode.of_json);
        preferred_availability_zone =
          (Aws.Util.option_map
             (Aws.Json.lookup j "PreferredAvailabilityZone") String.of_json);
        preferred_availability_zones =
        ...
        port =
          (Aws.Util.option_map (Aws.Json.lookup j "Port") Integer.of_json);
        notification_topic_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "NotificationTopicArn")
             String.of_json);
        auto_minor_version_upgrade =
          (Aws.Util.option_map (Aws.Json.lookup j "AutoMinorVersionUpgrade")
             Boolean.of_json);
        ...
        snapshot_window =
          (Aws.Util.option_map (Aws.Json.lookup j "SnapshotWindow")
             String.of_json);
        auth_token =
          (Aws.Util.option_map (Aws.Json.lookup j "AuthToken") String.of_json);
        outpost_mode =
          (Aws.Util.option_map (Aws.Json.lookup j "OutpostMode")
             OutpostMode.of_json);
        preferred_outpost_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "PreferredOutpostArn")
             String.of_json);
      ...
      Some
        {
          ...
          cache_cluster_id =
            (Aws.Util.option_bind (Aws.Xml.member "CacheClusterId" xml)
               String.parse);
          snapshot_status =
            (Aws.Util.option_bind (Aws.Xml.member "SnapshotStatus" xml)
               String.parse);
          snapshot_source =
            (Aws.Util.option_bind (Aws.Xml.member "SnapshotSource" xml)
               String.parse);
          cache_node_type =
            (Aws.Util.option_bind (Aws.Xml.member "CacheNodeType" xml)
               String.parse);
          ...
          snapshot_window =
            (Aws.Util.option_bind (Aws.Xml.member "SnapshotWindow" xml)
               String.parse);
          num_node_groups =
            (Aws.Util.option_bind (Aws.Xml.member "NumNodeGroups" xml)
               Integer.parse);
          automatic_failover =
            (Aws.Util.option_bind (Aws.Xml.member "AutomaticFailover" xml)
               AutomaticFailoverStatus.parse);
          node_snapshots =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "NodeSnapshots" xml)
        ...
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.automatic_failover
             (fun f ->
                Aws.Query.Pair
                  ("AutomaticFailover", (AutomaticFailoverStatus.to_query f)));
           Aws.Util.option_map v.num_node_groups
             (fun f -> Aws.Query.Pair ("NumNodeGroups", (Integer.to_query f)));
           Aws.Util.option_map v.snapshot_window
             (fun f -> Aws.Query.Pair ("SnapshotWindow", (String.to_query f)));
           Aws.Util.option_map v.snapshot_retention_limit
             (fun f ->
           ...
           Aws.Util.option_map v.cache_node_type
             (fun f -> Aws.Query.Pair ("CacheNodeType", (String.to_query f)));
           Aws.Util.option_map v.snapshot_source
             (fun f -> Aws.Query.Pair ("SnapshotSource", (String.to_query f)));
           Aws.Util.option_map v.snapshot_status
             (fun f -> Aws.Query.Pair ("SnapshotStatus", (String.to_query f)));
           Aws.Util.option_map v.cache_cluster_id
             (fun f -> Aws.Query.Pair ("CacheClusterId", (String.to_query f)));
           Aws.Util.option_map v.replication_group_description
             (fun f ->
                Aws.Query.Pair
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.kms_key_id
             (fun f -> ("KmsKeyId", (String.to_json f)));
           Some
             ("NodeSnapshots", (NodeSnapshotList.to_json v.node_snapshots));
           Aws.Util.option_map v.automatic_failover
             (fun f ->
                ("AutomaticFailover", (AutomaticFailoverStatus.to_json f)));
           Aws.Util.option_map v.num_node_groups
             (fun f -> ("NumNodeGroups", (Integer.to_json f)));
           Aws.Util.option_map v.snapshot_window
             (fun f -> ("SnapshotWindow", (String.to_json f)));
           Aws.Util.option_map v.snapshot_retention_limit
             (fun f -> ("SnapshotRetentionLimit", (Integer.to_json f)));
           ...
           Aws.Util.option_map v.cache_node_type
             (fun f -> ("CacheNodeType", (String.to_json f)));
           Aws.Util.option_map v.snapshot_source
             (fun f -> ("SnapshotSource", (String.to_json f)));
           Aws.Util.option_map v.snapshot_status
             (fun f -> ("SnapshotStatus", (String.to_json f)));
           Aws.Util.option_map v.cache_cluster_id
             (fun f -> ("CacheClusterId", (String.to_json f)));
           Aws.Util.option_map v.replication_group_description
             (fun f -> ("ReplicationGroupDescription", (String.to_json f)));
           Aws.Util.option_map v.replication_group_id
             (fun f -> ("ReplicationGroupId", (String.to_json f)));
           Aws.Util.option_map v.snapshot_name
             (fun f -> ("SnapshotName", (String.to_json f)))])
    let of_json j =
      {
        ...
        replication_group_description =
          (Aws.Util.option_map
             (Aws.Json.lookup j "ReplicationGroupDescription") String.of_json);
        cache_cluster_id =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheClusterId")
             String.of_json);
        snapshot_status =
          (Aws.Util.option_map (Aws.Json.lookup j "SnapshotStatus")
             String.of_json);
        snapshot_source =
          (Aws.Util.option_map (Aws.Json.lookup j "SnapshotSource")
             String.of_json);
        cache_node_type =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeType")
             String.of_json);
        ...
        cache_subnet_group_name =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheSubnetGroupName")
             String.of_json);
        vpc_id =
          (Aws.Util.option_map (Aws.Json.lookup j "VpcId") String.of_json);
        auto_minor_version_upgrade =
          (Aws.Util.option_map (Aws.Json.lookup j "AutoMinorVersionUpgrade")
             Boolean.of_json);
        snapshot_retention_limit =
        ...
        snapshot_window =
          (Aws.Util.option_map (Aws.Json.lookup j "SnapshotWindow")
             String.of_json);
        num_node_groups =
          (Aws.Util.option_map (Aws.Json.lookup j "NumNodeGroups")
             Integer.of_json);
        automatic_failover =
          (Aws.Util.option_map (Aws.Json.lookup j "AutomaticFailover")
             AutomaticFailoverStatus.of_json);
  ...
  struct
    ...
    let parse xml =
      Some
        {
          snapshot =
            (Aws.Util.option_bind (Aws.Xml.member "Snapshot" xml)
               Snapshot.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.snapshot
              (fun f -> Aws.Query.Pair ("Snapshot", (Snapshot.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.snapshot
    ...
    let of_json j =
      {
        snapshot =
          (Aws.Util.option_map (Aws.Json.lookup j "Snapshot")
             Snapshot.of_json)
      }
  end
      ...
      Some
        {
          source_snapshot_name =
            (Aws.Xml.required "SourceSnapshotName"
               (Aws.Util.option_bind
                  (Aws.Xml.member "SourceSnapshotName" xml) String.parse));
          target_snapshot_name =
            (Aws.Xml.required "TargetSnapshotName"
               (Aws.Util.option_bind
                  (Aws.Xml.member "TargetSnapshotName" xml) String.parse));
          target_bucket =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.kms_key_id
              (fun f -> Aws.Query.Pair ("KmsKeyId", (String.to_query f)));
           Aws.Util.option_map v.target_bucket
             (fun f -> Aws.Query.Pair ("TargetBucket", (String.to_query f)));
           Some
             (Aws.Query.Pair
                ("TargetSnapshotName",
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.kms_key_id
              (fun f -> ("KmsKeyId", (String.to_json f)));
           Aws.Util.option_map v.target_bucket
             (fun f -> ("TargetBucket", (String.to_json f)));
           Some
             ("TargetSnapshotName", (String.to_json v.target_snapshot_name));
           Some
             ("SourceSnapshotName", (String.to_json v.source_snapshot_name))])
    let of_json j =
      {
        source_snapshot_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "SourceSnapshotName")));
        target_snapshot_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TargetSnapshotName")));
        target_bucket =
          (Aws.Util.option_map (Aws.Json.lookup j "TargetBucket")
             String.of_json);
        kms_key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KmsKeyId") String.of_json)
      }
  ...
  struct
    ...
    let parse xml =
      Some
        {
          subnet_outpost_arn =
            (Aws.Util.option_bind (Aws.Xml.member "SubnetOutpostArn" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.subnet_outpost_arn
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.subnet_outpost_arn
              (fun f -> ("SubnetOutpostArn", (String.to_json f)))])
    let of_json j =
      {
        subnet_outpost_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "SubnetOutpostArn")
             String.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          subnet_identifier =
            (Aws.Util.option_bind (Aws.Xml.member "SubnetIdentifier" xml)
               String.parse);
          ...
          subnet_outpost =
            (Aws.Util.option_bind (Aws.Xml.member "SubnetOutpost" xml)
               SubnetOutpost.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.subnet_outpost
              (fun f ->
                 Aws.Query.Pair ("SubnetOutpost", (SubnetOutpost.to_query f)));
           Aws.Util.option_map v.subnet_availability_zone
             (fun f ->
                Aws.Query.Pair
                  ("SubnetAvailabilityZone", (AvailabilityZone.to_query f)));
           Aws.Util.option_map v.subnet_identifier
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.subnet_outpost
              (fun f -> ("SubnetOutpost", (SubnetOutpost.to_json f)));
           Aws.Util.option_map v.subnet_availability_zone
             (fun f ->
                ("SubnetAvailabilityZone", (AvailabilityZone.to_json f)));
           Aws.Util.option_map v.subnet_identifier
             (fun f -> ("SubnetIdentifier", (String.to_json f)))])
    let of_json j =
      {
        subnet_identifier =
          (Aws.Util.option_map (Aws.Json.lookup j "SubnetIdentifier")
             String.of_json);
        subnet_availability_zone =
          (Aws.Util.option_map (Aws.Json.lookup j "SubnetAvailabilityZone")
             AvailabilityZone.of_json);
        subnet_outpost =
          (Aws.Util.option_map (Aws.Json.lookup j "SubnetOutpost")
...
module SubnetList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Subnet.parse (Aws.Xml.members "Subnet" xml))
      ...
      Some
        {
          ...
          subnets =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Subnets" xml)
                  SubnetList.parse));
          a_r_n =
            (Aws.Util.option_bind (Aws.Xml.member "ARN" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("Subnets.member", (SubnetList.to_query v.subnets)));
           Aws.Util.option_map v.vpc_id
             (fun f -> Aws.Query.Pair ("VpcId", (String.to_query f)));
           Aws.Util.option_map v.cache_subnet_group_description
             (fun f ->
                Aws.Query.Pair
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.vpc_id
             (fun f -> ("VpcId", (String.to_json f)));
           Aws.Util.option_map v.cache_subnet_group_description
             (fun f -> ("CacheSubnetGroupDescription", (String.to_json f)));
           Aws.Util.option_map v.cache_subnet_group_name
             (fun f -> ("CacheSubnetGroupName", (String.to_json f)))])
    let of_json j =
      {
        ...
        cache_subnet_group_description =
          (Aws.Util.option_map
             (Aws.Json.lookup j "CacheSubnetGroupDescription") String.of_json);
        vpc_id =
          (Aws.Util.option_map (Aws.Json.lookup j "VpcId") String.of_json);
        subnets =
          (SubnetList.of_json
...
module CacheSubnetGroups =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map CacheSubnetGroup.parse
           (Aws.Xml.members "CacheSubnetGroup" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          source_identifier =
            (Aws.Util.option_bind (Aws.Xml.member "SourceIdentifier" xml)
               String.parse);
          source_type =
            (Aws.Util.option_bind (Aws.Xml.member "SourceType" xml)
               SourceType.parse);
          message =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.source_type
             (fun f -> Aws.Query.Pair ("SourceType", (SourceType.to_query f)));
           Aws.Util.option_map v.source_identifier
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.source_type
             (fun f -> ("SourceType", (SourceType.to_json f)));
           Aws.Util.option_map v.source_identifier
             (fun f -> ("SourceIdentifier", (String.to_json f)))])
    let of_json j =
      {
        source_identifier =
          (Aws.Util.option_map (Aws.Json.lookup j "SourceIdentifier")
             String.of_json);
        source_type =
          (Aws.Util.option_map (Aws.Json.lookup j "SourceType")
             SourceType.of_json);
        message =
...
module EventList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Event.parse (Aws.Xml.members "Event" xml))
      ...
      Some
        {
          ...
          events =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Events" xml)
                  EventList.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("Events.member", (EventList.to_query v.events)));
           Aws.Util.option_map v.marker
             (fun f -> Aws.Query.Pair ("Marker", (String.to_query f)))])
    let to_json v =
      `Assoc
    ...
    let of_json j =
      {
        ...
        events =
          (EventList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Events")))
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          cache_security_group_name =
            (Aws.Xml.required "CacheSecurityGroupName"
               (Aws.Util.option_bind
                  (Aws.Xml.member "CacheSecurityGroupName" xml) String.parse))
        }
    let to_query v =
    ...
    let of_json j =
      {
        cache_security_group_name =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheSecurityGroupName")))
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map CacheNodeUpdateStatus.parse
           (Aws.Xml.members "CacheNodeUpdateStatus" xml))
      ...
      Some
        {
          ...
          service_update_release_date =
            (Aws.Util.option_bind
               (Aws.Xml.member "ServiceUpdateReleaseDate" xml) DateTime.parse);
          service_update_severity =
            (Aws.Util.option_bind
               (Aws.Xml.member "ServiceUpdateSeverity" xml)
               ServiceUpdateSeverity.parse);
          service_update_status =
            (Aws.Util.option_bind (Aws.Xml.member "ServiceUpdateStatus" xml)
          ...
          service_update_recommended_apply_by_date =
            (Aws.Util.option_bind
               ...
               DateTime.parse);
          service_update_type =
            (Aws.Util.option_bind (Aws.Xml.member "ServiceUpdateType" xml)
          ...
          update_action_status =
            (Aws.Util.option_bind (Aws.Xml.member "UpdateActionStatus" xml)
               UpdateActionStatus.parse);
          nodes_updated =
            (Aws.Util.option_bind (Aws.Xml.member "NodesUpdated" xml)
               String.parse);
          update_action_status_modified_date =
            (Aws.Util.option_bind
               ...
               DateTime.parse);
          sla_met =
            (Aws.Util.option_bind (Aws.Xml.member "SlaMet" xml) SlaMet.parse);
          node_group_update_status =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
          ...
          estimated_update_time =
            (Aws.Util.option_bind (Aws.Xml.member "EstimatedUpdateTime" xml)
               String.parse);
          engine =
            (Aws.Util.option_bind (Aws.Xml.member "Engine" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.engine
              (fun f -> Aws.Query.Pair ("Engine", (String.to_query f)));
           Aws.Util.option_map v.estimated_update_time
             (fun f ->
           ...
           Aws.Util.option_map v.sla_met
             (fun f -> Aws.Query.Pair ("SlaMet", (SlaMet.to_query f)));
           Aws.Util.option_map v.update_action_status_modified_date
             (fun f ->
                Aws.Query.Pair
                  ("UpdateActionStatusModifiedDate", (DateTime.to_query f)));
           Aws.Util.option_map v.nodes_updated
             (fun f -> Aws.Query.Pair ("NodesUpdated", (String.to_query f)));
           Aws.Util.option_map v.update_action_status
             (fun f ->
                Aws.Query.Pair
                  ("UpdateActionStatus", (UpdateActionStatus.to_query f)));
           Aws.Util.option_map v.update_action_available_date
             (fun f ->
                Aws.Query.Pair
                  ("UpdateActionAvailableDate", (DateTime.to_query f)));
           Aws.Util.option_map v.service_update_type
             (fun f ->
                Aws.Query.Pair
                  ("ServiceUpdateType", (ServiceUpdateType.to_query f)));
           Aws.Util.option_map v.service_update_recommended_apply_by_date
             (fun f ->
                Aws.Query.Pair
                  ("ServiceUpdateRecommendedApplyByDate",
                    (DateTime.to_query f)));
           Aws.Util.option_map v.service_update_status
             (fun f ->
                Aws.Query.Pair
                  ("ServiceUpdateStatus", (ServiceUpdateStatus.to_query f)));
           Aws.Util.option_map v.service_update_severity
             (fun f ->
                Aws.Query.Pair
                  ("ServiceUpdateSeverity",
                    (ServiceUpdateSeverity.to_query f)));
           Aws.Util.option_map v.service_update_release_date
             (fun f ->
                Aws.Query.Pair
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.engine
              (fun f -> ("Engine", (String.to_json f)));
           Aws.Util.option_map v.estimated_update_time
             (fun f -> ("EstimatedUpdateTime", (String.to_json f)));
           Some
           ...
           Aws.Util.option_map v.sla_met
             (fun f -> ("SlaMet", (SlaMet.to_json f)));
           Aws.Util.option_map v.update_action_status_modified_date
             (fun f ->
                ("UpdateActionStatusModifiedDate", (DateTime.to_json f)));
           Aws.Util.option_map v.nodes_updated
             (fun f -> ("NodesUpdated", (String.to_json f)));
           Aws.Util.option_map v.update_action_status
             (fun f -> ("UpdateActionStatus", (UpdateActionStatus.to_json f)));
           Aws.Util.option_map v.update_action_available_date
             (fun f -> ("UpdateActionAvailableDate", (DateTime.to_json f)));
           Aws.Util.option_map v.service_update_type
             (fun f -> ("ServiceUpdateType", (ServiceUpdateType.to_json f)));
           Aws.Util.option_map v.service_update_recommended_apply_by_date
             (fun f ->
           ...
           Aws.Util.option_map v.service_update_release_date
             (fun f -> ("ServiceUpdateReleaseDate", (DateTime.to_json f)));
           Aws.Util.option_map v.service_update_name
             (fun f -> ("ServiceUpdateName", (String.to_json f)));
           Aws.Util.option_map v.cache_cluster_id
             (fun f -> ("CacheClusterId", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        service_update_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateName")
             String.of_json);
        service_update_release_date =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateReleaseDate")
             DateTime.of_json);
        service_update_severity =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateSeverity")
             ServiceUpdateSeverity.of_json);
        service_update_status =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateStatus")
        ...
        service_update_recommended_apply_by_date =
          (Aws.Util.option_map
             ...
             DateTime.of_json);
        service_update_type =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateType")
             ServiceUpdateType.of_json);
        update_action_available_date =
          (Aws.Util.option_map
             (Aws.Json.lookup j "UpdateActionAvailableDate") DateTime.of_json);
        update_action_status =
          (Aws.Util.option_map (Aws.Json.lookup j "UpdateActionStatus")
             UpdateActionStatus.of_json);
        nodes_updated =
          (Aws.Util.option_map (Aws.Json.lookup j "NodesUpdated")
             String.of_json);
        update_action_status_modified_date =
          (Aws.Util.option_map
             ...
             DateTime.of_json);
        sla_met =
          (Aws.Util.option_map (Aws.Json.lookup j "SlaMet") SlaMet.of_json);
        node_group_update_status =
          (NodeGroupUpdateStatusList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "NodeGroupUpdateStatus")));
        cache_node_update_status =
          (CacheNodeUpdateStatusList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheNodeUpdateStatus")));
        estimated_update_time =
          (Aws.Util.option_map (Aws.Json.lookup j "EstimatedUpdateTime")
             String.of_json);
        engine =
          (Aws.Util.option_map (Aws.Json.lookup j "Engine") String.of_json)
      }
...
module UpdateActionList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map UpdateAction.parse (Aws.Xml.members "UpdateAction" xml))
  ...
  struct
      ...
      Some
        {
          ...
          update_actions =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "UpdateActions" xml)
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("UpdateActions", (UpdateActionList.to_json v.update_actions));
           Aws.Util.option_map v.marker
             (fun f -> ("Marker", (String.to_json f)))])
    let of_json j =
      {
...
module ReservedCacheNodesOfferingList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list ReservedCacheNodesOffering.to_query v
  ...
  struct
      ...
      Some
        {
          ...
          password_count =
            (Aws.Util.option_bind (Aws.Xml.member "PasswordCount" xml)
               Integer.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.password_count
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.password_count
              (fun f -> ("PasswordCount", (Integer.to_json f)));
           Aws.Util.option_map v.type_
             (fun f -> ("Type", (AuthenticationType.to_json f)))])
    let of_json j =
      {
        type_ =
          (Aws.Util.option_map (Aws.Json.lookup j "Type")
             AuthenticationType.of_json);
        password_count =
          (Aws.Util.option_map (Aws.Json.lookup j "PasswordCount")
             Integer.of_json)
      }
  end
module User =
      ...
      Some
        {
          ...
          user_name =
            (Aws.Util.option_bind (Aws.Xml.member "UserName" xml)
               String.parse);
          status =
            (Aws.Util.option_bind (Aws.Xml.member "Status" xml) String.parse);
          engine =
            (Aws.Util.option_bind (Aws.Xml.member "Engine" xml) String.parse);
          access_string =
            (Aws.Util.option_bind (Aws.Xml.member "AccessString" xml)
               String.parse);
          user_group_ids =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "UserGroupIds" xml)
                  UserGroupIdList.parse));
          authentication =
            (Aws.Util.option_bind (Aws.Xml.member "Authentication" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.a_r_n
              (fun f -> Aws.Query.Pair ("ARN", (String.to_query f)));
           Aws.Util.option_map v.authentication
             (fun f ->
                Aws.Query.Pair
                  ("Authentication", (Authentication.to_query f)));
           Some
             (Aws.Query.Pair
                ("UserGroupIds.member",
                  (UserGroupIdList.to_query v.user_group_ids)));
           Aws.Util.option_map v.access_string
             (fun f -> Aws.Query.Pair ("AccessString", (String.to_query f)));
           Aws.Util.option_map v.engine
             (fun f -> Aws.Query.Pair ("Engine", (String.to_query f)));
           Aws.Util.option_map v.status
             (fun f -> Aws.Query.Pair ("Status", (String.to_query f)));
           Aws.Util.option_map v.user_name
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Some ("UserGroupIds", (UserGroupIdList.to_json v.user_group_ids));
           Aws.Util.option_map v.access_string
             (fun f -> ("AccessString", (String.to_json f)));
           Aws.Util.option_map v.engine
             (fun f -> ("Engine", (String.to_json f)));
           Aws.Util.option_map v.status
             (fun f -> ("Status", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        engine =
          (Aws.Util.option_map (Aws.Json.lookup j "Engine") String.of_json);
        access_string =
          (Aws.Util.option_map (Aws.Json.lookup j "AccessString")
             String.of_json);
        user_group_ids =
          (UserGroupIdList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "UserGroupIds")));
        authentication =
          (Aws.Util.option_map (Aws.Json.lookup j "Authentication")
...
module UserList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map User.parse (Aws.Xml.members "member" xml))
...
module UpdateActionStatusList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map UpdateActionStatus.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          start_time =
            (Aws.Util.option_bind (Aws.Xml.member "StartTime" xml)
               DateTime.parse);
          end_time =
            (Aws.Util.option_bind (Aws.Xml.member "EndTime" xml)
               DateTime.parse)
        }
    let to_query v =
      Aws.Query.List
      ...
      Some
        {
          ...
          cache_cluster_ids =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "CacheClusterIds" xml)
          ...
          show_node_level_update_status =
            (Aws.Util.option_bind
               (Aws.Xml.member "ShowNodeLevelUpdateStatus" xml) Boolean.parse);
          max_records =
            (Aws.Util.option_bind (Aws.Xml.member "MaxRecords" xml)
               Integer.parse);
          marker =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.max_records
             (fun f -> Aws.Query.Pair ("MaxRecords", (Integer.to_query f)));
           Aws.Util.option_map v.show_node_level_update_status
             (fun f ->
                Aws.Query.Pair
           ...
           Aws.Util.option_map v.service_update_time_range
             (fun f ->
                Aws.Query.Pair
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.max_records
             (fun f -> ("MaxRecords", (Integer.to_json f)));
           Aws.Util.option_map v.show_node_level_update_status
             (fun f -> ("ShowNodeLevelUpdateStatus", (Boolean.to_json f)));
           Some
             ("UpdateActionStatus",
    ...
    let of_json j =
      {
        ...
        replication_group_ids =
          (ReplicationGroupIdList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ReplicationGroupIds")));
        cache_cluster_ids =
        ...
        service_update_time_range =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateTimeRange")
        ...
        show_node_level_update_status =
          (Aws.Util.option_map
             (Aws.Json.lookup j "ShowNodeLevelUpdateStatus") Boolean.of_json);
        max_records =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxRecords")
             Integer.of_json);
        marker =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("SnapshotName", (String.to_query v.snapshot_name)));
           Aws.Util.option_map v.cache_cluster_id
             (fun f -> Aws.Query.Pair ("CacheClusterId", (String.to_query f)));
           Aws.Util.option_map v.replication_group_id
             (fun f ->
    ...
    let of_json j =
      {
        ...
        snapshot_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "SnapshotName")));
        kms_key_id =
          (Aws.Util.option_map (Aws.Json.lookup j "KmsKeyId") String.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          cache_cluster =
            (Aws.Util.option_bind (Aws.Xml.member "CacheCluster" xml)
               CacheCluster.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cache_cluster
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cache_cluster
              (fun f -> ("CacheCluster", (CacheCluster.to_json f)))])
    let of_json j =
      {
        cache_cluster =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheCluster")
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Some
             ("UserIdsToRemove", (UserIdList.to_json v.user_ids_to_remove))])
    let of_json j =
      {
        user_ids_to_remove =
          (UserIdList.of_json
      ...
      Some
        {
          ...
          user_ids =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "UserIds" xml)
                  UserIdList.parse));
          pending_changes =
            (Aws.Util.option_bind (Aws.Xml.member "PendingChanges" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.pending_changes
             (fun f ->
                Aws.Query.Pair
                  ("PendingChanges", (UserGroupPendingChanges.to_query f)));
           Some
             (Aws.Query.Pair
                ("UserIds.member", (UserIdList.to_query v.user_ids)));
           Aws.Util.option_map v.engine
             (fun f -> Aws.Query.Pair ("Engine", (String.to_query f)));
           Aws.Util.option_map v.status
             (fun f -> Aws.Query.Pair ("Status", (String.to_query f)));
           Aws.Util.option_map v.user_group_id
             (fun f -> Aws.Query.Pair ("UserGroupId", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.a_r_n
           ...
           Aws.Util.option_map v.status
             (fun f -> ("Status", (String.to_json f)));
           Aws.Util.option_map v.user_group_id
             (fun f -> ("UserGroupId", (String.to_json f)))])
    let of_json j =
      {
        user_group_id =
          (Aws.Util.option_map (Aws.Json.lookup j "UserGroupId")
             String.of_json);
        status =
          (Aws.Util.option_map (Aws.Json.lookup j "Status") String.of_json);
        engine =
        ...
        user_ids =
          (UserIdList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "UserIds")));
        pending_changes =
          (Aws.Util.option_map (Aws.Json.lookup j "PendingChanges")
...
module UserGroupList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map UserGroup.parse (Aws.Xml.members "member" xml))
        ...
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.product_description
             (fun f ->
                Aws.Query.Pair ("ProductDescription", (String.to_query f)));
           Aws.Util.option_map v.duration
             (fun f -> Aws.Query.Pair ("Duration", (String.to_query f)));
           Aws.Util.option_map v.cache_node_type
             (fun f -> Aws.Query.Pair ("CacheNodeType", (String.to_query f)));
           Aws.Util.option_map v.reserved_cache_nodes_offering_id
             (fun f ->
    ...
    let of_json j =
      {
        ...
        cache_node_type =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheNodeType")
             String.of_json);
        duration =
          (Aws.Util.option_map (Aws.Json.lookup j "Duration") String.of_json);
        product_description =
          (Aws.Util.option_map (Aws.Json.lookup j "ProductDescription")
             String.of_json);
        offering_type =
      ...
      Some
        {
          ...
          service_update_release_date =
            (Aws.Util.option_bind
               (Aws.Xml.member "ServiceUpdateReleaseDate" xml) DateTime.parse);
          service_update_end_date =
            (Aws.Util.option_bind (Aws.Xml.member "ServiceUpdateEndDate" xml)
               DateTime.parse);
          service_update_severity =
            (Aws.Util.option_bind
               (Aws.Xml.member "ServiceUpdateSeverity" xml)
          ...
          service_update_description =
            (Aws.Util.option_bind
               (Aws.Xml.member "ServiceUpdateDescription" xml) String.parse);
          service_update_type =
            (Aws.Util.option_bind (Aws.Xml.member "ServiceUpdateType" xml)
               ServiceUpdateType.parse);
          engine =
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.estimated_update_time
              (fun f ->
                 Aws.Query.Pair ("EstimatedUpdateTime", (String.to_query f)));
           Aws.Util.option_map v.auto_update_after_recommended_apply_by_date
             (fun f ->
                Aws.Query.Pair
           ...
           Aws.Util.option_map v.service_update_type
             (fun f ->
                Aws.Query.Pair
                  ("ServiceUpdateType", (ServiceUpdateType.to_query f)));
           Aws.Util.option_map v.service_update_description
             (fun f ->
                Aws.Query.Pair
                  ("ServiceUpdateDescription", (String.to_query f)));
           Aws.Util.option_map v.service_update_status
             (fun f ->
                Aws.Query.Pair
                  ("ServiceUpdateStatus", (ServiceUpdateStatus.to_query f)));
           ...
           Aws.Util.option_map v.service_update_severity
             (fun f ->
                Aws.Query.Pair
                  ("ServiceUpdateSeverity",
                    (ServiceUpdateSeverity.to_query f)));
           Aws.Util.option_map v.service_update_end_date
             (fun f ->
                Aws.Query.Pair
                  ("ServiceUpdateEndDate", (DateTime.to_query f)));
           Aws.Util.option_map v.service_update_release_date
             (fun f ->
                Aws.Query.Pair
                  ("ServiceUpdateReleaseDate", (DateTime.to_query f)));
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.service_update_type
             (fun f -> ("ServiceUpdateType", (ServiceUpdateType.to_json f)));
           Aws.Util.option_map v.service_update_description
             (fun f -> ("ServiceUpdateDescription", (String.to_json f)));
           Aws.Util.option_map v.service_update_status
             (fun f ->
                ("ServiceUpdateStatus", (ServiceUpdateStatus.to_json f)));
           Aws.Util.option_map v.service_update_recommended_apply_by_date
           ...
           Aws.Util.option_map v.service_update_severity
             (fun f ->
                ("ServiceUpdateSeverity", (ServiceUpdateSeverity.to_json f)));
           Aws.Util.option_map v.service_update_end_date
             (fun f -> ("ServiceUpdateEndDate", (DateTime.to_json f)));
           Aws.Util.option_map v.service_update_release_date
             (fun f -> ("ServiceUpdateReleaseDate", (DateTime.to_json f)));
           Aws.Util.option_map v.service_update_name
             (fun f -> ("ServiceUpdateName", (String.to_json f)))])
    let of_json j =
      {
        ...
        service_update_release_date =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateReleaseDate")
             DateTime.of_json);
        service_update_end_date =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateEndDate")
             DateTime.of_json);
        service_update_severity =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateSeverity")
             ServiceUpdateSeverity.of_json);
        ...
        service_update_status =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateStatus")
             ServiceUpdateStatus.of_json);
        service_update_description =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateDescription")
             String.of_json);
        service_update_type =
          (Aws.Util.option_map (Aws.Json.lookup j "ServiceUpdateType")
             ServiceUpdateType.of_json);
      ...
      Some
        {
          ...
          description =
            (Aws.Util.option_bind (Aws.Xml.member "Description" xml)
               String.parse);
          is_global =
            (Aws.Util.option_bind (Aws.Xml.member "IsGlobal" xml)
               Boolean.parse);
          a_r_n =
            (Aws.Util.option_bind (Aws.Xml.member "ARN" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.a_r_n
              (fun f -> Aws.Query.Pair ("ARN", (String.to_query f)));
           Aws.Util.option_map v.is_global
             (fun f -> Aws.Query.Pair ("IsGlobal", (Boolean.to_query f)));
           Aws.Util.option_map v.description
             (fun f -> Aws.Query.Pair ("Description", (String.to_query f)));
           Aws.Util.option_map v.cache_parameter_group_family
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.a_r_n
              (fun f -> ("ARN", (String.to_json f)));
           Aws.Util.option_map v.is_global
             (fun f -> ("IsGlobal", (Boolean.to_json f)));
           Aws.Util.option_map v.description
             (fun f -> ("Description", (String.to_json f)));
           Aws.Util.option_map v.cache_parameter_group_family
             (fun f -> ("CacheParameterGroupFamily", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json);
        is_global =
          (Aws.Util.option_map (Aws.Json.lookup j "IsGlobal") Boolean.of_json);
        a_r_n =
          (Aws.Util.option_map (Aws.Json.lookup j "ARN") String.of_json)
      }
  end
  ...
  struct
          ...
          cache_cluster_ids =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "CacheClusterIds" xml)
                  CacheClusterIdList.parse));
          service_update_name =
            (Aws.Xml.required "ServiceUpdateName"
               (Aws.Util.option_bind (Aws.Xml.member "ServiceUpdateName" xml)
                  String.parse))
        }
    let to_query v =
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("ServiceUpdateName", (String.to_json v.service_update_name));
           Some
             ("CacheClusterIds",
               (CacheClusterIdList.to_json v.cache_cluster_ids));
           Some
    ...
    let of_json j =
      {
        ...
        service_update_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ServiceUpdateName")))
      }
  end
...
module NodeGroupsToRetainList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "NodeGroupToRetain" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
...
module ReshardingConfigurationList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list ReshardingConfiguration.to_query v
...
module NodeGroupsToRemoveList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "NodeGroupToRemove" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
          ...
          replication_group_id =
            (Aws.Xml.required "ReplicationGroupId"
               (Aws.Util.option_bind
                  (Aws.Xml.member "ReplicationGroupId" xml) String.parse));
          node_group_count =
            (Aws.Xml.required "NodeGroupCount"
               (Aws.Util.option_bind (Aws.Xml.member "NodeGroupCount" xml)
                  Integer.parse));
          apply_immediately =
            (Aws.Xml.required "ApplyImmediately"
               (Aws.Util.option_bind (Aws.Xml.member "ApplyImmediately" xml)
    ...
    let of_json j =
      {
        ...
        node_group_count =
          (Integer.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "NodeGroupCount")));
        apply_immediately =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ApplyImmediately")));
        resharding_configuration =
          (ReshardingConfigurationList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ReshardingConfiguration")));
        node_groups_to_remove =
...
module GlobalNodeGroupIdList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map String.parse (Aws.Xml.members "GlobalNodeGroupId" xml))
    let to_query v = Aws.Query.to_query_list String.to_query v
    let to_json v = `List (List.map String.to_json v)
    let of_json j = Aws.Json.to_list String.of_json j
  end
    ...
    let of_json j =
      {
        user_groups =
          (UserGroupList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "UserGroups")));
        marker =
          (Aws.Util.option_map (Aws.Json.lookup j "Marker") String.of_json)
      }
  end
  ...
  struct
      ...
      Some
        {
          ...
          e_c2_security_group_name =
            (Aws.Util.option_bind (Aws.Xml.member "EC2SecurityGroupName" xml)
               String.parse);
          e_c2_security_group_owner_id =
            (Aws.Util.option_bind
               (Aws.Xml.member "EC2SecurityGroupOwnerId" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.e_c2_security_group_owner_id
              (fun f ->
                 Aws.Query.Pair
                   ("EC2SecurityGroupOwnerId", (String.to_query f)));
           Aws.Util.option_map v.e_c2_security_group_name
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.e_c2_security_group_owner_id
              (fun f -> ("EC2SecurityGroupOwnerId", (String.to_json f)));
           Aws.Util.option_map v.e_c2_security_group_name
             (fun f -> ("EC2SecurityGroupName", (String.to_json f)));
           Aws.Util.option_map v.status
             (fun f -> ("Status", (String.to_json f)))])
    let of_json j =
      {
        status =
          (Aws.Util.option_map (Aws.Json.lookup j "Status") String.of_json);
        e_c2_security_group_name =
          (Aws.Util.option_map (Aws.Json.lookup j "EC2SecurityGroupName")
             String.of_json);
        e_c2_security_group_owner_id =
          (Aws.Util.option_map (Aws.Json.lookup j "EC2SecurityGroupOwnerId")
             String.of_json)
      }
  end
module EC2SecurityGroupList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map EC2SecurityGroup.parse
           (Aws.Xml.members "EC2SecurityGroup" xml))
          ...
          cache_cluster_id =
            (Aws.Xml.required "CacheClusterId"
               (Aws.Util.option_bind (Aws.Xml.member "CacheClusterId" xml)
                  String.parse));
          cache_node_ids_to_reboot =
            (Aws.Xml.required "CacheNodeIdsToReboot"
               (Aws.Util.option_bind
                  (Aws.Xml.member "CacheNodeIdsToReboot" xml)
                  CacheNodeIdsList.parse))
        }
  ...
  struct
      ...
      Some
        {
          ...
          cache_clusters =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "CacheClusters" xml)
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("CacheClusters", (CacheClusterList.to_json v.cache_clusters));
           Aws.Util.option_map v.marker
             (fun f -> ("Marker", (String.to_json f)))])
    let of_json j =
      {
          ...
          cache_security_group_name =
            (Aws.Xml.required "CacheSecurityGroupName"
               (Aws.Util.option_bind
                  (Aws.Xml.member "CacheSecurityGroupName" xml) String.parse));
          e_c2_security_group_name =
            (Aws.Xml.required "EC2SecurityGroupName"
               (Aws.Util.option_bind
                  (Aws.Xml.member "EC2SecurityGroupName" xml) String.parse));
          e_c2_security_group_owner_id =
            (Aws.Xml.required "EC2SecurityGroupOwnerId"
               (Aws.Util.option_bind
                  (Aws.Xml.member "EC2SecurityGroupOwnerId" xml) String.parse))
        }
    let to_query v =
    ...
    let of_json j =
      {
        ...
        e_c2_security_group_name =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "EC2SecurityGroupName")));
        e_c2_security_group_owner_id =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "EC2SecurityGroupOwnerId")))
      }
  end
      ...
      Some
        {
          ...
          e_c2_security_groups =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "EC2SecurityGroups" xml)
          ...
          cache_parameter_group_name =
            (Aws.Xml.required "CacheParameterGroupName"
               (Aws.Util.option_bind
                  (Aws.Xml.member "CacheParameterGroupName" xml) String.parse));
          reset_all_parameters =
            (Aws.Util.option_bind (Aws.Xml.member "ResetAllParameters" xml)
               Boolean.parse);
          parameter_name_values =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
        ...
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("ParameterNameValues.member",
                   (ParameterNameValueList.to_query v.parameter_name_values)));
           Aws.Util.option_map v.reset_all_parameters
             (fun f ->
        ...
        (Aws.Util.list_filter_opt
           [Some
              ("ParameterNameValues",
                (ParameterNameValueList.to_json v.parameter_name_values));
           Aws.Util.option_map v.reset_all_parameters
             (fun f -> ("ResetAllParameters", (Boolean.to_json f)));
           Some
             ("CacheParameterGroupName",
               (String.to_json v.cache_parameter_group_name))])
    let of_json j =
        ...
        cache_parameter_group_name =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheParameterGroupName")));
        reset_all_parameters =
          (Aws.Util.option_map (Aws.Json.lookup j "ResetAllParameters")
             Boolean.of_json);
        parameter_name_values =
          (ParameterNameValueList.of_json
             (Aws.Util.of_option_exn
          ...
          replication_group_region =
            (Aws.Xml.required "ReplicationGroupRegion"
               (Aws.Util.option_bind
                  (Aws.Xml.member "ReplicationGroupRegion" xml) String.parse));
          resharding_configuration =
            (Aws.Xml.required "ReshardingConfiguration"
               (Aws.Util.option_bind
                  (Aws.Xml.member "ReshardingConfiguration" xml)
                  ReshardingConfigurationList.parse))
        }
      ...
      Some
        {
          ...
          replicas_to_remove =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ReplicasToRemove" xml)
  ...
  struct
          ...
          replication_group_id =
            (Aws.Xml.required "ReplicationGroupId"
               (Aws.Util.option_bind
                  (Aws.Xml.member "ReplicationGroupId" xml) String.parse));
          retain_primary_cluster =
            (Aws.Util.option_bind (Aws.Xml.member "RetainPrimaryCluster" xml)
               Boolean.parse);
          final_snapshot_identifier =
            (Aws.Util.option_bind
               (Aws.Xml.member "FinalSnapshotIdentifier" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.final_snapshot_identifier
              (fun f ->
                 Aws.Query.Pair
                   ("FinalSnapshotIdentifier", (String.to_query f)));
           Aws.Util.option_map v.retain_primary_cluster
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.final_snapshot_identifier
              (fun f -> ("FinalSnapshotIdentifier", (String.to_json f)));
           Aws.Util.option_map v.retain_primary_cluster
             (fun f -> ("RetainPrimaryCluster", (Boolean.to_json f)));
           Some
             ("ReplicationGroupId", (String.to_json v.replication_group_id))])
    let of_json j =
      {
        replication_group_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ReplicationGroupId")));
        retain_primary_cluster =
          (Aws.Util.option_map (Aws.Json.lookup j "RetainPrimaryCluster")
             Boolean.of_json);
        final_snapshot_identifier =
          (Aws.Util.option_map (Aws.Json.lookup j "FinalSnapshotIdentifier")
             String.of_json)
      }
  end
      ...
      Some
        {
          users =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Users" xml)
                  UserList.parse));
          marker =
            (Aws.Util.option_bind (Aws.Xml.member "Marker" xml) String.parse)
        }
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.marker
              (fun f -> Aws.Query.Pair ("Marker", (String.to_query f)));
           Some
             (Aws.Query.Pair ("Users.member", (UserList.to_query v.users)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.marker
    ...
    let of_json j =
      {
        users =
          (UserList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Users")));
        marker =
          (Aws.Util.option_map (Aws.Json.lookup j "Marker") String.of_json)
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map CacheParameterGroup.parse
           (Aws.Xml.members "CacheParameterGroup" xml))
      ...
      Some
        {
          ...
          service_updates =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ServiceUpdates" xml)
...
module GlobalReplicationGroupList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list GlobalReplicationGroup.to_query v
    ...
    let of_json j =
      {
        ...
        global_replication_groups =
          (GlobalReplicationGroupList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "GlobalReplicationGroups")))
      }
  end
          ...
          global_replication_group_id =
            (Aws.Xml.required "GlobalReplicationGroupId"
               (Aws.Util.option_bind
                  ...
                  String.parse));
          primary_region =
            (Aws.Xml.required "PrimaryRegion"
               (Aws.Util.option_bind (Aws.Xml.member "PrimaryRegion" xml)
                  String.parse));
          primary_replication_group_id =
            (Aws.Xml.required "PrimaryReplicationGroupId"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        ...
        primary_region =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "PrimaryRegion")));
        primary_replication_group_id =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "PrimaryReplicationGroupId")))
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map RegionalConfiguration.parse
           (Aws.Xml.members "RegionalConfiguration" xml))
...
module SnapshotList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Snapshot.parse (Aws.Xml.members "Snapshot" xml))
      ...
      Some
        {
          ...
          snapshots =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Snapshots" xml)
                  SnapshotList.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        ...
        snapshots =
          (SnapshotList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Snapshots")))
      }
  end
...
module FilterList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Filter.parse (Aws.Xml.members "member" xml))
    ...
    let of_json j =
      {
        ...
        reserved_cache_nodes_offerings =
          (ReservedCacheNodesOfferingList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ReservedCacheNodesOfferings")))
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          global_replication_group_id_suffix =
            (Aws.Xml.required "GlobalReplicationGroupIdSuffix"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        global_replication_group_id_suffix =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "GlobalReplicationGroupIdSuffix")));
        global_replication_group_description =
          (Aws.Util.option_map
             (Aws.Json.lookup j "GlobalReplicationGroupDescription")
             String.of_json);
  ...
  struct
    ...
    let parse xml =
      Some
        {
          cache_security_group =
            (Aws.Util.option_bind (Aws.Xml.member "CacheSecurityGroup" xml)
               CacheSecurityGroup.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cache_security_group
              (fun f ->
                 Aws.Query.Pair
    ...
    let of_json j =
      {
        cache_security_group =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheSecurityGroup")
      ...
      Some
        {
          ...
          customer_node_endpoint_list =
            (Aws.Xml.required "CustomerNodeEndpointList"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        ...
        customer_node_endpoint_list =
          (CustomerNodeEndpointList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CustomerNodeEndpointList")))
      }
  end
module Parameter =
  struct
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.description
             (fun f -> Aws.Query.Pair ("Description", (String.to_query f)));
           Aws.Util.option_map v.parameter_value
             (fun f -> Aws.Query.Pair ("ParameterValue", (String.to_query f)));
           Aws.Util.option_map v.parameter_name
             (fun f -> Aws.Query.Pair ("ParameterName", (String.to_query f)))])
    let to_json v =
      `Assoc
...
module ModifyCacheClusterMessage =
  struct
      ...
      Some
        {
          ...
          notification_topic_status =
            (Aws.Util.option_bind
               (Aws.Xml.member "NotificationTopicStatus" xml) String.parse);
          apply_immediately =
            (Aws.Util.option_bind (Aws.Xml.member "ApplyImmediately" xml)
               Boolean.parse);
          engine_version =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.auth_token_update_strategy
              (fun f ->
                 Aws.Query.Pair
           ...
           Aws.Util.option_map v.engine_version
             (fun f -> Aws.Query.Pair ("EngineVersion", (String.to_query f)));
           Aws.Util.option_map v.apply_immediately
             (fun f ->
                Aws.Query.Pair ("ApplyImmediately", (Boolean.to_query f)));
           Aws.Util.option_map v.notification_topic_status
             (fun f ->
                Aws.Query.Pair
                  ("NotificationTopicStatus", (String.to_query f)));
           Aws.Util.option_map v.cache_parameter_group_name
             (fun f ->
                Aws.Query.Pair
                  ("CacheParameterGroupName", (String.to_query f)));
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.engine_version
             (fun f -> ("EngineVersion", (String.to_json f)));
           Aws.Util.option_map v.apply_immediately
             (fun f -> ("ApplyImmediately", (Boolean.to_json f)));
           Aws.Util.option_map v.notification_topic_status
             (fun f -> ("NotificationTopicStatus", (String.to_json f)));
           Aws.Util.option_map v.cache_parameter_group_name
             (fun f -> ("CacheParameterGroupName", (String.to_json f)));
           Aws.Util.option_map v.notification_topic_arn
             (fun f -> ("NotificationTopicArn", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        new_availability_zones =
          (PreferredAvailabilityZoneList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "NewAvailabilityZones")));
        cache_security_group_names =
          (CacheSecurityGroupNameList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheSecurityGroupNames")));
        ...
        cache_parameter_group_name =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheParameterGroupName")
             String.of_json);
        notification_topic_status =
          (Aws.Util.option_map (Aws.Json.lookup j "NotificationTopicStatus")
             String.of_json);
        apply_immediately =
          (Aws.Util.option_map (Aws.Json.lookup j "ApplyImmediately")
             Boolean.of_json);
        engine_version =
          (Aws.Util.option_map (Aws.Json.lookup j "EngineVersion")
             String.of_json);
        ...
        auth_token =
          (Aws.Util.option_map (Aws.Json.lookup j "AuthToken") String.of_json);
        auth_token_update_strategy =
          (Aws.Util.option_map (Aws.Json.lookup j "AuthTokenUpdateStrategy")
  ...
  struct
    ...
    let parse xml =
      Some
        {
          cache_subnet_group =
            (Aws.Util.option_bind (Aws.Xml.member "CacheSubnetGroup" xml)
               CacheSubnetGroup.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cache_subnet_group
              (fun f ->
                 Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.cache_subnet_group
              (fun f -> ("CacheSubnetGroup", (CacheSubnetGroup.to_json f)))])
    let of_json j =
      {
        cache_subnet_group =
          (Aws.Util.option_map (Aws.Json.lookup j "CacheSubnetGroup")
  ...
  struct
    ...
    let parse xml =
      Some
        {
          cache_subnet_group_name =
            (Aws.Xml.required "CacheSubnetGroupName"
               (Aws.Util.option_bind
                  (Aws.Xml.member "CacheSubnetGroupName" xml) String.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        cache_subnet_group_name =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheSubnetGroupName")))
      }
  end
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("Filters.member", (FilterList.to_query v.filters)));
           Aws.Util.option_map v.user_id
             (fun f -> Aws.Query.Pair ("UserId", (String.to_query f)));
           Aws.Util.option_map v.engine
             (fun f -> Aws.Query.Pair ("Engine", (String.to_query f)))])
...
module ParametersList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Parameter.parse (Aws.Xml.members "Parameter" xml))
      ...
      Some
        {
          ...
          retain_primary_replication_group =
            (Aws.Xml.required "RetainPrimaryReplicationGroup"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        ...
        retain_primary_replication_group =
          (Boolean.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "RetainPrimaryReplicationGroup")))
      }
  end
  ...
  struct
      ...
      Some
        {
          ...
          automatic_failover_enabled =
            (Aws.Util.option_bind
               (Aws.Xml.member "AutomaticFailoverEnabled" xml) Boolean.parse);
          multi_a_z_enabled =
            (Aws.Util.option_bind (Aws.Xml.member "MultiAZEnabled" xml)
               Boolean.parse);
          node_group_id =
            (Aws.Util.option_bind (Aws.Xml.member "NodeGroupId" xml)
               String.parse);
          ...
          user_group_ids_to_remove =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
                  ...
                  UserGroupIdList.parse));
          remove_user_groups =
            (Aws.Util.option_bind (Aws.Xml.member "RemoveUserGroups" xml)
               Boolean.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.remove_user_groups
              (fun f ->
           ...
           Aws.Util.option_map v.node_group_id
             (fun f -> Aws.Query.Pair ("NodeGroupId", (String.to_query f)));
           Aws.Util.option_map v.multi_a_z_enabled
             (fun f ->
                Aws.Query.Pair ("MultiAZEnabled", (Boolean.to_query f)));
           Aws.Util.option_map v.automatic_failover_enabled
             (fun f ->
                Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.remove_user_groups
              (fun f -> ("RemoveUserGroups", (Boolean.to_json f)));
           Some
             ("UserGroupIdsToRemove",
               (UserGroupIdList.to_json v.user_group_ids_to_remove));
           Some
           ...
           Aws.Util.option_map v.node_group_id
             (fun f -> ("NodeGroupId", (String.to_json f)));
           Aws.Util.option_map v.multi_a_z_enabled
             (fun f -> ("MultiAZEnabled", (Boolean.to_json f)));
           Aws.Util.option_map v.automatic_failover_enabled
             (fun f -> ("AutomaticFailoverEnabled", (Boolean.to_json f)));
           Aws.Util.option_map v.snapshotting_cluster_id
             (fun f -> ("SnapshottingClusterId", (String.to_json f)));
           Aws.Util.option_map v.primary_cluster_id
             (fun f -> ("PrimaryClusterId", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        snapshotting_cluster_id =
          (Aws.Util.option_map (Aws.Json.lookup j "SnapshottingClusterId")
             String.of_json);
        automatic_failover_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "AutomaticFailoverEnabled")
             Boolean.of_json);
        multi_a_z_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "MultiAZEnabled")
             Boolean.of_json);
        node_group_id =
          (Aws.Util.option_map (Aws.Json.lookup j "NodeGroupId")
             String.of_json);
        ...
        user_group_ids_to_remove =
          (UserGroupIdList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "UserGroupIdsToRemove")));
        remove_user_groups =
          (Aws.Util.option_map (Aws.Json.lookup j "RemoveUserGroups")
             Boolean.of_json)
      }
  end
      ...
      Some
        {
          ...
          parameters =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Parameters" xml)
    ...
    let of_json j =
      {
        ...
        cache_node_type_specific_parameters =
          (CacheNodeTypeSpecificParametersList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheNodeTypeSpecificParameters")))
      }
  end
    ...
    let of_json j =
      {
        scale_up_modifications =
          (NodeTypeList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ScaleUpModifications")));
        scale_down_modifications =
          (NodeTypeList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ScaleDownModifications")))
      }
  end
    ...
    let of_json j =
      {
        ...
        regional_configurations =
          (RegionalConfigurationList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "RegionalConfigurations")));
        apply_immediately =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ApplyImmediately")))
      }
  ...
  struct
      ...
      Some
        {
          ...
          max_records =
            (Aws.Util.option_bind (Aws.Xml.member "MaxRecords" xml)
               Integer.parse);
          show_node_group_config =
            (Aws.Util.option_bind (Aws.Xml.member "ShowNodeGroupConfig" xml)
               Boolean.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.show_node_group_config
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.show_node_group_config
              (fun f -> ("ShowNodeGroupConfig", (Boolean.to_json f)));
           Aws.Util.option_map v.max_records
             (fun f -> ("MaxRecords", (Integer.to_json f)));
           Aws.Util.option_map v.marker
             (fun f -> ("Marker", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        max_records =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxRecords")
             Integer.of_json);
        show_node_group_config =
          (Aws.Util.option_map (Aws.Json.lookup j "ShowNodeGroupConfig")
             Boolean.of_json)
      }
  end
  ...
  struct
      ...
      Some
        {
          ...
          access_string =
            (Aws.Util.option_bind (Aws.Xml.member "AccessString" xml)
               String.parse);
          append_access_string =
            (Aws.Util.option_bind (Aws.Xml.member "AppendAccessString" xml)
               String.parse);
          passwords =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Passwords" xml)
                  PasswordListInput.parse));
          no_password_required =
            (Aws.Util.option_bind (Aws.Xml.member "NoPasswordRequired" xml)
               Boolean.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.no_password_required
              (fun f ->
           ...
           Aws.Util.option_map v.append_access_string
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.no_password_required
              (fun f -> ("NoPasswordRequired", (Boolean.to_json f)));
           Some ("Passwords", (PasswordListInput.to_json v.passwords));
           Aws.Util.option_map v.append_access_string
             (fun f -> ("AppendAccessString", (String.to_json f)));
           Aws.Util.option_map v.access_string
             (fun f -> ("AccessString", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        access_string =
          (Aws.Util.option_map (Aws.Json.lookup j "AccessString")
             String.of_json);
        append_access_string =
          (Aws.Util.option_map (Aws.Json.lookup j "AppendAccessString")
             String.of_json);
        passwords =
          (PasswordListInput.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Passwords")));
        no_password_required =
          (Aws.Util.option_map (Aws.Json.lookup j "NoPasswordRequired")
             Boolean.of_json)
      }
  end
...
module NodeGroupConfigurationList =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list NodeGroupConfiguration.to_query v
  ...
  struct
    ...
    let parse xml =
      Some
        {
          engine_defaults =
            (Aws.Xml.required "EngineDefaults"
               (Aws.Util.option_bind (Aws.Xml.member "EngineDefaults" xml)
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("EngineDefaults", (EngineDefaults.to_json v.engine_defaults))])
    let of_json j =
      {
        engine_defaults =
          ...
          cache_subnet_group_name =
            (Aws.Xml.required "CacheSubnetGroupName"
               (Aws.Util.option_bind
                  (Aws.Xml.member "CacheSubnetGroupName" xml) String.parse));
          cache_subnet_group_description =
            (Aws.Xml.required "CacheSubnetGroupDescription"
               (Aws.Util.option_bind
                  (Aws.Xml.member "CacheSubnetGroupDescription" xml)
                  String.parse));
          subnet_ids =
            (Aws.Xml.required "SubnetIds"
      ...
      Some
        {
          replication_group_id =
            (Aws.Xml.required "ReplicationGroupId"
               (Aws.Util.option_bind
                  (Aws.Xml.member "ReplicationGroupId" xml) String.parse));
          replication_group_description =
            (Aws.Xml.required "ReplicationGroupDescription"
               (Aws.Util.option_bind
                  (Aws.Xml.member "ReplicationGroupDescription" xml)
                  String.parse));
          global_replication_group_id =
          ...
          multi_a_z_enabled =
            (Aws.Util.option_bind (Aws.Xml.member "MultiAZEnabled" xml)
               Boolean.parse);
          num_cache_clusters =
            (Aws.Util.option_bind (Aws.Xml.member "NumCacheClusters" xml)
               Integer.parse);
          preferred_cache_cluster_a_zs =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
          ...
          num_node_groups =
            (Aws.Util.option_bind (Aws.Xml.member "NumNodeGroups" xml)
               Integer.parse);
          replicas_per_node_group =
            (Aws.Util.option_bind (Aws.Xml.member "ReplicasPerNodeGroup" xml)
               Integer.parse);
          node_group_configuration =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.replicas_per_node_group
             (fun f ->
           ...
           Aws.Util.option_map v.num_cache_clusters
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.replicas_per_node_group
             (fun f -> ("ReplicasPerNodeGroup", (Integer.to_json f)));
           Aws.Util.option_map v.num_node_groups
             (fun f -> ("NumNodeGroups", (Integer.to_json f)));
           Some
           ...
           Aws.Util.option_map v.num_cache_clusters
             (fun f -> ("NumCacheClusters", (Integer.to_json f)));
           Aws.Util.option_map v.multi_a_z_enabled
             (fun f -> ("MultiAZEnabled", (Boolean.to_json f)));
           Aws.Util.option_map v.automatic_failover_enabled
             (fun f -> ("AutomaticFailoverEnabled", (Boolean.to_json f)));
    ...
    let of_json j =
      {
        ...
        multi_a_z_enabled =
          (Aws.Util.option_map (Aws.Json.lookup j "MultiAZEnabled")
             Boolean.of_json);
        num_cache_clusters =
          (Aws.Util.option_map (Aws.Json.lookup j "NumCacheClusters")
             Integer.of_json);
        preferred_cache_cluster_a_zs =
          (AvailabilityZonesList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "PreferredCacheClusterAZs")));
        num_node_groups =
          (Aws.Util.option_map (Aws.Json.lookup j "NumNodeGroups")
             Integer.of_json);
        replicas_per_node_group =
          (Aws.Util.option_map (Aws.Json.lookup j "ReplicasPerNodeGroup")
             Integer.of_json);
        node_group_configuration =
    ...
    let of_json j =
      {
        ...
        global_node_groups_to_remove =
          (GlobalNodeGroupIdList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "GlobalNodeGroupsToRemove")));
        global_node_groups_to_retain =
          (GlobalNodeGroupIdList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "GlobalNodeGroupsToRetain")));
        apply_immediately =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ApplyImmediately")))
      }
          ...
          user_group_id =
            (Aws.Xml.required "UserGroupId"
               (Aws.Util.option_bind (Aws.Xml.member "UserGroupId" xml)
                  String.parse));
          engine =
            (Aws.Xml.required "Engine"
               (Aws.Util.option_bind (Aws.Xml.member "Engine" xml)
                  String.parse));
          user_ids =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "UserIds" xml)
    ...
    let of_json j =
      {
        ...
        engine =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Engine")));
        user_ids =
          (UserIdListInput.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "UserIds")))
      }
  ...
  struct
    ...
    let parse xml =
      Some
        {
          reserved_cache_nodes_offering_id =
            (Aws.Xml.required "ReservedCacheNodesOfferingId"
               (Aws.Util.option_bind
                  (Aws.Xml.member "ReservedCacheNodesOfferingId" xml)
                  String.parse));
          reserved_cache_node_id =
      ...
      Some
        {
          tag_list =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "TagList" xml)
                  TagList.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("TagList.member", (TagList.to_query v.tag_list)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        tag_list =
          (TagList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TagList")))
      }
  end
    ...
    let of_json j =
      {
        replication_group_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ReplicationGroupId")));
        force =
          (Aws.Util.option_map (Aws.Json.lookup j "Force") Boolean.of_json)
      }
  end
      ...
      Some
        {
          ...
          cache_subnet_groups =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "CacheSubnetGroups" xml)
  ...
  struct
      ...
      Some
        {
          ...
          marker =
            (Aws.Util.option_bind (Aws.Xml.member "Marker" xml) String.parse);
          show_member_info =
            (Aws.Util.option_bind (Aws.Xml.member "ShowMemberInfo" xml)
               Boolean.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.show_member_info
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.show_member_info
              (fun f -> ("ShowMemberInfo", (Boolean.to_json f)));
           Aws.Util.option_map v.marker
             (fun f -> ("Marker", (String.to_json f)));
           Aws.Util.option_map v.max_records
             (fun f -> ("MaxRecords", (Integer.to_json f)));
    ...
    let of_json j =
      {
        ...
        marker =
          (Aws.Util.option_map (Aws.Json.lookup j "Marker") String.of_json);
        show_member_info =
          (Aws.Util.option_map (Aws.Json.lookup j "ShowMemberInfo")
             Boolean.of_json)
      }
  end
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("AccessString", (String.to_query v.access_string)));
           Some
             (Aws.Query.Pair
                ("Passwords.member",
                  (PasswordListInput.to_query v.passwords)));
    ...
    let of_json j =
      {
        ...
        user_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "UserName")));
        engine =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Engine")));
        passwords =
        ...
        access_string =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AccessString")));
        no_password_required =
          (Aws.Util.option_map (Aws.Json.lookup j "NoPasswordRequired")
             Boolean.of_json)
      }
  ...
  struct
      ...
      Some
        {
          ...
          marker =
            (Aws.Util.option_bind (Aws.Xml.member "Marker" xml) String.parse);
          show_cache_node_info =
            (Aws.Util.option_bind (Aws.Xml.member "ShowCacheNodeInfo" xml)
               Boolean.parse);
          show_cache_clusters_not_in_replication_groups =
            (Aws.Util.option_bind
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map
              v.show_cache_clusters_not_in_replication_groups
              (fun f ->
                 Aws.Query.Pair
                   ("ShowCacheClustersNotInReplicationGroups",
                     (Boolean.to_query f)));
           Aws.Util.option_map v.show_cache_node_info
             (fun f ->
           ...
           [Aws.Util.option_map
              ...
              (fun f ->
                 ("ShowCacheClustersNotInReplicationGroups",
                   (Boolean.to_json f)));
           Aws.Util.option_map v.show_cache_node_info
             (fun f -> ("ShowCacheNodeInfo", (Boolean.to_json f)));
           Aws.Util.option_map v.marker
             (fun f -> ("Marker", (String.to_json f)));
           Aws.Util.option_map v.max_records
             (fun f -> ("MaxRecords", (Integer.to_json f)));
    ...
    let of_json j =
      {
        ...
        marker =
          (Aws.Util.option_map (Aws.Json.lookup j "Marker") String.of_json);
        show_cache_node_info =
          (Aws.Util.option_map (Aws.Json.lookup j "ShowCacheNodeInfo")
             Boolean.of_json);
        show_cache_clusters_not_in_replication_groups =
          (Aws.Util.option_map
    ...
    let of_json j =
      {
        ...
        cache_parameter_groups =
          (CacheParameterGroupList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "CacheParameterGroups")))
      }
  end
