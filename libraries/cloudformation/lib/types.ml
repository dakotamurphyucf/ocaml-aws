  ...
  struct
    ...
    let parse xml =
      Some
        {
          operation_id =
            (Aws.Util.option_bind (Aws.Xml.member "OperationId" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.operation_id
              (fun f -> Aws.Query.Pair ("OperationId", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.operation_id
              (fun f -> ("OperationId", (String.to_json f)))])
    let of_json j =
      {
        operation_id =
          (Aws.Util.option_map (Aws.Json.lookup j "OperationId")
             String.of_json)
      }
  end
...
module RollbackTrigger =
  struct
    ...
    let of_json j =
      {
        arn =
          (String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Arn")));
        type_ =
...
module RollbackTriggers =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map RollbackTrigger.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          enable_termination_protection =
            (Aws.Xml.required "EnableTerminationProtection"
               (Aws.Util.option_bind
                  (Aws.Xml.member "EnableTerminationProtection" xml)
                  Boolean.parse));
          stack_name =
            (Aws.Xml.required "StackName"
               (Aws.Util.option_bind (Aws.Xml.member "StackName" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair ("StackName", (String.to_query v.stack_name)));
           Some
             (Aws.Query.Pair
    ...
    let of_json j =
      {
        ...
        stack_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StackName")))
      }
  end
  ...
  struct
      ...
      Some
        {
          ...
          status_reason =
            (Aws.Util.option_bind (Aws.Xml.member "StatusReason" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.status_reason
              (fun f -> Aws.Query.Pair ("StatusReason", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.status_reason
              (fun f -> ("StatusReason", (String.to_json f)));
           Aws.Util.option_map v.status
    ...
    let of_json j =
      {
        status =
          (Aws.Util.option_map (Aws.Json.lookup j "Status")
             AccountGateStatus.of_json);
        status_reason =
          (Aws.Util.option_map (Aws.Json.lookup j "StatusReason")
             String.of_json)
      }
  end
      ...
      Some
        {
          ...
          status_reason =
            (Aws.Util.option_bind (Aws.Xml.member "StatusReason" xml)
               String.parse);
          account_gate_result =
            (Aws.Util.option_bind (Aws.Xml.member "AccountGateResult" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.account_gate_result
             (fun f ->
                Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.account_gate_result
             (fun f -> ("AccountGateResult", (AccountGateResult.to_json f)));
           Aws.Util.option_map v.status_reason
             (fun f -> ("StatusReason", (String.to_json f)));
           Aws.Util.option_map v.status
    ...
    let of_json j =
      {
        ...
        status_reason =
          (Aws.Util.option_map (Aws.Json.lookup j "StatusReason")
             String.of_json);
        account_gate_result =
          (Aws.Util.option_map (Aws.Json.lookup j "AccountGateResult")
...
module StageList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map TemplateStage.parse (Aws.Xml.members "member" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          template_body =
            (Aws.Util.option_bind (Aws.Xml.member "TemplateBody" xml)
               String.parse);
          stages_available =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "StagesAvailable" xml)
                  StageList.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.template_body
             (fun f -> Aws.Query.Pair ("TemplateBody", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("StagesAvailable", (StageList.to_json v.stages_available));
           Aws.Util.option_map v.template_body
             (fun f -> ("TemplateBody", (String.to_json f)))])
    let of_json j =
      {
        template_body =
          (Aws.Util.option_map (Aws.Json.lookup j "TemplateBody")
             String.of_json);
        stages_available =
          (StageList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StagesAvailable")))
      }
  end
    ...
    let of_json j =
      {
        allowed_values =
          (AllowedValues.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AllowedValues")))
      }
  end
      ...
      Some
        {
          stack_drift_detection_id =
            (Aws.Xml.required "StackDriftDetectionId"
               (Aws.Util.option_bind
                  (Aws.Xml.member "StackDriftDetectionId" xml) String.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        stack_drift_detection_id =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "StackDriftDetectionId")))
      }
  end
module RegionList =
  struct
  ...
  struct
    ...
    let parse xml =
      Some
        {
          property_path =
            (Aws.Xml.required "PropertyPath"
               (Aws.Util.option_bind (Aws.Xml.member "PropertyPath" xml)
                  String.parse));
          expected_value =
            (Aws.Xml.required "ExpectedValue"
               (Aws.Util.option_bind (Aws.Xml.member "ExpectedValue" xml)
                  String.parse));
          actual_value =
            (Aws.Xml.required "ActualValue"
               (Aws.Util.option_bind (Aws.Xml.member "ActualValue" xml)
                  String.parse));
          difference_type =
            (Aws.Xml.required "DifferenceType"
               (Aws.Util.option_bind (Aws.Xml.member "DifferenceType" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("ActualValue", (String.to_query v.actual_value)));
           Some
             (Aws.Query.Pair
                ("ExpectedValue", (String.to_query v.expected_value)));
           Some
             (Aws.Query.Pair
                ("PropertyPath", (String.to_query v.property_path)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("DifferenceType", (DifferenceType.to_json v.difference_type));
    ...
    let of_json j =
      {
        property_path =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "PropertyPath")));
        expected_value =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ExpectedValue")));
        actual_value =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ActualValue")));
        difference_type =
...
module PropertyDifferences =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map PropertyDifference.parse (Aws.Xml.members "member" xml))
...
module PhysicalResourceIdContext =
  struct
    ...
    let to_query v =
      Aws.Query.to_query_list PhysicalResourceIdContextKeyValuePair.to_query
        v
    let to_json v =
      `List (List.map PhysicalResourceIdContextKeyValuePair.to_json v)
    let of_json j =
      Aws.Json.to_list PhysicalResourceIdContextKeyValuePair.of_json j
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          stack_id =
            (Aws.Xml.required "StackId"
               (Aws.Util.option_bind (Aws.Xml.member "StackId" xml)
                  String.parse));
          logical_resource_id =
            (Aws.Xml.required "LogicalResourceId"
               (Aws.Util.option_bind (Aws.Xml.member "LogicalResourceId" xml)
                  String.parse));
          physical_resource_id =
            (Aws.Util.option_bind (Aws.Xml.member "PhysicalResourceId" xml)
               String.parse);
          physical_resource_id_context =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
          ...
          resource_type =
            (Aws.Xml.required "ResourceType"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceType" xml)
                  String.parse));
          expected_properties =
            (Aws.Util.option_bind (Aws.Xml.member "ExpectedProperties" xml)
               String.parse);
          actual_properties =
            (Aws.Util.option_bind (Aws.Xml.member "ActualProperties" xml)
               String.parse);
          property_differences =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
          ...
          stack_resource_drift_status =
            (Aws.Xml.required "StackResourceDriftStatus"
               (Aws.Util.option_bind
                  (Aws.Xml.member "StackResourceDriftStatus" xml)
                  StackResourceDriftStatus.parse));
          timestamp =
            (Aws.Xml.required "Timestamp"
               (Aws.Util.option_bind (Aws.Xml.member "Timestamp" xml)
                  DateTime.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair ("Timestamp", (DateTime.to_query v.timestamp)));
           Some
             (Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.actual_properties
             (fun f -> ("ActualProperties", (String.to_json f)));
           Aws.Util.option_map v.expected_properties
             (fun f -> ("ExpectedProperties", (String.to_json f)));
           ...
           Some
             ("PhysicalResourceIdContext",
               (PhysicalResourceIdContext.to_json
                  v.physical_resource_id_context));
           Aws.Util.option_map v.physical_resource_id
             (fun f -> ("PhysicalResourceId", (String.to_json f)));
    ...
    let of_json j =
      {
        stack_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StackId")));
        logical_resource_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "LogicalResourceId")));
        physical_resource_id =
          (Aws.Util.option_map (Aws.Json.lookup j "PhysicalResourceId")
             String.of_json);
        physical_resource_id_context =
          (PhysicalResourceIdContext.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "PhysicalResourceIdContext")));
        resource_type =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ResourceType")));
        expected_properties =
          (Aws.Util.option_map (Aws.Json.lookup j "ExpectedProperties")
             String.of_json);
        actual_properties =
          (Aws.Util.option_map (Aws.Json.lookup j "ActualProperties")
             String.of_json);
        property_differences =
          (PropertyDifferences.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "PropertyDifferences")));
        stack_resource_drift_status =
          (StackResourceDriftStatus.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "StackResourceDriftStatus")));
        timestamp =
          (DateTime.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Timestamp")))
      }
  end
      ...
      Some
        {
          stack_resource_drift =
            (Aws.Xml.required "StackResourceDrift"
               (Aws.Util.option_bind
  ...
  struct
      ...
      Some
        {
          ...
          last_check_timestamp =
            (Aws.Util.option_bind (Aws.Xml.member "LastCheckTimestamp" xml)
               DateTime.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.last_check_timestamp
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.last_check_timestamp
              (fun f -> ("LastCheckTimestamp", (DateTime.to_json f)));
           Some
             ("StackResourceDriftStatus",
               (StackResourceDriftStatus.to_json
                  v.stack_resource_drift_status))])
        ...
        stack_resource_drift_status =
          (StackResourceDriftStatus.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "StackResourceDriftStatus")));
        last_check_timestamp =
          (Aws.Util.option_map (Aws.Json.lookup j "LastCheckTimestamp")
             DateTime.of_json)
      }
  end
          ...
          timestamp =
            (Aws.Xml.required "Timestamp"
               (Aws.Util.option_bind (Aws.Xml.member "Timestamp" xml)
                  DateTime.parse));
          resource_status =
            (Aws.Xml.required "ResourceStatus"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceStatus" xml)
                  ResourceStatus.parse));
          resource_status_reason =
            (Aws.Util.option_bind (Aws.Xml.member "ResourceStatusReason" xml)
               String.parse);
          description =
            (Aws.Util.option_bind (Aws.Xml.member "Description" xml)
               String.parse);
          drift_information =
            (Aws.Util.option_bind (Aws.Xml.member "DriftInformation" xml)
               StackResourceDriftInformation.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.drift_information
              (fun f ->
                 Aws.Query.Pair
                   ("DriftInformation",
           ...
           Aws.Util.option_map v.resource_status_reason
             (fun f ->
           ...
           Some
             (Aws.Query.Pair
                ("LogicalResourceId",
                  (String.to_query v.logical_resource_id)));
           Aws.Util.option_map v.stack_id
             (fun f -> Aws.Query.Pair ("StackId", (String.to_query f)));
           Aws.Util.option_map v.stack_name
             (fun f -> Aws.Query.Pair ("StackName", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.drift_information
           ...
           Aws.Util.option_map v.resource_status_reason
             (fun f -> ("ResourceStatusReason", (String.to_json f)));
           Some
             ("ResourceStatus", (ResourceStatus.to_json v.resource_status));
           Some ("Timestamp", (DateTime.to_json v.timestamp));
           Some ("ResourceType", (String.to_json v.resource_type));
           Aws.Util.option_map v.physical_resource_id
             (fun f -> ("PhysicalResourceId", (String.to_json f)));
           Some ("LogicalResourceId", (String.to_json v.logical_resource_id));
           Aws.Util.option_map v.stack_id
             (fun f -> ("StackId", (String.to_json f)));
           Aws.Util.option_map v.stack_name
             (fun f -> ("StackName", (String.to_json f)))])
    let of_json j =
      {
        stack_name =
          (Aws.Util.option_map (Aws.Json.lookup j "StackName") String.of_json);
        stack_id =
          (Aws.Util.option_map (Aws.Json.lookup j "StackId") String.of_json);
        logical_resource_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "LogicalResourceId")));
        physical_resource_id =
        ...
        resource_status_reason =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourceStatusReason")
             String.of_json);
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json);
        drift_information =
          (Aws.Util.option_map (Aws.Json.lookup j "DriftInformation")
...
module StackResources =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map StackResource.parse (Aws.Xml.members "member" xml))
  ...
  struct
      ...
      Some
        {
          stack_resources =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "StackResources" xml)
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("StackResources", (StackResources.to_json v.stack_resources))])
    let of_json j =
      {
        stack_resources =
...
module AutoDeployment =
  struct
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.retain_stacks_on_account_removal
              (fun f ->
                 Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.retain_stacks_on_account_removal
              (fun f -> ("RetainStacksOnAccountRemoval", (Boolean.to_json f)));
           Aws.Util.option_map v.enabled
  ...
  struct
    ...
    let parse xml =
      Some
        {
          stack_set_name =
            (Aws.Util.option_bind (Aws.Xml.member "StackSetName" xml)
               String.parse);
          stack_set_id =
            (Aws.Util.option_bind (Aws.Xml.member "StackSetId" xml)
               String.parse);
          description =
            (Aws.Util.option_bind (Aws.Xml.member "Description" xml)
               String.parse);
          status =
            (Aws.Util.option_bind (Aws.Xml.member "Status" xml)
               StackSetStatus.parse);
          auto_deployment =
            (Aws.Util.option_bind (Aws.Xml.member "AutoDeployment" xml)
               AutoDeployment.parse);
          permission_model =
            (Aws.Util.option_bind (Aws.Xml.member "PermissionModel" xml)
               PermissionModels.parse);
          drift_status =
            (Aws.Util.option_bind (Aws.Xml.member "DriftStatus" xml)
               StackDriftStatus.parse);
          last_drift_check_timestamp =
            (Aws.Util.option_bind
               (Aws.Xml.member "LastDriftCheckTimestamp" xml) DateTime.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.last_drift_check_timestamp
              (fun f ->
                 Aws.Query.Pair
                   ("LastDriftCheckTimestamp", (DateTime.to_query f)));
           Aws.Util.option_map v.drift_status
             (fun f ->
                Aws.Query.Pair ("DriftStatus", (StackDriftStatus.to_query f)));
           Aws.Util.option_map v.permission_model
             (fun f ->
                Aws.Query.Pair
                  ("PermissionModel", (PermissionModels.to_query f)));
           Aws.Util.option_map v.auto_deployment
             (fun f ->
                Aws.Query.Pair
                  ("AutoDeployment", (AutoDeployment.to_query f)));
           Aws.Util.option_map v.status
             (fun f -> Aws.Query.Pair ("Status", (StackSetStatus.to_query f)));
           Aws.Util.option_map v.description
             (fun f -> Aws.Query.Pair ("Description", (String.to_query f)));
           Aws.Util.option_map v.stack_set_id
             (fun f -> Aws.Query.Pair ("StackSetId", (String.to_query f)));
           Aws.Util.option_map v.stack_set_name
             (fun f -> Aws.Query.Pair ("StackSetName", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.last_drift_check_timestamp
              (fun f -> ("LastDriftCheckTimestamp", (DateTime.to_json f)));
           Aws.Util.option_map v.drift_status
             (fun f -> ("DriftStatus", (StackDriftStatus.to_json f)));
           Aws.Util.option_map v.permission_model
             (fun f -> ("PermissionModel", (PermissionModels.to_json f)));
           Aws.Util.option_map v.auto_deployment
             (fun f -> ("AutoDeployment", (AutoDeployment.to_json f)));
           Aws.Util.option_map v.status
             (fun f -> ("Status", (StackSetStatus.to_json f)));
           Aws.Util.option_map v.description
             (fun f -> ("Description", (String.to_json f)));
           Aws.Util.option_map v.stack_set_id
             (fun f -> ("StackSetId", (String.to_json f)));
           Aws.Util.option_map v.stack_set_name
             (fun f -> ("StackSetName", (String.to_json f)))])
    let of_json j =
      {
        stack_set_name =
          (Aws.Util.option_map (Aws.Json.lookup j "StackSetName")
             String.of_json);
        stack_set_id =
          (Aws.Util.option_map (Aws.Json.lookup j "StackSetId")
             String.of_json);
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json);
        status =
          (Aws.Util.option_map (Aws.Json.lookup j "Status")
             StackSetStatus.of_json);
        auto_deployment =
          (Aws.Util.option_map (Aws.Json.lookup j "AutoDeployment")
             AutoDeployment.of_json);
        permission_model =
          (Aws.Util.option_map (Aws.Json.lookup j "PermissionModel")
             PermissionModels.of_json);
        drift_status =
          (Aws.Util.option_map (Aws.Json.lookup j "DriftStatus")
             StackDriftStatus.of_json);
        last_drift_check_timestamp =
          (Aws.Util.option_map (Aws.Json.lookup j "LastDriftCheckTimestamp")
             DateTime.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          stack_drift_status =
            (Aws.Xml.required "StackDriftStatus"
               (Aws.Util.option_bind (Aws.Xml.member "StackDriftStatus" xml)
                  StackDriftStatus.parse));
          last_check_timestamp =
            (Aws.Util.option_bind (Aws.Xml.member "LastCheckTimestamp" xml)
               DateTime.parse)
      ...
      Some
        {
          ...
          stack_name =
            (Aws.Xml.required "StackName"
               (Aws.Util.option_bind (Aws.Xml.member "StackName" xml)
                  String.parse));
          template_description =
            (Aws.Util.option_bind (Aws.Xml.member "TemplateDescription" xml)
               String.parse);
          creation_time =
            (Aws.Xml.required "CreationTime"
          ...
          deletion_time =
            (Aws.Util.option_bind (Aws.Xml.member "DeletionTime" xml)
               DateTime.parse);
          stack_status =
            (Aws.Xml.required "StackStatus"
               (Aws.Util.option_bind (Aws.Xml.member "StackStatus" xml)
                  StackStatus.parse));
          stack_status_reason =
            (Aws.Util.option_bind (Aws.Xml.member "StackStatusReason" xml)
               String.parse);
          parent_id =
            (Aws.Util.option_bind (Aws.Xml.member "ParentId" xml)
               String.parse);
          root_id =
            (Aws.Util.option_bind (Aws.Xml.member "RootId" xml) String.parse);
          drift_information =
            (Aws.Util.option_bind (Aws.Xml.member "DriftInformation" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.root_id
             (fun f -> Aws.Query.Pair ("RootId", (String.to_query f)));
           Aws.Util.option_map v.parent_id
             (fun f -> Aws.Query.Pair ("ParentId", (String.to_query f)));
           Aws.Util.option_map v.stack_status_reason
             (fun f ->
           ...
           Aws.Util.option_map v.deletion_time
             (fun f -> Aws.Query.Pair ("DeletionTime", (DateTime.to_query f)));
           ...
           Aws.Util.option_map v.template_description
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.root_id
             (fun f -> ("RootId", (String.to_json f)));
           Aws.Util.option_map v.parent_id
             (fun f -> ("ParentId", (String.to_json f)));
           Aws.Util.option_map v.stack_status_reason
             (fun f -> ("StackStatusReason", (String.to_json f)));
           Some ("StackStatus", (StackStatus.to_json v.stack_status));
           Aws.Util.option_map v.deletion_time
             (fun f -> ("DeletionTime", (DateTime.to_json f)));
           Aws.Util.option_map v.last_updated_time
             (fun f -> ("LastUpdatedTime", (DateTime.to_json f)));
           Some ("CreationTime", (DateTime.to_json v.creation_time));
           Aws.Util.option_map v.template_description
             (fun f -> ("TemplateDescription", (String.to_json f)));
           Some ("StackName", (String.to_json v.stack_name));
           Aws.Util.option_map v.stack_id
             (fun f -> ("StackId", (String.to_json f)))])
    let of_json j =
      {
        ...
        stack_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StackName")));
        template_description =
          (Aws.Util.option_map (Aws.Json.lookup j "TemplateDescription")
             String.of_json);
        creation_time =
          (DateTime.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "CreationTime")));
        last_updated_time =
          (Aws.Util.option_map (Aws.Json.lookup j "LastUpdatedTime")
             DateTime.of_json);
        deletion_time =
          (Aws.Util.option_map (Aws.Json.lookup j "DeletionTime")
             DateTime.of_json);
        stack_status =
          (StackStatus.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StackStatus")));
        stack_status_reason =
          (Aws.Util.option_map (Aws.Json.lookup j "StackStatusReason")
             String.of_json);
        parent_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ParentId") String.of_json);
        root_id =
          (Aws.Util.option_map (Aws.Json.lookup j "RootId") String.of_json);
        drift_information =
          (Aws.Util.option_map (Aws.Json.lookup j "DriftInformation")
      ...
      Some
        {
          ...
          values =
            (Aws.Util.option_bind (Aws.Xml.member "Values" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.values
              (fun f -> Aws.Query.Pair ("Values", (String.to_query f)));
    ...
    let of_json j =
      {
        ...
        values =
          (Aws.Util.option_map (Aws.Json.lookup j "Values") String.of_json)
      }
  end
  ...
  struct
      ...
      Some
        {
          region_order =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "RegionOrder" xml)
                  RegionList.parse));
          failure_tolerance_count =
            (Aws.Util.option_bind
               (Aws.Xml.member "FailureToleranceCount" xml) Integer.parse);
          failure_tolerance_percentage =
            (Aws.Util.option_bind
               (Aws.Xml.member "FailureTolerancePercentage" xml)
               Integer.parse);
          max_concurrent_count =
            (Aws.Util.option_bind (Aws.Xml.member "MaxConcurrentCount" xml)
               Integer.parse);
          max_concurrent_percentage =
            (Aws.Util.option_bind
               (Aws.Xml.member "MaxConcurrentPercentage" xml) Integer.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_concurrent_percentage
              (fun f ->
                 Aws.Query.Pair
                   ("MaxConcurrentPercentage", (Integer.to_query f)));
           Aws.Util.option_map v.max_concurrent_count
             (fun f ->
                Aws.Query.Pair ("MaxConcurrentCount", (Integer.to_query f)));
           Aws.Util.option_map v.failure_tolerance_percentage
             (fun f ->
                Aws.Query.Pair
                  ("FailureTolerancePercentage", (Integer.to_query f)));
           Aws.Util.option_map v.failure_tolerance_count
             (fun f ->
                Aws.Query.Pair
                  ("FailureToleranceCount", (Integer.to_query f)));
           Some
             (Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.max_concurrent_percentage
              (fun f -> ("MaxConcurrentPercentage", (Integer.to_json f)));
           Aws.Util.option_map v.max_concurrent_count
             (fun f -> ("MaxConcurrentCount", (Integer.to_json f)));
           Aws.Util.option_map v.failure_tolerance_percentage
             (fun f -> ("FailureTolerancePercentage", (Integer.to_json f)));
           Aws.Util.option_map v.failure_tolerance_count
             (fun f -> ("FailureToleranceCount", (Integer.to_json f)));
           Some ("RegionOrder", (RegionList.to_json v.region_order))])
    let of_json j =
      {
        region_order =
          (RegionList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RegionOrder")));
        failure_tolerance_count =
          (Aws.Util.option_map (Aws.Json.lookup j "FailureToleranceCount")
             Integer.of_json);
        failure_tolerance_percentage =
          (Aws.Util.option_map
             (Aws.Json.lookup j "FailureTolerancePercentage") Integer.of_json);
        max_concurrent_count =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxConcurrentCount")
             Integer.of_json);
        max_concurrent_percentage =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxConcurrentPercentage")
             Integer.of_json)
      }
  end
module Parameter =
  struct
    ...
    let parse xml =
      Some
        {
          parameter_key =
            (Aws.Util.option_bind (Aws.Xml.member "ParameterKey" xml)
               String.parse);
          parameter_value =
            (Aws.Util.option_bind (Aws.Xml.member "ParameterValue" xml)
               String.parse);
          use_previous_value =
            (Aws.Util.option_bind (Aws.Xml.member "UsePreviousValue" xml)
               Boolean.parse);
          resolved_value =
            (Aws.Util.option_bind (Aws.Xml.member "ResolvedValue" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.resolved_value
              (fun f -> Aws.Query.Pair ("ResolvedValue", (String.to_query f)));
           Aws.Util.option_map v.use_previous_value
             (fun f ->
           ...
           Aws.Util.option_map v.parameter_key
             (fun f -> Aws.Query.Pair ("ParameterKey", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.resolved_value
              (fun f -> ("ResolvedValue", (String.to_json f)));
           Aws.Util.option_map v.use_previous_value
             (fun f -> ("UsePreviousValue", (Boolean.to_json f)));
           Aws.Util.option_map v.parameter_value
             (fun f -> ("ParameterValue", (String.to_json f)));
           Aws.Util.option_map v.parameter_key
             (fun f -> ("ParameterKey", (String.to_json f)))])
    let of_json j =
      {
        parameter_key =
          (Aws.Util.option_map (Aws.Json.lookup j "ParameterKey")
             String.of_json);
        parameter_value =
          (Aws.Util.option_map (Aws.Json.lookup j "ParameterValue")
             String.of_json);
        use_previous_value =
          (Aws.Util.option_map (Aws.Json.lookup j "UsePreviousValue")
             Boolean.of_json);
        resolved_value =
          (Aws.Util.option_map (Aws.Json.lookup j "ResolvedValue")
             String.of_json)
      }
  end
module Parameters =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Parameter.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          accounts =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Accounts" xml)
                  AccountList.parse));
    ...
    let of_json j =
      {
        accounts =
          (AccountList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Accounts")));
        organizational_unit_ids =
          (OrganizationalUnitIdList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "OrganizationalUnitIds")))
      }
  end
          ...
          accounts =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Accounts" xml)
                  AccountList.parse));
          deployment_targets =
            (Aws.Util.option_bind (Aws.Xml.member "DeploymentTargets" xml)
               DeploymentTargets.parse);
          regions =
            (Aws.Xml.required "Regions"
               (Aws.Util.option_bind (Aws.Xml.member "Regions" xml)
                  RegionList.parse));
          parameter_overrides =
            (Aws.Util.of_option []
               (Aws.Util.option_bind
                  (Aws.Xml.member "ParameterOverrides" xml) Parameters.parse));
          operation_preferences =
            (Aws.Util.option_bind (Aws.Xml.member "OperationPreferences" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.operation_id
              (fun f -> Aws.Query.Pair ("OperationId", (String.to_query f)));
           Aws.Util.option_map v.operation_preferences
             (fun f ->
                Aws.Query.Pair
           ...
           Some
             (Aws.Query.Pair
                ("Regions.member", (RegionList.to_query v.regions)));
           Aws.Util.option_map v.deployment_targets
             (fun f ->
                Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.deployment_targets
             (fun f -> ("DeploymentTargets", (DeploymentTargets.to_json f)));
           Some ("Accounts", (AccountList.to_json v.accounts));
    ...
    let of_json j =
      {
        stack_set_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StackSetName")));
        accounts =
          (AccountList.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Accounts")));
        deployment_targets =
          (Aws.Util.option_map (Aws.Json.lookup j "DeploymentTargets")
        ...
        operation_preferences =
          (Aws.Util.option_map (Aws.Json.lookup j "OperationPreferences")
    ...
    let of_json j =
      {
        registration_token_list =
          (RegistrationTokenList.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "RegistrationTokenList")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
  ...
  struct
      ...
      Some
        {
          stack_id =
            (Aws.Xml.required "StackId"
               (Aws.Util.option_bind (Aws.Xml.member "StackId" xml)
                  String.parse));
          event_id =
            (Aws.Xml.required "EventId"
               (Aws.Util.option_bind (Aws.Xml.member "EventId" xml)
                  String.parse));
          stack_name =
            (Aws.Xml.required "StackName"
               (Aws.Util.option_bind (Aws.Xml.member "StackName" xml)
          ...
          resource_status_reason =
            (Aws.Util.option_bind (Aws.Xml.member "ResourceStatusReason" xml)
               String.parse);
          resource_properties =
            (Aws.Util.option_bind (Aws.Xml.member "ResourceProperties" xml)
               String.parse);
          client_request_token =
            (Aws.Util.option_bind (Aws.Xml.member "ClientRequestToken" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.client_request_token
              (fun f ->
                 Aws.Query.Pair ("ClientRequestToken", (String.to_query f)));
           Aws.Util.option_map v.resource_properties
             (fun f ->
                Aws.Query.Pair ("ResourceProperties", (String.to_query f)));
           Aws.Util.option_map v.resource_status_reason
             (fun f ->
                Aws.Query.Pair ("ResourceStatusReason", (String.to_query f)));
           Aws.Util.option_map v.resource_status
             (fun f ->
                Aws.Query.Pair
                  ("ResourceStatus", (ResourceStatus.to_query f)));
           Some
             (Aws.Query.Pair ("Timestamp", (DateTime.to_query v.timestamp)));
           ...
           Aws.Util.option_map v.physical_resource_id
             (fun f ->
                Aws.Query.Pair ("PhysicalResourceId", (String.to_query f)));
           Aws.Util.option_map v.logical_resource_id
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.client_request_token
              (fun f -> ("ClientRequestToken", (String.to_json f)));
           Aws.Util.option_map v.resource_properties
             (fun f -> ("ResourceProperties", (String.to_json f)));
           Aws.Util.option_map v.resource_status_reason
             (fun f -> ("ResourceStatusReason", (String.to_json f)));
           Aws.Util.option_map v.resource_status
             (fun f -> ("ResourceStatus", (ResourceStatus.to_json f)));
           Some ("Timestamp", (DateTime.to_json v.timestamp));
           Aws.Util.option_map v.resource_type
           ...
           Aws.Util.option_map v.physical_resource_id
             (fun f -> ("PhysicalResourceId", (String.to_json f)));
           Aws.Util.option_map v.logical_resource_id
             (fun f -> ("LogicalResourceId", (String.to_json f)));
           Some ("StackName", (String.to_json v.stack_name));
    ...
    let of_json j =
      {
        ...
        event_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "EventId")));
        stack_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StackName")));
        logical_resource_id =
          (Aws.Util.option_map (Aws.Json.lookup j "LogicalResourceId")
             String.of_json);
        physical_resource_id =
          (Aws.Util.option_map (Aws.Json.lookup j "PhysicalResourceId")
             String.of_json);
        ...
        timestamp =
          (DateTime.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Timestamp")));
        resource_status =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourceStatus")
             ResourceStatus.of_json);
        resource_status_reason =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourceStatusReason")
             String.of_json);
        resource_properties =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourceProperties")
             String.of_json);
        client_request_token =
          (Aws.Util.option_map (Aws.Json.lookup j "ClientRequestToken")
             String.of_json)
      }
  end
module StackEvents =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map StackEvent.parse (Aws.Xml.members "member" xml))
  ...
  struct
      ...
      Some
        {
          rollback_triggers =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "RollbackTriggers" xml)
                  RollbackTriggers.parse));
          monitoring_time_in_minutes =
            (Aws.Util.option_bind
               (Aws.Xml.member "MonitoringTimeInMinutes" xml) Integer.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.monitoring_time_in_minutes
              (fun f ->
                 Aws.Query.Pair
                   ("MonitoringTimeInMinutes", (Integer.to_query f)));
           Some
             (Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.monitoring_time_in_minutes
              (fun f -> ("MonitoringTimeInMinutes", (Integer.to_json f)));
           Some
             ("RollbackTriggers",
    ...
    let of_json j =
      {
        ...
        monitoring_time_in_minutes =
          (Aws.Util.option_map (Aws.Json.lookup j "MonitoringTimeInMinutes")
             Integer.of_json)
      }
  end
module ChangeAction =
...
module Tags =
  struct
    ...
    let make elems () = elems
    let parse xml =
      Aws.Util.option_all (List.map Tag.parse (Aws.Xml.members "member" xml))
...
module Capabilities =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Capability.parse (Aws.Xml.members "member" xml))
...
module CreateStackInput =
  struct
      ...
      Some
        {
          ...
          template_body =
            (Aws.Util.option_bind (Aws.Xml.member "TemplateBody" xml)
               String.parse);
          template_u_r_l =
            (Aws.Util.option_bind (Aws.Xml.member "TemplateURL" xml)
               String.parse);
          parameters =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Parameters" xml)
                  Parameters.parse));
          disable_rollback =
            (Aws.Util.option_bind (Aws.Xml.member "DisableRollback" xml)
               Boolean.parse);
          rollback_configuration =
            (Aws.Util.option_bind
          ...
          timeout_in_minutes =
            (Aws.Util.option_bind (Aws.Xml.member "TimeoutInMinutes" xml)
               Integer.parse);
          notification_a_r_ns =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "NotificationARNs" xml)
                  NotificationARNs.parse));
          capabilities =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Capabilities" xml)
                  Capabilities.parse));
          resource_types =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ResourceTypes" xml)
                  ResourceTypes.parse));
          role_a_r_n =
            (Aws.Util.option_bind (Aws.Xml.member "RoleARN" xml) String.parse);
          on_failure =
            (Aws.Util.option_bind (Aws.Xml.member "OnFailure" xml)
               OnFailure.parse);
          stack_policy_body =
            (Aws.Util.option_bind (Aws.Xml.member "StackPolicyBody" xml)
               String.parse);
          stack_policy_u_r_l =
            (Aws.Util.option_bind (Aws.Xml.member "StackPolicyURL" xml)
               String.parse);
          tags =
            (Aws.Util.of_option []
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.enable_termination_protection
              (fun f ->
                 Aws.Query.Pair
           ...
           Aws.Util.option_map v.stack_policy_u_r_l
             (fun f -> Aws.Query.Pair ("StackPolicyURL", (String.to_query f)));
           Aws.Util.option_map v.stack_policy_body
             (fun f ->
                Aws.Query.Pair ("StackPolicyBody", (String.to_query f)));
           Aws.Util.option_map v.on_failure
             (fun f -> Aws.Query.Pair ("OnFailure", (OnFailure.to_query f)));
           Aws.Util.option_map v.role_a_r_n
             (fun f -> Aws.Query.Pair ("RoleARN", (String.to_query f)));
           Some
             (Aws.Query.Pair
           ...
           Aws.Util.option_map v.timeout_in_minutes
             (fun f ->
                Aws.Query.Pair ("TimeoutInMinutes", (Integer.to_query f)));
           Aws.Util.option_map v.rollback_configuration
             (fun f ->
                Aws.Query.Pair
                  ("RollbackConfiguration",
                    (RollbackConfiguration.to_query f)));
           Aws.Util.option_map v.disable_rollback
             (fun f ->
                Aws.Query.Pair ("DisableRollback", (Boolean.to_query f)));
           Some
             (Aws.Query.Pair
                ("Parameters.member", (Parameters.to_query v.parameters)));
           Aws.Util.option_map v.template_u_r_l
             (fun f -> Aws.Query.Pair ("TemplateURL", (String.to_query f)));
           Aws.Util.option_map v.template_body
             (fun f -> Aws.Query.Pair ("TemplateBody", (String.to_query f)));
           Some
             (Aws.Query.Pair ("StackName", (String.to_query v.stack_name)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.enable_termination_protection
              (fun f -> ("EnableTerminationProtection", (Boolean.to_json f)));
           Aws.Util.option_map v.client_request_token
             (fun f -> ("ClientRequestToken", (String.to_json f)));
           Some ("Tags", (Tags.to_json v.tags));
           Aws.Util.option_map v.stack_policy_u_r_l
             (fun f -> ("StackPolicyURL", (String.to_json f)));
           Aws.Util.option_map v.stack_policy_body
             (fun f -> ("StackPolicyBody", (String.to_json f)));
           Aws.Util.option_map v.on_failure
             (fun f -> ("OnFailure", (OnFailure.to_json f)));
           Aws.Util.option_map v.role_a_r_n
             (fun f -> ("RoleARN", (String.to_json f)));
           ...
           Aws.Util.option_map v.timeout_in_minutes
             (fun f -> ("TimeoutInMinutes", (Integer.to_json f)));
           Aws.Util.option_map v.rollback_configuration
             (fun f ->
                ("RollbackConfiguration", (RollbackConfiguration.to_json f)));
           Aws.Util.option_map v.disable_rollback
             (fun f -> ("DisableRollback", (Boolean.to_json f)));
           Some ("Parameters", (Parameters.to_json v.parameters));
           Aws.Util.option_map v.template_u_r_l
             (fun f -> ("TemplateURL", (String.to_json f)));
           Aws.Util.option_map v.template_body
             (fun f -> ("TemplateBody", (String.to_json f)));
           Some ("StackName", (String.to_json v.stack_name))])
    let of_json j =
      {
        ...
        template_body =
          (Aws.Util.option_map (Aws.Json.lookup j "TemplateBody")
             String.of_json);
        template_u_r_l =
          (Aws.Util.option_map (Aws.Json.lookup j "TemplateURL")
             String.of_json);
        parameters =
          (Parameters.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Parameters")));
        disable_rollback =
          (Aws.Util.option_map (Aws.Json.lookup j "DisableRollback")
             Boolean.of_json);
        rollback_configuration =
          (Aws.Util.option_map (Aws.Json.lookup j "RollbackConfiguration")
             RollbackConfiguration.of_json);
        timeout_in_minutes =
          (Aws.Util.option_map (Aws.Json.lookup j "TimeoutInMinutes")
             Integer.of_json);
        notification_a_r_ns =
        ...
        capabilities =
          (Capabilities.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Capabilities")));
        resource_types =
          (ResourceTypes.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ResourceTypes")));
        role_a_r_n =
          (Aws.Util.option_map (Aws.Json.lookup j "RoleARN") String.of_json);
        on_failure =
          (Aws.Util.option_map (Aws.Json.lookup j "OnFailure")
             OnFailure.of_json);
        stack_policy_body =
          (Aws.Util.option_map (Aws.Json.lookup j "StackPolicyBody")
             String.of_json);
        stack_policy_u_r_l =
          (Aws.Util.option_map (Aws.Json.lookup j "StackPolicyURL")
             String.of_json);
        tags =
          (Tags.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Tags")));
        client_request_token =
          (Aws.Util.option_map (Aws.Json.lookup j "ClientRequestToken")
             String.of_json);
        enable_termination_protection =
      ...
      Some
        {
          ...
          stack_instance_account =
            (Aws.Xml.required "StackInstanceAccount"
               (Aws.Util.option_bind
                  (Aws.Xml.member "StackInstanceAccount" xml) String.parse));
          stack_instance_region =
            (Aws.Xml.required "StackInstanceRegion"
               (Aws.Util.option_bind
                  (Aws.Xml.member "StackInstanceRegion" xml) String.parse))
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        ...
        stack_instance_account =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "StackInstanceAccount")));
        stack_instance_region =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "StackInstanceRegion")))
      }
  end
module AccountLimit =
  struct
      ...
      Some
        {
          ...
          value =
            (Aws.Util.option_bind (Aws.Xml.member "Value" xml) Integer.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.value
              (fun f -> Aws.Query.Pair ("Value", (Integer.to_query f)));
           Aws.Util.option_map v.name
    ...
    let of_json j =
      {
        ...
        value =
          (Aws.Util.option_map (Aws.Json.lookup j "Value") Integer.of_json)
      }
  end
module AccountLimitList =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map AccountLimit.parse (Aws.Xml.members "member" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          change_set_name =
            (Aws.Xml.required "ChangeSetName"
               (Aws.Util.option_bind (Aws.Xml.member "ChangeSetName" xml)
                  String.parse));
          stack_name =
            (Aws.Util.option_bind (Aws.Xml.member "StackName" xml)
               String.parse);
    ...
    let of_json j =
      {
        change_set_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ChangeSetName")));
        stack_name =
          (Aws.Util.option_map (Aws.Json.lookup j "StackName") String.of_json);
        client_request_token =
          (Aws.Util.option_map (Aws.Json.lookup j "ClientRequestToken")
      ...
      Some
        {
          ...
          template_u_r_l =
            (Aws.Util.option_bind (Aws.Xml.member "TemplateURL" xml)
               String.parse);
          use_previous_template =
            (Aws.Util.option_bind (Aws.Xml.member "UsePreviousTemplate" xml)
               Boolean.parse);
          stack_policy_during_update_body =
            (Aws.Util.option_bind
          ...
          stack_policy_during_update_u_r_l =
            (Aws.Util.option_bind
               (Aws.Xml.member "StackPolicyDuringUpdateURL" xml) String.parse);
          parameters =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Parameters" xml)
                  Parameters.parse));
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("Parameters.member", (Parameters.to_query v.parameters)));
           Aws.Util.option_map v.stack_policy_during_update_u_r_l
             (fun f ->
                Aws.Query.Pair
                  ("StackPolicyDuringUpdateURL", (String.to_query f)));
           Aws.Util.option_map v.stack_policy_during_update_body
             (fun f ->
                Aws.Query.Pair
                  ("StackPolicyDuringUpdateBody", (String.to_query f)));
           Aws.Util.option_map v.use_previous_template
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Some ("Parameters", (Parameters.to_json v.parameters));
           Aws.Util.option_map v.stack_policy_during_update_u_r_l
             (fun f -> ("StackPolicyDuringUpdateURL", (String.to_json f)));
           Aws.Util.option_map v.stack_policy_during_update_body
             (fun f -> ("StackPolicyDuringUpdateBody", (String.to_json f)));
           Aws.Util.option_map v.use_previous_template
             (fun f -> ("UsePreviousTemplate", (Boolean.to_json f)));
           Aws.Util.option_map v.template_u_r_l
             (fun f -> ("TemplateURL", (String.to_json f)));
           Aws.Util.option_map v.template_body
             (fun f -> ("TemplateBody", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        template_u_r_l =
          (Aws.Util.option_map (Aws.Json.lookup j "TemplateURL")
             String.of_json);
        use_previous_template =
          (Aws.Util.option_map (Aws.Json.lookup j "UsePreviousTemplate")
             Boolean.of_json);
        stack_policy_during_update_body =
          (Aws.Util.option_map
             (Aws.Json.lookup j "StackPolicyDuringUpdateBody") String.of_json);
        stack_policy_during_update_u_r_l =
          (Aws.Util.option_map
             (Aws.Json.lookup j "StackPolicyDuringUpdateURL") String.of_json);
        parameters =
          (Parameters.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Parameters")));
        capabilities =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          output_key =
            (Aws.Util.option_bind (Aws.Xml.member "OutputKey" xml)
               String.parse);
          output_value =
            (Aws.Util.option_bind (Aws.Xml.member "OutputValue" xml)
               String.parse);
          description =
            (Aws.Util.option_bind (Aws.Xml.member "Description" xml)
               String.parse);
          export_name =
            (Aws.Util.option_bind (Aws.Xml.member "ExportName" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.export_name
              (fun f -> Aws.Query.Pair ("ExportName", (String.to_query f)));
           Aws.Util.option_map v.description
             (fun f -> Aws.Query.Pair ("Description", (String.to_query f)));
           Aws.Util.option_map v.output_value
             (fun f -> Aws.Query.Pair ("OutputValue", (String.to_query f)));
           Aws.Util.option_map v.output_key
             (fun f -> Aws.Query.Pair ("OutputKey", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.export_name
              (fun f -> ("ExportName", (String.to_json f)));
           Aws.Util.option_map v.description
             (fun f -> ("Description", (String.to_json f)));
           Aws.Util.option_map v.output_value
             (fun f -> ("OutputValue", (String.to_json f)));
           Aws.Util.option_map v.output_key
             (fun f -> ("OutputKey", (String.to_json f)))])
    let of_json j =
      {
        output_key =
          (Aws.Util.option_map (Aws.Json.lookup j "OutputKey") String.of_json);
        output_value =
          (Aws.Util.option_map (Aws.Json.lookup j "OutputValue")
             String.of_json);
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json);
        export_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ExportName")
             String.of_json)
      }
  end
module Outputs =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Output.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          ...
          stack_name =
            (Aws.Xml.required "StackName"
               (Aws.Util.option_bind (Aws.Xml.member "StackName" xml)
                  String.parse));
          change_set_id =
            (Aws.Util.option_bind (Aws.Xml.member "ChangeSetId" xml)
               String.parse);
          description =
            (Aws.Util.option_bind (Aws.Xml.member "Description" xml)
               String.parse);
          ...
          outputs =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Outputs" xml)
                  Outputs.parse));
          role_a_r_n =
            (Aws.Util.option_bind (Aws.Xml.member "RoleARN" xml) String.parse);
          tags =
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.role_a_r_n
             (fun f -> Aws.Query.Pair ("RoleARN", (String.to_query f)));
           Some
             (Aws.Query.Pair ("Outputs.member", (Outputs.to_query v.outputs)));
           Some
             (Aws.Query.Pair
                ("Capabilities.member",
                  (Capabilities.to_query v.capabilities)));
           ...
           Aws.Util.option_map v.description
             (fun f -> Aws.Query.Pair ("Description", (String.to_query f)));
           Aws.Util.option_map v.change_set_id
             (fun f -> Aws.Query.Pair ("ChangeSetId", (String.to_query f)));
           Some
             (Aws.Query.Pair ("StackName", (String.to_query v.stack_name)));
           Aws.Util.option_map v.stack_id
             (fun f -> Aws.Query.Pair ("StackId", (String.to_query f)))])
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.description
             (fun f -> ("Description", (String.to_json f)));
           Aws.Util.option_map v.change_set_id
             (fun f -> ("ChangeSetId", (String.to_json f)));
           Some ("StackName", (String.to_json v.stack_name));
           Aws.Util.option_map v.stack_id
             (fun f -> ("StackId", (String.to_json f)))])
    let of_json j =
      {
        ...
        stack_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StackName")));
        change_set_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ChangeSetId")
             String.of_json);
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json);
        ...
        outputs =
          (Outputs.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Outputs")));
        role_a_r_n =
          (Aws.Util.option_map (Aws.Json.lookup j "RoleARN") String.of_json);
        tags =
          (Tags.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Tags")));
...
module Stacks =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Stack.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          stacks =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Stacks" xml)
                  Stacks.parse));
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse)
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Some
             (Aws.Query.Pair ("Stacks.member", (Stacks.to_query v.stacks)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
    ...
    let of_json j =
      {
        stacks =
          (Stacks.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Stacks")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          detailed_status =
            (Aws.Util.option_bind (Aws.Xml.member "DetailedStatus" xml)
               StackInstanceDetailedStatus.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.detailed_status
              (fun f ->
                 Aws.Query.Pair
                   ("DetailedStatus",
    ...
    let of_json j =
      {
        detailed_status =
          (Aws.Util.option_map (Aws.Json.lookup j "DetailedStatus")
      ...
      Some
        {
          ...
          status_reason =
            (Aws.Util.option_bind (Aws.Xml.member "StatusReason" xml)
               String.parse);
          stack_instance_status =
            (Aws.Util.option_bind (Aws.Xml.member "StackInstanceStatus" xml)
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.organizational_unit_id
             (fun f ->
                Aws.Query.Pair ("OrganizationalUnitId", (String.to_query f)));
           Aws.Util.option_map v.stack_instance_status
             (fun f ->
                Aws.Query.Pair
                  ("StackInstanceStatus",
    ...
    let of_json j =
      {
        ...
        status_reason =
          (Aws.Util.option_map (Aws.Json.lookup j "StatusReason")
             String.of_json);
        stack_instance_status =
          (Aws.Util.option_map (Aws.Json.lookup j "StackInstanceStatus")
      ...
      Some
        {
          summaries =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Summaries" xml)
    ...
    let of_json j =
      {
        ...
        resource_identifiers =
          (ResourceIdentifiers.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ResourceIdentifiers")))
      }
  end
module ResourceIdentifierSummaries =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ResourceIdentifierSummary.parse
           (Aws.Xml.members "member" xml))
    let to_query v =
      Aws.Query.to_query_list ResourceIdentifierSummary.to_query v
      ...
      Some
        {
          ...
          name =
            (Aws.Util.option_bind (Aws.Xml.member "Name" xml) String.parse);
          requires_recreation =
            (Aws.Util.option_bind (Aws.Xml.member "RequiresRecreation" xml)
               RequiresRecreation.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.requires_recreation
              (fun f ->
                 Aws.Query.Pair
    ...
    let of_json j =
      {
        ...
        name =
          (Aws.Util.option_map (Aws.Json.lookup j "Name") String.of_json);
        requires_recreation =
          (Aws.Util.option_map (Aws.Json.lookup j "RequiresRecreation")
  ...
  struct
    ...
    let parse xml =
      Some
        {
          target =
            (Aws.Util.option_bind (Aws.Xml.member "Target" xml)
               ResourceTargetDefinition.parse);
          evaluation =
            (Aws.Util.option_bind (Aws.Xml.member "Evaluation" xml)
               EvaluationType.parse);
          change_source =
            (Aws.Util.option_bind (Aws.Xml.member "ChangeSource" xml)
               ChangeSource.parse);
          causing_entity =
            (Aws.Util.option_bind (Aws.Xml.member "CausingEntity" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.causing_entity
              (fun f -> Aws.Query.Pair ("CausingEntity", (String.to_query f)));
           Aws.Util.option_map v.change_source
             (fun f ->
                Aws.Query.Pair ("ChangeSource", (ChangeSource.to_query f)));
           Aws.Util.option_map v.evaluation
             (fun f ->
                Aws.Query.Pair ("Evaluation", (EvaluationType.to_query f)));
           Aws.Util.option_map v.target
             (fun f ->
                Aws.Query.Pair
                  ("Target", (ResourceTargetDefinition.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.causing_entity
              (fun f -> ("CausingEntity", (String.to_json f)));
           Aws.Util.option_map v.change_source
             (fun f -> ("ChangeSource", (ChangeSource.to_json f)));
           Aws.Util.option_map v.evaluation
    ...
    let of_json j =
      {
        target =
          (Aws.Util.option_map (Aws.Json.lookup j "Target")
             ResourceTargetDefinition.of_json);
        evaluation =
          (Aws.Util.option_map (Aws.Json.lookup j "Evaluation")
             EvaluationType.of_json);
        change_source =
          (Aws.Util.option_map (Aws.Json.lookup j "ChangeSource")
             ChangeSource.of_json);
        causing_entity =
          (Aws.Util.option_map (Aws.Json.lookup j "CausingEntity")
             String.of_json)
      }
  end
      ...
      Some
        {
          ...
          administration_role_a_r_n =
            (Aws.Util.option_bind
               (Aws.Xml.member "AdministrationRoleARN" xml) String.parse);
          execution_role_name =
            (Aws.Util.option_bind (Aws.Xml.member "ExecutionRoleName" xml)
               String.parse);
          deployment_targets =
            (Aws.Util.option_bind (Aws.Xml.member "DeploymentTargets" xml)
               DeploymentTargets.parse);
        ...
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.deployment_targets
             (fun f ->
                Aws.Query.Pair
                  ("DeploymentTargets", (DeploymentTargets.to_query f)));
           Aws.Util.option_map v.execution_role_name
             (fun f ->
                Aws.Query.Pair ("ExecutionRoleName", (String.to_query f)));
           Aws.Util.option_map v.administration_role_a_r_n
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.deployment_targets
             (fun f -> ("DeploymentTargets", (DeploymentTargets.to_json f)));
           Aws.Util.option_map v.execution_role_name
             (fun f -> ("ExecutionRoleName", (String.to_json f)));
           Aws.Util.option_map v.administration_role_a_r_n
             (fun f -> ("AdministrationRoleARN", (String.to_json f)));
           Aws.Util.option_map v.operation_preferences
             (fun f ->
                ("OperationPreferences",
                  (StackSetOperationPreferences.to_json f)));
    ...
    let of_json j =
      {
        ...
        operation_preferences =
          (Aws.Util.option_map (Aws.Json.lookup j "OperationPreferences")
             StackSetOperationPreferences.of_json);
        administration_role_a_r_n =
          (Aws.Util.option_map (Aws.Json.lookup j "AdministrationRoleARN")
             String.of_json);
        execution_role_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ExecutionRoleName")
             String.of_json);
        deployment_targets =
          (Aws.Util.option_map (Aws.Json.lookup j "DeploymentTargets")
             DeploymentTargets.of_json);
      ...
      Some
        {
          type_ =
            (Aws.Util.option_bind (Aws.Xml.member "Type" xml)
               RegistryType.parse);
          type_name =
            (Aws.Util.option_bind (Aws.Xml.member "TypeName" xml)
               String.parse);
          version_id =
            (Aws.Util.option_bind (Aws.Xml.member "VersionId" xml)
               String.parse);
          is_default_version =
            (Aws.Util.option_bind (Aws.Xml.member "IsDefaultVersion" xml)
               Boolean.parse);
          arn =
            (Aws.Util.option_bind (Aws.Xml.member "Arn" xml) String.parse);
          time_created =
            (Aws.Util.option_bind (Aws.Xml.member "TimeCreated" xml)
               DateTime.parse);
          description =
            (Aws.Util.option_bind (Aws.Xml.member "Description" xml)
               String.parse)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.description
              (fun f -> Aws.Query.Pair ("Description", (String.to_query f)));
           Aws.Util.option_map v.time_created
             (fun f -> Aws.Query.Pair ("TimeCreated", (DateTime.to_query f)));
           Aws.Util.option_map v.arn
             (fun f -> Aws.Query.Pair ("Arn", (String.to_query f)));
           Aws.Util.option_map v.is_default_version
             (fun f ->
           ...
           Aws.Util.option_map v.type_name
             (fun f -> Aws.Query.Pair ("TypeName", (String.to_query f)));
           Aws.Util.option_map v.type_
             (fun f -> Aws.Query.Pair ("Type", (RegistryType.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.description
              (fun f -> ("Description", (String.to_json f)));
           Aws.Util.option_map v.time_created
             (fun f -> ("TimeCreated", (DateTime.to_json f)));
           Aws.Util.option_map v.arn (fun f -> ("Arn", (String.to_json f)));
           Aws.Util.option_map v.is_default_version
             (fun f -> ("IsDefaultVersion", (Boolean.to_json f)));
           Aws.Util.option_map v.version_id
             (fun f -> ("VersionId", (String.to_json f)));
           Aws.Util.option_map v.type_name
             (fun f -> ("TypeName", (String.to_json f)));
           Aws.Util.option_map v.type_
             (fun f -> ("Type", (RegistryType.to_json f)))])
    let of_json j =
      {
        type_ =
          (Aws.Util.option_map (Aws.Json.lookup j "Type")
             RegistryType.of_json);
        type_name =
          (Aws.Util.option_map (Aws.Json.lookup j "TypeName") String.of_json);
        version_id =
          (Aws.Util.option_map (Aws.Json.lookup j "VersionId") String.of_json);
        is_default_version =
          (Aws.Util.option_map (Aws.Json.lookup j "IsDefaultVersion")
             Boolean.of_json);
        arn = (Aws.Util.option_map (Aws.Json.lookup j "Arn") String.of_json);
        time_created =
          (Aws.Util.option_map (Aws.Json.lookup j "TimeCreated")
             DateTime.of_json);
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json)
  ...
  struct
    ...
    let parse xml =
      Some
        {
          log_role_arn =
            (Aws.Xml.required "LogRoleArn"
               (Aws.Util.option_bind (Aws.Xml.member "LogRoleArn" xml)
                  String.parse));
          log_group_name =
            (Aws.Xml.required "LogGroupName"
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair ("LogRoleArn", (String.to_query v.log_role_arn)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        log_role_arn =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "LogRoleArn")));
        log_group_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "LogGroupName")))
      }
  end
      ...
      Some
        {
          parameter_key =
            (Aws.Util.option_bind (Aws.Xml.member "ParameterKey" xml)
               String.parse);
          default_value =
            (Aws.Util.option_bind (Aws.Xml.member "DefaultValue" xml)
               String.parse);
          parameter_type =
            (Aws.Util.option_bind (Aws.Xml.member "ParameterType" xml)
               String.parse);
          no_echo =
            (Aws.Util.option_bind (Aws.Xml.member "NoEcho" xml) Boolean.parse);
          description =
            (Aws.Util.option_bind (Aws.Xml.member "Description" xml)
               String.parse);
          parameter_constraints =
            (Aws.Util.option_bind (Aws.Xml.member "ParameterConstraints" xml)
               ParameterConstraints.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.parameter_constraints
              (fun f ->
                 Aws.Query.Pair
           ...
           Aws.Util.option_map v.description
             (fun f -> Aws.Query.Pair ("Description", (String.to_query f)));
           Aws.Util.option_map v.no_echo
             (fun f -> Aws.Query.Pair ("NoEcho", (Boolean.to_query f)));
           Aws.Util.option_map v.parameter_type
             (fun f -> Aws.Query.Pair ("ParameterType", (String.to_query f)));
           Aws.Util.option_map v.default_value
             (fun f -> Aws.Query.Pair ("DefaultValue", (String.to_query f)));
           Aws.Util.option_map v.parameter_key
             (fun f -> Aws.Query.Pair ("ParameterKey", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.description
             (fun f -> ("Description", (String.to_json f)));
           Aws.Util.option_map v.no_echo
             (fun f -> ("NoEcho", (Boolean.to_json f)));
           Aws.Util.option_map v.parameter_type
             (fun f -> ("ParameterType", (String.to_json f)));
           Aws.Util.option_map v.default_value
             (fun f -> ("DefaultValue", (String.to_json f)));
           Aws.Util.option_map v.parameter_key
             (fun f -> ("ParameterKey", (String.to_json f)))])
    let of_json j =
      {
        parameter_key =
          (Aws.Util.option_map (Aws.Json.lookup j "ParameterKey")
             String.of_json);
        default_value =
          (Aws.Util.option_map (Aws.Json.lookup j "DefaultValue")
             String.of_json);
        parameter_type =
          (Aws.Util.option_map (Aws.Json.lookup j "ParameterType")
             String.of_json);
        no_echo =
          (Aws.Util.option_map (Aws.Json.lookup j "NoEcho") Boolean.of_json);
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json);
        parameter_constraints =
          (Aws.Util.option_map (Aws.Json.lookup j "ParameterConstraints")
      ...
      Some
        {
          ...
          drift_detection_status =
            (Aws.Util.option_bind (Aws.Xml.member "DriftDetectionStatus" xml)
          ...
          total_stack_instances_count =
            (Aws.Util.option_bind
               (Aws.Xml.member "TotalStackInstancesCount" xml) Integer.parse);
          drifted_stack_instances_count =
            (Aws.Util.option_bind
          ...
          in_sync_stack_instances_count =
            (Aws.Util.option_bind
               (Aws.Xml.member "InSyncStackInstancesCount" xml) Integer.parse);
          in_progress_stack_instances_count =
            (Aws.Util.option_bind
          ...
          failed_stack_instances_count =
            (Aws.Util.option_bind
               (Aws.Xml.member "FailedStackInstancesCount" xml) Integer.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.failed_stack_instances_count
              (fun f ->
                 Aws.Query.Pair
                   ("FailedStackInstancesCount", (Integer.to_query f)));
           Aws.Util.option_map v.in_progress_stack_instances_count
             (fun f ->
                Aws.Query.Pair
                  ("InProgressStackInstancesCount", (Integer.to_query f)));
           Aws.Util.option_map v.in_sync_stack_instances_count
             (fun f ->
                Aws.Query.Pair
                  ("InSyncStackInstancesCount", (Integer.to_query f)));
           Aws.Util.option_map v.drifted_stack_instances_count
             (fun f ->
                Aws.Query.Pair
                  ("DriftedStackInstancesCount", (Integer.to_query f)));
           Aws.Util.option_map v.total_stack_instances_count
             (fun f ->
                Aws.Query.Pair
                  ("TotalStackInstancesCount", (Integer.to_query f)));
           Aws.Util.option_map v.last_drift_check_timestamp
             (fun f ->
                Aws.Query.Pair
                  ("LastDriftCheckTimestamp", (DateTime.to_query f)));
           Aws.Util.option_map v.drift_detection_status
             (fun f ->
                Aws.Query.Pair
           ...
           Aws.Util.option_map v.drift_status
             (fun f ->
                Aws.Query.Pair
                  ("DriftStatus", (StackSetDriftStatus.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.failed_stack_instances_count
              (fun f -> ("FailedStackInstancesCount", (Integer.to_json f)));
           Aws.Util.option_map v.in_progress_stack_instances_count
             (fun f -> ("InProgressStackInstancesCount", (Integer.to_json f)));
           Aws.Util.option_map v.in_sync_stack_instances_count
             (fun f -> ("InSyncStackInstancesCount", (Integer.to_json f)));
           Aws.Util.option_map v.drifted_stack_instances_count
             (fun f -> ("DriftedStackInstancesCount", (Integer.to_json f)));
           Aws.Util.option_map v.total_stack_instances_count
             (fun f -> ("TotalStackInstancesCount", (Integer.to_json f)));
           Aws.Util.option_map v.last_drift_check_timestamp
             (fun f -> ("LastDriftCheckTimestamp", (DateTime.to_json f)));
           Aws.Util.option_map v.drift_detection_status
             (fun f ->
           ...
           Aws.Util.option_map v.drift_status
             (fun f -> ("DriftStatus", (StackSetDriftStatus.to_json f)))])
    let of_json j =
      {
        drift_status =
          (Aws.Util.option_map (Aws.Json.lookup j "DriftStatus")
        ...
        drift_detection_status =
          (Aws.Util.option_map (Aws.Json.lookup j "DriftDetectionStatus")
             StackSetDriftDetectionStatus.of_json);
        last_drift_check_timestamp =
          (Aws.Util.option_map (Aws.Json.lookup j "LastDriftCheckTimestamp")
             DateTime.of_json);
        total_stack_instances_count =
          (Aws.Util.option_map (Aws.Json.lookup j "TotalStackInstancesCount")
             Integer.of_json);
        drifted_stack_instances_count =
          (Aws.Util.option_map
             (Aws.Json.lookup j "DriftedStackInstancesCount") Integer.of_json);
        in_sync_stack_instances_count =
          (Aws.Util.option_map
             (Aws.Json.lookup j "InSyncStackInstancesCount") Integer.of_json);
        in_progress_stack_instances_count =
          (Aws.Util.option_map
        ...
        failed_stack_instances_count =
          (Aws.Util.option_map
             (Aws.Json.lookup j "FailedStackInstancesCount") Integer.of_json)
      }
  end
module StackSet =
  struct
      ...
      Some
        {
          ...
          tags =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Tags" xml) Tags.parse));
          stack_set_a_r_n =
            (Aws.Util.option_bind (Aws.Xml.member "StackSetARN" xml)
               String.parse);
          administration_role_a_r_n =
            (Aws.Util.option_bind
               (Aws.Xml.member "AdministrationRoleARN" xml) String.parse);
        ...
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.auto_deployment
             (fun f ->
                Aws.Query.Pair
                  ("AutoDeployment", (AutoDeployment.to_query f)));
           Aws.Util.option_map v.stack_set_drift_detection_details
             (fun f ->
                Aws.Query.Pair
           ...
           Aws.Util.option_map v.administration_role_a_r_n
             (fun f ->
                Aws.Query.Pair ("AdministrationRoleARN", (String.to_query f)));
           Aws.Util.option_map v.stack_set_a_r_n
             (fun f -> Aws.Query.Pair ("StackSetARN", (String.to_query f)));
           Some (Aws.Query.Pair ("Tags.member", (Tags.to_query v.tags)));
           Some
             (Aws.Query.Pair
                ("Capabilities.member",
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.administration_role_a_r_n
             (fun f -> ("AdministrationRoleARN", (String.to_json f)));
           Aws.Util.option_map v.stack_set_a_r_n
             (fun f -> ("StackSetARN", (String.to_json f)));
           Some ("Tags", (Tags.to_json v.tags));
           Some ("Capabilities", (Capabilities.to_json v.capabilities));
           Some ("Parameters", (Parameters.to_json v.parameters));
           Aws.Util.option_map v.template_body
    ...
    let of_json j =
      {
        ...
        tags =
          (Tags.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Tags")));
        stack_set_a_r_n =
          (Aws.Util.option_map (Aws.Json.lookup j "StackSetARN")
             String.of_json);
        administration_role_a_r_n =
          (Aws.Util.option_map (Aws.Json.lookup j "AdministrationRoleARN")
             String.of_json);
      ...
      Some
        {
          ...
          resource_type =
            (Aws.Xml.required "ResourceType"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceType" xml)
                  String.parse));
          last_updated_timestamp =
            (Aws.Xml.required "LastUpdatedTimestamp"
               (Aws.Util.option_bind
                  (Aws.Xml.member "LastUpdatedTimestamp" xml) DateTime.parse));
          resource_status =
            (Aws.Xml.required "ResourceStatus"
               (Aws.Util.option_bind (Aws.Xml.member "ResourceStatus" xml)
                  ResourceStatus.parse));
          ...
          description =
            (Aws.Util.option_bind (Aws.Xml.member "Description" xml)
               String.parse);
          metadata =
            (Aws.Util.option_bind (Aws.Xml.member "Metadata" xml)
               String.parse);
          drift_information =
            (Aws.Util.option_bind (Aws.Xml.member "DriftInformation" xml)
               StackResourceDriftInformation.parse)
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.metadata
             (fun f -> Aws.Query.Pair ("Metadata", (String.to_query f)));
           Aws.Util.option_map v.description
             (fun f -> Aws.Query.Pair ("Description", (String.to_query f)));
           Aws.Util.option_map v.resource_status_reason
             (fun f ->
    ...
    let of_json j =
      {
        ...
        last_updated_timestamp =
          (DateTime.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "LastUpdatedTimestamp")));
        resource_status =
          (ResourceStatus.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ResourceStatus")));
        resource_status_reason =
        ...
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json);
        metadata =
          (Aws.Util.option_map (Aws.Json.lookup j "Metadata") String.of_json);
        drift_information =
          (Aws.Util.option_map (Aws.Json.lookup j "DriftInformation")
             StackResourceDriftInformation.of_json)
      }
          ...
          capabilities =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Capabilities" xml)
                  Capabilities.parse));
          capabilities_reason =
            (Aws.Util.option_bind (Aws.Xml.member "CapabilitiesReason" xml)
               String.parse);
          resource_types =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ResourceTypes" xml)
        ...
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("ResourceTypes.member",
                  (ResourceTypes.to_query v.resource_types)));
           Aws.Util.option_map v.capabilities_reason
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Some ("ResourceTypes", (ResourceTypes.to_json v.resource_types));
           Aws.Util.option_map v.capabilities_reason
             (fun f -> ("CapabilitiesReason", (String.to_json f)));
           Some ("Capabilities", (Capabilities.to_json v.capabilities));
           Aws.Util.option_map v.description
             (fun f -> ("Description", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        capabilities =
          (Capabilities.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Capabilities")));
        capabilities_reason =
          (Aws.Util.option_map (Aws.Json.lookup j "CapabilitiesReason")
             String.of_json);
        resource_types =
          (ResourceTypes.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ResourceTypes")));
        ...
        resource_identifier_summaries =
          (ResourceIdentifierSummaries.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "ResourceIdentifierSummaries")))
      }
  end
          ...
          logical_resource_id =
            (Aws.Xml.required "LogicalResourceId"
               (Aws.Util.option_bind (Aws.Xml.member "LogicalResourceId" xml)
                  String.parse));
          unique_id =
            (Aws.Xml.required "UniqueId"
               (Aws.Util.option_bind (Aws.Xml.member "UniqueId" xml)
                  String.parse));
          status =
    ...
    let of_json j =
      {
        ...
        unique_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "UniqueId")));
        status =
  ...
  struct
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some
              ("LogicalResourceId", (String.to_json v.logical_resource_id));
           Some ("StackName", (String.to_json v.stack_name))])
    let of_json j =
      {
        stack_name =
      ...
      Some
        {
          type_ =
            (Aws.Util.option_bind (Aws.Xml.member "Type" xml)
               RegistryType.parse);
          type_name =
            (Aws.Xml.required "TypeName"
               (Aws.Util.option_bind (Aws.Xml.member "TypeName" xml)
                  String.parse));
          schema_handler_package =
            (Aws.Xml.required "SchemaHandlerPackage"
               (Aws.Util.option_bind
                  (Aws.Xml.member "SchemaHandlerPackage" xml) String.parse));
          logging_config =
            (Aws.Util.option_bind (Aws.Xml.member "LoggingConfig" xml)
               LoggingConfig.parse);
          execution_role_arn =
            (Aws.Util.option_bind (Aws.Xml.member "ExecutionRoleArn" xml)
               String.parse);
          client_request_token =
            (Aws.Util.option_bind (Aws.Xml.member "ClientRequestToken" xml)
               String.parse)
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.client_request_token
              (fun f ->
                 Aws.Query.Pair ("ClientRequestToken", (String.to_query f)));
           Aws.Util.option_map v.execution_role_arn
             (fun f ->
                Aws.Query.Pair ("ExecutionRoleArn", (String.to_query f)));
           Aws.Util.option_map v.logging_config
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.client_request_token
              (fun f -> ("ClientRequestToken", (String.to_json f)));
           Aws.Util.option_map v.execution_role_arn
             (fun f -> ("ExecutionRoleArn", (String.to_json f)));
           Aws.Util.option_map v.logging_config
             (fun f -> ("LoggingConfig", (LoggingConfig.to_json f)));
           Some
             ("SchemaHandlerPackage",
    ...
    let of_json j =
      {
        ...
        type_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TypeName")));
        schema_handler_package =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "SchemaHandlerPackage")));
        logging_config =
          (Aws.Util.option_map (Aws.Json.lookup j "LoggingConfig")
             LoggingConfig.of_json);
        execution_role_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "ExecutionRoleArn")
             String.of_json);
        client_request_token =
          (Aws.Util.option_map (Aws.Json.lookup j "ClientRequestToken")
             String.of_json)
  ...
  struct
      ...
      Some
        {
          ...
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse);
          max_results =
            (Aws.Util.option_bind (Aws.Xml.member "MaxResults" xml)
               Integer.parse);
          filters =
            (Aws.Util.of_option []
          ...
          stack_instance_account =
            (Aws.Util.option_bind (Aws.Xml.member "StackInstanceAccount" xml)
               String.parse);
          stack_instance_region =
            (Aws.Util.option_bind (Aws.Xml.member "StackInstanceRegion" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.stack_instance_region
              (fun f ->
                 Aws.Query.Pair ("StackInstanceRegion", (String.to_query f)));
           Aws.Util.option_map v.stack_instance_account
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.stack_instance_region
              (fun f -> ("StackInstanceRegion", (String.to_json f)));
           Aws.Util.option_map v.stack_instance_account
             (fun f -> ("StackInstanceAccount", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json);
        max_results =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxResults")
             Integer.of_json);
        filters =
          (StackInstanceFilters.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Filters")));
        stack_instance_account =
          (Aws.Util.option_map (Aws.Json.lookup j "StackInstanceAccount")
             String.of_json);
        stack_instance_region =
          (Aws.Util.option_map (Aws.Json.lookup j "StackInstanceRegion")
             String.of_json)
      }
  end
      ...
      Some
        {
          ...
          type_name =
            (Aws.Util.option_bind (Aws.Xml.member "TypeName" xml)
               String.parse);
          default_version_id =
            (Aws.Util.option_bind (Aws.Xml.member "DefaultVersionId" xml)
               String.parse);
          is_default_version =
            (Aws.Util.option_bind (Aws.Xml.member "IsDefaultVersion" xml)
               Boolean.parse);
          ...
          provisioning_type =
            (Aws.Util.option_bind (Aws.Xml.member "ProvisioningType" xml)
               ProvisioningType.parse);
          deprecated_status =
            (Aws.Util.option_bind (Aws.Xml.member "DeprecatedStatus" xml)
          ...
          execution_role_arn =
            (Aws.Util.option_bind (Aws.Xml.member "ExecutionRoleArn" xml)
               String.parse);
          visibility =
            (Aws.Util.option_bind (Aws.Xml.member "Visibility" xml)
               Visibility.parse);
          source_url =
            (Aws.Util.option_bind (Aws.Xml.member "SourceUrl" xml)
               String.parse);
          documentation_url =
            (Aws.Util.option_bind (Aws.Xml.member "DocumentationUrl" xml)
               String.parse);
          last_updated =
            (Aws.Util.option_bind (Aws.Xml.member "LastUpdated" xml)
               DateTime.parse);
          time_created =
            (Aws.Util.option_bind (Aws.Xml.member "TimeCreated" xml)
               DateTime.parse)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.time_created
              (fun f -> Aws.Query.Pair ("TimeCreated", (DateTime.to_query f)));
           Aws.Util.option_map v.last_updated
             (fun f -> Aws.Query.Pair ("LastUpdated", (DateTime.to_query f)));
           Aws.Util.option_map v.documentation_url
             (fun f ->
                Aws.Query.Pair ("DocumentationUrl", (String.to_query f)));
           Aws.Util.option_map v.source_url
             (fun f -> Aws.Query.Pair ("SourceUrl", (String.to_query f)));
           Aws.Util.option_map v.visibility
             (fun f -> Aws.Query.Pair ("Visibility", (Visibility.to_query f)));
           Aws.Util.option_map v.execution_role_arn
             (fun f ->
                Aws.Query.Pair ("ExecutionRoleArn", (String.to_query f)));
           Aws.Util.option_map v.logging_config
             (fun f ->
                Aws.Query.Pair ("LoggingConfig", (LoggingConfig.to_query f)));
           Aws.Util.option_map v.deprecated_status
             (fun f ->
                Aws.Query.Pair
                  ("DeprecatedStatus", (DeprecatedStatus.to_query f)));
           Aws.Util.option_map v.provisioning_type
             (fun f ->
                Aws.Query.Pair
                  ("ProvisioningType", (ProvisioningType.to_query f)));
           Aws.Util.option_map v.schema
             (fun f -> Aws.Query.Pair ("Schema", (String.to_query f)));
           Aws.Util.option_map v.description
             (fun f -> Aws.Query.Pair ("Description", (String.to_query f)));
           Aws.Util.option_map v.is_default_version
             (fun f ->
                Aws.Query.Pair ("IsDefaultVersion", (Boolean.to_query f)));
           Aws.Util.option_map v.default_version_id
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.time_created
              (fun f -> ("TimeCreated", (DateTime.to_json f)));
           Aws.Util.option_map v.last_updated
             (fun f -> ("LastUpdated", (DateTime.to_json f)));
           Aws.Util.option_map v.documentation_url
             (fun f -> ("DocumentationUrl", (String.to_json f)));
           Aws.Util.option_map v.source_url
             (fun f -> ("SourceUrl", (String.to_json f)));
           Aws.Util.option_map v.visibility
           ...
           Aws.Util.option_map v.logging_config
             (fun f -> ("LoggingConfig", (LoggingConfig.to_json f)));
           Aws.Util.option_map v.deprecated_status
             (fun f -> ("DeprecatedStatus", (DeprecatedStatus.to_json f)));
           Aws.Util.option_map v.provisioning_type
             (fun f -> ("ProvisioningType", (ProvisioningType.to_json f)));
           Aws.Util.option_map v.schema
             (fun f -> ("Schema", (String.to_json f)));
           Aws.Util.option_map v.description
             (fun f -> ("Description", (String.to_json f)));
           Aws.Util.option_map v.is_default_version
             (fun f -> ("IsDefaultVersion", (Boolean.to_json f)));
           Aws.Util.option_map v.default_version_id
             (fun f -> ("DefaultVersionId", (String.to_json f)));
           Aws.Util.option_map v.type_name
             (fun f -> ("TypeName", (String.to_json f)));
           Aws.Util.option_map v.type_
             (fun f -> ("Type", (RegistryType.to_json f)));
    ...
    let of_json j =
      {
        ...
        type_name =
          (Aws.Util.option_map (Aws.Json.lookup j "TypeName") String.of_json);
        default_version_id =
          (Aws.Util.option_map (Aws.Json.lookup j "DefaultVersionId")
             String.of_json);
        is_default_version =
          (Aws.Util.option_map (Aws.Json.lookup j "IsDefaultVersion")
             Boolean.of_json);
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json);
        schema =
          (Aws.Util.option_map (Aws.Json.lookup j "Schema") String.of_json);
        provisioning_type =
          (Aws.Util.option_map (Aws.Json.lookup j "ProvisioningType")
             ProvisioningType.of_json);
        deprecated_status =
          (Aws.Util.option_map (Aws.Json.lookup j "DeprecatedStatus")
        ...
        execution_role_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "ExecutionRoleArn")
             String.of_json);
        visibility =
          (Aws.Util.option_map (Aws.Json.lookup j "Visibility")
             Visibility.of_json);
        source_url =
          (Aws.Util.option_map (Aws.Json.lookup j "SourceUrl") String.of_json);
        documentation_url =
          (Aws.Util.option_map (Aws.Json.lookup j "DocumentationUrl")
             String.of_json);
        last_updated =
          (Aws.Util.option_map (Aws.Json.lookup j "LastUpdated")
             DateTime.of_json);
        time_created =
          (Aws.Util.option_map (Aws.Json.lookup j "TimeCreated")
             DateTime.of_json)
  ...
  struct
    ...
    let parse xml =
      Some
        {
          url =
            (Aws.Util.option_bind (Aws.Xml.member "Url" xml) String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.url
              (fun f -> Aws.Query.Pair ("Url", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
...
module TemplateParameters =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map TemplateParameter.parse (Aws.Xml.members "member" xml))
...
module Scope =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ResourceAttribute.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          ...
          resource_type =
            (Aws.Util.option_bind (Aws.Xml.member "ResourceType" xml)
               String.parse);
          replacement =
            (Aws.Util.option_bind (Aws.Xml.member "Replacement" xml)
               Replacement.parse);
          scope =
            (Aws.Util.of_option []
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.replacement
             (fun f ->
           ...
           Aws.Util.option_map v.action
             (fun f -> Aws.Query.Pair ("Action", (ChangeAction.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        ...
        resource_type =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourceType")
             String.of_json);
        replacement =
          (Aws.Util.option_map (Aws.Json.lookup j "Replacement")
             Replacement.of_json);
        scope =
          (Scope.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Scope")));
        details =
      ...
      Some
        {
          type_ =
            (Aws.Util.option_bind (Aws.Xml.member "Type" xml)
               ChangeType.parse);
          resource_change =
            (Aws.Util.option_bind (Aws.Xml.member "ResourceChange" xml)
               ResourceChange.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.resource_change
              (fun f ->
                 Aws.Query.Pair
                   ("ResourceChange", (ResourceChange.to_query f)));
           Aws.Util.option_map v.type_
             (fun f -> Aws.Query.Pair ("Type", (ChangeType.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.resource_change
              (fun f -> ("ResourceChange", (ResourceChange.to_json f)));
           Aws.Util.option_map v.type_
             (fun f -> ("Type", (ChangeType.to_json f)))])
    let of_json j =
      {
        type_ =
          (Aws.Util.option_map (Aws.Json.lookup j "Type") ChangeType.of_json);
        resource_change =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourceChange")
          ...
          logical_resource_id =
            (Aws.Xml.required "LogicalResourceId"
               (Aws.Util.option_bind (Aws.Xml.member "LogicalResourceId" xml)
                  String.parse));
          resource_identifier =
            (Aws.Xml.required "ResourceIdentifier"
               (Aws.Util.option_bind
...
module ResourcesToImport =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ResourceToImport.parse (Aws.Xml.members "member" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          bearer_token =
            (Aws.Xml.required "BearerToken"
               (Aws.Util.option_bind (Aws.Xml.member "BearerToken" xml)
                  String.parse));
          operation_status =
            (Aws.Xml.required "OperationStatus"
               (Aws.Util.option_bind (Aws.Xml.member "OperationStatus" xml)
          ...
          status_message =
            (Aws.Util.option_bind (Aws.Xml.member "StatusMessage" xml)
               String.parse);
          error_code =
            (Aws.Util.option_bind (Aws.Xml.member "ErrorCode" xml)
               HandlerErrorCode.parse);
          resource_model =
            (Aws.Util.option_bind (Aws.Xml.member "ResourceModel" xml)
               String.parse);
          client_request_token =
            (Aws.Util.option_bind (Aws.Xml.member "ClientRequestToken" xml)
               String.parse)
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.client_request_token
              (fun f ->
                 Aws.Query.Pair ("ClientRequestToken", (String.to_query f)));
           Aws.Util.option_map v.resource_model
             (fun f -> Aws.Query.Pair ("ResourceModel", (String.to_query f)));
           ...
           Aws.Util.option_map v.current_operation_status
             (fun f ->
                Aws.Query.Pair
           ...
           Some
             (Aws.Query.Pair
                ("BearerToken", (String.to_query v.bearer_token)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.client_request_token
              (fun f -> ("ClientRequestToken", (String.to_json f)));
           Aws.Util.option_map v.resource_model
             (fun f -> ("ResourceModel", (String.to_json f)));
           Aws.Util.option_map v.error_code
             (fun f -> ("ErrorCode", (HandlerErrorCode.to_json f)));
           Aws.Util.option_map v.status_message
    ...
    let of_json j =
      {
        bearer_token =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "BearerToken")));
        operation_status =
          (OperationStatus.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "OperationStatus")));
        current_operation_status =
          (Aws.Util.option_map (Aws.Json.lookup j "CurrentOperationStatus")
             OperationStatus.of_json);
        status_message =
          (Aws.Util.option_map (Aws.Json.lookup j "StatusMessage")
             String.of_json);
        error_code =
          (Aws.Util.option_map (Aws.Json.lookup j "ErrorCode")
             HandlerErrorCode.of_json);
        resource_model =
          (Aws.Util.option_map (Aws.Json.lookup j "ResourceModel")
             String.of_json);
        client_request_token =
          (Aws.Util.option_map (Aws.Json.lookup j "ClientRequestToken")
             String.of_json)
  ...
  struct
    ...
    let parse xml =
      Some
        {
          progress_status =
            (Aws.Util.option_bind (Aws.Xml.member "ProgressStatus" xml)
               RegistrationStatus.parse);
          description =
            (Aws.Util.option_bind (Aws.Xml.member "Description" xml)
               String.parse);
          type_arn =
            (Aws.Util.option_bind (Aws.Xml.member "TypeArn" xml) String.parse);
          type_version_arn =
            (Aws.Util.option_bind (Aws.Xml.member "TypeVersionArn" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.type_version_arn
              (fun f ->
                 Aws.Query.Pair ("TypeVersionArn", (String.to_query f)));
           Aws.Util.option_map v.type_arn
             (fun f -> Aws.Query.Pair ("TypeArn", (String.to_query f)));
           Aws.Util.option_map v.description
             (fun f -> Aws.Query.Pair ("Description", (String.to_query f)));
           Aws.Util.option_map v.progress_status
             (fun f ->
                Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.type_version_arn
              (fun f -> ("TypeVersionArn", (String.to_json f)));
           Aws.Util.option_map v.type_arn
             (fun f -> ("TypeArn", (String.to_json f)));
           Aws.Util.option_map v.description
             (fun f -> ("Description", (String.to_json f)));
           Aws.Util.option_map v.progress_status
             (fun f -> ("ProgressStatus", (RegistrationStatus.to_json f)))])
    let of_json j =
      {
        progress_status =
          (Aws.Util.option_map (Aws.Json.lookup j "ProgressStatus")
             RegistrationStatus.of_json);
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json);
        type_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "TypeArn") String.of_json);
        type_version_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "TypeVersionArn")
             String.of_json)
      }
  end
...
module StackSetSummaries =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map StackSetSummary.parse (Aws.Xml.members "member" xml))
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("OperationId", (String.to_query v.operation_id)));
           Some
             (Aws.Query.Pair
                ("StackSetName", (String.to_query v.stack_set_name)))])
    let to_json v =
    ...
    let of_json j =
      {
        ...
        operation_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "OperationId")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json);
        max_results =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxResults")
      ...
      Some
        {
          ...
          creation_timestamp =
            (Aws.Util.option_bind (Aws.Xml.member "CreationTimestamp" xml)
               DateTime.parse);
          end_timestamp =
            (Aws.Util.option_bind (Aws.Xml.member "EndTimestamp" xml)
               DateTime.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.end_timestamp
              (fun f ->
           ...
           Aws.Util.option_map v.status
             (fun f ->
                Aws.Query.Pair
                  ("Status", (StackSetOperationStatus.to_query f)));
           Aws.Util.option_map v.action
             (fun f ->
                Aws.Query.Pair
                  ("Action", (StackSetOperationAction.to_query f)));
           Aws.Util.option_map v.operation_id
             (fun f -> Aws.Query.Pair ("OperationId", (String.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.end_timestamp
              (fun f -> ("EndTimestamp", (DateTime.to_json f)));
           Aws.Util.option_map v.creation_timestamp
    ...
    let of_json j =
      {
        ...
        creation_timestamp =
          (Aws.Util.option_map (Aws.Json.lookup j "CreationTimestamp")
             DateTime.of_json);
        end_timestamp =
          (Aws.Util.option_map (Aws.Json.lookup j "EndTimestamp")
             DateTime.of_json)
      }
  end
module StackSetOperationSummaries =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map StackSetOperationSummary.parse
           (Aws.Xml.members "member" xml))
    let to_query v =
      Aws.Query.to_query_list StackSetOperationSummary.to_query v
  ...
  struct
    ...
    let parse xml =
      Some
        {
          exporting_stack_id =
            (Aws.Util.option_bind (Aws.Xml.member "ExportingStackId" xml)
               String.parse);
          name =
            (Aws.Util.option_bind (Aws.Xml.member "Name" xml) String.parse);
          value =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.name
             (fun f -> Aws.Query.Pair ("Name", (String.to_query f)));
           Aws.Util.option_map v.exporting_stack_id
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.name (fun f -> ("Name", (String.to_json f)));
           Aws.Util.option_map v.exporting_stack_id
             (fun f -> ("ExportingStackId", (String.to_json f)))])
    let of_json j =
      {
        exporting_stack_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ExportingStackId")
             String.of_json);
        name =
          (Aws.Util.option_map (Aws.Json.lookup j "Name") String.of_json);
        value =
    ...
    let of_json j =
      {
        stack_resource_summaries =
          (StackResourceSummaries.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "StackResourceSummaries")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Some
             (Aws.Query.Pair ("ExportName", (String.to_query v.export_name)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
    ...
    let of_json j =
      {
        export_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ExportName")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map StackSetOperationResultSummary.parse
           (Aws.Xml.members "member" xml))
    let to_query v =
      Aws.Query.to_query_list StackSetOperationResultSummary.to_query v
  ...
  struct
    ...
    let parse xml =
      Some
        {
          registration_token =
            (Aws.Util.option_bind (Aws.Xml.member "RegistrationToken" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.registration_token
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.registration_token
              (fun f -> ("RegistrationToken", (String.to_json f)))])
    let of_json j =
      {
        registration_token =
          (Aws.Util.option_map (Aws.Json.lookup j "RegistrationToken")
             String.of_json)
      }
  end
...
module StackStatusFilter =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map StackStatus.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          imports =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Imports" xml)
                  Imports.parse));
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse)
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Some
             (Aws.Query.Pair ("Imports.member", (Imports.to_query v.imports)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
    ...
    let of_json j =
      {
        imports =
          (Imports.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Imports")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
...
module TypeVersionSummaries =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map TypeVersionSummary.parse (Aws.Xml.members "member" xml))
    ...
    let of_json j =
      {
        type_version_summaries =
          (TypeVersionSummaries.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "TypeVersionSummaries")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
...
module Exports =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Export.parse (Aws.Xml.members "member" xml))
  ...
  struct
    ...
    let parse xml =
      Some
        {
          stack_set =
            (Aws.Util.option_bind (Aws.Xml.member "StackSet" xml)
               StackSet.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.stack_set
              (fun f -> Aws.Query.Pair ("StackSet", (StackSet.to_query f)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.stack_set
              (fun f -> ("StackSet", (StackSet.to_json f)))])
    let of_json j =
      {
        stack_set =
          (Aws.Util.option_map (Aws.Json.lookup j "StackSet")
             StackSet.of_json)
      }
  end
      ...
      Some
        {
          stack_events =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "StackEvents" xml)
                  StackEvents.parse));
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse)
    ...
    let of_json j =
      {
        stack_events =
          (StackEvents.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "StackEvents")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
      ...
      Some
        {
          ...
          operation_preferences =
            (Aws.Util.option_bind (Aws.Xml.member "OperationPreferences" xml)
               StackSetOperationPreferences.parse);
          retain_stacks =
            (Aws.Util.option_bind (Aws.Xml.member "RetainStacks" xml)
               Boolean.parse);
          administration_role_a_r_n =
            (Aws.Util.option_bind
               (Aws.Xml.member "AdministrationRoleARN" xml) String.parse);
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.deployment_targets
             (fun f ->
                Aws.Query.Pair
                  ("DeploymentTargets", (DeploymentTargets.to_query f)));
           Aws.Util.option_map v.end_timestamp
             (fun f -> Aws.Query.Pair ("EndTimestamp", (DateTime.to_query f)));
           Aws.Util.option_map v.creation_timestamp
             (fun f ->
                Aws.Query.Pair ("CreationTimestamp", (DateTime.to_query f)));
           Aws.Util.option_map v.execution_role_name
           ...
           Aws.Util.option_map v.administration_role_a_r_n
             (fun f ->
                Aws.Query.Pair ("AdministrationRoleARN", (String.to_query f)));
           Aws.Util.option_map v.retain_stacks
             (fun f -> Aws.Query.Pair ("RetainStacks", (Boolean.to_query f)));
           Aws.Util.option_map v.operation_preferences
             (fun f ->
                Aws.Query.Pair
                  ("OperationPreferences",
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.administration_role_a_r_n
             (fun f -> ("AdministrationRoleARN", (String.to_json f)));
           Aws.Util.option_map v.retain_stacks
             (fun f -> ("RetainStacks", (Boolean.to_json f)));
           Aws.Util.option_map v.operation_preferences
             (fun f ->
                ("OperationPreferences",
                  (StackSetOperationPreferences.to_json f)));
    ...
    let of_json j =
      {
        ...
        operation_preferences =
          (Aws.Util.option_map (Aws.Json.lookup j "OperationPreferences")
             StackSetOperationPreferences.of_json);
        retain_stacks =
          (Aws.Util.option_map (Aws.Json.lookup j "RetainStacks")
             Boolean.of_json);
        administration_role_a_r_n =
          (Aws.Util.option_map (Aws.Json.lookup j "AdministrationRoleARN")
             String.of_json);
  ...
  struct
    ...
    let parse xml =
      Some
        {
          stack_set_operation =
            (Aws.Util.option_bind (Aws.Xml.member "StackSetOperation" xml)
               StackSetOperation.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.stack_set_operation
              (fun f ->
                 Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.stack_set_operation
              (fun f -> ("StackSetOperation", (StackSetOperation.to_json f)))])
    let of_json j =
      {
        stack_set_operation =
          (Aws.Util.option_map (Aws.Json.lookup j "StackSetOperation")
...
module TypeSummaries =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map TypeSummary.parse (Aws.Xml.members "member" xml))
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.max_results
             (fun f -> Aws.Query.Pair ("MaxResults", (Integer.to_query f)));
           Aws.Util.option_map v.registration_status_filter
             (fun f ->
                Aws.Query.Pair
    ...
    let of_json j =
      {
        ...
        type_arn =
          (Aws.Util.option_map (Aws.Json.lookup j "TypeArn") String.of_json);
        registration_status_filter =
          (Aws.Util.option_map (Aws.Json.lookup j "RegistrationStatusFilter")
             RegistrationStatus.of_json);
        max_results =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxResults")
             Integer.of_json);
      ...
      Some
        {
          ...
          stack_drift_status =
            (Aws.Util.option_bind (Aws.Xml.member "StackDriftStatus" xml)
               StackDriftStatus.parse);
          detection_status =
            (Aws.Xml.required "DetectionStatus"
               (Aws.Util.option_bind (Aws.Xml.member "DetectionStatus" xml)
                  StackDriftDetectionStatus.parse));
          detection_status_reason =
            (Aws.Util.option_bind
               (Aws.Xml.member "DetectionStatusReason" xml) String.parse);
          drifted_stack_resource_count =
            (Aws.Util.option_bind
               (Aws.Xml.member "DriftedStackResourceCount" xml) Integer.parse);
          timestamp =
            (Aws.Xml.required "Timestamp"
               (Aws.Util.option_bind (Aws.Xml.member "Timestamp" xml)
                  DateTime.parse))
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair ("Timestamp", (DateTime.to_query v.timestamp)));
           Aws.Util.option_map v.drifted_stack_resource_count
             (fun f ->
                Aws.Query.Pair
                  ("DriftedStackResourceCount", (Integer.to_query f)));
           Aws.Util.option_map v.detection_status_reason
             (fun f ->
           ...
           Aws.Util.option_map v.stack_drift_status
             (fun f ->
                Aws.Query.Pair
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Some ("Timestamp", (DateTime.to_json v.timestamp));
           Aws.Util.option_map v.drifted_stack_resource_count
             (fun f -> ("DriftedStackResourceCount", (Integer.to_json f)));
           Aws.Util.option_map v.detection_status_reason
             (fun f -> ("DetectionStatusReason", (String.to_json f)));
           Some
             ("DetectionStatus",
               (StackDriftDetectionStatus.to_json v.detection_status));
           Aws.Util.option_map v.stack_drift_status
             (fun f -> ("StackDriftStatus", (StackDriftStatus.to_json f)));
           Some
             ("StackDriftDetectionId",
               (String.to_json v.stack_drift_detection_id));
           Some ("StackId", (String.to_json v.stack_id))])
        ...
        stack_drift_detection_id =
          (String.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "StackDriftDetectionId")));
        stack_drift_status =
          (Aws.Util.option_map (Aws.Json.lookup j "StackDriftStatus")
             StackDriftStatus.of_json);
        detection_status =
          (StackDriftDetectionStatus.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "DetectionStatus")));
        detection_status_reason =
          (Aws.Util.option_map (Aws.Json.lookup j "DetectionStatusReason")
             String.of_json);
        drifted_stack_resource_count =
          (Aws.Util.option_map
             (Aws.Json.lookup j "DriftedStackResourceCount") Integer.of_json);
        timestamp =
          (DateTime.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Timestamp")))
      }
  ...
  struct
    ...
    let parse xml =
      Some
        {
          registration_token =
            (Aws.Xml.required "RegistrationToken"
               (Aws.Util.option_bind (Aws.Xml.member "RegistrationToken" xml)
                  String.parse))
        }
    let to_query v =
    ...
    let of_json j =
      {
        registration_token =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RegistrationToken")))
      }
  end
...
module DescribeStackResourceOutput =
  struct
      ...
      Some
        {
          stack_resource_detail =
            (Aws.Util.option_bind (Aws.Xml.member "StackResourceDetail" xml)
               StackResourceDetail.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.stack_resource_detail
              (fun f ->
                 Aws.Query.Pair
    ...
    let of_json j =
      {
        stack_resource_detail =
          (Aws.Util.option_map (Aws.Json.lookup j "StackResourceDetail")
      ...
      Some
        {
          type_summaries =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "TypeSummaries" xml)
                  TypeSummaries.parse));
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse)
    ...
    let of_json j =
      {
        type_summaries =
          (TypeSummaries.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "TypeSummaries")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          stack_instance =
            (Aws.Util.option_bind (Aws.Xml.member "StackInstance" xml)
               StackInstance.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.stack_instance
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.stack_instance
              (fun f -> ("StackInstance", (StackInstance.to_json f)))])
    let of_json j =
      {
        stack_instance =
          (Aws.Util.option_map (Aws.Json.lookup j "StackInstance")
      ...
      Some
        {
          ...
          change_set_name =
            (Aws.Util.option_bind (Aws.Xml.member "ChangeSetName" xml)
               String.parse);
          execution_status =
            (Aws.Util.option_bind (Aws.Xml.member "ExecutionStatus" xml)
               ExecutionStatus.parse);
          status =
            (Aws.Util.option_bind (Aws.Xml.member "Status" xml)
               ChangeSetStatus.parse);
          status_reason =
            (Aws.Util.option_bind (Aws.Xml.member "StatusReason" xml)
               String.parse);
          creation_time =
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.execution_status
             (fun f ->
                Aws.Query.Pair
                  ("ExecutionStatus", (ExecutionStatus.to_query f)));
           Aws.Util.option_map v.change_set_name
             (fun f -> Aws.Query.Pair ("ChangeSetName", (String.to_query f)));
           Aws.Util.option_map v.change_set_id
             (fun f -> Aws.Query.Pair ("ChangeSetId", (String.to_query f)));
           Aws.Util.option_map v.stack_name
             (fun f -> Aws.Query.Pair ("StackName", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.execution_status
             (fun f -> ("ExecutionStatus", (ExecutionStatus.to_json f)));
           Aws.Util.option_map v.change_set_name
             (fun f -> ("ChangeSetName", (String.to_json f)));
           Aws.Util.option_map v.change_set_id
             (fun f -> ("ChangeSetId", (String.to_json f)));
           Aws.Util.option_map v.stack_name
             (fun f -> ("StackName", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        change_set_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ChangeSetId")
             String.of_json);
        change_set_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ChangeSetName")
             String.of_json);
        execution_status =
          (Aws.Util.option_map (Aws.Json.lookup j "ExecutionStatus")
             ExecutionStatus.of_json);
        status =
          (Aws.Util.option_map (Aws.Json.lookup j "Status")
             ChangeSetStatus.of_json);
        status_reason =
          (Aws.Util.option_map (Aws.Json.lookup j "StatusReason")
             String.of_json);
        creation_time =
...
module StackSummaries =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map StackSummary.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          ...
          resources_to_skip =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ResourcesToSkip" xml)
      ...
      Some
        {
          ...
          description =
            (Aws.Util.option_bind (Aws.Xml.member "Description" xml)
               String.parse);
          change_set_type =
            (Aws.Util.option_bind (Aws.Xml.member "ChangeSetType" xml)
               ChangeSetType.parse);
          resources_to_import =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "ResourcesToImport" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.change_set_type
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.change_set_type
             (fun f -> ("ChangeSetType", (ChangeSetType.to_json f)));
           Aws.Util.option_map v.description
             (fun f -> ("Description", (String.to_json f)));
           Aws.Util.option_map v.client_token
    ...
    let of_json j =
      {
        ...
        change_set_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "ChangeSetName")));
        client_token =
          (Aws.Util.option_map (Aws.Json.lookup j "ClientToken")
             String.of_json);
        description =
          (Aws.Util.option_map (Aws.Json.lookup j "Description")
             String.of_json);
        change_set_type =
          (Aws.Util.option_map (Aws.Json.lookup j "ChangeSetType")
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("RetainStacks", (Boolean.to_query v.retain_stacks)));
           Aws.Util.option_map v.operation_preferences
             (fun f ->
                Aws.Query.Pair
                  ("OperationPreferences",
    ...
    let of_json j =
      {
        ...
        retain_stacks =
          (Boolean.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RetainStacks")));
        operation_id =
          (Aws.Util.option_map (Aws.Json.lookup j "OperationId")
             String.of_json)
      }
      ...
      Some
        {
          ...
          retain_resources =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "RetainResources" xml)
      ...
      Some
        {
          exports =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Exports" xml)
                  Exports.parse));
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse)
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Some
             (Aws.Query.Pair ("Exports.member", (Exports.to_query v.exports)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
    ...
    let of_json j =
      {
        exports =
          (Exports.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Exports")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
...
module ChangeSetSummaries =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map ChangeSetSummary.parse (Aws.Xml.members "member" xml))
...
module StackResourceDrifts =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map StackResourceDrift.parse (Aws.Xml.members "member" xml))
...
module Changes =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map Change.parse (Aws.Xml.members "member" xml))
      ...
      Some
        {
          ...
          changes =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "Changes" xml)
                  Changes.parse));
          next_token =
            (Aws.Util.option_bind (Aws.Xml.member "NextToken" xml)
               String.parse)
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> Aws.Query.Pair ("NextToken", (String.to_query f)));
           Some
             (Aws.Query.Pair ("Changes.member", (Changes.to_query v.changes)));
           Some (Aws.Query.Pair ("Tags.member", (Tags.to_query v.tags)));
           Some
             (Aws.Query.Pair
                ("Capabilities.member",
    ...
    let of_json j =
      {
        ...
        changes =
          (Changes.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Changes")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
      ...
      Some
        {
          ...
          stack_status_filter =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "StackStatusFilter" xml)
  ...
  struct
      ...
      Some
        {
          ...
          change_set_name =
            (Aws.Util.option_bind (Aws.Xml.member "ChangeSetName" xml)
               String.parse);
          template_stage =
            (Aws.Util.option_bind (Aws.Xml.member "TemplateStage" xml)
               TemplateStage.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.template_stage
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.template_stage
              (fun f -> ("TemplateStage", (TemplateStage.to_json f)));
           Aws.Util.option_map v.change_set_name
             (fun f -> ("ChangeSetName", (String.to_json f)));
           Aws.Util.option_map v.stack_name
             (fun f -> ("StackName", (String.to_json f)))])
    let of_json j =
      {
        ...
        change_set_name =
          (Aws.Util.option_map (Aws.Json.lookup j "ChangeSetName")
             String.of_json);
        template_stage =
          (Aws.Util.option_map (Aws.Json.lookup j "TemplateStage")
      ...
      Some
        {
          stack_resource_drifts =
            (Aws.Xml.required "StackResourceDrifts"
               (Aws.Util.option_bind
    ...
    let of_json j =
      {
        stack_resource_drifts =
          (StackResourceDrifts.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "StackResourceDrifts")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json)
      }
  end
      ...
      Some
        {
          stack_summaries =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "StackSummaries" xml)
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> ("NextToken", (String.to_json f)));
           Some
             ("StackSummaries", (StackSummaries.to_json v.stack_summaries))])
    let of_json j =
      {
        stack_summaries =
      ...
      Some
        {
          account_limits =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "AccountLimits" xml)
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.next_token
              (fun f -> ("NextToken", (String.to_json f)));
           Some
             ("AccountLimits", (AccountLimitList.to_json v.account_limits))])
    let of_json j =
      {
        account_limits =
...
module StackResourceDriftStatusFilters =
  struct
    ...
    let parse xml =
      Aws.Util.option_all
        (List.map StackResourceDriftStatus.parse
           (Aws.Xml.members "member" xml))
    let to_query v =
      Aws.Query.to_query_list StackResourceDriftStatus.to_query v
    ...
    let of_json j =
      {
        ...
        stack_resource_drift_status_filters =
          (StackResourceDriftStatusFilters.of_json
             (Aws.Util.of_option_exn
                (Aws.Json.lookup j "StackResourceDriftStatusFilters")));
        next_token =
          (Aws.Util.option_map (Aws.Json.lookup j "NextToken") String.of_json);
        max_results =
          (Aws.Util.option_map (Aws.Json.lookup j "MaxResults")
