  ...
  struct
    ...
    let parse xml =
      Some
        {
          role_arn =
            (Aws.Xml.required "RoleArn"
               (Aws.Util.option_bind (Aws.Xml.member "RoleArn" xml)
                  String.parse));
          role_session_name =
            (Aws.Xml.required "RoleSessionName"
               (Aws.Util.option_bind (Aws.Xml.member "RoleSessionName" xml)
                  String.parse));
          policy_arns =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "PolicyArns" xml)
                  PolicyDescriptorListType.parse));
          policy =
            (Aws.Util.option_bind (Aws.Xml.member "Policy" xml) String.parse);
          duration_seconds =
            (Aws.Util.option_bind (Aws.Xml.member "DurationSeconds" xml)
               Integer.parse);
          tags =
            (Aws.Util.of_option []
          ...
          transitive_tag_keys =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "TransitiveTagKeys" xml)
                  TagKeyListType.parse));
          external_id =
            (Aws.Util.option_bind (Aws.Xml.member "ExternalId" xml)
               String.parse);
          serial_number =
            (Aws.Util.option_bind (Aws.Xml.member "SerialNumber" xml)
               String.parse);
          token_code =
            (Aws.Util.option_bind (Aws.Xml.member "TokenCode" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.token_code
              (fun f -> Aws.Query.Pair ("TokenCode", (String.to_query f)));
           Aws.Util.option_map v.serial_number
             (fun f -> Aws.Query.Pair ("SerialNumber", (String.to_query f)));
           Aws.Util.option_map v.external_id
             (fun f -> Aws.Query.Pair ("ExternalId", (String.to_query f)));
           Some
             (Aws.Query.Pair
                ("TransitiveTagKeys.member",
                  (TagKeyListType.to_query v.transitive_tag_keys)));
           Some
             (Aws.Query.Pair ("Tags.member", (TagListType.to_query v.tags)));
           Aws.Util.option_map v.duration_seconds
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.token_code
              (fun f -> ("TokenCode", (String.to_json f)));
           Aws.Util.option_map v.serial_number
             (fun f -> ("SerialNumber", (String.to_json f)));
           Aws.Util.option_map v.external_id
             (fun f -> ("ExternalId", (String.to_json f)));
           Some
             ("TransitiveTagKeys",
               (TagKeyListType.to_json v.transitive_tag_keys));
           Some ("Tags", (TagListType.to_json v.tags));
           Aws.Util.option_map v.duration_seconds
             (fun f -> ("DurationSeconds", (Integer.to_json f)));
           Aws.Util.option_map v.policy
             (fun f -> ("Policy", (String.to_json f)));
           Some
             ("PolicyArns", (PolicyDescriptorListType.to_json v.policy_arns));
    ...
    let of_json j =
      {
        role_arn =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RoleArn")));
        role_session_name =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "RoleSessionName")));
        policy_arns =
        ...
        duration_seconds =
          (Aws.Util.option_map (Aws.Json.lookup j "DurationSeconds")
             Integer.of_json);
        tags =
          (TagListType.of_json
        ...
        external_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ExternalId")
             String.of_json);
        serial_number =
          (Aws.Util.option_map (Aws.Json.lookup j "SerialNumber")
             String.of_json);
        token_code =
          (Aws.Util.option_map (Aws.Json.lookup j "TokenCode") String.of_json)
      }
  end
          ...
          role_session_name =
            (Aws.Xml.required "RoleSessionName"
               (Aws.Util.option_bind (Aws.Xml.member "RoleSessionName" xml)
                  String.parse));
          web_identity_token =
            (Aws.Xml.required "WebIdentityToken"
               (Aws.Util.option_bind (Aws.Xml.member "WebIdentityToken" xml)
                  String.parse));
          provider_id =
            (Aws.Util.option_bind (Aws.Xml.member "ProviderId" xml)
               String.parse);
          policy_arns =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "PolicyArns" xml)
        ...
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("PolicyArns.member",
                  (PolicyDescriptorListType.to_query v.policy_arns)));
           Aws.Util.option_map v.provider_id
             (fun f -> Aws.Query.Pair ("ProviderId", (String.to_query f)));
           Some
             (Aws.Query.Pair
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Some
             ("PolicyArns", (PolicyDescriptorListType.to_json v.policy_arns));
           Aws.Util.option_map v.provider_id
             (fun f -> ("ProviderId", (String.to_json f)));
    ...
    let of_json j =
      {
        ...
        web_identity_token =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "WebIdentityToken")));
        provider_id =
          (Aws.Util.option_map (Aws.Json.lookup j "ProviderId")
             String.of_json);
        policy_arns =
          (PolicyDescriptorListType.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "PolicyArns")));
  ...
  struct
    ...
    let parse xml =
      Some
        {
          access_key_id =
            (Aws.Xml.required "AccessKeyId"
               (Aws.Util.option_bind (Aws.Xml.member "AccessKeyId" xml)
                  String.parse));
          secret_access_key =
            (Aws.Xml.required "SecretAccessKey"
               (Aws.Util.option_bind (Aws.Xml.member "SecretAccessKey" xml)
                  String.parse));
          session_token =
            (Aws.Xml.required "SessionToken"
               (Aws.Util.option_bind (Aws.Xml.member "SessionToken" xml)
                  String.parse));
          expiration =
            (Aws.Xml.required "Expiration"
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Some
              (Aws.Query.Pair
                 ("Expiration", (DateTime.to_query v.expiration)));
           Some
             (Aws.Query.Pair
                ("SessionToken", (String.to_query v.session_token)));
           Some
             (Aws.Query.Pair
                ("SecretAccessKey", (String.to_query v.secret_access_key)));
           Some
             (Aws.Query.Pair
                ("AccessKeyId", (String.to_query v.access_key_id)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        access_key_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AccessKeyId")));
        secret_access_key =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "SecretAccessKey")));
        session_token =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "SessionToken")));
        expiration =
          (DateTime.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "Expiration")))
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          assumed_role_id =
            (Aws.Xml.required "AssumedRoleId"
               (Aws.Util.option_bind (Aws.Xml.member "AssumedRoleId" xml)
                  String.parse));
          arn =
    ...
    let of_json j =
      {
        assumed_role_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "AssumedRoleId")));
        arn =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          credentials =
            (Aws.Util.option_bind (Aws.Xml.member "Credentials" xml)
               Credentials.parse);
          subject_from_web_identity_token =
            (Aws.Util.option_bind
               ...
               String.parse);
          assumed_role_user =
            (Aws.Util.option_bind (Aws.Xml.member "AssumedRoleUser" xml)
               AssumedRoleUser.parse);
          packed_policy_size =
            (Aws.Util.option_bind (Aws.Xml.member "PackedPolicySize" xml)
               Integer.parse);
          provider =
            (Aws.Util.option_bind (Aws.Xml.member "Provider" xml)
               String.parse);
          audience =
            (Aws.Util.option_bind (Aws.Xml.member "Audience" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.audience
              (fun f -> Aws.Query.Pair ("Audience", (String.to_query f)));
           Aws.Util.option_map v.provider
             (fun f -> Aws.Query.Pair ("Provider", (String.to_query f)));
           Aws.Util.option_map v.packed_policy_size
             (fun f ->
                Aws.Query.Pair ("PackedPolicySize", (Integer.to_query f)));
           Aws.Util.option_map v.assumed_role_user
             (fun f ->
                Aws.Query.Pair
                  ("AssumedRoleUser", (AssumedRoleUser.to_query f)));
           Aws.Util.option_map v.subject_from_web_identity_token
             (fun f ->
                Aws.Query.Pair
                  ("SubjectFromWebIdentityToken", (String.to_query f)));
           Aws.Util.option_map v.credentials
             (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           ...
           Aws.Util.option_map v.packed_policy_size
             (fun f -> ("PackedPolicySize", (Integer.to_json f)));
           Aws.Util.option_map v.assumed_role_user
             (fun f -> ("AssumedRoleUser", (AssumedRoleUser.to_json f)));
           Aws.Util.option_map v.subject_from_web_identity_token
             (fun f -> ("SubjectFromWebIdentityToken", (String.to_json f)));
           Aws.Util.option_map v.credentials
             (fun f -> ("Credentials", (Credentials.to_json f)))])
    let of_json j =
      {
        credentials =
          (Aws.Util.option_map (Aws.Json.lookup j "Credentials")
             Credentials.of_json);
        subject_from_web_identity_token =
          (Aws.Util.option_map
             (Aws.Json.lookup j "SubjectFromWebIdentityToken") String.of_json);
        assumed_role_user =
          (Aws.Util.option_map (Aws.Json.lookup j "AssumedRoleUser")
             AssumedRoleUser.of_json);
        packed_policy_size =
          (Aws.Util.option_map (Aws.Json.lookup j "PackedPolicySize")
             Integer.of_json);
        provider =
          (Aws.Util.option_map (Aws.Json.lookup j "Provider") String.of_json);
        audience =
          (Aws.Util.option_map (Aws.Json.lookup j "Audience") String.of_json)
      }
  end
          ...
          principal_arn =
            (Aws.Xml.required "PrincipalArn"
               (Aws.Util.option_bind (Aws.Xml.member "PrincipalArn" xml)
                  String.parse));
          s_a_m_l_assertion =
            (Aws.Xml.required "SAMLAssertion"
               (Aws.Util.option_bind (Aws.Xml.member "SAMLAssertion" xml)
                  String.parse));
          policy_arns =
            (Aws.Util.of_option []
               (Aws.Util.option_bind (Aws.Xml.member "PolicyArns" xml)
    ...
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           ...
           Some
             (Aws.Query.Pair
                ("PrincipalArn", (String.to_query v.principal_arn)));
           Some (Aws.Query.Pair ("RoleArn", (String.to_query v.role_arn)))])
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
    ...
    let of_json j =
      {
        ...
        s_a_m_l_assertion =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "SAMLAssertion")));
        policy_arns =
          (PolicyDescriptorListType.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "PolicyArns")));
        policy =
  ...
  struct
    ...
    let parse xml =
      Some
        {
          encoded_message =
            (Aws.Xml.required "EncodedMessage"
               (Aws.Util.option_bind (Aws.Xml.member "EncodedMessage" xml)
                  String.parse))
        }
    let to_query v =
      Aws.Query.List
    ...
    let of_json j =
      {
        encoded_message =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "EncodedMessage")))
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          decoded_message =
            (Aws.Util.option_bind (Aws.Xml.member "DecodedMessage" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.decoded_message
              (fun f ->
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.decoded_message
              (fun f -> ("DecodedMessage", (String.to_json f)))])
    let of_json j =
      {
        decoded_message =
          (Aws.Util.option_map (Aws.Json.lookup j "DecodedMessage")
             String.of_json)
      }
  end
  ...
  struct
    ...
    let parse xml =
      Some
        {
          federated_user_id =
            (Aws.Xml.required "FederatedUserId"
               (Aws.Util.option_bind (Aws.Xml.member "FederatedUserId" xml)
                  String.parse));
          arn =
            (Aws.Xml.required "Arn"
               (Aws.Util.option_bind (Aws.Xml.member "Arn" xml) String.parse))
    ...
    let of_json j =
      {
        federated_user_id =
          (String.of_json
             (Aws.Util.of_option_exn (Aws.Json.lookup j "FederatedUserId")));
        arn =
          (String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "Arn")))
      }
  end
  ...
  struct
      ...
      Some
        {
          ...
          subject_type =
            (Aws.Util.option_bind (Aws.Xml.member "SubjectType" xml)
               String.parse);
          issuer =
            (Aws.Util.option_bind (Aws.Xml.member "Issuer" xml) String.parse);
          audience =
            (Aws.Util.option_bind (Aws.Xml.member "Audience" xml)
               String.parse);
          name_qualifier =
            (Aws.Util.option_bind (Aws.Xml.member "NameQualifier" xml)
               String.parse)
        }
    let to_query v =
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.name_qualifier
              (fun f -> Aws.Query.Pair ("NameQualifier", (String.to_query f)));
           Aws.Util.option_map v.audience
             (fun f -> Aws.Query.Pair ("Audience", (String.to_query f)));
           Aws.Util.option_map v.issuer
             (fun f -> Aws.Query.Pair ("Issuer", (String.to_query f)));
           Aws.Util.option_map v.subject_type
             (fun f -> Aws.Query.Pair ("SubjectType", (String.to_query f)));
    ...
    let to_json v =
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.name_qualifier
              (fun f -> ("NameQualifier", (String.to_json f)));
           Aws.Util.option_map v.audience
             (fun f -> ("Audience", (String.to_json f)));
           Aws.Util.option_map v.issuer
             (fun f -> ("Issuer", (String.to_json f)));
           Aws.Util.option_map v.subject_type
             (fun f -> ("SubjectType", (String.to_json f)));
           Aws.Util.option_map v.subject
    ...
    let of_json j =
      {
        ...
        subject_type =
          (Aws.Util.option_map (Aws.Json.lookup j "SubjectType")
             String.of_json);
        issuer =
          (Aws.Util.option_map (Aws.Json.lookup j "Issuer") String.of_json);
        audience =
          (Aws.Util.option_map (Aws.Json.lookup j "Audience") String.of_json);
        name_qualifier =
          (Aws.Util.option_map (Aws.Json.lookup j "NameQualifier")
             String.of_json)
      }
  end
      ...
      Some
        {
          credentials =
            (Aws.Util.option_bind (Aws.Xml.member "Credentials" xml)
               Credentials.parse);
          federated_user =
            (Aws.Util.option_bind (Aws.Xml.member "FederatedUser" xml)
               FederatedUser.parse);
          packed_policy_size =
            (Aws.Util.option_bind (Aws.Xml.member "PackedPolicySize" xml)
               Integer.parse)
      ...
      Aws.Query.List
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.packed_policy_size
              (fun f ->
                 Aws.Query.Pair ("PackedPolicySize", (Integer.to_query f)));
           Aws.Util.option_map v.federated_user
             (fun f ->
      ...
      `Assoc
        (Aws.Util.list_filter_opt
           [Aws.Util.option_map v.packed_policy_size
              (fun f -> ("PackedPolicySize", (Integer.to_json f)));
           Aws.Util.option_map v.federated_user
             (fun f -> ("FederatedUser", (FederatedUser.to_json f)));
           Aws.Util.option_map v.credentials
             (fun f -> ("Credentials", (Credentials.to_json f)))])
    let of_json j =
      {
        credentials =
          (Aws.Util.option_map (Aws.Json.lookup j "Credentials")
             Credentials.of_json);
        federated_user =
          (Aws.Util.option_map (Aws.Json.lookup j "FederatedUser")
